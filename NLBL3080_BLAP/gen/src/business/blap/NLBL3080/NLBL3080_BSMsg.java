...
/*
 *NLBL3080_BSMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLBL3080_BSMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** XX_SMRY_LINE_FLG_B2*/
	public final EZDSStringItem              xxSmryLineFlg_B2;
    ...
    /** CPO_ORD_NUM_B1*/
	public final EZDSStringItem              cpoOrdNum_B1;
    ...
    /** CPO_DTL_LINE_NUM_B1*/
	public final EZDSStringItem              cpoDtlLineNum_B1;

    /** CPO_DTL_LINE_SUB_NUM_B1*/
	public final EZDSStringItem              cpoDtlLineSubNum_B1;

    /** XX_DPLY_BY_ITEM_NM_B1*/
	public final EZDSStringItem              xxDplyByItemNm_B1;

    /** SVC_CONFIG_MSTR_PK_B1*/
	public final EZDSBigDecimalItem              svcConfigMstrPk_B1;

    /** T_MDL_NM_B1*/
	public final EZDSStringItem              t_MdlNm_B1;
    ...
    /** XX_SUPD_FLG_B1*/
	public final EZDSStringItem              xxSupdFlg_B1;
    ...
    /** ORD_QTY_B1*/
	public final EZDSBigDecimalItem              ordQty_B1;

    /** ORD_QTY_B2*/
	public final EZDSBigDecimalItem              ordQty_B2;
	...
	public final EZDSStringItem              dsOrdLineCatgDescTxt_B1;

    /** ORD_LINE_STS_NM_B1*/
	public final EZDSStringItem              ordLineStsNm_B1;
    ...
    /** SUPD_LOCK_FLG_B1*/
	public final EZDSStringItem              supdLockFlg_B1;

    /** SHPG_PLN_NUM_B1*/
	public final EZDSStringItem              shpgPlnNum_B1;

    /** TRX_SRC_TP_CD_B1*/
	public final EZDSStringItem              trxSrcTpCd_B1;

    /** INVTY_LOC_CD_B1*/
	public final EZDSStringItem              invtyLocCd_B1;

    /** REQ_SHPG_SVC_LVL_CD_B1*/
	public final EZDSStringItem              reqShpgSvcLvlCd_B1;

    /** CPO_ORD_TS_B1*/
	public final EZDSStringItem              cpoOrdTs_B1;
	...
	public final EZDSStringItem              svcMachMstrLocStsCd_B1;

    /** CUR_LOC_NUM_B1*/
	public final EZDSStringItem              curLocNum_B1;

    /** ALLOC_REQ_FLG_B1*/
	public final EZDSStringItem              allocReqFlg_B1;
	...
	/**
	 * NLBL3080_BSMsg is constructor.
	 * The initialization when the instance of NLBL3080_BSMsg is generated.
	 */
	public NLBL3080_BSMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLBL3080_BSMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		xxSmryLineFlg_B2 = (EZDSStringItem)newItem("xxSmryLineFlg_B2");
		xxChkBox_B1 = (EZDSStringItem)newItem("xxChkBox_B1");
		xxChkBox_B2 = (EZDSStringItem)newItem("xxChkBox_B2");
		cpoOrdNum_B1 = (EZDSStringItem)newItem("cpoOrdNum_B1");
		dsOrdPosnNum_B1 = (EZDSStringItem)newItem("dsOrdPosnNum_B1");
		dplyLineNum_B1 = (EZDSStringItem)newItem("dplyLineNum_B1");
		cpoDtlLineNum_B1 = (EZDSStringItem)newItem("cpoDtlLineNum_B1");
		cpoDtlLineSubNum_B1 = (EZDSStringItem)newItem("cpoDtlLineSubNum_B1");
		xxDplyByItemNm_B1 = (EZDSStringItem)newItem("xxDplyByItemNm_B1");
		svcConfigMstrPk_B1 = (EZDSBigDecimalItem)newItem("svcConfigMstrPk_B1");
		t_MdlNm_B1 = (EZDSStringItem)newItem("t_MdlNm_B1");
		...
		xxSupdFlg_B1 = (EZDSStringItem)newItem("xxSupdFlg_B1");
		...
		ordQty_B1 = (EZDSBigDecimalItem)newItem("ordQty_B1");
		ordQty_B2 = (EZDSBigDecimalItem)newItem("ordQty_B2");
		...
		dsOrdLineCatgDescTxt_B1 = (EZDSStringItem)newItem("dsOrdLineCatgDescTxt_B1");
		ordLineStsNm_B1 = (EZDSStringItem)newItem("ordLineStsNm_B1");
		...
		supdLockFlg_B1 = (EZDSStringItem)newItem("supdLockFlg_B1");
		shpgPlnNum_B1 = (EZDSStringItem)newItem("shpgPlnNum_B1");
		trxSrcTpCd_B1 = (EZDSStringItem)newItem("trxSrcTpCd_B1");
		invtyLocCd_B1 = (EZDSStringItem)newItem("invtyLocCd_B1");
		reqShpgSvcLvlCd_B1 = (EZDSStringItem)newItem("reqShpgSvcLvlCd_B1");
		cpoOrdTs_B1 = (EZDSStringItem)newItem("cpoOrdTs_B1");
		setShpgPlnNum_B1 = (EZDSStringItem)newItem("setShpgPlnNum_B1");
		svcMachMstrPk_B1 = (EZDSBigDecimalItem)newItem("svcMachMstrPk_B1");
		svcMachMstrLocStsCd_B1 = (EZDSStringItem)newItem("svcMachMstrLocStsCd_B1");
		curLocNum_B1 = (EZDSStringItem)newItem("curLocNum_B1");
		allocReqFlg_B1 = (EZDSStringItem)newItem("allocReqFlg_B1");
	 ...
	 * @return NLBL3080_BSMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLBL3080_BSMsgArray();
	}
