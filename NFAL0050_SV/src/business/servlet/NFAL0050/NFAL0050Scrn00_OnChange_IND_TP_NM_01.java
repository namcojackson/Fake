 ...
 * NFAL0050Scrn00_OnChange_IND_TP_NM_01
 * <dd>Remarks:
 * @version 1.0
 * @author N.Sasaki
 */
public class NFAL0050Scrn00_OnChange_IND_TP_NM_01 extends S21CommonHandler implements NFAL0050Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.ajePtrnIndTpCd_1V.isClear()) {
    ...
    private void inputProtectedOtherIndType(NFAL0050BMsg scrnMsg) {
        scrnMsg.ajePtrnIndTpCd_1V.setInputProtected(false);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        String selectedVal = scrnMsg.ajePtrnIndTpCd_1V.getValue();
        String indTpCd02 = scrnMsg.ajePtrnIndTpCd_2V.getValue();
        // Check if Indicator type code 2 already exists
        if (selectedVal.equals(DEFAULT_VAL_CD_3) && // Is default
                (!indTpCd02.equals(BLANK) && !indTpCd02.equals(DEFAULT_VAL_CD_3))) {
            scrnMsg.ajePtrnIndTpCd_1V.setErrorInfo(1, "NFAM0059E", new String[] {"Default", "Type 2" });
            inputProtectedOtherIndType(scrnMsg);
            common.setUnEditableMode(scrnMsg, this);
        }
        if (!selectedVal.equals(DEFAULT_VAL_CD_3) && // NOT default
                (selectedVal.equals(scrnMsg.ajePtrnIndTpCd_2V.getValue()) || selectedVal.equals(scrnMsg.ajePtrnIndTpCd_3V.getValue()))) {
            scrnMsg.ajePtrnIndTpCd_1V.setErrorInfo(1, "NFAM0060E", new String[] {"Indicator Type" });
            inputProtectedOtherIndType(scrnMsg);
            common.setUnEditableMode(scrnMsg, this);
        }
        scrnMsg.addCheckItem(scrnMsg.ajePtrnIndTpCd_1V);
