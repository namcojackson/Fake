 ...
 * NFAL0050Scrn00_OnChange_IND_TP_NM_02
 * <dd>Remarks:
 * @version 1.0
 * @author N.Sasaki
 */
public class NFAL0050Scrn00_OnChange_IND_TP_NM_02 extends S21CommonHandler implements NFAL0050Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.ajePtrnIndTpCd_2V.isClear()) {
    ...
    private void inputProtectedOtherIndType(NFAL0050BMsg scrnMsg) {
        ...
        scrnMsg.ajePtrnIndTpCd_2V.setInputProtected(false);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        String selectedVal = scrnMsg.ajePtrnIndTpCd_2V.getValue();
        String indTpCd03 = scrnMsg.ajePtrnIndTpCd_3V.getValue();

        if (selectedVal.equals(DEFAULT_VAL_CD_3) // Is default
                && (!indTpCd03.equals(BLANK) && !indTpCd03.equals(DEFAULT_VAL_CD_3))) {
            scrnMsg.ajePtrnIndTpCd_2V.setErrorInfo(1, "NFAM0059E", new String[] {"Default", "Type 3" });
            inputProtectedOtherIndType(scrnMsg);
            common.setUnEditableMode(scrnMsg, this);
        }
        if (!selectedVal.equals(DEFAULT_VAL_CD_3) // Not default
                && (selectedVal.equals(scrnMsg.ajePtrnIndTpCd_1V.getValue()) || selectedVal.equals(scrnMsg.ajePtrnIndTpCd_3V.getValue()))) {
            scrnMsg.ajePtrnIndTpCd_2V.setErrorInfo(1, "NFAM0060E", new String[] {"Indicator Type" });
            inputProtectedOtherIndType(scrnMsg);
            common.setUnEditableMode(scrnMsg, this);
        }
        scrnMsg.addCheckItem(scrnMsg.ajePtrnIndTpCd_2V);
