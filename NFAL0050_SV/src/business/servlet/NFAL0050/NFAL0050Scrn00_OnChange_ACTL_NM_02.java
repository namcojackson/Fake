 ...
 * NFAL0050Scrn00_OnChange_ACTL_NM_02
 * <dd>Remarks:
 * @version 1.0
 * @author N.Sasaki
 */
public class NFAL0050Scrn00_OnChange_ACTL_NM_02 extends S21CommonHandler implements NFAL0050Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.ajePtrnActlCd_2V.isClear()) {
    ...
    private void inputProtectedOtherIndType(NFAL0050BMsg scrnMsg) {
        ...
        scrnMsg.ajePtrnActlCd_2V.setInputProtected(false);
