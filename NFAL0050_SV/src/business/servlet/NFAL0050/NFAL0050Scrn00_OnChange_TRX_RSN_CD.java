 ...
 * NFAL0050Scrn00_OnChange_TRX_RSN_CD
 * <dd>Remarks:
 * @version 1.0
 * @author N.Sasaki
 */
public class NFAL0050Scrn00_OnChange_TRX_RSN_CD extends S21CommonHandler implements NFAL0050Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.trxRsnCd_3.isClear()) {
            // NFAM0043E=0,Invalid @
            scrnMsg.trxRsnCd_3.setErrorInfo(1, "NFAM0043E", new String[] {"input" });
        }
