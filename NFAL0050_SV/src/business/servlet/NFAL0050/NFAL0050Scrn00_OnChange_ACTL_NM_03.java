 ...
 * NFAL0050Scrn00_OnChange_ACTL_NM_03
 * <dd>Remarks:
 * @version 1.0
 * @author N.Sasaki
 */
public class NFAL0050Scrn00_OnChange_ACTL_NM_03 extends S21CommonHandler implements NFAL0050Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.ajePtrnActlCd_3V.isClear()) {
    ...
    private void inputProtectedOtherIndType(NFAL0050BMsg scrnMsg) {
        ...
        scrnMsg.ajePtrnActlCd_3V.setInputProtected(false);
    }
