 ...
 *</pre>
 */
public class NPAL1160Scrn00_TAB_Transaction extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxDplyTab.setValue(DISPLAY_TAB_NM_TRANSACTION);
        NPAL1160CommonLogic.clearTable(scrnMsg, DISPLAY_TAB_NM_TRANSACTION);
