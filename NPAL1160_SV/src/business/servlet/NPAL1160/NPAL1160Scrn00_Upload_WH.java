 ...
 *</pre>
 */
public class NPAL1160Scrn00_Upload_WH extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.rtlWhNm_LT.clear();

        NPAL1160CommonLogic.setTableScreenD(this, scrnMsg);

        // Set focus
        int index = scrnMsg.D.getValidCount();
        if(index != 0){
            scrnMsg.setFocusItem(scrnMsg.D.no(index - 1).apvlTeamNm_D1);
        }
