...
/*
 *NLEL0060_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLEL0060_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** DS_ASSET_MSTR_PK_A1*/
	public final EZDCBigDecimalItem              dsAssetMstrPk_A1;

    /** DS_ASSET_DESC_TXT_A1*/
	public final EZDCStringItem              dsAssetDescTxt_A1;

    /** ASSET_TP_DESC_TXT_A1*/
	public final EZDCStringItem              assetTpDescTxt_A1;

    /** ASSET_STS_CD_A1*/
	public final EZDCStringItem              assetStsCd_A1;

    /** ASSET_STS_DESC_TXT_A1*/
	public final EZDCStringItem              assetStsDescTxt_A1;

    /** DEPC_MTH_NUM_A1*/
	public final EZDCStringItem              depcMthNum_A1;

    /** TOT_ASSET_QTY_A1*/
	public final EZDCBigDecimalItem              totAssetQty_A1;

    /** DEPC_START_DT_A1*/
	public final EZDCDateItem              depcStartDt_A1;
    ...
    /** ASSET_TAG_NUM_A1*/
	public final EZDCStringItem              assetTagNum_A1;

    /** DS_ASSET_GRP_INIT_BOOK_AMT_A1*/
	public final EZDCBigDecimalItem              dsAssetGrpInitBookAmt_A1;

    /** CUR_VAL_AMT_A1*/
	public final EZDCBigDecimalItem              curValAmt_A1;

    /** AMT_CHNG_RSN_TP_CD_A1*/
	public final EZDCStringItem              amtChngRsnTpCd_A1;

    /** PRNT_DS_ASSET_MSTR_PK_A1*/
	public final EZDCBigDecimalItem              prntDsAssetMstrPk_A1;
    ...
    /** LAST_DEPC_YR_MTH_A1*/
	public final EZDCDateItem              lastDepcYrMth_A1;

    /** SVC_MACH_MSTR_PK_A1*/
	public final EZDCBigDecimalItem              svcMachMstrPk_A1;

    /** MAN_ENTRY_FLG_A1*/
	public final EZDCStringItem              manEntryFlg_A1;

    /** SHIP_TO_CUST_ACCT_CD_A1*/
	public final EZDCStringItem              shipToCustAcctCd_A1;

    /** DEPC_CNT_A1*/
	public final EZDCBigDecimalItem              depcCnt_A1;

    /** INIT_BOOK_AMT_A1*/
	public final EZDCBigDecimalItem              initBookAmt_A1;

    /** RSDL_VAL_AMT_A1*/
	public final EZDCBigDecimalItem              rsdlValAmt_A1;

    /** XX_PG_FLG_A1*/
	public final EZDCStringItem              xxPgFlg_A1;

    /** DTL_CMNT_TXT_A1*/
	public final EZDCStringItem              dtlCmntTxt_A1;

    /** ADJ_COA_ACCT_CD_A1*/
	public final EZDCStringItem              adjCoaAcctCd_A1;


	/**
	 * NLEL0060_ACMsg is constructor.
	 * The initialization when the instance of NLEL0060_ACMsg is generated.
	 */
	public NLEL0060_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLEL0060_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		xxChkBox_A1 = (EZDCStringItem)newItem("xxChkBox_A1");
		dsAssetMstrPk_A1 = (EZDCBigDecimalItem)newItem("dsAssetMstrPk_A1");
		dsAssetDescTxt_A1 = (EZDCStringItem)newItem("dsAssetDescTxt_A1");
		assetTpDescTxt_A1 = (EZDCStringItem)newItem("assetTpDescTxt_A1");
		assetStsCd_A1 = (EZDCStringItem)newItem("assetStsCd_A1");
		assetStsDescTxt_A1 = (EZDCStringItem)newItem("assetStsDescTxt_A1");
		depcMthNum_A1 = (EZDCStringItem)newItem("depcMthNum_A1");
		totAssetQty_A1 = (EZDCBigDecimalItem)newItem("totAssetQty_A1");
		depcStartDt_A1 = (EZDCDateItem)newItem("depcStartDt_A1");
		...
		assetTagNum_A1 = (EZDCStringItem)newItem("assetTagNum_A1");
		dsAssetGrpInitBookAmt_A1 = (EZDCBigDecimalItem)newItem("dsAssetGrpInitBookAmt_A1");
		curValAmt_A1 = (EZDCBigDecimalItem)newItem("curValAmt_A1");
		amtChngRsnTpCd_A1 = (EZDCStringItem)newItem("amtChngRsnTpCd_A1");
		prntDsAssetMstrPk_A1 = (EZDCBigDecimalItem)newItem("prntDsAssetMstrPk_A1");
		...
		lastDepcYrMth_A1 = (EZDCDateItem)newItem("lastDepcYrMth_A1");
		svcMachMstrPk_A1 = (EZDCBigDecimalItem)newItem("svcMachMstrPk_A1");
		manEntryFlg_A1 = (EZDCStringItem)newItem("manEntryFlg_A1");
		shipToCustAcctCd_A1 = (EZDCStringItem)newItem("shipToCustAcctCd_A1");
		depcCnt_A1 = (EZDCBigDecimalItem)newItem("depcCnt_A1");
		initBookAmt_A1 = (EZDCBigDecimalItem)newItem("initBookAmt_A1");
		rsdlValAmt_A1 = (EZDCBigDecimalItem)newItem("rsdlValAmt_A1");
		xxPgFlg_A1 = (EZDCStringItem)newItem("xxPgFlg_A1");
		dtlCmntTxt_A1 = (EZDCStringItem)newItem("dtlCmntTxt_A1");
		adjCoaAcctCd_A1 = (EZDCStringItem)newItem("adjCoaAcctCd_A1");
	}

	/**
	 * get the type of array which is stored
	 * @return NLEL0060_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLEL0060_ACMsgArray();
	}
