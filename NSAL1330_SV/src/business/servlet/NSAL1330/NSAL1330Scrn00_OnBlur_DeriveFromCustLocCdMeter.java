...
/**
 *<pre>
 * NSAL1330Scrn00_OnBlur_DeriveFromCustLocCdMeter
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OnBlur_DeriveFromCustLocCdMeter extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.U.no(selectIndex).billToLocNum_U)) {
            scrnMsg.addCheckItem(scrnMsg.U.no(selectIndex).billToLocNum_U);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.U.no(selectIndex).billToLocNum_U)) {
            ...
            scrnMsg.setFocusItem(scrnMsg.U.no(selectIndex).xxGenlFldAreaTxt_U);
            return;
        }
        ...
        scrnMsg.setFocusItem(scrnMsg.U.no(selectIndex).billToLocNum_U);
    }
}
