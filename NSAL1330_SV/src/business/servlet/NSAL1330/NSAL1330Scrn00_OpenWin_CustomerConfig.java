...
import static business.servlet.NSAL1330.constant.NSAL1330Constant.LINK_CUSTOMER;
...
/**
 *<pre>
 * NSAL1330Scrn00_OpenWin_CustomerConfig
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OpenWin_CustomerConfig extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.manContrOvrdFlg.getValue()) || NSAL1330CommonLogic.isImport(scrnMsg)) {
            scrnMsg.setMessageInfo(NSAM0655E, new String[] {LINK_CUSTOMER, LINK_CUSTOMER });
