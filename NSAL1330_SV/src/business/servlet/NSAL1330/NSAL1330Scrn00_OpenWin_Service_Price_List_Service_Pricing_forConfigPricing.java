...
/**
 *<pre>
 * NSAL1330Scrn00_OpenWin_Service_Price_List_Service_Pricing_forConfigPricing
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OpenWin_Service_Price_List_Service_Pricing_forConfigPricing extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSAL1330_RBMsg rScrnMsg = scrnMsg.R.no(index);
        if (rScrnMsg.prcCatgNm_R.isInputProtected()) {
            scrnMsg.setMessageInfo(NSAM0655E, new String[] {LINK_SVC_PRC_LIST, LINK_SVC_PRC_LIST });
            throw new EZDFieldErrorException();
        }
        Object[] params = NSAL1330CommonLogic.getNWAL1760Prm(scrnMsg, POP_UP_SVC_PRC_SPC, PRC_CTX_TP.SERVICE_PRICING, null);
