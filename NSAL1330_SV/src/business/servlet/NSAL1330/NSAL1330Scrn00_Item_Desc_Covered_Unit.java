 ...
 *</pre>
 */
public class NSAL1330Scrn00_Item_Desc_Covered_Unit extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.C.no(index).mdseCd_CU)) {
            scrnMsg.C.no(index).mdseCd_CU.setErrorInfo(1, NSAM0649E, new String[] {"Covered Unit" });
