...
/**
 *<pre>
 * NSAL1330Scrn00_OnBlur_CoveredUnit
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OnBlur_CoveredUnit extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.C.no(selectIndex).mdseCd_CU);
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        NSAL1330BMsg scrnMsg = (NSAL1330BMsg) bMsg;
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.C.no(selectIndex).mdseCd_CU)) {
            return null;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.C.no(selectIndex).mdseCd_CU)) {
            scrnMsg.setFocusItem(scrnMsg.C.no(selectIndex).mdseCd_CU);
            scrnMsg.C.no(selectIndex).mdseDescShortTxt_CU.clear();
            return;
        }
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxRqstFlg.getValue())) {
            ...
            Object[] params = NSAL1330CommonLogic.getCoveredUnitPopUpPrm(scrnMsg, getButtonSelectNumber());
