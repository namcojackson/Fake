...
/**
 *<pre>
 * NSAL1330Scrn00_OnBlur_CoveredItem
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OnBlur_CoveredItem extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.J.no(selectIndex).mdseCd_J);
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        NSAL1330BMsg scrnMsg = (NSAL1330BMsg) bMsg;
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.J.no(selectIndex).mdseCd_J)) {
            return null;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.J.no(selectIndex).mdseCd_J)) {
            scrnMsg.setFocusItem(scrnMsg.J.no(selectIndex).mdseCd_J);
            scrnMsg.J.no(selectIndex).mdseDescShortTxt_J.clear();
            return;
        }
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxRqstFlg.getValue())) {
            ...
            Object[] params //
            = NSAL1330CommonLogic.getCoveredItemPopUpPrm(scrnMsg, getButtonSelectNumber(), POP_UP_COVERED_ITEM, scrnMsg.J.no(selectIndex).mdseCd_J.getValue());
