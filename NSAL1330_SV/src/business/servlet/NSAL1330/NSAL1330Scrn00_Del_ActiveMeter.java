...
/**
 *<pre>
 * NSAL1330Scrn00_Del_ActiveMeter
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_Del_ActiveMeter extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.U.no(index).prcListBandDescTxt_U);
        if (scrnMsg.getMessageCode().endsWith("E")) {
            scrnMsg.setFocusItem(scrnMsg.U.no(index).prcListBandDescTxt_U);
