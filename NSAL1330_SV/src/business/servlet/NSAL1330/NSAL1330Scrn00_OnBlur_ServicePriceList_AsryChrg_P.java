...
/**
 *<pre>
 * NSAL1330Scrn00_OnBlur_ServicePriceList_AsryChrg_P
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OnBlur_ServicePriceList_AsryChrg_P extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.J.no(selectIndex).prcCatgNm_J);
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        NSAL1330BMsg scrnMsg = (NSAL1330BMsg) bMsg;
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.J.no(selectIndex).prcCatgNm_J)) {
            scrnMsg.J.no(selectIndex).addlBasePrcCatgCd_J.clear();
            return null;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.J.no(selectIndex).prcCatgNm_J)) {
            scrnMsg.setFocusItem(scrnMsg.J.no(selectIndex).prcCatgNm_J);
            scrnMsg.J.no(selectIndex).addlBasePrcCatgCd_J.clear();
            return;
        }
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxRqstFlg.getValue())) {
            ...
            = NSAL1330CommonLogic.getNWAL1760Prm(//
                    ...
                    , scrnMsg.J.no(selectIndex).prcCatgNm_J.getValue());
            setArgForSubScreen(params);
        }

        scrnMsg.setFocusItem(scrnMsg.J.no(selectIndex).prcListEquipConfigNum_J);
    }
}
