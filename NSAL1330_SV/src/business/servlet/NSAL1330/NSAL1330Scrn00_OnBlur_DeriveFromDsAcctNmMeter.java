...
/**
 *<pre>
 * NSAL1330Scrn00_OnBlur_DeriveFromDsAcctNmMeter
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OnBlur_DeriveFromDsAcctNmMeter extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.U.no(selectIndex).dsAcctNm_U)) { // 2017/03/29 S21_NA#18171 Mod
            scrnMsg.addCheckItem(scrnMsg.U.no(selectIndex).dsAcctNm_U); // 2017/03/29 S21_NA#18171 Mod
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.U.no(selectIndex).dsAcctNm_U)) { // 2017/03/29 S21_NA#18171 Mod
            scrnMsg.U.no(selectIndex).billToCustCd_U.clear();
            scrnMsg.U.no(selectIndex).billToLocNum_U.clear();
            scrnMsg.U.no(selectIndex).xxGenlFldAreaTxt_U.clear();
            scrnMsg.setFocusItem(scrnMsg.U.no(selectIndex).dsAcctNm_U); // 2017/03/29 S21_NA#18171 Mod
            return;
        }
