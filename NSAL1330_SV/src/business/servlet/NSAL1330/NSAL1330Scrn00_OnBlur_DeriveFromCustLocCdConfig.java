...
/**
 *<pre>
 * NSAL1330Scrn00_OnBlur_DeriveFromCustLocCdConfig
 *
 ...
 *</pre>
 */
public class NSAL1330Scrn00_OnBlur_DeriveFromCustLocCdConfig extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.R.no(selectIndex).billToLocNum_R)) {
            scrnMsg.addCheckItem(scrnMsg.R.no(selectIndex).billToLocNum_R);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.R.no(selectIndex).billToLocNum_R)) {
            ...
            scrnMsg.setFocusItem(scrnMsg.R.no(selectIndex).xxGenlFldAreaTxt_R);
            return;
        }
        ...
        scrnMsg.setFocusItem(scrnMsg.R.no(selectIndex).billToLocNum_R);
    }
}
