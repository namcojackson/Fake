...
public class ZZML0040Scrn00_Edit extends S21CommonHandler implements ZZML0040Constant {
	...
	protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        System.out.println(bizMsg.xxRowNum.getValueInt());
 		return bizMsg;
	}
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.mlTmplId_01.setInputProtected(true);
        scrnMsg.mlLocId_01.setInputProtected(true);
