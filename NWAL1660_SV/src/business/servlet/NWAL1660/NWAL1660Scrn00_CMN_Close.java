...
/**
 *<pre>
 * NWAL1660Scrn00_CMN_Close
 *
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2015/11/09   Fujitsu         M.Yamada        Create          N/A
 *</pre>
 */
public class NWAL1660Scrn00_CMN_Close extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (arg instanceof Object[]) {
            NWAL1660CommonLogic.setOutputParam((Object[]) arg, bizMsg);
        }
    }
}
