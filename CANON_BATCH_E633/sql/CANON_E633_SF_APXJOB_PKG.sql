create or replace PACKAGE CANON_E633_SF_APXJOB_PKG
AS
...
END CANON_E633_SF_APXJOB_PKG;
/

create or replace PACKAGE BODY CANON_E633_SF_APXJOB_PKG
AS

G_PACKAGE_NAME        VARCHAR2 (5000) := 'CANON_E633_SF_APXJOB_PKG';
...
PROCEDURE get_apxjob_setup(p_batch_program    IN VARCHAR2
   ...
   SELECT source_name
         ...
         ,last_finished_date
     FROM canon_e633_sf_apxjob_setup_tbl
   ...
   BEGIN
   UPDATE canon_e633_sf_apxjob_setup_tbl
