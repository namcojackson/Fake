CREATE OR REPLACE PACKAGE CANON_E633_SF_ERROR_LOG_PKG
AS
PROCEDURE log_error
...
END canon_e633_sf_error_log_pkg;
/

CREATE OR REPLACE PACKAGE BODY CANON_e633_SF_ERROR_LOG_PKG
AS
...
IS
   ...
   BEGIN
      --IF l_debug = TRUE THEN
         INSERT INTO CANON_e633_SF_ERRORS_TBL
                     (package_name,
                      process_name,
                      key1,
                      key2,
...
EXCEPTION
   WHEN OTHERS THEN
      dbms_output.put_line('Unexpected error occured while logging the errors in CANON_e633_SF_ERRORS_TBL. Oracle Error Message:' || SQLERRM);
END log_error;
END canon_e633_sf_error_log_pkg;
/
