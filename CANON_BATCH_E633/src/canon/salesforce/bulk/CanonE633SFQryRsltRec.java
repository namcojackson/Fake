...
public class CanonE633SFQryRsltRec implements java.sql.SQLData, java.io.Serializable {
        ...
        public CanonE633SFQryRsltRec() {
        }

        public CanonE633SFQryRsltRec(String sfdcid, String attribute1,
        ...
        public String getSQLTypeName() throws SQLException {
            return "CANON_E633_SF_QRY_RSLT_REC";
        }
        ...
        public static oracle.sql.ARRAY canonE633SFQryRsltTblListToArray(List list, Connection connection) throws SQLException {
   		 System.out.println("connection : " +connection);
   		 System.out.println("connection : " +connection.getMetaData().getConnection());
   		ArrayDescriptor arraydesc = ArrayDescriptor.createDescriptor("CANON_E633_SF_QRY_RSLT_TBL",connection.getMetaData().getConnection());
   		System.out.println("arraydesc : " +arraydesc);
            ...
            CanonE633SFQryRsltRec[] elements = (CanonE633SFQryRsltRec[]) list.toArray(new CanonE633SFQryRsltRec[0]);
		...
		public String toString() {
			return "CanonE633SFQryRsltRec [sfdcid=" + sfdcid
