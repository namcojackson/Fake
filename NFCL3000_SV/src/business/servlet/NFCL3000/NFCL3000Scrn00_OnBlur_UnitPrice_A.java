 ...
 *</pre>
 */
public class NFCL3000Scrn00_OnBlur_UnitPrice_A extends S21CommonHandler {
...
//        scrnMsg.addCheckItem(scrnMsg.A.no(no).shipQty_A1);
//        scrnMsg.addCheckItem(scrnMsg.A.no(no).dealNetUnitPrcAmt_A1);
        
//        NFCL3000CommonLogic.addCheckItem_Calc_Line(scrnMsg);
