 ...
 * ----------------------------------------------------------------------
 * 2016/04/20   Fujitsu         T.Tanaka        Create          N/A
 *</pre>
 */
public class NFCL3000Scrn00_Select_InvBolLineNum_A extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NFCL3000CommonLogic.addCheckItem_A_Line(scrnMsg);
