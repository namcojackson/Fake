 ...
 * ----------------------------------------------------------------------
 * 2016/03/10   CUSA            Fujitsu         Create          N/A
 *</pre>
 */
public class NFCL3000Scrn00_Select_PaymentMethod extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if(scrnMsg.dsPmtMethCd_E1.getValue().equals(DS_PMT_METH.CREDIT_CARD)) {
            this.setButtonProperties("CreditCard"   , "CreditCard"   , "Credit Card"   , 1, null);
        } else {
            this.setButtonProperties("CreditCard"   , "CreditCard"   , "Credit Card"   , 0, null);
        }
    }
}
