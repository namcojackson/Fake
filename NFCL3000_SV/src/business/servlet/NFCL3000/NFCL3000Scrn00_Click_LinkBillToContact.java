 ...
 *</pre>
 */
public class NFCL3000Scrn00_Click_LinkBillToContact extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(0).xxPopPrm, scrnMsg.ctacPsnPk_H3.toString());
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(3).xxPopPrm, scrnMsg.billToCustAcctCd_H3.getValue());
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(4).xxPopPrm, scrnMsg.locNum_H3.getValue());
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(19).xxPopPrm, scrnMsg.ctacPsnPk_H3.toString());
        ...
        params[19] = scrnMsg.ctacPsnPk_H3;
