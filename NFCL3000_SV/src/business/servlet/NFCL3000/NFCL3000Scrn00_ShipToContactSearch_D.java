...
/**
 *<pre>
 * NFCL3000Scrn00_ShipToContactSearch_D
 *
 ...
 *</pre>
 */
public class NFCL3000Scrn00_ShipToContactSearch_D extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(3).xxPopPrm, scrnMsg.D.no(idx).shipToCustAcctCd_D1.getValue());
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(4).xxPopPrm, scrnMsg.D.no(idx).locNum_D1.getValue());
