 ...
 * ----------------------------------------------------------------------
 * 2016/02/01   Fujitsu         T.Tanaka        Create          N/A
 *</pre>
 */
public class NFCL3000Scrn00_Select_InvLineNum_B extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NFCL3000CommonLogic.addCheckItem_SlsCr(scrnMsg, false);
