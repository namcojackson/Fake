...
import static business.servlet.NPAL1080.constant.NPAL1080Constant.NMAM0288E;
 ...
 *</pre>
 */
public class NPAL1080Scrn00_Search extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NPAL1080BMsg scrnMsg = (NPAL1080BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.prchReqNum_H1)) {
            scrnMsg.prchReqNum_H1.setErrorInfo(1, NMAM0288E, new String[] {});
        }
