 ...
 *</pre>
 */
public class NPAL1080Scrn00_GetItemName extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(idx).mdseCd_D1)) {
            scrnMsg.A.no(idx).mdseCd_D1.setErrorInfo(1, NPAM1329E, new String[] {"Item#", " Please select." });
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(idx).mdseCd_D1);
    }
}
