 ...
 * Function Name : Button Action to Select All
 * </pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NPAL1080Scrn00_SelectAll extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
            ...
            if (BigDecimal.ZERO.equals(scrnMsg.A.no(i).prchReqLineSubNum_D1.getValue())) {
                scrnMsg.A.no(i).xxChkBox_D1.setValue(ZYPConstant.CHKBOX_ON_Y);
            }
        }
    }
}
