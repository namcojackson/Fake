 ...
 *</pre>
 */
public class NSAL1310Scrn00_Search extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NSAL1310BMsg scrnMsg = (NSAL1310BMsg) bMsg;
        scrnMsg.addCheckItem(scrnMsg.svcCovTmplTpCd_SV);
        scrnMsg.addCheckItem(scrnMsg.svcTermAttrbDescTxt_H);
