...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NWAL2180Scrn00">
			<!-- Set Page Name -->
			...
			<td>
				<table width="100%" id="shellHeader" style="table-layout:fixed" border="0">
					...
					<tr>
						...
						<td>
							<ezf:inputText name="dsImptSvcLineNum" ezfName="dsImptSvcLineNum" value="1" otherAttr=" size=\"3\" maxlength=\"3\" ezftoupper=\"\""/>
						</td>
						<td class="stab">
							Service Program
						</td>
						<td colspan="3">
							...
							<ezf:inputText name="dsImptSvcMdseCd" ezfName="dsImptSvcMdseCd" value="153ZZ884" otherAttr=" size=\"10\" maxlength=\"30\" ezftoupper=\"\""/>
						</td>
					...
					<tr>
						...
						<td>
							...
							<ezf:inputText name="shpgIntvlMthNum" ezfName="shpgIntvlMthNum" value="12" otherAttr=" size=\"3\" maxlength=\"3\" style=\"text-align:right;\""/>
						</td>
						<td class="stab">
							Contract Indicator
						</td>
	                    ...
	                    <td>
	                    	<ezf:inputText name="dsContrNum" ezfName="dsContrNum" value="123456789012345" otherAttr=" size=\"10\" maxlength=\"30\" ezftoupper=\"\""/>
	                    </td>
					...
					<tr>
						...
						<td>
							<ezf:inputText name="fixTermInMthAot" ezfName="fixTermInMthAot" value="123" otherAttr=" size=\"3\" maxlength=\"3\" style=\"text-align:right;\""/>
						</td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr>
						...
						<td colspan="4">
							<ezf:inputText name="xxBillToAcctNmSrchTxt" ezfName="xxBillToAcctNmSrchTxt" value="2408 N HIGHWAY 67 US TITLE FLORISSANT,MO 63033-2036" otherAttr=" size=\"32\" maxlength=\"1000\""/>
...
<%@ page import="business.servlet.NWAL2180.NWAL2180BMsg" %>
...
<% NWAL2180BMsg bMsg = (NWAL2180BMsg)databean.getEZDBMsg(); %>
		...
		<%--	A <ezf:row ezfHyo="A">	--%>
	                                ...
	                                <table width="1089" cellpadding="0" cellspacing="0" border="0" style="table-layout:fixed;">
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td>
	                                        	<ezf:inputText name="shpgIntvlMthNum_A" ezfName="shpgIntvlMthNum_A" value="12" ezfHyo="A" ezfArrayNo="<%= i %>" otherAttr=" size=\"2\" maxlength=\"2\" ezftoupper=\"\""/>
	                                        </td>
	                                        <td>
	                                        	<!--
	                                        	<ezf:inputButton name="OpenWin_Supply_Agreement" value="Supply Agreement" ezfHyo="A" ezfArrayNo="<%= i %>" htmlClass="pBtn9" />
	                                        	-->
	                                        </td>
	                                    </tr>
	                                </table>
	                            ...
	                            <div style="overflow-x:none;width:0854; margin-left:30px;" id="<%= "usgPrc" + i %>" >
	                                <table width="0840" border="1" cellpadding="1" cellspacing="0" style="table-layout: fixed;word-break: normal;}">
	                                    ...
	                                    <tr height="034">
	                                        ...
	                                        <td class="pClothBs">Billing Counter Name<BR />
	                                                             Hard Counter Name/Multiplier</td>
	                                        <td class="pClothBs">Covered<BR />
		                                                         Images</td>
	                                        <td class="pClothBs">Image<BR />
		                                                         Charge</td>
	                                        <td class="pClothBs">Tier</td>
	                                        <td class="pClothBs">Free Copy</td>
	                                        <td class="pClothBs">Min. Vol</td>
	                                        <td class="pClothBs">Min. Amt</td>
	                                        <td class="pClothBs">Roll<BR />
	                                                             Over %</td>
	                                    </tr>
	                                </table>
                ...
                (DS_CONTR_CATG.FLEET.equals(bMsg.dsContrCatgCd.getValue()) ||
                	(ZYPCommonFunc.hasValue(modelId) && ZYPCommonFunc.hasValue(modelId_Z) && modelId.compareTo(modelId_Z) == 0))) { %>
	                                    ...
	                                    <tr valign="top">
	                                        ...
	                                        <td>
	                                            <ezf:inputText name="mtrLbDescTxt_ZB" ezfName="mtrLbDescTxt_ZB" value="BIL BW" ezfHyo="Z" ezfArrayNo="<%= j %>" otherAttr=" size=\"20\" maxlength=\"50\" ezftoupper=\"\""/>
	                                        ...
	                                        <td>
	                                            <!-- Free Copy -->
	                                        	<ezf:inputText name="bllgFreeCopyCnt_Z" ezfName="bllgFreeCopyCnt_Z" value="12000" ezfHyo="Z" ezfArrayNo="<%= j %>" otherAttr=" size=\"10\" maxlength=\"12\" ezftoupper=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                            <!-- Min. Vol -->
	                                        	<ezf:inputText name="bllgMinCnt_Z" ezfName="bllgMinCnt_Z" value="200000" ezfHyo="Z" ezfArrayNo="<%= j %>" otherAttr=" size=\"10\" maxlength=\"12\" ezftoupper=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                            <!-- Min. Amt -->
	                                        	<ezf:inputText name="bllgMinAmtRate_Z" ezfName="bllgMinAmtRate_Z" value="150" ezfHyo="Z" ezfArrayNo="<%= j %>" otherAttr=" size=\"10\" maxlength=\"12\" ezftoupper=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                            <!-- Roll Over % -->
	                                        	<ezf:inputText name="bllgRollOverRatio_Z" ezfName="bllgRollOverRatio_Z" value="0.05000" ezfHyo="Z" ezfArrayNo="<%= j %>" otherAttr=" size=\"10\" maxlength=\"12\" ezftoupper=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td>
	                                        	&nbsp;
                                                <ezf:inputHidden name="xsMtrAmtRate_Z" ezfName="xsMtrAmtRate_Z" value="0.05000" ezfHyo="Z" ezfArrayNo="<%= j %>" otherAttr=" size=\"8\" maxlength=\"7\" ezftoupper=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                        	&nbsp;
	                                        </td>
                                        ...
                                        <ezf:inputHidden name="dsImptSvcUsgPrcPk_Z" ezfName="dsImptSvcUsgPrcPk_Z" ezfHyo="Z" ezfArrayNo="<%= j %>"/>
...
<%--	Z </ezf:row>	--%>
		...
		<table style="margin-left:10px">
			<tr>
				...
				<td>
					<ezf:inputButton name="ApplyAllFromModel" value="Apply All" ezfHyo="A" ezfArrayNo="<%= i %>" htmlClass="pBtn4" />
				</td>
			</tr>
		</table>
	...
	<div id=<%= "configPricing" + i %>>
			<% for ( int ixR = 0; ixR < bMsg.R.getValidCount(); ixR++ ) { %>
			    ...
			    <% BigDecimal cpoSvcConfigRefPk_R = bMsg.R.no( ixR ).cpoSvcConfigRefPk_R.getValue(); %>
				...
				<%--	R <ezf:row ezfHyo="R">	--%>
	    			<div id=<%= "configSvcPrc" + ixR %> style="BACKGROUND-COLOR: #e9E9ff;">
	                    ...
	                    <table width="1059" cellpadding="0" cellspacing="0" border="0" style="table-layout:fixed;">
	                        ...
	                        <tr>
	                            ...
	                            <td class="stab">Term </td>
	                            <td>
	                            	<ezf:inputText name="shpgIntvlMthNum_R" ezfName="shpgIntvlMthNum_R" value="12" ezfHyo="R" ezfArrayNo="<%= ixR %>" otherAttr=" size=\"2\" maxlength=\"2\" ezftoupper=\"\""/>
	                            </td>
	                            <td>
	                    ...
	                    <table width="1059" cellpadding="0" cellspacing="0" border="0" style="table-layout:fixed;">
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3">
                                    <ezf:inputText name="xxBillToAcctNmSrchTxt_R" ezfName="xxBillToAcctNmSrchTxt_R" value="2408 N HIGHWAY 67 US TITLE FLORISSANT,MO 63033-2036" ezfHyo="R" ezfArrayNo="<%= ixR %>" otherAttr=" tabIndex=\"-1\" size=\"30\" maxlength=\"1000\""/>
	                ...
	                <div style="overflow-x:none;width:1074; margin-left:0px;" id="<%= "usgPrcConfig" + ixR %>" >
		                <table width="1058" border="1" cellpadding="1" cellspacing="0" style="table-layout: fixed;word-break: normal;}">
		                    ...
		                    <col width="160" align="center" valign="bottom"><!-- Billing Counter Name / Hard Counter Name / Multiplier -->
		                    <col width="090" align="center" valign="bottom"><!-- Per Unit Periodic Covered Images -->
		                    <col width="070" align="center" valign="bottom"><!-- Excess Per Image Charge -->
...
<%--	U <ezf:row ezfHyo="U">	--%>
    ...
    <% BigDecimal cpoSvcConfigRefPk_U = BigDecimal.ZERO; %>
    <% for( int ixU = 0; ixU < bMsg.U.getValidCount(); ixU++ ) { %>
        ...
        <% cpoSvcConfigRefPk_U = bMsg.U.no( ixU ).cpoSvcConfigRefPk_U.getValue(); %>
        ...
        <% if (ZYPCommonFunc.hasValue(bMsg.usgBllgCycleCd)
                  && (ZYPCommonFunc.hasValue(modelId) && ZYPCommonFunc.hasValue(modelId_U) && modelId.compareTo(modelId_U) == 0
                    && ZYPCommonFunc.hasValue(cpoSvcConfigRefPk_R) && ZYPCommonFunc.hasValue(cpoSvcConfigRefPk_U) && cpoSvcConfigRefPk_R.compareTo(cpoSvcConfigRefPk_U) == 0)) { %>
                                 ...
                                 <% if (ZYPConstant.FLG_ON_Y.equals(actvFlg)) { %>
	                                    ...
	                                    <tr valign="top">
	                                        ...
	                                        <td>
	                                            <ezf:inputText name="mtrLbDescTxt_UB" ezfName="mtrLbDescTxt_UB" value="BIL BW" ezfHyo="U" ezfArrayNo="<%= ixU %>" otherAttr=" size=\"20\" maxlength=\"50\" ezftoupper=\"\""/>
                                                <ezf:inputHidden name="mtrLbDescTxt_U" ezfName="mtrLbDescTxt_U" value="REG BW SMALL" ezfHyo="U" ezfArrayNo="<%= ixU %>" otherAttr=" size=\"9\" maxlength=\"50\" ezftoupper=\"\""/>
                                                <ezf:inputHidden name="contrMtrMultRate_U" ezfName="contrMtrMultRate_U" value="1.25" ezfHyo="U" ezfArrayNo="<%= ixU %>" otherAttr=" size=\"5\" maxlength=\"4\" ezftouppe=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                        ...
	                                        <td>
	                                            ...
	                                            C
	                                            <ezf:inputText name="xxBillToAcctNmSrchTxt_U" ezfName="xxBillToAcctNmSrchTxt_U" value="" ezfHyo="U" ezfArrayNo="<%= ixU %>" otherAttr=" size=\"18\" maxlength=\"1000\" ezftoupper=\"\""/>
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td>
	                                            ...
	                                            <ezf:inputText name="contrMtrMultRate_U" ezfName="contrMtrMultRate_U" value="1.25" ezfHyo="U" ezfArrayNo="<%= ixU %>" otherAttr=" size=\"8\" maxlength=\"4\" ezftouppe=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                        	&nbsp;
                                                <ezf:inputHidden name="mlyCopyInclPrcQty_U" ezfName="mlyCopyInclPrcQty_U" value="1,000" ezfHyo="U" ezfArrayNo="<%= ixU %>" otherAttr=" size=\"11\" maxlength=\"11\" ezftoupper=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                        	&nbsp;
                                                <ezf:inputHidden name="xsMtrAmtRate_U" ezfName="xsMtrAmtRate_U" value="0.05000" ezfHyo="U" ezfArrayNo="<%= ixU %>" otherAttr=" size=\"8\" maxlength=\"7\" ezftoupper=\"\" style=\"text-align:right;padding:0px;\""/>
	                                        </td>
	                                        <td>
	                                        	&nbsp;
	                                        </td>
	                                        ...
	                                        <td>
		                                        ...
		                                        <ezf:inputHidden name="xxBillToAcctNmSrchTxt_U" ezfName="xxBillToAcctNmSrchTxt_U" value="" ezfHyo="U" ezfArrayNo="<%= ixU %>"/>
                                 ...
                                 <% } %>
                                        ...
                                        <ezf:inputHidden name="dsImptSvcUsgPrcPk_U" ezfName="dsImptSvcUsgPrcPk_U" ezfHyo="U" ezfArrayNo="<%= ixU %>"/>
...
<!-- Rental Equipment Charge Base & Accessory -->
                        ...
                        <table width="1089" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <table width="1089" border="1" cellpadding="1" cellspacing="0" style="table-layout: fixed;word-break: normal;}">
                                    ...
                                    <col width="080" align="center" valign="bottom">
                                    <tr height="34">
                                        <td class="pClothBs"></td>
                                        <td class="pClothBs">Line#</td>
                                        <td class="pClothBs">Covered Item</td>
...
<!-- Additional Service Charge -->
		                        ...
		                        <table width="1089" border="1" cellpadding="1" cellspacing="0" style="table-layout: fixed;word-break: normal;">
		                            ...
		                            <tr>
		                                ...
		                                <td class="pClothBs">Periodic Service Price</td>
                                        <td class="pClothBs">Print Detail<BR />
                                                             on Invoice</td>
		                            </tr>
		                        </table>
