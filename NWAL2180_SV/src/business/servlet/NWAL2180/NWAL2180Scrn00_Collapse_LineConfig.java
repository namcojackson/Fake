...
/**
 *<pre>
 * NWAL2180Scrn00_Collapse_LineConfig
 *
 ...
 *</pre>
 */
public class NWAL2180Scrn00_Collapse_LineConfig extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NWAL2180BMsg scrnMsg = (NWAL2180BMsg) bMsg;
        scrnMsg.xxNum_Z.setValue(getButtonSelectNumber());
        ZYPEZDItemValueSetter.setValue(scrnMsg.U.no(getButtonSelectNumber()).xxSmryLineFlg_U, ZYPConstant.FLG_ON_Y); //[-] -> [+]
    }
