 ...
 *</pre>
 */
public class NLAL2040Scrn00_OpenWin_MdseDetail extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // Set Event Name
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_P1, EVENT_OPEN_WIN_MDSE_DETAIL);

        // Set Condition
        int eventRowIndex = getButtonSelectNumber();
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxCondNm_P1, scrnMsg.A.no(eventRowIndex).t_MdlNm_A1);
