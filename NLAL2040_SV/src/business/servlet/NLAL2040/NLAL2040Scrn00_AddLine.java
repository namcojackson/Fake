 ...
 * 02/16/2018   CITS            K.Ogino         Update          QC#22856
 *</pre>
 */
public class NLAL2040Scrn00_AddLine extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!"E".equals(bizMsg.getMessageKind())) {
            scrnMsg.A.no(scrnMsg.A.getValidCount() - 1).t_MdlNm_A1.setInputProtected(false);
            scrnMsg.A.no(scrnMsg.A.getValidCount() - 1).svcSegDescTxt_A1.setInputProtected(true);
            setButtonEnabled(EVENT_OPEN_WIN_MDSE_DETAIL, scrnMsg.A.getValidCount() - 1, true);
