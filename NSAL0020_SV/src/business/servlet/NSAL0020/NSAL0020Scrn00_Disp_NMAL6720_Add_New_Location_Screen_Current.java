 ...
 *</pre>
 */
public class NSAL0020Scrn00_Disp_NMAL6720_Add_New_Location_Screen_Current extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        params[1] = scrnMsg.A.no(index).curLocAcctNum_A0;
        params[2] = scrnMsg.A.no(index).indCurLocNum_A0;
