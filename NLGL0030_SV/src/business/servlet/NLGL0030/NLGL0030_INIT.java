 ...
 *</pre>
 */
public class NLGL0030_INIT extends S21CommonHandler implements NLGL0030Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.whCd_P1.setNameForMessage(NAME_FOR_MESSAGE_WH);
        scrnMsg.mdseCd_H1.setNameForMessage(NAME_FOR_MESSAGE_ITEM_NUMBER);
