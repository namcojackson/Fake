...
<form name="customerGroupLOV" id ="customerGroupLOV" 
      action="canonCustomBillingCustomerGroupLOV.jsp" method="POST">
    ...
    <table width="650" align="center" bgColor="ffffff">
        ...
        <%
            ...
            ArrayList list =null;
            Object[] result = dao.getGroupNames(customerGroupSrch, p_start_range, p_end_range);
            ...
            <td>
                <table cellspacing="1" cellpadding="0" class="OraBGAccentDark" width="98%" align="center">
                    ...
                    <%
                        ...
                        if (size > 0) {
                            for (i = 0; i < size; i++) {
                            	CanonCustomBillingCustomerGroupBean bean =
                                        (CanonCustomBillingCustomerGroupBean) list.get(i);
