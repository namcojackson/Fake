...
<form name="parentCustomerLOV" id ="parentCustomerLOV" 
      action="canonCustomBillingManualParentCustomerLOV.jsp" method="POST">
    ...
    <table width="650" align="center" bgColor="ffffff">
        ...
        <%
            ...
            Object[] result = dao.getManualParentCustomerNameLov(customerId,parentCustomerSrch, p_start_range, p_end_range, sortBy, sortOrder);
            ...
            <td>
                <table cellspacing="1" cellpadding="0" class="OraBGAccentDark" width="98%" align="center">
                    ...
                    <%
                        ...
                        if (size > 0) {
                            for (i = 0; i < size; i++) {
                            	CanonCustomBillingManualDAO.CustNameInfo bean =
                                        (CanonCustomBillingManualDAO.CustNameInfo) list.get(i);
