...
//import oracle.apps.e008.server.CanonE008ItemProcessDAO.RowMapper;
...
public class CanonE008ItemRec implements java.sql.SQLData, java.io.Serializable  {
	  ...
	  private String safetyhazerdousclass;
	  private String safetyhazerdousid;
	  private String safetyhazerdousmaterial;
	  private String safetyhazerdousnumber;
	  private String safetyhazerdousshiplabel;
  ...
  public CanonE008ItemRec(String eztableid,
		  ...
		  String safetyhazerdousclass,
		  String safetyhazerdousid,
		  String safetyhazerdousmaterial,
		  String safetyhazerdousnumber,
		  String safetyhazerdousshiplabel,
		  String seatsfrom,
		  String seatsto,
		...
		super();
		   ...
		   this.safetyhazerdousclass=             safetyhazerdousclass;
		   this.safetyhazerdousid=                safetyhazerdousid;
		   this.safetyhazerdousmaterial=          safetyhazerdousmaterial;
		   this.safetyhazerdousnumber=            safetyhazerdousnumber;
		   this.safetyhazerdousshiplabel=         safetyhazerdousshiplabel;
...
public String getSafetyhazerdousclass() {
	return safetyhazerdousclass;
}

public void setSafetyhazerdousclass(String safetyhazerdousclass) {
	this.safetyhazerdousclass = safetyhazerdousclass;
}

public String getSafetyhazerdousid() {
	return safetyhazerdousid;
}

public void setSafetyhazerdousid(String safetyhazerdousid) {
	this.safetyhazerdousid = safetyhazerdousid;
}

public String getSafetyhazerdousmaterial() {
	return safetyhazerdousmaterial;
}

public void setSafetyhazerdousmaterial(String safetyhazerdousmaterial) {
	this.safetyhazerdousmaterial = safetyhazerdousmaterial;
}

public String getSafetyhazerdousnumber() {
	return safetyhazerdousnumber;
}

public void setSafetyhazerdousnumber(String safetyhazerdousnumber) {
	this.safetyhazerdousnumber = safetyhazerdousnumber;
}

public String getSafetyhazerdousshiplabel() {
	return safetyhazerdousshiplabel;
}

public void setSafetyhazerdousshiplabel(String safetyhazerdousshiplabel) {
	this.safetyhazerdousshiplabel = safetyhazerdousshiplabel;
}
...
public static RowMapper getRowMapper(){
    ...
    public void readSQL(SQLInput stream, String typeName) throws SQLException {
    	...
    	safetyhazerdousclass=stream.readString();
    	safetyhazerdousid=stream.readString();
    	safetyhazerdousmaterial=stream.readString();
    	safetyhazerdousnumber=stream.readString();
    	safetyhazerdousshiplabel=stream.readString();
	...
	public void writeSQL(SQLOutput stream) throws SQLException {
    	...
    	stream.writeString(safetyhazerdousclass);
    	stream.writeString(safetyhazerdousid);
    	stream.writeString(safetyhazerdousmaterial);
    	stream.writeString(safetyhazerdousnumber);
    	stream.writeString(safetyhazerdousshiplabel);
