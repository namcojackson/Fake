 ...
 *</pre>
 */
public class NMAL7080Scrn00_OnClick_Apply extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.mdseCd_IC)) {
            scrnMsg.mdseCd_IC.setErrorInfo(1, ZZM9000E, new String[] {scrnMsg.mdseCd_IC.getNameForMessage() });
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.mdseCd_IC);
