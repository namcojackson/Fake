...
import static business.servlet.NMAL7080.constant.NMAL7080Constant.NMAM8444E;
 ...
 *</pre>
 */
public class NMAL7080Scrn00_DeleteRow extends S21CommonHandler {
        ...
        if (delIdxList.size() == 0) {
            ...
            for (int idx : delIdxList) {
                if (ZYPCommonFunc.hasValue(scrnMsg.A.no(idx).splyAgmtPlnDtlPk_A)) {
                    scrnMsg.A.no(idx).xxChkBox_A.setErrorInfo(1, NMAM8444E);
                }
            }
        }
