 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB073001;
...
import business.db.NSBI2130_01TMsg;
...
/**
 * <pre>
 * Web OMAL FE Visit Task Interrupt Codes Batch
 * 
 ...
 * </pre>
 */
public class NSBB073001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB073001().executeBatch(NSBB073001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2130_01TMsg> inTMsgList = new ArrayList<NSBI2130_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2130_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2130_01TMsg> inMsgLst) {
        NSBI2130_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2130_01TMsg[inMsgLst.size()];
    ...
    private NSBI2130_01TMsg setCreateValue(ResultSet rs) {

        NSBI2130_01TMsg inParam = new NSBI2130_01TMsg();
