 ...
 *</pre>
 */
public class NMAL2460Scrn00_OpenWin_TerritoryDtl_05 extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(eventLine).orgNm_B5)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(eventLine).orgNm_B5);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.asgTrtyAttrbCd, ASG_TRTY_ATTRB.ATTRIBUTE5_ID);

        NMAL2460CommonLogic.clearParam(scrnMsg);
        // Mod Start 2017/11/28 QC#21044
        //Object[] params = NMAL2460CommonLogic.setParamForTerritoryPopupDtl(scrnMsg, scrnMsg.B.no(scrnMsg.xxNum_EV.getValueInt()).orgNm_B5);
        Object[] params = NMAL2460CommonLogic.setParamForTerritoryPopupDtl(scrnMsg, //
                scrnMsg.B.no(scrnMsg.xxNum_EV.getValueInt()).orgNm_B5, scrnMsg.slsCrQuotFlg_05);
