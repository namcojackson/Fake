 ...
 *</pre>
 */
public class NMAL2460Scrn00_PageJump extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (SRCH_LYOT_TP.LAYOUT_1.equals(scrnMsg.srchLyotTpCd.getValue())) {
            ...
            S21SequentialSearchPagenationScrnSupport.checkInputForPageJump(scrnMsg, scrnMsg.B, scrnMsg.xxPageShowFromNum_B, scrnMsg.xxPageShowToNum_B, scrnMsg.xxPageShowOfNum_B, scrnMsg.xxPageShowCurNum_B, scrnMsg.xxPageShowTotNum_B);
        }
    }
