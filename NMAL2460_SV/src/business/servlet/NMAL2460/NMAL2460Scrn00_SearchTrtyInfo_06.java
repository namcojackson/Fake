 ...
 *</pre>
 */
public class NMAL2460Scrn00_SearchTrtyInfo_06 extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(eventLine).orgNm_B6)) {
            scrnMsg.B.no(eventLine).orgNm_B6.setErrorInfo(1, NMAM8368E, new String[] {MSG_PARAM_TRTY_NM });
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.B.no(scrnMsg.xxNum_EV.getValueInt()).orgNm_B6);
    }
}
