...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NSAL0670Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Cancel Contract or Machine on Contract">
<center>
					...
					<ul>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="96%">
									<div>
										<li title="Add general Notes" class="pTab_ON"><a href="#">Canc Contr</a></li>
									</div>
								</td>
						...
						<tr>
							<td>
								<table style="table-layout:fixed;" border="1" cellpadding="1" cellspacing="0">
									...
									<col width="210" align="center"><!-- Model -->
								...
								<div style="width:1057; height:385; display:block; overflow-x:none; overflow-y:scroll;">
									<table id="A" style="table-layout:fixed;" border="1" cellpadding="1" cellspacing="0">
										...
										<%@ page import="business.servlet.NSAL0670.NSAL0670BMsg" %>
										<%@ page import="java.math.BigDecimal" %>
										<% NSAL0670BMsg bMsg = (NSAL0670BMsg)databean.getEZDBMsg(); %>
										...
										<% index++; %>
											<tr height="25">
												...
												<% } %>
													...
													<td><ezf:inputText name="serNum_A1" ezfName="serNum_A1" value="ABC00228" ezfHyo="A" ezfArrayNo="0" otherAttr=" size=\"10\""/></td>
													<td><ezf:inputText name="dsContrCtrlStsNm_AD" ezfName="dsContrCtrlStsNm_AD" value="ACTIVE" ezfHyo="A" ezfArrayNo="0" otherAttr=" size=\"10\""/></td>
													<td><ezf:inputText name="t_MdlNm_A1" ezfName="t_MdlNm_A1" value="19IPC7VPE00O" ezfHyo="A" ezfArrayNo="0" otherAttr=" size=\"40\""/></td>
