...
/*
 *NWCL0150_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NWCL0150_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** CFS_PO_NUM_A1*/
	public final EZDCStringItem              cfsPoNum_A1;
    ...
    /** CFS_PO_AMT_A1*/
	public final EZDCBigDecimalItem              cfsPoAmt_A1;

    /** INV_CPLT_AMT_RATE_A1*/
	public final EZDCBigDecimalItem              invCpltAmtRate_A1;

    /** CR_REBIL_HLD_FLG_A1*/
	public final EZDCStringItem              crRebilHldFlg_A1;

    /** CFS_LEASE_PKG_HLD_FLG_A1*/
	public final EZDCStringItem              cfsLeasePkgHldFlg_A1;

    /** LEASE_PKG_CRAT_FLG_A1*/
	public final EZDCStringItem              leasePkgCratFlg_A1;

    /** PO_INFO_PROC_FLG_A1*/
	public final EZDCStringItem              poInfoProcFlg_A1;

    /** CFS_MAN_HLD_ACT_TP_CD_A1*/
	public final EZDCStringItem              cfsManHldActTpCd_A1;

    /** CFS_LEASE_PKG_PO_HDR_PK_A1*/
	public final EZDCBigDecimalItem              cfsLeasePkgPoHdrPk_A1;
	...
	/**
	 * NWCL0150_ACMsg is constructor.
	 * The initialization when the instance of NWCL0150_ACMsg is generated.
	 */
	public NWCL0150_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NWCL0150_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		cfsPoNum_A1 = (EZDCStringItem)newItem("cfsPoNum_A1");
		...
		cfsPoAmt_A1 = (EZDCBigDecimalItem)newItem("cfsPoAmt_A1");
		invCpltAmtRate_A1 = (EZDCBigDecimalItem)newItem("invCpltAmtRate_A1");
		crRebilHldFlg_A1 = (EZDCStringItem)newItem("crRebilHldFlg_A1");
		cfsLeasePkgHldFlg_A1 = (EZDCStringItem)newItem("cfsLeasePkgHldFlg_A1");
		leasePkgCratFlg_A1 = (EZDCStringItem)newItem("leasePkgCratFlg_A1");
		poInfoProcFlg_A1 = (EZDCStringItem)newItem("poInfoProcFlg_A1");
		cfsManHldActTpCd_A1 = (EZDCStringItem)newItem("cfsManHldActTpCd_A1");
		cfsLeasePkgPoHdrPk_A1 = (EZDCBigDecimalItem)newItem("cfsLeasePkgPoHdrPk_A1");
	 ...
	 * @return NWCL0150_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NWCL0150_ACMsgArray();
	}
