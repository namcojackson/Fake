 ...
 *</pre>
 */
public class NFCL2650Scrn00_Get_CustNmFrom extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.dsAcctNum_FR.isClear()) {
            if (scrnMsg.dsAcctNm_F1.isClear()) {
                scrnMsg.dsAcctNum_FR.setErrorInfo(1, NFCM0038E);
            } else {
                scrnMsg.dsAcctNm_F1.clear();
            }
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.dsAcctNm_F1);
        scrnMsg.addCheckItem(scrnMsg.dsAcctNum_FR);
        scrnMsg.putErrorScreen();
    }
}
