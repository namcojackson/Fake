 ...
 *</pre>
 */
public class NLBL3200Query extends S21SsmEZDQuerySupport {

    /**
     * Singleton instance.
     */
    private static final NLBL3200Query MY_INSTANCE = new NLBL3200Query();

    /**
     * Constructor.
     */
    public NLBL3200Query() {
        super();
    }

    /**
     * Singleton instance getter.
     * @return NLBL3200Query
     */
    public static NLBL3200Query getInstance() {
        return MY_INSTANCE;
    }
    ...
    // Tomimatsu start
    public S21SsmEZDResult getShipOrdForShipNum(Map<String, String> ssmParam) {
        return getSsmEZDClient().queryObjectList("getShipOrdForShipNum", ssmParam);
    }
    // Tomimatsu end
     ...
     * @return S21SsmEZDResult
     */
    public void searchSoList(Map<String, Object> ssmParam, NLBL3200CMsg cMsg, NLBL3200SMsg sMsg) {
    ...
    private static class SoResult extends S21SsmVoidResultSetHandlerSupport {
        ...
        /** */
        private NLBL3200SMsg sMsg;

        private NLBL3200CMsg cMsg;

        public SoResult(NLBL3200CMsg cMsg, NLBL3200SMsg sMsg) {
            this.sMsg = sMsg;
            this.cMsg = cMsg;
        }
        ...
        protected void doProcessQueryResult(ResultSet rs) throws SQLException {
            ...
            do {
                ...
                NLBL3200_ASMsg aSMsg = sMsg.A.no(rowCnt);
                ...
                // tomimatsu ADD START
              ZYPEZDItemValueSetter.setValue(aSMsg.shpgStsCd_AH, rs.getString("SHPG_STS_CD"));
              ZYPEZDItemValueSetter.setValue(aSMsg.whCd_AH, rs.getString("WH_CD"));
              ZYPEZDItemValueSetter.setValue(aSMsg.shipToCustCd_AH, rs.getString("SHIP_TO_CUST_CD"));
              ZYPEZDItemValueSetter.setValue(aSMsg.frtChrgToCd_AH, rs.getString("FRT_CHRG_TO_CD"));
              ZYPEZDItemValueSetter.setValue(aSMsg.frtChrgMethCd_AH, rs.getString("FRT_CHRG_METH_CD"));
                ZYPEZDItemValueSetter.setValue(aSMsg.prtShipNum_A1, rs.getString("PRT_SHIP_NUM"));
                // tomimatsu ADD END
