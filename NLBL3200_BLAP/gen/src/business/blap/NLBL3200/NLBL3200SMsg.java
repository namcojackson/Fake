...
/*
 *NLBL3200SMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLBL3200SMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** A*/
	public final business.blap.NLBL3200.NLBL3200_ASMsgArray              A;
    ...
    /** B*/
	public final business.blap.NLBL3200.NLBL3200_BSMsgArray              B;

    /** C*/
	public final business.blap.NLBL3200.NLBL3200_CSMsgArray              C;
    ...
    /** P*/
	public final business.blap.NLBL3200.NLBL3200_PSMsgArray              P;
    ...
    /** S*/
	public final business.blap.NLBL3200.NLBL3200_SSMsgArray              S;
    ...
    /** T*/
	public final business.blap.NLBL3200.NLBL3200_TSMsgArray              T;


	/**
	 * NLBL3200SMsg is constructor.
	 * The initialization when the instance of NLBL3200SMsg is generated.
	 */
	public NLBL3200SMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLBL3200SMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		A = (business.blap.NLBL3200.NLBL3200_ASMsgArray)newMsgArray("A");
		...
		B = (business.blap.NLBL3200.NLBL3200_BSMsgArray)newMsgArray("B");
		C = (business.blap.NLBL3200.NLBL3200_CSMsgArray)newMsgArray("C");
		...
		P = (business.blap.NLBL3200.NLBL3200_PSMsgArray)newMsgArray("P");
		...
		S = (business.blap.NLBL3200.NLBL3200_SSMsgArray)newMsgArray("S");
		...
		T = (business.blap.NLBL3200.NLBL3200_TSMsgArray)newMsgArray("T");
	}

	/**
	 * get the type of array which is stored
	 * @return NLBL3200SMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLBL3200SMsgArray();
	}

	/**
	 * Definition of Sub class for Schema Item Array(Basic data,Visible Field)
	 */
	private static class NLBL3200SMsgSchemaContents1 {
		...
		//["key name", "variable", "suffix", "array length", "item type", "digits", "after decimal point degits"] <- This is how to define.
			...
			{"A", "A", null, "1000", "business.blap.NLBL3200.NLBL3200_ASMsgArray", null, null},
			...
			{"B", "B", null, "1000", "business.blap.NLBL3200.NLBL3200_BSMsgArray", null, null},
			{"C", "C", null, "1000", "business.blap.NLBL3200.NLBL3200_CSMsgArray", null, null},
			...
			{"P", "P", null, "35", "business.blap.NLBL3200.NLBL3200_PSMsgArray", null, null},
			{"xxSortTblNm", "xxSortTblNm", null, null, TYPE_HANKAKUEISU, "1", null},
			{"xxSortItemNm", "xxSortItemNm", null, null, TYPE_HANKAKUEISU, "50", null},
			{"xxSortOrdByTxt", "xxSortOrdByTxt", null, null, TYPE_HANKAKUEISU, "4", null},
			{"S", "S", null, "2000", "business.blap.NLBL3200.NLBL3200_SSMsgArray", null, null},
	...
	private static class NLBL3200SMsgSchemaContents2 {
		...
		private static final String[][] BASE_CONTENTS = {
		//["key name", "variable", "suffix", "array length", "item type", "digits", "after decimal point degits"] <- This is how to define.
			{"T", "T", null, "2000", "business.blap.NLBL3200.NLBL3200_TSMsgArray", null, null},
		};
	 ...
	 */
	private static final String[][] BASE_CONTENTS = new String[101][NLBL3200SMsgSchemaContents1.BASE_CONTENTS[0].length];
	static {
		int arcpStartPoint=0;
	System.arraycopy(NLBL3200SMsgSchemaContents1.BASE_CONTENTS, 0, BASE_CONTENTS, arcpStartPoint, NLBL3200SMsgSchemaContents1.BASE_CONTENTS.length);
	arcpStartPoint = arcpStartPoint + NLBL3200SMsgSchemaContents1.BASE_CONTENTS.length;
	System.arraycopy(NLBL3200SMsgSchemaContents2.BASE_CONTENTS, 0, BASE_CONTENTS, arcpStartPoint, NLBL3200SMsgSchemaContents2.BASE_CONTENTS.length);
	arcpStartPoint = arcpStartPoint + NLBL3200SMsgSchemaContents2.BASE_CONTENTS.length;
	}
	...
	static {
		int arcpStartPoint=0;
		System.arraycopy(NLBL3200SMsgSchemaContents1.DISP_CONTENTS, 0, DISP_CONTENTS, arcpStartPoint, NLBL3200SMsgSchemaContents1.DISP_CONTENTS.length);
		arcpStartPoint = arcpStartPoint + NLBL3200SMsgSchemaContents1.DISP_CONTENTS.length;
		System.arraycopy(NLBL3200SMsgSchemaContents2.DISP_CONTENTS, 0, DISP_CONTENTS, arcpStartPoint, NLBL3200SMsgSchemaContents2.DISP_CONTENTS.length);
		arcpStartPoint = arcpStartPoint + NLBL3200SMsgSchemaContents2.DISP_CONTENTS.length;
	}
