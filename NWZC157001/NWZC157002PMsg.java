...
// Generated on    :20150907093543000
...
public class NWZC157002PMsg extends EZDPMsg implements EZDSchemaItemDefines {
    ...
    /** DS_CPO_LINE_CATG_CD*/
	public final EZDPStringItem              dsCpoLineCatgCd;
    ...
    /** GEO_CD_SH*/
	public final EZDPStringItem              geoCd_SH;
    ...
    /** XX_LINE_CLO_FLG*/
	public final EZDPStringItem              xxLineCloFlg;
	...
	public NWZC157002PMsg(boolean child, int eleNo) {
		...
		dsCpoLineCatgCd = (EZDPStringItem)newItem("dsCpoLineCatgCd");
		...
		geoCd_SH = (EZDPStringItem)newItem("geoCd_SH");
		...
		xxLineCloFlg = (EZDPStringItem)newItem("xxLineCloFlg");
	...
	private static class NWZC157002PMsgSchemaContents1 {
		...
		//["key name", "variable", "suffix", "array length", "item type", "digits", "after decimal point degits"] <- This is how to define.
			...
			{"dsAcctNum_SH", "dsAcctNum_SH", "SH", null, TYPE_HANKAKUEISU, "28", null},
			{"dsAcctNm_SH", "dsAcctNm_SH", "SH", null, TYPE_HANKAKUEISU, "60", null},
			...
			{"dsAcctDlrCd_SH", "dsAcctDlrCd_SH", "SH", null, TYPE_HANKAKUEISU, "4", null},
			...
			{"dsAcctNum_BL", "dsAcctNum_BL", "BL", null, TYPE_HANKAKUEISU, "28", null},
			{"dsAcctNm_BL", "dsAcctNm_BL", "BL", null, TYPE_HANKAKUEISU, "60", null},
			...
			{"dsAcctDlrCd_BL", "dsAcctDlrCd_BL", "BL", null, TYPE_HANKAKUEISU, "4", null},
			...
			{"dsCpoLineCatgCd", "dsCpoLineCatgCd", null, null, TYPE_HANKAKUEISU, "10", null},
			...
			{"geoCd_SH", "geoCd_SH", "SH", null, TYPE_HANKAKUEISU, "9", null},
		...
		// ["message display string","mandotry item", "minimum", "maximum", "I/O type", "yen", "comma", "zero suppress", "plus display flag", "display length", "display length after decimal point digit", "Dividing date", "Year display pattern", "zero pudding for date", "separator for date"] <- This is how to define
	        ...
	        {"DS_CPO_LINE_CATG_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsCpoLineCatgCd
	        ...
	        {"GEO_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//geoCd_SH
	...
	private static class NWZC157002PMsgSchemaContents2 {
		...
		//["key name", "variable", "suffix", "array length", "item type", "digits", "after decimal point degits"] <- This is how to define.
			...
			{"xxLineCloFlg", "xxLineCloFlg", null, null, TYPE_HANKAKUEISU, "1", null},
			{"coaExtnCd", "coaExtnCd", null, null, TYPE_HANKAKUEISU, "3", null},
			{"xxMsgIdList", "xxMsgIdList", null, "100", "business.parts.NWZC157002_xxMsgIdListPMsgArray", null, null},
			{"NWZC157003PMsg", "NWZC157003PMsg", null, "999", "business.parts.NWZC157003PMsgArray", null, null},
		};
		...
		// ["message display string","mandotry item", "minimum", "maximum", "I/O type", "yen", "comma", "zero suppress", "plus display flag", "display length", "display length after decimal point digit", "Dividing date", "Year display pattern", "zero pudding for date", "separator for date"] <- This is how to define
	        ...
	        {"XX_LINE_CLO_FLG",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxLineCloFlg
	 ...
	 */
	private static final String[][] BASE_CONTENTS = new String[120][NWZC157002PMsgSchemaContents1.BASE_CONTENTS[0].length];
	static {
