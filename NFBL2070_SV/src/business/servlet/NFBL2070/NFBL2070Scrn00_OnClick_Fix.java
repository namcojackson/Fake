 ...
 * 2016/11/29   Fujitsu         T.Murai         Update          QC#16158
 *</pre>
 */
public class NFBL2070Scrn00_OnClick_Fix extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int slctLine = getButtonSelectNumber(); // ADD 2016/11/28 [QC#16158]
        EZDMsg.copy(bizMsg, null, scrnMsg, null);

        NFBL2070CommonLogic.openSelectedRow(scrnMsg);
        scrnMsg.setFocusItem(scrnMsg.A.no(slctLine).rtlInvNum_A1); // ADD 2016/11/28 [QC#16158]
    }
}
