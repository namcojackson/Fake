...
public class ZZZL9100Scrn00_OpenSubWin_XXXL9901 extends S21CommonHandler implements ZZZL9100Constant {
	...
	protected void doProcess( EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg ) {
		...
		int clickedIndex = getButtonSelectNumber();
		
		Object[] params = new Object[2];
		params[0] = scrnMsg.A.no( clickedIndex ).ezBusinessID_A1;
		params[1] = scrnMsg.A.no( clickedIndex ).ezCompanyCode_A1;
