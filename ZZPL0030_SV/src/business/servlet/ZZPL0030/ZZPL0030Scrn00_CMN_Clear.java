 ...
 *</pre>
 */
public class ZZPL0030Scrn00_CMN_Clear extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        // clear ZZPL0030Scrn00 data
        scrnMsg.xxRptNm_0.clear();
        ZYPTableUtil.clear(scrnMsg.A);
        scrnMsg.xxPageShowFromNum_0.clear();
        scrnMsg.xxPageShowToNum_0.clear();
        scrnMsg.xxPageShowOfNum_0.clear();
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        S21SortColumnIMGController.clearIMG(ZZPL0030Constant.SCREENID_SCRN00, scrnMsg, scrnMsg.A.no(0).getBaseContents());
