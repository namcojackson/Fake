 ...
 *</pre>
 */
public class ZZPL0030Scrn01_TBLColumnSort extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if ("B".equals(sortTblNm)) {
            if (scrnMsg.B.getValidCount() > 0) {
                ...
                scrnMsg.xxSortTblNm_1.setValue(sortTblNm);
                scrnMsg.xxSortItemNm_1.setValue(sortItemNm);
                scrnMsg.xxSortOrdByTxt_1.setValue(sortOrderBy);
