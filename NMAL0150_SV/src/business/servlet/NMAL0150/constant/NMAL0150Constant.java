package business.servlet.NMAL0150.constant;
...
public interface NMAL0150Constant {
     ...
     * Business ID.
     */
    String BUSINESS_ID = "NMAL0150";

    /**
     * Screen ID.
     */
    String SCREEN_ID = "NMAL0150Scrn00";
     ...
     * LineItem Button
     */
    String[] Line_Item_BTN = {"btn12", "LineItem", "LineItem" };
     ...
     * Upload Button
     */
    String[] Upload_BTN = {"btn14", "Upload", "Upload" };

    /**
     * Read Authorization
     */
	String AUTH_READ = "NMAL0150T010";

    /**
     * Edit Authorization
     */
	String AUTH_EDIT = "NMAL0150T020";
