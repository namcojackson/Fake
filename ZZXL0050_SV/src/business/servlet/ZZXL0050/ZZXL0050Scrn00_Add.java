...
public class ZZXL0050Scrn00_Add extends S21CommonHandler implements ZZXL0050Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.dtProcCd_01.setInputProtected( false );
        scrnMsg.dtMgtPgmId_01.setIndispensable( true );
        scrnMsg.setFocusItem( scrnMsg.dtProcCd_01 );
    }
