 ...
 *</pre>
 */
public class NWAL2400_NMAL6760 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!EVENT_NM_CMN_CLOSE.equals(getLastGuard())) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.A.no(index).billToCustCd_A, scrnMsg.P.no(15).xxPopPrm_P);
        }

        scrnMsg.setFocusItem(scrnMsg.A.no(index).billToCustCd_A);
    }
}
