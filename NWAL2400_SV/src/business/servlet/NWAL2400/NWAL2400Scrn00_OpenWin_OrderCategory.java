 ...
 *</pre>
 */
public class NWAL2400Scrn00_OpenWin_OrderCategory extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NWAL2400CommonLogic.getParamNWAL1130ForOrderCategory(scrnMsg, selectNum);

        // Subscreen transition
        setArgForSubScreen(params);

        scrnMsg.eventNm.setValue(EVENT_NM_ORDER_CATEGORY);
    }
}
