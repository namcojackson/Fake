 ...
 *</pre>
 */
public class NWAL1740Scrn00_Add_Line extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.B.no(scrnMsg.B.getValidCount() - 1).xxBtnFlg_B);
    }
}
