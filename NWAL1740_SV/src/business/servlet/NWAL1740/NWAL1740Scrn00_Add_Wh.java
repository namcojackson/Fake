 ...
 *</pre>
 */
public class NWAL1740Scrn00_Add_Wh extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.C.no(scrnMsg.C.getValidCount() - 1).xxBtnFlg_C);
    }
}
