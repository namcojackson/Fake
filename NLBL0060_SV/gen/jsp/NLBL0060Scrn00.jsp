...
<fmt:setBundle basename="I18N_NLBL0060Scrn00" var="I18N_SCREEN_ID" scope="request" />
...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="<fmt:message key="i18n.NLBL0060Scrn00.title" bundle="${I18N_SCREEN_ID}">WH Lead Time</fmt:message>">
<center>
				...
				<div class="pTab_BODY">
					<table>
						...
						<tr height="30">
                            ...
                            <td class="stab"><fmt:message key="i18n.NLBL0060Scrn00.label.8" bundle="${I18N_SCREEN_ID}">WH</fmt:message></td>
                                 2013/05/20 R-OM025 Inventory Transaction Delte End --%>
                            <%-- 2013/05/20 R-OM025 Inventory Transaction Add Start --%>
                            <td class="stab"><ezf:anchor name="xxLinkProt_H2" ezfName="xxLinkProt_H2" ezfEmulateBtn="1" ezfGuard="OpenWin_RetailWarehouse" ><fmt:message key="i18n.NLBL0060Scrn00.label.8" bundle="${I18N_SCREEN_ID}">WH</fmt:message></ezf:anchor></td>
                            <%-- 2013/05/20 R-OM025 Inventory Transaction Add End --%>
							<td>
                                <%-- 2013/05/20 R-OM025 Inventory Transaction Delete Start
							...
							<td></td>
							<td class="stab"><fmt:message key="i18n.NLBL0060Scrn00.label.9" bundle="${I18N_SCREEN_ID}">Effective Period</fmt:message></td>
							<td>
...
<%-- ######################################## DETAIL ######################################## --%>
                    ...
                    <%-- 2013/05/20 R-OM025 Inventory Transaction Modify End --%>
						<tr>
                            ...
                            <%-- 2013/05/20 R-OM025 Inventory Transaction Modify Start --%>
                            <td class="pClothBs" rowspan="2"><fmt:message key="i18n.NLBL0060Scrn00.label.13" bundle="${I18N_SCREEN_ID}">Warehouse</fmt:message></td>
                            <%-- 2013/05/20 R-OM025 Inventory Transaction Modify End --%>
							<td class="pClothBs" colspan="2"><fmt:message key="i18n.NLBL0060Scrn00.label.9" bundle="${I18N_SCREEN_ID}">Effective Period</fmt:message></td>
							<td class="pClothBs" rowspan="2"><fmt:message key="i18n.NLBL0060Scrn00.label.14" bundle="${I18N_SCREEN_ID}">Shipping Mode</fmt:message></td>
							<td class="pClothBs" rowspan="2"><fmt:message key="i18n.NLBL0060Scrn00.label.15" bundle="${I18N_SCREEN_ID}">Service Level</fmt:message></td>
							<td class="pClothBs" rowspan="2"><fmt:message key="i18n.NLBL0060Scrn00.label.16" bundle="${I18N_SCREEN_ID}">Shipping Closing<br>Time(EST, 24H)</fmt:message></td>
							<td class="pClothBs" rowspan="2"><fmt:message key="i18n.NLBL0060Scrn00.label.17" bundle="${I18N_SCREEN_ID}">Lead Time<br>(day(s))</fmt:message></td>
						</tr>
						<tr>
							<!-- Event -->
							<td class="pClothBs"><fmt:message key="i18n.NLBL0060Scrn00.label.18" bundle="${I18N_SCREEN_ID}">Start</fmt:message></td>
							<td class="pClothBs"><fmt:message key="i18n.NLBL0060Scrn00.label.19" bundle="${I18N_SCREEN_ID}">End</fmt:message></td>
						</tr>
					</table>
								...
								<tr height="28">
									...
									<td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="1">
                                            ...
                                            <tr>
                                                <td class="stab"><ezf:anchor name="" ezfName="" ezfHyo="A" ezfArrayNo="0" ezfEmulateBtn="1" ezfGuard="OpenWin_RetailWarehouse_For_List" otherAttr=" id=\"whLink#{EZF_ROW_NUMBER}\""><fmt:message key="i18n.NLBL0060Scrn00.label.8" bundle="${I18N_SCREEN_ID}">WH</fmt:message></ezf:anchor></td>
