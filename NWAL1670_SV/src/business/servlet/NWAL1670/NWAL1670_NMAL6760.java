 ...
 *</pre>
 */
public class NWAL1670_NMAL6760 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!"CMN_Close".equals(getLastGuard()) && hasValue(scrnMsg.xxPopPrm_01)) {
            setValue(scrnMsg.C.no(index).ordTeamAttrbValTxt_C, scrnMsg.xxPopPrm_01);
            setValue(scrnMsg.C.no(index).dsAcctNm_C, scrnMsg.xxPopPrm_02);
        }
