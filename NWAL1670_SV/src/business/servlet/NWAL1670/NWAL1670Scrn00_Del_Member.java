 ...
 *</pre>
 */
public class NWAL1670Scrn00_Del_Member extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NWAL1670CommonLogic.controlScreenFieldsChgMember(this, scrnMsg);

        if (scrnMsg.B.getValidCount() >= 0) {
            scrnMsg.setFocusItem(scrnMsg.B.no(0).ordTeamAttrbValTxt_B);
        }
