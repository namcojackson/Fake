 ...
 *</pre>
 */
public class ZZVL0020Scrn00_Select extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxNum_1, BigDecimal.valueOf(selected));
        ZYPEZDItemValueSetter.setValue(scrnMsg.roleNm_2, scrnMsg.C.no(selected).roleNm_C.getValue());
