 ...
 *</pre>
 */
public class ZZVL0020Scrn00_PagePrev extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPageShowFromNum_1, BigDecimal.valueOf(scrnMsg.xxPageShowFromNum_1.getValueInt() - scrnMsg.C.length() - 1));
