 ...
 *</pre>
 */
public class ZZVL0020Scrn01_PagePrev extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPageShowFromNum_A1, BigDecimal.valueOf(scrnMsg.xxPageShowFromNum_A1.getValueInt() - scrnMsg.A.length() - 1));
