...
/*
 *NSAL0850Bean.java Copyright FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
...
/*
 * NSAL0850 is data bean class.
 */
public class NSAL0850Bean extends EZDCommonDataBean {
	...
	public static final String prcAllocIntfcTpCd_A = "prcAllocIntfcTpCd_A";
	...
	public static final String prcAllocIntfcPk_A = "prcAllocIntfcPk_A";
	...
	public static final String prcAllocIntfcTpCd_AP = "prcAllocIntfcTpCd_AP";

	/** PRC_ALLOC_INTFC_TP_DESC_TXT_AP*/
	public static final String prcAllocIntfcTpDescTxt_AP = "prcAllocIntfcTpDescTxt_AP";
	...
	/**
	 * Method name:NSAL0850 is Bean's Constructor.
	 * <dd>method explanation:Initialization when instance of NSAL0850Bean is generated
	 * <dd>Remarks:
	 */
	public NSAL0850Bean() {
		super("business.servlet.NSAL0850.NSAL0850BMsg");
	}
	...
	/**
	 * get  PRC_ALLOC_INTFC_TP_CD_A.
	 * @param idx1 List Number
	 * @return PRC_ALLOC_INTFC_TP_CD_A
	 */
	public String getPrcAllocIntfcTpCd_A(int idx1) {
		return outputValue(A, idx1, prcAllocIntfcTpCd_A);
	}

	/**
	 * set  PRC_ALLOC_INTFC_TP_CD_A.
	 * @param data PRC_ALLOC_INTFC_TP_CD_AArray
	 */
	public void setPrcAllocIntfcTpCd_A(String[] data) {
		int i,j;
		int startPoint = getDisplayStartPoint(A);
		for(i = startPoint, j = 0; i < (startPoint + data.length); i++, j++) {
			inputValue(A, i, prcAllocIntfcTpCd_A, data[j]);
		}
	}
	...
	/**
	 * get  PRC_ALLOC_INTFC_PK_A.
	 * @param idx1 List Number
	 * @return PRC_ALLOC_INTFC_PK_A
	 */
	public String getPrcAllocIntfcPk_A(int idx1) {
		return outputValue(A, idx1, prcAllocIntfcPk_A);
	}

	/**
	 * set  PRC_ALLOC_INTFC_PK_A.
	 * @param data PRC_ALLOC_INTFC_PK_AArray
	 */
	public void setPrcAllocIntfcPk_A(String[] data) {
		int i,j;
		int startPoint = getDisplayStartPoint(A);
		for(i = startPoint, j = 0; i < (startPoint + data.length); i++, j++) {
			inputValue(A, i, prcAllocIntfcPk_A, data[j]);
		}
	}
	...
	/**
	 * get  PRC_ALLOC_INTFC_TP_CD_AP.
	 * @param idx1 Index Number
	 * @return PRC_ALLOC_INTFC_TP_CD_AP
	 */
	public String getPrcAllocIntfcTpCd_AP(int idx1) {
	 	 return outputValue(prcAllocIntfcTpCd_AP, idx1);
	}

	/**
	 * get  PRC_ALLOC_INTFC_TP_DESC_TXT_AP.
	 * @param idx1 Index Number
	 * @return PRC_ALLOC_INTFC_TP_DESC_TXT_AP
	 */
	public String getPrcAllocIntfcTpDescTxt_AP(int idx1) {
	 	 return outputValue(prcAllocIntfcTpDescTxt_AP, idx1);
	}
