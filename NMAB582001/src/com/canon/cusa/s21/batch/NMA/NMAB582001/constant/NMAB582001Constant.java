 ...
 */
package com.canon.cusa.s21.batch.NMA.NMAB582001.constant;
 ...
 * 09/08/2016   CITS            T.Gotoda        UPDATE          QC#11907
 * 12/20/2016   CITS            R.Shimamoto     UPDATE          QC#16596
 *</pre>
 */
public class NMAB582001Constant {

    /** Business ID */
    public static final String BUSINESS_ID = "NMAB5820";

    /** Output Log Program ID */
    public static final String PROGRAM_ID = "NMAB582001";
    ...
    public static final String API_NMZC201001 = "NMZC201001 updateSupplierApi";
    ...
    /** Mail Template ID. */
    public static final String MAIL_TEMPLATE_ID_M001 = "NMAB5820M001";

    /** Mail Template ID. */
    public static final String MAIL_TEMPLATE_ID_M002 = "NMAB5820M002";

    /** */
    public static final String ML_WARN_SUBJECT_TXT = "Warning Report --  Receive Supplier Info From ARCS Batch ";

    /** */
    public static final String ML_WARN_TXT_LINE_01 = "These Supplier/Site were skipped in processing of registration/update in S21.";

    /** */
    public static final String ML_WARN_TXT_LINE_02 = "Because these supplier site doesn't exist in S21.";

    /** */
    public static final String ML_WARN_TXT_LINE_03 = "****   Receive Supplier Info From ARCS Batch Waring REPORT   **** ";

    /** */
    public static final String ML_NR_SUBJECT_TXT = "New Registration Report --  Receive Supplier Info From ARCS Batch ";

    /** */
    public static final String ML_NR_TXT_LINE_01 = "These Supplier/Site were registered in S21.";

    /** */
    public static final String ML_NR_TXT_LINE_02 = "Please set up ATTRIBUTE5 in ARCS with S21 Supplier Site code.";

    /** */
    public static final String ML_NR_TXT_LINE_03 = "****   Receive Supplier Info From ARCS Batch Waring REPORT   **** ";

    /** */
    public static final String ML_END_OF_SENTENCE_TXT = "Please don't reply to this e-mail. ";

    /** */
    public static final String ML_ARCS_SPLY_SITE_ATTB5_TXT = "S21 Supplier Site Code in ARCS";

    /** */
    public static final String ML_ARCS_SPLY_NUM_TXT = "Supplier Number";

    /** */
    public static final String ML_PRNT_VND_NM_TXT = "Supplier Name";

    /** */
    public static final String ML_ARCS_SPLY_SITE_CD_TXT = "Supplier Site Name";

    /** */
    public static final String ML_VND_CD_TXT = "S21 Supplier Site code";

    /** */
    public static final String ML_SPACE_TXT = " ";

    /** */
    public static final String ML_COLON_TXT = ":";

    /** */
    public static final String ML_LINE_SEPARATOR_TXT = "-------------------------------------------------------------------------";

    /** */
    public static final int ML_LEN_PADDING_SIZE = 40;
    ...
    /**
     * The maximum length of the LEN_SUBSTRING_ADDR
     */
    public static final int LEN_SUBSTRING_ADDR = 60;
