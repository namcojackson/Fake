...
/**
 * <pre>
 * When Event[INIT] in BusinessID NLBL0110 is generated, this class processes it. 
 * </pre>
 * <pre>
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 ...
 * </pre>
 */
public class NLBL0110_INIT extends S21CommonHandler implements NLBL0110Constant {
