 ...
 *</pre>
 */
public class NLBL3140Scrn00_AddNewRow extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLBL3140CommonLogic.changeTableBackGroundColor(scrnMsg);
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(index - 1).lineBizTpCd_A);
