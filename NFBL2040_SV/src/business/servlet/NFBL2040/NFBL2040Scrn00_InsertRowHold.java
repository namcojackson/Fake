...
import static business.servlet.NFBL2040.constant.NFBL2040Constant.NFAM0072E;
 ...
 *</pre>
 */
public class NFBL2040Scrn00_InsertRowHold extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NFBL2040BMsg scrnMsg = (NFBL2040BMsg) bMsg;
        if (scrnMsg.H.getValidCount() == scrnMsg.H.length()) {
            scrnMsg.setMessageInfo(NFAM0072E, new String[] {"Hold", Integer.toString(scrnMsg.H.length()) });
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        //scrnMsg.setFocusItem(scrnMsg.H.no(scrnMsg.H.getValidCount() - 1).pmtHldCd_H1);
        scrnMsg.setFocusItem(scrnMsg.H.no(scrnMsg.H.getValidCount() - 1).xxChkBox_H2);
        ...
        //         if (scrnMsg.H.no(i).xxInsUpdDelFlg_H1.getValue().equals(ZYPConstant.FLG_ON_Y)) {
        //             isProtected = true;
        //         }
        //     }
        //     if (isProtected) {
        //         this.setButtonEnabled(BTN_CMN_SUBMIT[0], true);
        //     }
        // }
