 ...
 * 2016/08/14   Hitachi         Y.Tsuchimoto    Update          QC#13333
 ...
 *</pre>
 */
public class NFBL2040Scrn00_InsertRow extends S21CommonHandler implements NFBL2040Constant {
...
//                || !CM_AP_INV_TP.STANDARD.equals(scrnMsg.cmApInvTpCd_S.getValue())) {
        ...
        if (scrnMsg.A.getValidCount() == scrnMsg.A.length()) {
            // NFAM0072E=0, @ cannot be added because it is exceeding the maximum number of row [@]
