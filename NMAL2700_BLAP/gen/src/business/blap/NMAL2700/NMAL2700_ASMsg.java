...
/*
 *NMAL2700_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL2700_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** FIRST_ORG_CD_A*/
	public final EZDSStringItem              firstOrgCd_A;

    /** ORG_FUNC_ROLE_TP_CD_A*/
	public final EZDSStringItem              orgFuncRoleTpCd_A;
    ...
    /** EQUIP_FLG_A*/
	public final EZDSStringItem              equipFlg_A;

    /** MGR_FLG_A*/
	public final EZDSStringItem              mgrFlg_A;

    /** SPCL_FLG_A*/
	public final EZDSStringItem              spclFlg_A;

    /** CMSN_FLG_A*/
	public final EZDSStringItem              cmsnFlg_A;

    /** ADMIN_FLG_A*/
	public final EZDSStringItem              adminFlg_A;

    /** GES_TP_CD_A*/
	public final EZDSStringItem              gesTpCd_A;

    /** APVL_LIMIT_AMT_A*/
	public final EZDSBigDecimalItem              apvlLimitAmt_A;

    /** SLS_REP_FLG_A*/
	public final EZDSStringItem              slsRepFlg_A;

    /** ASG_CONTR_FLG_A*/
	public final EZDSStringItem              asgContrFlg_A;

    /** THIRD_PTY_TECH_FLG_A*/
	public final EZDSStringItem              thirdPtyTechFlg_A;

    /** TECH_MSTR_REQ_FLG_A*/
	public final EZDSStringItem              techMstrReqFlg_A;

    /** CRM_SLS_EXCL_FLG_A*/
	public final EZDSStringItem              crmSlsExclFlg_A;

    /** CRM_SLS_PRFL_NM_A*/
	public final EZDSStringItem              crmSlsPrflNm_A;

    /** SLS_ASG_ELIG_FLG_A*/
	public final EZDSStringItem              slsAsgEligFlg_A;

    /** SLS_ADMIN_ELIG_FLG_A*/
	public final EZDSStringItem              slsAdminEligFlg_A;

    /** MULT_PSN_ASG_FLG_A*/
	public final EZDSStringItem              multPsnAsgFlg_A;

    /** TECH_ASG_ELIG_FLG_A*/
	public final EZDSStringItem              techAsgEligFlg_A;

    /** TOC_REQ_FLG_A*/
	public final EZDSStringItem              tocReqFlg_A;

    /** ORG_STRU_TP_CD_A*/
	public final EZDSStringItem              orgStruTpCd_A;

    /** S21_ORG_REQ_FLG_A*/
	public final EZDSStringItem              s21OrgReqFlg_A;
	...
	/**
	 * NMAL2700_ASMsg is constructor.
	 * The initialization when the instance of NMAL2700_ASMsg is generated.
	 */
	public NMAL2700_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL2700_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		xxChkBox_A = (EZDSStringItem)newItem("xxChkBox_A");
		firstOrgCd_A = (EZDSStringItem)newItem("firstOrgCd_A");
		orgFuncRoleTpCd_A = (EZDSStringItem)newItem("orgFuncRoleTpCd_A");
		...
		equipFlg_A = (EZDSStringItem)newItem("equipFlg_A");
		mgrFlg_A = (EZDSStringItem)newItem("mgrFlg_A");
		spclFlg_A = (EZDSStringItem)newItem("spclFlg_A");
		cmsnFlg_A = (EZDSStringItem)newItem("cmsnFlg_A");
		adminFlg_A = (EZDSStringItem)newItem("adminFlg_A");
		gesTpCd_A = (EZDSStringItem)newItem("gesTpCd_A");
		apvlLimitAmt_A = (EZDSBigDecimalItem)newItem("apvlLimitAmt_A");
		slsRepFlg_A = (EZDSStringItem)newItem("slsRepFlg_A");
		asgContrFlg_A = (EZDSStringItem)newItem("asgContrFlg_A");
		thirdPtyTechFlg_A = (EZDSStringItem)newItem("thirdPtyTechFlg_A");
		techMstrReqFlg_A = (EZDSStringItem)newItem("techMstrReqFlg_A");
		crmSlsExclFlg_A = (EZDSStringItem)newItem("crmSlsExclFlg_A");
		crmSlsPrflNm_A = (EZDSStringItem)newItem("crmSlsPrflNm_A");
		slsAsgEligFlg_A = (EZDSStringItem)newItem("slsAsgEligFlg_A");
		slsAdminEligFlg_A = (EZDSStringItem)newItem("slsAdminEligFlg_A");
		multPsnAsgFlg_A = (EZDSStringItem)newItem("multPsnAsgFlg_A");
		techAsgEligFlg_A = (EZDSStringItem)newItem("techAsgEligFlg_A");
		tocReqFlg_A = (EZDSStringItem)newItem("tocReqFlg_A");
		orgStruTpCd_A = (EZDSStringItem)newItem("orgStruTpCd_A");
		s21OrgReqFlg_A = (EZDSStringItem)newItem("s21OrgReqFlg_A");
	 ...
	 * @return NMAL2700_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL2700_ASMsgArray();
	}
