 ...
 *</pre>
 */
public class NLGL0010Scrn00_OnClick_DownloadEditTab extends S21CommonHandler implements NLGL0010Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLGL0010CommonLogic.busDNLDControl_DataList(this, scrnMsg);
        ...
        if (ZYPConstant.FLG_OFF_N.equals(validCopyFlag)) {
            // Resend
            scrnMsg.xxTpCd_J2.setInputProtected(true);
