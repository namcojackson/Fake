 ...
 *</pre>
 */
public class NLGL0010Scrn00_OnChange_DNLD_SelectSendType extends S21CommonHandler implements NLGL0010Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (TP_CD_COPY.equals(bizMsg.xxTpCd_J2.getValue())) {
            // Copy
            NLGL0010CommonLogic.busDNLDControl_Enabel(this, scrnMsg);
        } else {
            // Resend
            NLGL0010CommonLogic.busDNLDControl_Disenabel(this, scrnMsg);
        }
    }
}
