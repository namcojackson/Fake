...
public class ZZOL0110Scrn00_SelectAppC extends S21CommonHandlerEx implements ZZOL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        String bizId = "";
        String processId = "";
        bizId = scrnMsg.B.no(index).bizAppId_B1.getValue();
        processId = scrnMsg.B.no(index).wfAppNm_B1.getValue();
