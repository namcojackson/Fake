 ...
 * Function Name : Search Technician
 * </pre>
 * <pre>
 ...
 *</pre>
 */
public class NLCL0630Scrn00_SearchTechnician extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.techTocCd)) {
            scrnMsg.techTocCd.setErrorInfo(1, ZZM9000E, new String[] {DISPLAY_NM_TECH_TOC_CD});
