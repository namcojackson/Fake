...
public class CanonE307ServReqFutureCallRec implements SQLData{
	...
	public CanonE307ServReqFutureCallRec(){
		
	}

	public CanonE307ServReqFutureCallRec(String strSerNum, String strTagNum,
