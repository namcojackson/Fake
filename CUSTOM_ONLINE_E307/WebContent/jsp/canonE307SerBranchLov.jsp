...
<%
    	...
    	String strBranchDesc=request.getParameter("branchDesc");
    	...
    	//System.out.println("strBranch:"+strBranch);
      	if(strBranchDesc==null||strBranchDesc.equalsIgnoreCase("undefined"))
      		strBranchDesc="";
      	else
      	{
      		//System.out.println("strBranchDesc:before"+strBranchDesc);
      		strBranchDesc=strBranchDesc.trim();
      	}
		...
		ArrayList arList  =objLevelDAO.getBranchLOV(strBranch,strBranchDesc,start, end);
	...
	<TABLE cellspacing="0" cellpadding="4" width="40%" summary="" align="center">	
		<tr>	
			...
			<td nowrap align="left" width="20%">
				<a href="javascript:searchBranch('1')" class="btn">Search</a>
			</td>			
		</tr>
	</TABLE>
    <br/>
 <%           		
		...
		if(arList.size()>1){ 
			...
			String fnGetBranch="searchBranch";
            ...
            <table width="98%" >
             ...
             <tr>
				...
				<th width="45%">Branch Description</th>
			 </tr>
			 </thead>
			 <tbody>
		            <%
			      ...
			      <tr>
					  <td align="left">
					         <jsp:include page="canonE307MsgPaginationIncl.jsp">
							   ...
							   <jsp:param value="<%=fnGetBranch %>" name="fn"/>
							   </jsp:include>
					  </td>
				   </tr>
			 	  </table>
...
//alert("searchModel:pageNum:"+pageNum);
	 ...
	 var rowcount=<%=rowIndex%>
	 var brdesc=customEncodeURIComponent($("#strLevelDesc").val());
	 //console.log("brdesc"+brdesc);
	var qryStr = "modalName=" + modalName + "&pageNum=" + pageNum + "&level=" + strLevel+ "&branchDesc=" + brdesc+ "&rowIndex=" + rowcount;
	showPleaseWait();
	$.ajax( {
		url : "canonE307SerBranchLov.jsp",
		data : qryStr,
		type : "POST",
		cache : false,
