...
<%-- 	<script src="<%=commonRoot%>/jquery/jquery-1.10.2.min.js" type='text/javascript'></script>   		
    ...
    <script src='<%=ctxPath%>/e307/js/canonE307ServiceReqCommon.js?v=8' type='text/javascript'></script>
    <script src='<%=ctxPath%>/e307/js/tcepps.js?v=9' type='text/javascript'></script>
	...
	<script src='<%=ctxPath%>/e307/js/canonE307ServReqBlockUI.js?v=3' type='text/javascript'></script>
...
<script type="text/javascript">
 ...
 function getPageTitle(){
	 var sTitle="CSA Advanced Service Call Center:  <%=pageTitle%>";
	 return sTitle;
