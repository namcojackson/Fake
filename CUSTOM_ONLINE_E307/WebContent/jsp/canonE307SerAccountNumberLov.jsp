...
<%
    	...
    	String strAccountNumber = request.getParameter("level");
    	
    	String levelDropdownValue = request.getParameter("levelDropdownValue"); 
		String rowIndex = request.getParameter("rowIndex");
    	if(strAccountNumber==null||"undefined".equalsIgnoreCase(strAccountNumber))
    		strAccountNumber="";
    	else
    		strAccountNumber=strAccountNumber.trim();	
    	//System.out.println("strAccountNumber:"+strAccountNumber);
		int pageNum =1; 		
		...
		ArrayList arList  =objLevelDAO.getAccountNumberLOV(strAccountNumber,start, end);

		
 %>
	<TABLE cellspacing="0" cellpadding="4" width="40%" summary="" align="center">	
		<tr>	
			<td nowrap align="right" class="search_text" width="30%">Account Number</td>
			<td>
				<input style="border: solid 1px #336699"  type="text" name="strLevel" id="strLevel" value="<%=strAccountNumber==null?"":strAccountNumber%>" />
		    </td>
			<td nowrap align="left" width="20%">
				<a href="javascript:searchAccountNumber('1')" class="btn">Search</a>
			</td>
		</tr>
	</TABLE>
    <br/>
 <%           		
		...
		if(arList.size()>1){ 
			...
			String fnGetAccountNumber="searchAccountNumber";
            ...
            <table width="100%" >
             ...
             <table class="supplies-table" style="width: 98%;"  cellpadding="1" cellspacing="1" style="background-color:#cccc99" id="regionTbl">
              <thead>
				...
				<th  width="20%" nowrap>Account Number</th>
				<th  width="40%">Party Name</th>
				<th  width="18%" nowrap>Party Number</th>
				</tr>
				</thead>
				 <tbody>
		            <%
			         for(int i=0;i<arList.size();i++){
			        	CanonE307SRMsgsBean accountBeanObj = (CanonE307SRMsgsBean) arList.get(i);
			 			String strAccount = accountBeanObj.accountNumber;
						String strPartysite = accountBeanObj.partySiteNumber;
						String strParty = accountBeanObj.partyName;
			 			String strPartyNo = accountBeanObj.partyNumber;
			 			String rowStyle ="";
			 			if((i%2) == 0)
			      ...
			      <tr>
					  <td align="left">
					         <jsp:include page="canonE307MsgPaginationIncl.jsp">
							   ...
							   <jsp:param value="<%=fnGetAccountNumber %>" name="fn"/>
							   </jsp:include>
					  </td>
				   </tr>
			 	  </table>
