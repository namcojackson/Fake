 ...
 *</pre>
 */
public class NMAL6820Scrn00_OpenWin_ShipToState extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NMAL6820CommonLogic.setInitParamForShipToStPopup(scrnMsg);

        ZYPEZDItemValueSetter.setValue(scrnMsg.stCd_G1, scrnMsg.stCd_S1);

        // Making of subscreen delivery information
        Object[] params = NMAL6820CommonLogic.setParamForShipToStPopup(scrnMsg);

        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_EV, EVENT_NM_AL6820SCRN00_OPEN_WIN_SHIP_TO_STATE);
