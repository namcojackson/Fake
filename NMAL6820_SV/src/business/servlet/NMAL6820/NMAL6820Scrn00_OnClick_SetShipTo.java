 ...
 *</pre>
 */
public class NMAL6820Scrn00_OnClick_SetShipTo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.locNum_S1)) {
            scrnMsg.locNum_S1.setErrorInfo(1, ZZM9000E, new String[] {NAME_FOR_MESSAGE_SHIP_TO_CD});
        }
