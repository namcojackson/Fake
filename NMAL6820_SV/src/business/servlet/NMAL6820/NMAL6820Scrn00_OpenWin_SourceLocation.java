 ...
 * Function Name : Open Sourcing Location Search Popup(NPAL1010)
 * 
 ...
 *</pre>
 */
public class NMAL6820Scrn00_OpenWin_SourceLocation extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (PROCR_TP.SUPPLIER.equals(scrnMsg.procrTpCd_S1.getValue())) {
            params = NMAL6820CommonLogic.setParamForSupplierPopup(scrnMsg, scrnMsg.prntVndNm_SD.getValue(), scrnMsg.vndNm_SD.getValue());
            setResult("T");

        } else {
            NMAL6820CommonLogic.setInitParamForLocationPopup(scrnMsg, ZYPConstant.FLG_ON_Y);
            params = NMAL6820CommonLogic.setParamForLocationPopup(scrnMsg, null, scrnMsg.prntVndNm_SD, scrnMsg.vndNm_SD, ZYPConstant.FLG_OFF_N);
            setResult("W");
        }

        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_EV, EVENT_NM_AL6820SCRN00_OPEN_WIN_SOURCE_LOCATION);
