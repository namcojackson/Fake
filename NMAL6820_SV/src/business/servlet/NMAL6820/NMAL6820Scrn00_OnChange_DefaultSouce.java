 ...
 *</pre>
 */
public class NMAL6820Scrn00_OnChange_DefaultSouce extends S21CommonHandler {
...
//        NMAL6820CommonLogic.clearSourcePullDownListForSWHTab(scrnMsg);
        scrnMsg.A.no(eventRowIndex).prntVndNm_AS.clear();
        scrnMsg.A.no(eventRowIndex).vndNm_AS.clear();
        scrnMsg.setFocusItem(scrnMsg.A.no(eventRowIndex).procrTpCd_A1);
    }
}
