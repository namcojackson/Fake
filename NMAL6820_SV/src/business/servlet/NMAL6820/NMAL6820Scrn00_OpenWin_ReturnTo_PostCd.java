 ...
 * ----------------------------------------------------------------------
 * 2016/08/03   CITS            S.Endo          Create          QC#10838
 *</pre>
 */
public class NMAL6820Scrn00_OpenWin_ReturnTo_PostCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_21, LINK_OPENWIN_RETURNTO_POSTCD_EVENT_NM);
        Object[] params = NMAL6820CommonLogic.getAddressPopUpReturnToParam(scrnMsg, getGlobalCompanyCode());
