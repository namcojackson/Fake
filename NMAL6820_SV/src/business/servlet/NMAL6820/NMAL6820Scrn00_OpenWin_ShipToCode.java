 ...
 *</pre>
 */
public class NMAL6820Scrn00_OpenWin_ShipToCode extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NMAL6820CommonLogic.setParamForAccountPopup(scrnMsg, scrnMsg.locNum_S1, scrnMsg.dsAcctNum_S1, scrnMsg.dsAcctNm_S1);

        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_EV, EVENT_NM_AL6820SCRN00_OPEN_WIN_SHIP_TO_CODE);
