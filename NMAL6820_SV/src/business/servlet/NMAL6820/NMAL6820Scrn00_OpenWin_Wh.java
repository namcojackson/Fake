 ...
 * Function Name : Open Warehouse Search Popup(NMAL6050)
 * 
 ...
 *</pre>
 */
public class NMAL6820Scrn00_OpenWin_Wh extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NMAL6820CommonLogic.setInitParamForLocationPopup(scrnMsg, ZYPConstant.FLG_OFF_N);

        // Making of subscreen delivery information
        Object[] params = NMAL6820CommonLogic.setParamForLocationPopup(scrnMsg, scrnMsg.rtlWhCd_H1, null, null, ZYPConstant.FLG_ON_Y);

        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_EV, EVENT_NM_AL6820SCRN00_OPEN_WIN_WH);
