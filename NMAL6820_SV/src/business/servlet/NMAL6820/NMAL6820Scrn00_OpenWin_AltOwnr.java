 ...
 * Function Name : Open Alternate Owner Search Popup(NMAL6050)
 * 
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 02/22/2016   CSAI            D.Fukaya        Create          QC# 2369
 *</pre>
 */
public class NMAL6820Scrn00_OpenWin_AltOwnr extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NMAL6820CommonLogic.setInitParamForAltOwnrPopup(scrnMsg);

        // Making of subscreen delivery information
        Object[] params = NMAL6820CommonLogic.setParamForAltOwnrPopup(scrnMsg);

        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_EV, EVENT_NM_AL6820SCRN00_OPEN_WIN_ALT_OWNR);
