 ...
 *</pre>
 */
public class NMAL0160_INIT extends S21INITCommonHandler implements NMAL0160Constant {
	...
	protected void setNameForMessage(EZDBMsg bMsg) {
	    NMAL0160BMsg scrnMsg = (NMAL0160BMsg) bMsg;
	    NMAL0160_ABMsg aBMsg;
        for (int i = 0; i < scrnMsg.A.length(); i++) {
            aBMsg = scrnMsg.A.no(i);
            aBMsg.mdseCstUpdEffFromDt_A1.setNameForMessage("Effective Date");
        }
