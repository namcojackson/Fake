...
/*
 *NWAL1710_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NWAL1710_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** DS_ORD_CATG_NM_A*/
	public final EZDSStringItem              dsOrdCatgNm_A;

    /** DS_ORD_TP_CD_A*/
	public final EZDSStringItem              dsOrdTpCd_A;

    /** DS_ORD_TP_NM_A*/
	public final EZDSStringItem              dsOrdTpNm_A;

    /** ORD_PROC_TP_NM_A*/
	public final EZDSStringItem              ordProcTpNm_A;

    /** DS_ORD_RSN_GRP_NM_A*/
	public final EZDSStringItem              dsOrdRsnGrpNm_A;

    /** DS_ORD_TP_DESC_TXT_A*/
	public final EZDSStringItem              dsOrdTpDescTxt_A;

    /** LINE_BIZ_TP_NM_A*/
	public final EZDSStringItem              lineBizTpNm_A;
	...
	/**
	 * NWAL1710_ASMsg is constructor.
	 * The initialization when the instance of NWAL1710_ASMsg is generated.
	 */
	public NWAL1710_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NWAL1710_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		dsOrdCatgCd_A = (EZDSStringItem)newItem("dsOrdCatgCd_A");
		dsOrdCatgNm_A = (EZDSStringItem)newItem("dsOrdCatgNm_A");
		dsOrdTpCd_A = (EZDSStringItem)newItem("dsOrdTpCd_A");
		dsOrdTpNm_A = (EZDSStringItem)newItem("dsOrdTpNm_A");
		ordProcTpNm_A = (EZDSStringItem)newItem("ordProcTpNm_A");
		dsOrdRsnGrpNm_A = (EZDSStringItem)newItem("dsOrdRsnGrpNm_A");
		dsOrdTpDescTxt_A = (EZDSStringItem)newItem("dsOrdTpDescTxt_A");
		lineBizTpNm_A = (EZDSStringItem)newItem("lineBizTpNm_A");
	 ...
	 * @return NWAL1710_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NWAL1710_ASMsgArray();
	}
