 ...
 *</pre>
 */
public class NSBL0280Scrn00_CMN_Submit extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NSBL0280BMsg scrnMsg = (NSBL0280BMsg) bMsg;
        NSBL0280CommonLogic.checkInputAddCheckItem(scrnMsg);
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        NSBL0280CMsg bizMsg = NSBL0280CommonLogic.setRequestData_UpdateCommon();
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSBL0280CommonLogic.submitScreenControl(this, scrnMsg);
    }
}
