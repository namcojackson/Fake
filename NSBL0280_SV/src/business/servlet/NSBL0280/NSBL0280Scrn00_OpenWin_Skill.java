 ...
 *</pre>
 */
public class NSBL0280Scrn00_OpenWin_Skill extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        List<Object[]> columnList = NSBL0280CommonLogic.getSkillTypeColumnList();
        params[i++] = columnList;
        // 5 : Lv2 : Sort Condition (List: Sort columns)
        params[i++] = NSBL0280CommonLogic.getSkillTypeSortConditionList();
        // 6 : Lv2 : Output
        params[i++] = scrnMsg.C;

        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, "OpenWin_Skill");
    ...
    private String getSqlStr(NSBL0280BMsg scrnMsg) {
        ...
        return NSBL0280CommonLogic.getSkillTypeSql(scrnMsg);
    }

    private List<Object[]> getWhereList(NSBL0280BMsg scrnMsg) {

        int index = getButtonSelectNumber();
        return NSBL0280CommonLogic.getSkillTypeWhereList(scrnMsg, index);
    }
}
