 ...
 *</pre>
 */
public class NSBL0280Scrn00_PagePrev extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSBL0280CommonLogic.checkInputPageCheckItem(scrnMsg);
        scrnMsg.putErrorScreen();

        NSBL0280CommonLogic.searchScreenControl(this, scrnMsg);
    }
}
