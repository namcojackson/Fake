...
/**
 *<pre>
 * NWAL1570Scrn00_OpenWin_OrderReason
 *
 ...
 *</pre>
 */
public class NWAL1570Scrn00_OpenWin_OrderReason extends S21CommonHandler {
    ...
    private static Object[] setPopupParameter(NWAL1570BMsg scrnMsg, String glblCmpyCd) {
        ...
        suffixP0 = "";
        scrnNmP1 = "Order Reason Popup";

        tblNmP2.append(" SELECT");
        tblNmP2.append(" DOT.GLBL_CMPY_CD");
        tblNmP2.append(",DOT.EZCANCELFLAG");
        tblNmP2.append(",DOT.DS_ORD_TP_SORT_NUM");
        tblNmP2.append(",DOT.DS_ORD_TP_CD");
        tblNmP2.append(",DOT.DS_ORD_TP_DESC_TXT");
        tblNmP2.append(" FROM DS_ORD_TP DOT");
        tblNmP2.append(" WHERE");
        tblNmP2.append(" DOT.GLBL_CMPY_CD = '").append(glblCmpyCd).append("'");
        tblNmP2.append(" AND DOT.EZCANCELFLAG = '").append("0").append("'");

        Object[] whereArray0 = new Object[IDX_4];
        whereArray0[0] = "Order Type Code";
        whereArray0[1] = "DS_ORD_TP_CD";
        whereArray0[2] = scrnMsg.xxPopPrm_P1.getValue();
        whereArray0[3] = "Y";
        whereListP3.add(whereArray0);

        Object[] whereArray1 = new Object[IDX_4];
        whereArray1[0] = "Order Type Name";
        whereArray1[1] = "DS_ORD_TP_DESC_TXT";
        whereArray1[2] = scrnMsg.xxPopPrm_P1.getValue();
        whereArray1[3] = "Y";
        whereListP3.add(whereArray1);

        Object[] columnArray0 = new Object[IDX_4];
        columnArray0[0] = "Order Type Code";
        ...
        columnArray1[0] = "Order Type Name";
        ...
        sortConditionArray1[0] = "DS_ORD_TP_SORT_NUM";
        sortConditionArray1[1] = "ASC";
        sortConditionListP5.add(sortConditionArray1);

        scrnMsg.Z.clear();

        String[] strList = scrnMsg.xxDsOrdTpSrchTxt.getValue().split(scrnMsg.xxSplCharTxt.getValue(), 0);
