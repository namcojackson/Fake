 ...
 *</pre>
 */
public class NWAL1570Scrn01_TransitionByPRNumber extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        param = createNPAL1280Parameters(recordMsg);

        setArgForSubScreen(param.toArray(new EZDBStringItem[0]));

    }

    private List<EZDBStringItem> createNPAL1280Parameters(NWAL1570_ABMsg recordMsg) {

        List<EZDBStringItem> param = new ArrayList<EZDBStringItem>();

        // [0]:Purchase Requisition Number
        param.add(recordMsg.prchReqNum_A1);
