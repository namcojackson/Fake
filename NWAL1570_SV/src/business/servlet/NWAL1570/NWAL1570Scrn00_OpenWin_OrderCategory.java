...
/**
 *<pre>
 * NWAL1570Scrn00_OpenWin_OrderCategory
 *
 ...
 *</pre>
 */
public class NWAL1570Scrn00_OpenWin_OrderCategory extends S21CommonHandler {
    ...
    private static Object[] setPopupParameter(NWAL1570BMsg scrnMsg, String glblCmpyCd) {
        ...
        String[] strList = scrnMsg.xxDsOrdCatgSrchTxt.getValue().split(scrnMsg.xxSplCharTxt.getValue(), 0);
