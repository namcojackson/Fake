 ...
 *</pre>
 */
public class NMAL7250Scrn00_OpenWin_CustomerGroup extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.prcGrpPk_CG)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(28).xxPopPrm, scrnMsg.prcGrpPk_CG.getValue().toString());
        }

        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.CUSTOMER_PRICE_GROUP_BILL_TO, scrnMsg.P.no(28).xxPopPrm, scrnMsg.P.no(29).xxPopPrm, getGlobalCompanyCode(), scrnMsg.P));
    }
}
