 ...
 *</pre>
 */
public class NMAL7250Scrn00_OpenWin_CSMPNum extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.CSMP_NUM, scrnMsg.csmpContrNum, scrnMsg.P.no(29).xxPopPrm, getGlobalCompanyCode(), scrnMsg.P));
    }
}
