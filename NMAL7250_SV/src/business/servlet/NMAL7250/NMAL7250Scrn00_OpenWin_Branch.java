 ...
 *</pre>
 */
public class NMAL7250Scrn00_OpenWin_Branch extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.BRANCH, scrnMsg.coaBrCd, scrnMsg.P.no(29).xxPopPrm, prmList));
    }
}
