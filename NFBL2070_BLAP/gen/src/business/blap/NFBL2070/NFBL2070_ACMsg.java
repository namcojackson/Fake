...
/*
 *NFBL2070_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NFBL2070_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** RTL_INV_PK_A1*/
	public final EZDCBigDecimalItem              rtlInvPk_A1;

    /** RTL_INV_LINE_PK_A1*/
	public final EZDCBigDecimalItem              rtlInvLinePk_A1;

    /** RTL_INV_STS_CD_A1*/
	public final EZDCStringItem              rtlInvStsCd_A1;
    ...
    /** RTL_INV_APVL_DT_A1*/
	public final EZDCDateItem              rtlInvApvlDt_A1;
    ...
    /** RTL_INV_LINE_NUM_A1*/
	public final EZDCStringItem              rtlInvLineNum_A1;

    /** RTL_INV_CHRG_TP_DESC_TXT_A1*/
	public final EZDCStringItem              rtlInvChrgTpDescTxt_A1;
    ...
    /** SLS_TAX_RATE_A1*/
	public final EZDCBigDecimalItem              slsTaxRate_A1;

    /** BLLG_BIZ_TP_CD_A1*/
	public final EZDCStringItem              bllgBizTpCd_A1;

    /** RTL_DIV_CD_A1*/
	public final EZDCStringItem              rtlDivCd_A1;

    /** RTL_INV_NUM_A1*/
	public final EZDCStringItem              rtlInvNum_A1;

    /** ITRL_RTL_SMRY_INV_NUM_A1*/
	public final EZDCStringItem              itrlRtlSmryInvNum_A1;

    /** MDSE_CD_A1*/
	public final EZDCStringItem              mdseCd_A1;

    /** SVC_DLR_CD_A1*/
	public final EZDCStringItem              svcDlrCd_A1;

    /** INSTL_POST_CD_A1*/
	public final EZDCStringItem              instlPostCd_A1;

    /** INSTL_CD_A1*/
	public final EZDCStringItem              instlCd_A1;

    /** ISTL_SUB_LOC_CD_A1*/
	public final EZDCStringItem              istlSubLocCd_A1;

    /** INV_LINE_CRAT_DT_A1*/
	public final EZDCDateItem              invLineCratDt_A1;

    /** INV_LINE_MOD_DT_A1*/
	public final EZDCDateItem              invLineModDt_A1;

    /** AP_INV_ROSS_STS_CD_A1*/
	public final EZDCStringItem              apInvRossStsCd_A1;


	/**
	 * NFBL2070_ACMsg is constructor.
	 * The initialization when the instance of NFBL2070_ACMsg is generated.
	 */
	public NFBL2070_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NFBL2070_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		xxChkBox_A1 = (EZDCStringItem)newItem("xxChkBox_A1");
		rtlInvPk_A1 = (EZDCBigDecimalItem)newItem("rtlInvPk_A1");
		rtlInvLinePk_A1 = (EZDCBigDecimalItem)newItem("rtlInvLinePk_A1");
		rtlInvStsCd_A1 = (EZDCStringItem)newItem("rtlInvStsCd_A1");
		...
		rtlInvApvlDt_A1 = (EZDCDateItem)newItem("rtlInvApvlDt_A1");
		bllgPerFromDt_A1 = (EZDCDateItem)newItem("bllgPerFromDt_A1");
		bllgPerThruDt_A1 = (EZDCDateItem)newItem("bllgPerThruDt_A1");
		rtlInvLineNum_A1 = (EZDCStringItem)newItem("rtlInvLineNum_A1");
		rtlInvChrgTpDescTxt_A1 = (EZDCStringItem)newItem("rtlInvChrgTpDescTxt_A1");
		shipQty_A1 = (EZDCBigDecimalItem)newItem("shipQty_A1");
		dealGrsUnitPrcAmt_A1 = (EZDCBigDecimalItem)newItem("dealGrsUnitPrcAmt_A1");
		slsTaxRate_A1 = (EZDCBigDecimalItem)newItem("slsTaxRate_A1");
		bllgBizTpCd_A1 = (EZDCStringItem)newItem("bllgBizTpCd_A1");
		rtlDivCd_A1 = (EZDCStringItem)newItem("rtlDivCd_A1");
		rtlInvNum_A1 = (EZDCStringItem)newItem("rtlInvNum_A1");
		itrlRtlSmryInvNum_A1 = (EZDCStringItem)newItem("itrlRtlSmryInvNum_A1");
		mdseCd_A1 = (EZDCStringItem)newItem("mdseCd_A1");
		svcDlrCd_A1 = (EZDCStringItem)newItem("svcDlrCd_A1");
		instlPostCd_A1 = (EZDCStringItem)newItem("instlPostCd_A1");
		instlCd_A1 = (EZDCStringItem)newItem("instlCd_A1");
		istlSubLocCd_A1 = (EZDCStringItem)newItem("istlSubLocCd_A1");
		invLineCratDt_A1 = (EZDCDateItem)newItem("invLineCratDt_A1");
		invLineModDt_A1 = (EZDCDateItem)newItem("invLineModDt_A1");
		apInvRossStsCd_A1 = (EZDCStringItem)newItem("apInvRossStsCd_A1");
	}

	/**
	 * get the type of array which is stored
	 * @return NFBL2070_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NFBL2070_ACMsgArray();
	}
