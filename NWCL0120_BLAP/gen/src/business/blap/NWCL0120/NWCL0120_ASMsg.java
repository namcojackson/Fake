...
/*
 *NWCL0120_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NWCL0120_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** BILL_TO_CUST_CD_A0*/
	public final EZDSStringItem              billToCustCd_A0;

    /** DS_ACCT_NM_A0*/
	public final EZDSStringItem              dsAcctNm_A0;

    /** INV_DT_A0*/
	public final EZDSDateItem              invDt_A0;

    /** INV_NUM_A0*/
	public final EZDSStringItem              invNum_A0;

    /** CPO_ORD_NUM_A0*/
	public final EZDSStringItem              cpoOrdNum_A0;

    /** DS_ORD_CATG_DESC_TXT_A0*/
	public final EZDSStringItem              dsOrdCatgDescTxt_A0;

    /** DS_ORD_TP_DESC_TXT_A0*/
	public final EZDSStringItem              dsOrdTpDescTxt_A0;

    /** XX_FLG_NM_A0*/
	public final EZDSStringItem              xxFlgNm_A0;

    /** INV_TOT_DEAL_NET_AMT_A0*/
	public final EZDSBigDecimalItem              invTotDealNetAmt_A0;

    /** INV_ERR_MSG_TXT_A0*/
	public final EZDSStringItem              invErrMsgTxt_A0;
	...
	/**
	 * NWCL0120_ASMsg is constructor.
	 * The initialization when the instance of NWCL0120_ASMsg is generated.
	 */
	public NWCL0120_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NWCL0120_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		billToCustCd_A0 = (EZDSStringItem)newItem("billToCustCd_A0");
		dsAcctNm_A0 = (EZDSStringItem)newItem("dsAcctNm_A0");
		invDt_A0 = (EZDSDateItem)newItem("invDt_A0");
		invNum_A0 = (EZDSStringItem)newItem("invNum_A0");
		cpoOrdNum_A0 = (EZDSStringItem)newItem("cpoOrdNum_A0");
		dsOrdCatgDescTxt_A0 = (EZDSStringItem)newItem("dsOrdCatgDescTxt_A0");
		dsOrdTpDescTxt_A0 = (EZDSStringItem)newItem("dsOrdTpDescTxt_A0");
		xxFlgNm_A0 = (EZDSStringItem)newItem("xxFlgNm_A0");
		invTotDealNetAmt_A0 = (EZDSBigDecimalItem)newItem("invTotDealNetAmt_A0");
		invErrMsgTxt_A0 = (EZDSStringItem)newItem("invErrMsgTxt_A0");
	 ...
	 * @return NWCL0120_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NWCL0120_ASMsgArray();
	}
