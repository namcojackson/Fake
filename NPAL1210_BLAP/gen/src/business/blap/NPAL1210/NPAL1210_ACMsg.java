...
/*
 *NPAL1210_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NPAL1210_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** SEQ_NUMBER_A1*/
	public final EZDCBigDecimalItem              seqNumber_A1;

    /** APVL_BY_PSN_CD_A1*/
	public final EZDCStringItem              apvlByPsnCd_A1;

    /** APVL_FULL_PSN_NM_A1*/
	public final EZDCStringItem              apvlFullPsnNm_A1;

    /** APVL_HIST_ACT_TP_DESC_TXT_A1*/
	public final EZDCStringItem              apvlHistActTpDescTxt_A1;

    /** XX_DT_TM_A1*/
	public final EZDCStringItem              xxDtTm_A1;

    /** APVL_HIST_TXT_A1*/
	public final EZDCStringItem              apvlHistTxt_A1;


	/**
	 * NPAL1210_ACMsg is constructor.
	 * The initialization when the instance of NPAL1210_ACMsg is generated.
	 */
	public NPAL1210_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NPAL1210_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		seqNumber_A1 = (EZDCBigDecimalItem)newItem("seqNumber_A1");
		apvlByPsnCd_A1 = (EZDCStringItem)newItem("apvlByPsnCd_A1");
		apvlFullPsnNm_A1 = (EZDCStringItem)newItem("apvlFullPsnNm_A1");
		apvlHistActTpDescTxt_A1 = (EZDCStringItem)newItem("apvlHistActTpDescTxt_A1");
		xxDtTm_A1 = (EZDCStringItem)newItem("xxDtTm_A1");
		apvlHistTxt_A1 = (EZDCStringItem)newItem("apvlHistTxt_A1");
	}

	/**
	 * get the type of array which is stored
	 * @return NPAL1210_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NPAL1210_ACMsgArray();
	}
