 ...
 *</pre>
 */
public class NSAL0740Scrn00_OnChangeHldPrcUtilDt extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(aBMsg.uplftFixedDt_D1);
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        int idx = getButtonSelectNumber();
        NSAL0740_ABMsg aBMsg = scrnMsg.A.no(idx);
        if (!hasValue(aBMsg.uplftFixedDt_D1)) {
            aBMsg.fixTermInMthAot_D1.clear();
            aBMsg.uplftPcyDt_D1.clear();
            scrnMsg.setFocusItem(aBMsg.uplftFixedDt_D1);
            return null;
        }
