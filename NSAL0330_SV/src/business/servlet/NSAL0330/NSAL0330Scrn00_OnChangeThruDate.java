 ...
 * 2016/08/09   Hitachi         K.Kishimoto     Update          QC#12879
 *</pre>
 */
public class NSAL0330Scrn00_OnChangeThruDate extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(getButtonSelectNumber()).bllgSchdThruDt_A1);
    }
}
