...
/*
 *NSAL0830BMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0830BMsg extends EZDBMsg implements EZDSchemaItemDefines {
    ...
    /** XX_SEL_NUM_H*/
	public final EZDBStringItem              xxSelNum_H;

    /** ROW_SQ_NUM_H*/
	public final EZDBBigDecimalItem              rowSqNum_H;
    ...
    /** A*/
	public final business.servlet.NSAL0830.NSAL0830_ABMsgArray              A;
    ...
    /** O*/
	public final business.servlet.NSAL0830.NSAL0830_OBMsgArray              O;
    ...
    /** T*/
	public final business.servlet.NSAL0830.NSAL0830_TBMsgArray              T;

    /** P*/
	public final business.servlet.NSAL0830.NSAL0830_PBMsgArray              P;


	/**
	 * NSAL0830BMsg is constructor.
	 * The initialization when the instance of NSAL0830BMsg is generated.
	 */
	public NSAL0830BMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0830BMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		xxSelNum_H = (EZDBStringItem)newItem("xxSelNum_H");
		rowSqNum_H = (EZDBBigDecimalItem)newItem("rowSqNum_H");
		...
		A = (business.servlet.NSAL0830.NSAL0830_ABMsgArray)newMsgArray("A");
		...
		O = (business.servlet.NSAL0830.NSAL0830_OBMsgArray)newMsgArray("O");
		...
		T = (business.servlet.NSAL0830.NSAL0830_TBMsgArray)newMsgArray("T");
		P = (business.servlet.NSAL0830.NSAL0830_PBMsgArray)newMsgArray("P");
	}

	/**
	 * get the type of array which is stored
	 * @return NSAL0830BMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0830BMsgArray();
	}
	...
	{"xxSelNum_H", "xxSelNum_H", "H", null, TYPE_HANKAKUEISU, "5", null},
	{"rowSqNum_H", "rowSqNum_H", "H", null, TYPE_SEISU_SYOSU, "28", "0"},
	...
	{"A", "A", null, "50", "business.servlet.NSAL0830.NSAL0830_ABMsgArray", null, null},
	...
	{"O", "O", null, "1000", "business.servlet.NSAL0830.NSAL0830_OBMsgArray", null, null},
	...
	{"T", "T", null, "200", "business.servlet.NSAL0830.NSAL0830_TBMsgArray", null, null},
	
	{"P", "P", null, "200", "business.servlet.NSAL0830.NSAL0830_PBMsgArray", null, null},
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"XX_SEL_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxSelNum_H
        {"ROW_SQ_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//rowSqNum_H
