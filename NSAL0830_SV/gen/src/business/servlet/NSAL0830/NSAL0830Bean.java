...
/*
 *NSAL0830Bean.java Copyright FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
...
/*
 * NSAL0830 is data bean class.
 */
public class NSAL0830Bean extends EZDCommonDataBean {
	...
	/** XX_SEL_NUM_H*/
	public static final String xxSelNum_H = "xxSelNum_H";

	/** ROW_SQ_NUM_H*/
	public static final String rowSqNum_H = "rowSqNum_H";
	...
	/** XS_MTR_LVL_NUM_A*/
	public static final String xsMtrLvlNum_A = "xsMtrLvlNum_A";
	...
	public static final String dsXsCopyIntfcPk_A = "dsXsCopyIntfcPk_A";
	...
	/**
	 * Method name:NSAL0830 is Bean's Constructor.
	 * <dd>method explanation:Initialization when instance of NSAL0830Bean is generated
	 * <dd>Remarks:
	 */
	public NSAL0830Bean() {
		super("business.servlet.NSAL0830.NSAL0830BMsg");
	}
	 ...
	 * @return XX_SEL_NUM_H
	 */
	public String getXxSelNum_H() {
		return outputValue(xxSelNum_H);
	}

	/**
	 * set  XX_SEL_NUM_H.
	 * @param data XX_SEL_NUM_H
	 */
	public void setXxSelNum_H(String data) {
		inputValue(xxSelNum_H,data);
	}
	 ...
	 * @return ROW_SQ_NUM_H
	 */
	public String getRowSqNum_H() {
		return outputValue(rowSqNum_H);
	}

	/**
	 * set  ROW_SQ_NUM_H.
	 * @param data ROW_SQ_NUM_H
	 */
	public void setRowSqNum_H(String data) {
		inputValue(rowSqNum_H,data);
	}
	...
	/**
	 * get  XS_MTR_LVL_NUM_A.
	 * @param idx1 List Number
	 * @return XS_MTR_LVL_NUM_A
	 */
	public String getXsMtrLvlNum_A(int idx1) {
		return outputValue(A, idx1, xsMtrLvlNum_A);
	}

	/**
	 * set  XS_MTR_LVL_NUM_A.
	 * @param data XS_MTR_LVL_NUM_AArray
	 */
	public void setXsMtrLvlNum_A(String[] data) {
		int i,j;
		int startPoint = getDisplayStartPoint(A);
		for(i = startPoint, j = 0; i < (startPoint + data.length); i++, j++) {
			inputValue(A, i, xsMtrLvlNum_A, data[j]);
		}
	}
	...
	/**
	 * get  DS_XS_COPY_INTFC_PK_A.
	 * @param idx1 List Number
	 * @return DS_XS_COPY_INTFC_PK_A
	 */
	public String getDsXsCopyIntfcPk_A(int idx1) {
		return outputValue(A, idx1, dsXsCopyIntfcPk_A);
	}

	/**
	 * set  DS_XS_COPY_INTFC_PK_A.
	 * @param data DS_XS_COPY_INTFC_PK_AArray
	 */
	public void setDsXsCopyIntfcPk_A(String[] data) {
		int i,j;
		int startPoint = getDisplayStartPoint(A);
		for(i = startPoint, j = 0; i < (startPoint + data.length); i++, j++) {
			inputValue(A, i, dsXsCopyIntfcPk_A, data[j]);
		}
	}
