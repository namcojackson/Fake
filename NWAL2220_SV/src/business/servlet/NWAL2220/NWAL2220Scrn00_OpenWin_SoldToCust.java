 ...
 *</pre>
 */
public class NWAL2220Scrn00_OpenWin_SoldToCust extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setValue(scrnMsg.xxPopPrm_00, scrnMsg.sellToCustCd);
        setValue(scrnMsg.xxPopPrm_01, scrnMsg.dsAcctNm_OT);
        setValue(scrnMsg.xxPopPrm_12, DISP_HRCH_ACCT_CD_BILL);
        setValue(scrnMsg.xxPopPrm_15, scrnMsg.soldToCustLocCd);
