 ...
 *</pre>
 */
public class NWAL2220Scrn00_OpenWin_BillToCust extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setValue(scrnMsg.xxPopPrm_00, scrnMsg.billToCustAcctCd);
        setValue(scrnMsg.xxPopPrm_01, scrnMsg.dsAcctNm_BT);
        setValue(scrnMsg.xxPopPrm_12, DISP_HRCH_ACCT_CD_BILL);
        setValue(scrnMsg.xxPopPrm_15, scrnMsg.billToCustCd);
