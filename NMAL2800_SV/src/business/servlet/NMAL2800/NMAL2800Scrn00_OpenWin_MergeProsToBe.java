...
/**
 *<pre>
 * NMAL2800Scrn00_OpenWin_MergeProsToBe
 *
 ...
 *</pre>
 */
public class NMAL2800Scrn00_OpenWin_MergeProsToBe extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(aBMsg.aftLocNum_A1)) {
            aBMsg.aftLocNum_A1.setErrorInfo(1, ZZM9000E, new String[] {AFT_LOC_NUM });
...
//        }
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxModeCd_R1, NMAL2800Constant.MODE_SET_LOC);
        ZYPEZDItemValueSetter.setValue(scrnMsg.rvwProsNum_R1, aBMsg.rvwProsNum_A1.getValue());
        ZYPEZDItemValueSetter.setValue(scrnMsg.locNum_R1, aBMsg.aftLocNum_A1.getValue());
