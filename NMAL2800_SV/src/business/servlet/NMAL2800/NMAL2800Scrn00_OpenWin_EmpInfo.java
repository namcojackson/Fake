...
/**
 *<pre>
 * NMAL2800Scrn00_OpenWin_EmpInfo
 *
 ...
 *</pre>
 */
public class NMAL2800Scrn00_OpenWin_EmpInfo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(1).xxPopPrm, scrnMsg.befPsnNum_H1);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(2).xxPopPrm, ZYPConstant.FLG_ON_Y);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(10).xxPopPrm, POPUP_EMP);
