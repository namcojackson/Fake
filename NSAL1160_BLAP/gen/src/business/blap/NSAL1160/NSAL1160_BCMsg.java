...
/*
 *NSAL1160_BCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL1160_BCMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** PROC_DT_D1*/
	public final EZDCDateItem              procDt_D1;

    /** PROC_DT_D2*/
	public final EZDCDateItem              procDt_D2;

    /** SVC_MEMO_TP_DESC_TXT*/
	public final EZDCStringItem              svcMemoTpDescTxt;
	...
	/**
	 * NSAL1160_BCMsg is constructor.
	 * The initialization when the instance of NSAL1160_BCMsg is generated.
	 */
	public NSAL1160_BCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL1160_BCMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		procDt_D1 = (EZDCDateItem)newItem("procDt_D1");
		procDt_D2 = (EZDCDateItem)newItem("procDt_D2");
		svcMemoTpDescTxt = (EZDCStringItem)newItem("svcMemoTpDescTxt");
		svcCmntTxt = (EZDCStringItem)newItem("svcCmntTxt");
	}

	/**
	 * get the type of array which is stored
	 * @return NSAL1160_BCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL1160_BCMsgArray();
	}
