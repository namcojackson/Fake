...
import static business.servlet.NMAL0240.constant.NMAL0240Constant.NMAM0050E;
 ...
 *</pre>
 */
public class NMAL0240Scrn00_InsertRow extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.A.getValidCount() + 1 >= len) {
            scrnMsg.setMessageInfo(NMAM0050E, new String[] {Integer.toString(len) });
