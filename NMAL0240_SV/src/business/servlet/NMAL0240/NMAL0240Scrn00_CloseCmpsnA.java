 ...
 *</pre>
 */
public class NMAL0240Scrn00_CloseCmpsnA extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxCellIdx_A, scrnMsg.A.no(sel).xxRowNum_A1.getValue());
