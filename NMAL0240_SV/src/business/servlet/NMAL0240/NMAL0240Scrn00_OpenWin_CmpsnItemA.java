...
/**
 *<pre>
 * NMAL0240Scrn00_OpenWin_CmpsnItem
 *
 ...
 *</pre>
 */
public class NMAL0240Scrn00_OpenWin_CmpsnItemA extends S21CommonHandler {
...
//        scrnMsg.xxScrNm.setValue(OPEN_CMPSN_A);
//
...
//        whereArray0[2] = scrnMsg.A.no(getButtonSelectNumber()).mdseCd_A1.getValue();
//        whereArray0[3] = "Y";
...
//        setArgForSubScreen(params);
		...
		scrnMsg.O.no(0).xxPopPrm.setValue(scrnMsg.A.no(getButtonSelectNumber()).mdseCd_A1.getValue());
		//scrnMsg.O.no(7).xxPopPrm.setValue(scrnMsg.mdseDescShortTxt_H1.getValue());
		scrnMsg.O.no(29).xxPopPrm.setValue("NMAL0240Scrn00_OpenWin_CmpsnItemA");
