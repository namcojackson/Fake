...
/*
 *NMAL0240_ABMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL0240_ABMsg extends EZDBMsg implements EZDSchemaItemDefines {
    ...
    /** XX_NUM_A2*/
	public final EZDBBigDecimalItem              xxNum_A2;

    /** XX_ROW_NUM_A1*/
	public final EZDBBigDecimalItem              xxRowNum_A1;

    /** CMPSN_CHNG_REQ_PK_A1*/
	public final EZDBBigDecimalItem              cmpsnChngReqPk_A1;

    /** CMPSN_PK_A1*/
	public final EZDBBigDecimalItem              cmpsnPk_A1;
    ...
    /** MDSE_CMPSN_TP_CD_A1*/
	public final EZDBStringItem              mdseCmpsnTpCd_A1;
	...
	/**
	 * NMAL0240_ABMsg is constructor.
	 * The initialization when the instance of NMAL0240_ABMsg is generated.
	 */
	public NMAL0240_ABMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL0240_ABMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		xxNum_A2 = (EZDBBigDecimalItem)newItem("xxNum_A2");
		xxRowNum_A1 = (EZDBBigDecimalItem)newItem("xxRowNum_A1");
		cmpsnChngReqPk_A1 = (EZDBBigDecimalItem)newItem("cmpsnChngReqPk_A1");
		cmpsnPk_A1 = (EZDBBigDecimalItem)newItem("cmpsnPk_A1");
		...
		mdseCmpsnTpCd_A1 = (EZDBStringItem)newItem("mdseCmpsnTpCd_A1");
	 ...
	 * @return NMAL0240_ABMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL0240_ABMsgArray();
	}
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"XX_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxNum_A2
        {"XX_ROW_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxRowNum_A1
        {"CMPSN_CHNG_REQ_PK",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//cmpsnChngReqPk_A1
        {"CMPSN_PK",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//cmpsnPk_A1
        ...
        {"CHILD_MDSE_QTY",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//childMdseQty_A1
        ...
        {"XX_SCR_ITEM_10_TXT",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxScrItem10Txt_A1
        ...
        {"MDSE_CMPSN_TP_CD",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//mdseCmpsnTpCd_A1
