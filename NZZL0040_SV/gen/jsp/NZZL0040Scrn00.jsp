...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NZZL0040Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Customer Care launcher Screen">

<%@include file="../common/common.jsp" %>
<%
    //EXTNE307T010
    String functionID = ((business.servlet.NZZL0040.NZZL0040Bean)databean).getXxScrEventNm();
%>
			<center>
									...
									<tr>
										<td height="28px" width="1070px" valign="bottom">
											<table class="pTab_UPPER_ON" border="0" cellpadding="0" cellspacing="0" >
												<tr title="Customer Care">
													<td align="center" class="same">Customer Care</td>
												</tr>
...
<% if (functionID != null && !"".equals(functionID)) {%>
		                                    <a href="<%=getCustomAppURL(functionID)%>" target="CustomerCare" onclick="f_open_window_max(this.href, 'CustomerCare')"><font size="7">Customer Care</font></a>
<% } else { %>
                                            <font size="7">Customer Care</font>
<% } %>
                                        </td>
                                    </tr>
                                </table>
