...
import static business.servlet.NZZL0040.constant.NZZL0040Constant.*;
import business.servlet.NZZL0040.NZZL0040BMsg;
...
/** 
 *<pre>
 * Business ID : NZZL0040 Customer Care launcher Screen
 *</pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NZZL0040_INIT extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NZZL0040BMsg scrnMsg = (NZZL0040BMsg) bMsg;
        ...
        boolean authTarget = getUserProfileService().isFunctionGranted(user, CUSTOMER_CARE_FUNCTION_ID);
        if (authScreen && authTarget) {
	        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, CUSTOMER_CARE_FUNCTION_ID);
        } else {
