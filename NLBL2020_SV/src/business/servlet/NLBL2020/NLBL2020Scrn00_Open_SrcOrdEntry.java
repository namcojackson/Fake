 ...
 *</pre>
 */
public class NLBL2020Scrn00_Open_SrcOrdEntry extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (SCE_ORD_TP.DIRECT_SALES.equals(selectRecord.sceOrdTpCd_AH.getValue()) || SCE_ORD_TP.DC_TRANSFER.equals(selectRecord.sceOrdTpCd_AH.getValue())) {
            ...
            setResult(NLBL2020Constant.RTRN_CD_RS);
            ...
            setResult(NLBL2020Constant.RTRN_CD_DT);

        } else if (SCE_ORD_TP.TECH_REQUEST.equals(selectRecord.sceOrdTpCd_AH.getValue())) {

            setResult(NLBL2020Constant.RTRN_CD_TR);
            ...
            setResult(NLBL2020Constant.RTRN_CD_RM);
        }
