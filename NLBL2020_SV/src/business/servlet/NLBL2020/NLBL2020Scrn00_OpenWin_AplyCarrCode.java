 ...
 *</pre>
 */
public class NLBL2020Scrn00_OpenWin_AplyCarrCode extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxMntEventNm, NLBL2020Constant.EVENT_NM_NLBL2020SCRN00_OPENWIN_APLYCARRCODE);
        setArgForSubScreen(params);
    }

    private List<Object> getSearchConditionSetting(NLBL2020BMsg scrnMsg) {
    ...
    private String getSelectSQL(NLBL2020BMsg scrnMsg) {
