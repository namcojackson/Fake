 ...
 *</pre>
 */
public class NLBL2020Scrn00_OpenWin_CarrInfo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxMntEventNm, NLBL2020Constant.EVENT_NM_NLBL2020SCRN00_OPENWIN_CARRINFO);
        setArgForSubScreen(params);
    }

    private List<Object> getSearchConditionSetting(NLBL2020BMsg scrnMsg, int index) {
    ...
    private List<Object> getDisplayColumnSetting(NLBL2020BMsg scrnMsg) {
    ...
    private List<Object> getSortSetting(NLBL2020BMsg scrnMsg) {
    ...
    private String getSelectSQL(NLBL2020BMsg scrnMsg, int index) {
    ...
    private int selectNumberForShpgSvcLvlPulldown(NLBL2020BMsg scrnMsg, EZDBStringItem selectShpgSvcLvlCd){
