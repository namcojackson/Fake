 ...
 *</pre>
 */
public class NLBL2020Scrn00_Open_Location_Info_Popup extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NLBL2020CommonLogic.setLocationPopupParam(scrnMsg, true);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxMntEventNm, NLBL2020Constant.EVENT_NM_OPENWIN_LOCINFO_RTLWH);
