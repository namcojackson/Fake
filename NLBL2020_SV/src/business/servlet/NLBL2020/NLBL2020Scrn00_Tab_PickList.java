 ...
 *</pre>
 */
public class NLBL2020Scrn00_Tab_PickList extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if ("E".equals(bizMsg.getMessageKind())) {
            ...
            // Set Tab Pick List
            scrnMsg.xxDplyTab.setValue(NLBL2020Constant.TAB_PICK_LIST);

            // clear image file of sort columns (Gif file. ASC or DESC.)
            S21SortColumnIMGController.clearIMG(NLBL2020Constant.SCRN_ID, scrnMsg, scrnMsg.B.no(0).getBaseContents());
        }
