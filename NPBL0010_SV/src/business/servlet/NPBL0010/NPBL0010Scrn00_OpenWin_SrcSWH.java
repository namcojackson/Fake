 ...
 *</pre>
 */
public class NPBL0010Scrn00_OpenWin_SrcSWH extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NPBL0010CommonLogic.setInitParamForSrcWarehousePopup(scrnMsg);

        // Making of subscreen delivery information
        Object[] params = NPBL0010CommonLogic.setParamForSrcWarehousePopup(scrnMsg);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(12).xxPopPrm, SOURCE_SUB_WAREHOUSE);
