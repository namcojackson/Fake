 ...
 *</pre>
 */
public class NPBL0010Scrn00_OpenWin_Carrier extends S21CommonHandler {
...
//        NPBL0010CMsg bizMsg  = (NPBL0010CMsg) cMsg;
        ...
        NPBL0010CommonLogic.setInitParamForCarrierPopup(scrnMsg);

        // Making of subscreen delivery information
        Object[] params = NPBL0010CommonLogic.setParamForCarrierPopup(scrnMsg);
