 ...
 *</pre>
 */
public class NSBL0210Scrn00_OpenWin_ShiftDetail extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NSBL0210CommonLogic.createShiftSearchPopupParameter(scrnMsg, null, null, scrnMsg.A.no(selIndex).svcLineBizCd.getValue()));
    }
}
