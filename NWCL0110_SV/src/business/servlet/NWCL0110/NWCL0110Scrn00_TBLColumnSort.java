 ...
 *</pre>
 */
public class NWCL0110Scrn00_TBLColumnSort extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (NWCL0110Bean.A.equals(sortTblNm)) {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (bizMsg != null) {
            ...
            // set sort icons
            if (NWCL0110Bean.A.equals(scrnMsg.xxSortTblNm.getValue())) {
