...
/*
 *NFAL0270SMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NFAL0270SMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	public final EZDSStringItemArray              svcInvChrgTpCd_PD;

    /** SVC_INV_CHRG_TP_DESC_TXT_PD*/
	public final EZDSStringItemArray              svcInvChrgTpDescTxt_PD;

    /** SVC_INV_CHRG_TP_CD_H*/
	public final EZDSStringItem              svcInvChrgTpCd_H;

    /** SVC_ALLOC_TP_CD_PD*/
	public final EZDSStringItemArray              svcAllocTpCd_PD;

    /** SVC_ALLOC_TP_DESC_TXT_PD*/
	public final EZDSStringItemArray              svcAllocTpDescTxt_PD;

    /** SVC_ALLOC_TP_CD_H*/
	public final EZDSStringItem              svcAllocTpCd_H;
    ...
    /** XX_SORT_TBL_NM_B1*/
	public final EZDSStringItem              xxSortTblNm_B1;

    /** XX_SORT_ITEM_NM_B1*/
	public final EZDSStringItem              xxSortItemNm_B1;

    /** XX_SORT_ORD_BY_TXT_B1*/
	public final EZDSStringItem              xxSortOrdByTxt_B1;

    /** A*/
	public final business.blap.NFAL0270.NFAL0270_ASMsgArray              A;

    /** B*/
	public final business.blap.NFAL0270.NFAL0270_BSMsgArray              B;
    ...
    /** P*/
	public final business.blap.NFAL0270.NFAL0270_PSMsgArray              P;
	...
	/**
	 * NFAL0270SMsg is constructor.
	 * The initialization when the instance of NFAL0270SMsg is generated.
	 */
	public NFAL0270SMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NFAL0270SMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		svcInvChrgTpCd_PD = (EZDSStringItemArray)newItemArray("svcInvChrgTpCd_PD");
		svcInvChrgTpDescTxt_PD = (EZDSStringItemArray)newItemArray("svcInvChrgTpDescTxt_PD");
		svcInvChrgTpCd_H = (EZDSStringItem)newItem("svcInvChrgTpCd_H");
		svcAllocTpCd_PD = (EZDSStringItemArray)newItemArray("svcAllocTpCd_PD");
		svcAllocTpDescTxt_PD = (EZDSStringItemArray)newItemArray("svcAllocTpDescTxt_PD");
		svcAllocTpCd_H = (EZDSStringItem)newItem("svcAllocTpCd_H");
		...
		xxSortTblNm_B1 = (EZDSStringItem)newItem("xxSortTblNm_B1");
		xxSortItemNm_B1 = (EZDSStringItem)newItem("xxSortItemNm_B1");
		xxSortOrdByTxt_B1 = (EZDSStringItem)newItem("xxSortOrdByTxt_B1");
		A = (business.blap.NFAL0270.NFAL0270_ASMsgArray)newMsgArray("A");
		B = (business.blap.NFAL0270.NFAL0270_BSMsgArray)newMsgArray("B");
		xxComnColOrdTxt = (EZDSStringItem)newItem("xxComnColOrdTxt");
		xxFileData = (EZDSMimeSourceItem)newItem("xxFileData");
		P = (business.blap.NFAL0270.NFAL0270_PSMsgArray)newMsgArray("P");
	 ...
	 * @return NFAL0270SMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NFAL0270SMsgArray();
	}
	...
	{"A", "A", null, "200", "business.blap.NFAL0270.NFAL0270_ASMsgArray", null, null},
	
	{"B", "B", null, "200", "business.blap.NFAL0270.NFAL0270_BSMsgArray", null, null},
	
	{"xxComnColOrdTxt", "xxComnColOrdTxt", null, null, TYPE_HANKAKUEISU, "2000", null},
	{"xxFileData", "xxFileData", null, null, TYPE_UPLOAD, null, null},
	{"P", "P", null, "99", "business.blap.NFAL0270.NFAL0270_PSMsgArray", null, null},
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"SVC_INV_CHRG_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcInvChrgTpCd_PD
        {"SVC_INV_CHRG_TP_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcInvChrgTpDescTxt_PD
        {"SVC_INV_CHRG_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcInvChrgTpCd_H
        {"SVC_ALLOC_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcAllocTpCd_PD
        {"SVC_ALLOC_TP_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcAllocTpDescTxt_PD
        {"SVC_ALLOC_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcAllocTpCd_H
