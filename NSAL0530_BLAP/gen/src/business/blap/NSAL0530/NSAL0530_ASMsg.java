...
// Generated on    :20161128100943000
// Velocity macro:EZDMsg.vm V200607010
// Excel Add-in :BusinessComponentInterfaceDefinitionDocumentAddIn_XLS200710010.xla XLA200710010
/*
 *NSAL0530_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
...
/**
 * It is NSAL0530 Business Application Global Area Message class.
 * @author
 * @version XLA200710010
 */
public class NSAL0530_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** SVC_SLN_SQ_AL*/
	public final EZDSBigDecimalItem              svcSlnSq_AL;
    ...
    /** XX_LOC_NM_A1*/
	public final EZDSStringItem              xxLocNm_A1;

    /** XX_LOC_NM_A2*/
	public final EZDSStringItem              xxLocNm_A2;

    /** XX_LOC_NM_A3*/
	public final EZDSStringItem              xxLocNm_A3;

    /** SVC_SLN_CRAT_DT_A*/
	public final EZDSDateItem              svcSlnCratDt_A;

    /** SVC_SLN_CRAT_PSN_CD_A*/
	public final EZDSStringItem              svcSlnCratPsnCd_A;

    /** SVC_SLN_UPD_DT_A*/
	public final EZDSDateItem              svcSlnUpdDt_A;
	...
	/**
	 * NSAL0530_ASMsg is constructor.
	 * The initialization when the instance of NSAL0530_ASMsg is generated.
	 */
	public NSAL0530_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0530_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		svcSlnSq_AL = (EZDSBigDecimalItem)newItem("svcSlnSq_AL");
		svcSlnSq_A = (EZDSBigDecimalItem)newItem("svcSlnSq_A");
		svcSlnNm_A = (EZDSStringItem)newItem("svcSlnNm_A");
		xxLocNm_A1 = (EZDSStringItem)newItem("xxLocNm_A1");
		xxLocNm_A2 = (EZDSStringItem)newItem("xxLocNm_A2");
		xxLocNm_A3 = (EZDSStringItem)newItem("xxLocNm_A3");
		svcSlnCratDt_A = (EZDSDateItem)newItem("svcSlnCratDt_A");
		svcSlnCratPsnCd_A = (EZDSStringItem)newItem("svcSlnCratPsnCd_A");
		svcSlnUpdDt_A = (EZDSDateItem)newItem("svcSlnUpdDt_A");
	 ...
	 * @return NSAL0530_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0530_ASMsgArray();
	}
