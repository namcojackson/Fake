 ...
 * Function Name : The business process for OnClick Delete Row<br>
 * </p>
 * 
 * <pre>
 ...
 * </pre>
 */
public class NMAL6840Scrn00_OnClick_DeleteRow extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.A.getValidCount() == 0) {
            ...
            NMAL6840CommonLogic.deactivateButton(BTN_CMN.SUBMIT, this);
            return;
        }
        ...
        if (lastRow.xxChkBox_A1.isInputProtected()) {
            // focus on Sub WH Name
            scrnMsg.setFocusItem(lastRow.rtlSwhNm_A1);
        } else {
