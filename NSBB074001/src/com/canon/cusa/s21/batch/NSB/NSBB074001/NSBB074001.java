 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB074001;
...
import business.db.NSBI2140_01TMsg;
...
/**
 * <pre>
 * Web OMAL FF Configuration Types Batch
 * 
 ...
 * </pre>
 */
public class NSBB074001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB074001().executeBatch(NSBB074001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2140_01TMsg> inTMsgList = new ArrayList<NSBI2140_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2140_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2140_01TMsg> inMsgLst) {
        NSBI2140_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2140_01TMsg[inMsgLst.size()];
    ...
    private NSBI2140_01TMsg setCreateValue(ResultSet rs) {

        NSBI2140_01TMsg inParam = new NSBI2140_01TMsg();
