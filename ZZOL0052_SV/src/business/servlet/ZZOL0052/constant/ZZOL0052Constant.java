package business.servlet.ZZOL0052.constant;

public interface ZZOL0052Constant {

    String businessId = "ZZOL0052";

    String screenId = "ZZOL0052Scrn00";
    ...
    String[] CMN_BTN10 = { "btn10", "CMN_Close",    "Close" };
