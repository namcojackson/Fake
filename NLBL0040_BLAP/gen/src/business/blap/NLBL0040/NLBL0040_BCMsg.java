...
/*
 *NLBL0040_BCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLBL0040_BCMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** FROM_ZIP_CD_B1*/
	public final EZDCStringItem              fromZipCd_B1;

    /** TO_ZIP_CD_B1*/
	public final EZDCStringItem              toZipCd_B1;

    /** TRNSP_LT_AOT_B1*/
	public final EZDCBigDecimalItem              trnspLtAot_B1;

    /** _EZCancelFlag_B1*/
	public final EZDCStringItem              ezCancelFlag_B1;

    /** ST_CD_B1*/
	public final EZDCStringItem              stCd_B1;

    /** SHPG_MODE_CD_B1*/
	public final EZDCStringItem              shpgModeCd_B1;

    /** ZIP_SQ_NUM_B1*/
	public final EZDCStringItem              zipSqNum_B1;
	...
	/**
	 * NLBL0040_BCMsg is constructor.
	 * The initialization when the instance of NLBL0040_BCMsg is generated.
	 */
	public NLBL0040_BCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLBL0040_BCMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		xxChkBox_B1 = (EZDCStringItem)newItem("xxChkBox_B1");
		fromZipCd_B1 = (EZDCStringItem)newItem("fromZipCd_B1");
		toZipCd_B1 = (EZDCStringItem)newItem("toZipCd_B1");
		trnspLtAot_B1 = (EZDCBigDecimalItem)newItem("trnspLtAot_B1");
		ezCancelFlag_B1 = (EZDCStringItem)newItem("ezCancelFlag_B1");
		stCd_B1 = (EZDCStringItem)newItem("stCd_B1");
		shpgModeCd_B1 = (EZDCStringItem)newItem("shpgModeCd_B1");
		zipSqNum_B1 = (EZDCStringItem)newItem("zipSqNum_B1");
	 ...
	 * @return NLBL0040_BCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLBL0040_BCMsgArray();
	}
