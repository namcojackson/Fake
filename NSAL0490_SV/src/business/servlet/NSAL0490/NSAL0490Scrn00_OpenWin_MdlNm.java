 ...
 *</pre>
 */
public class NSAL0490Scrn00_OpenWin_MdlNm extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue(NSAL0490Constant.ITEM_NM_MDL_NM);

        // set param
        NSAL0490CommonLogic.setParamMdlNm(scrnMsg);
