 ...
 *</pre>
 */
public class NSAL0490Scrn00_TAB_SvcRules extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (NSAL0490CommonLogic.hasUpdateFuncId()) {
            NSAL0490CommonLogic.controlSvcRulesField(scrnMsg, true);
        } else {
            NSAL0490CommonLogic.controlSvcRulesField(scrnMsg, false);
        }
        ...
        NSAL0490CommonLogic.controlCommonTabBtn(scrnMsg, true, false, true, true, true);
        ...
        scrnMsg.xxDplyTab.setValue(NSAL0490Constant.TAB_SVC_RULES);
    }
}
