...
/*
 *NSAL1330_XSMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL1330_XSMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** CONTR_XS_COPY_PK_X*/
	public final EZDSBigDecimalItem              contrXsCopyPk_X;

    /** CONTR_PHYS_BLLG_MTR_RELN_PK_X*/
	public final EZDSBigDecimalItem              contrPhysBllgMtrRelnPk_X;

    /** DS_CONTR_BLLG_MTR_PK_X*/
	public final EZDSBigDecimalItem              dsContrBllgMtrPk_X;
	...
	/**
	 * NSAL1330_XSMsg is constructor.
	 * The initialization when the instance of NSAL1330_XSMsg is generated.
	 */
	public NSAL1330_XSMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL1330_XSMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		contrXsCopyPk_X = (EZDSBigDecimalItem)newItem("contrXsCopyPk_X");
		contrPhysBllgMtrRelnPk_X = (EZDSBigDecimalItem)newItem("contrPhysBllgMtrRelnPk_X");
		dsContrBllgMtrPk_X = (EZDSBigDecimalItem)newItem("dsContrBllgMtrPk_X");
	 ...
	 * @return NSAL1330_XSMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL1330_XSMsgArray();
	}
