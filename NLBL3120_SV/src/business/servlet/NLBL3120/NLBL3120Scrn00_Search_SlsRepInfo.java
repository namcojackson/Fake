 ...
 *</pre>
 */
public class NLBL3120Scrn00_Search_SlsRepInfo extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NLBL3120BMsg scrnMsg = (NLBL3120BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.slsRepOrSlsTeamTocCd)) {
            scrnMsg.slsRepOrSlsTeamTocCd.setErrorInfo(1, ZZM9000E
                    , new String[]{scrnMsg.slsRepOrSlsTeamTocCd.getNameForMessage()});
        }
