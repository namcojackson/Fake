 ...
 *</pre>
 */
public class NLBL3120Scrn00_Search_SupvInfo extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NLBL3120BMsg scrnMsg = (NLBL3120BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.supvPsnCd)) {
            scrnMsg.supvPsnCd.setErrorInfo(1, ZZM9000E
                    , new String[]{scrnMsg.supvPsnCd.getNameForMessage()});
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.supvPsnCd);
