 ...
 *</pre>
 */
public class NLBL3120Scrn00_Search_CoordInfo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.schdCoordPsnCd)) {
            scrnMsg.schdCoordPsnCd.setErrorInfo(1, ZZM9000E
                    , new String[]{scrnMsg.schdCoordPsnCd.getNameForMessage()});
        }
