 ...
 *</pre>
 */
public class NFDL0160Scrn00_OpenWin_CR extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // set ScrEventNm CR_Equip,CR_Svc or CR_Sply
        scrnMsg.xxScrEventNm.setValue(getSubmitedFieldNm(ctx));

        Object[] params = NFDL0160CommonLogic.getParamNWAL1130ForOpenWinCR(scrnMsg);
