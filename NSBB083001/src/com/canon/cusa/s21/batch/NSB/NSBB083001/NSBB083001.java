 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB083001;
...
import business.db.NSBI2230_01TMsg;
...
/**
 * <pre>
 * Web OMAL G8 Contract Billing Batch
 * 
 * Date         Company         Name            Create/Update   Defect No
 * 
 * ----------------------------------------------------------------------
 * 2016/06/03   Hitachi         T.Mizuki        Create          N/A
 * </pre>
 */
public class NSBB083001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB083001().executeBatch(NSBB083001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2230_01TMsg> inTMsgList = new ArrayList<NSBI2230_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2230_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2230_01TMsg> inMsgLst) {
        NSBI2230_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2230_01TMsg[inMsgLst.size()];
    ...
    private NSBI2230_01TMsg setCreateValue(ResultSet rs) {

        NSBI2230_01TMsg inParam = new NSBI2230_01TMsg();
