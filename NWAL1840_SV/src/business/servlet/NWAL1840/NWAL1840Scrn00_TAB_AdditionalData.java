 ...
 *</pre>
 */
public class NWAL1840Scrn00_TAB_AdditionalData extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        //if (TAB_ADDITIONAL.equals(dplyTab) || TAB_LINES.equals(dplyTab) && ZYPCommonFunc.hasValue(scrnMsg.A.no(0).mdseCd_A)) {
        if (TAB_ADDITIONAL.equals(dplyTab) || TAB_LINES.equals(dplyTab) && !ZYPCommonFunc.hasValue(scrnMsg.A.no(0).mdseCd_A)) {
