 ...
 * ----------------------------------------------------------------------
 * 2016/04/27   Fujitsu         T.Murai         Create          N/A
 * </pre>
 */
public class NWAL1840Scrn00_OpenWin_PrcContrNum extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NWAL1840CommonLogic.getParamNWAL1130ForAssnProgram(scrnMsg);
