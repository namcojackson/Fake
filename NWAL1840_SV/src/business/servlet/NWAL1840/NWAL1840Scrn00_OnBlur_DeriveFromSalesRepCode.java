 ...
 *</pre>
 */
public class NWAL1840Scrn00_OnBlur_DeriveFromSalesRepCode extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.psnNum)) { //S21_NA#7861 Mod Start slsRepPsnCd -> psnNum
            scrnMsg.setFocusItem(scrnMsg.slsRepTocNm);
            return;
        }

        scrnMsg.addCheckItem(scrnMsg.dsOrdCatgDescTxt);
        scrnMsg.addCheckItem(scrnMsg.psnNum); //S21_NA#7861 Mod Start slsRepPsnCd -> psnNum
        scrnMsg.putErrorScreen();
