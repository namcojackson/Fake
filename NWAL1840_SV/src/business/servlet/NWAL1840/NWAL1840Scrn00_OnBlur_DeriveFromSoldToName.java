 ...
 * 2018/03/09   Fujitus         A.Kosai         Update          S21_NA#22387
 * 2018/07/26   Fujitsu         H.Kumagai       Update          QC#14307
 *</pre>
 */
public class NWAL1840Scrn00_OnBlur_DeriveFromSoldToName extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
       ...
       // 2018/07/26 QC#14307 Add End
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxRqstFlg.getValue())) {
            ...
            Object[] params = NWAL1840CommonLogic.getParamNMAL6760ForSoldTo(scrnMsg);
            setArgForSubScreen(params);
            return;
        }
