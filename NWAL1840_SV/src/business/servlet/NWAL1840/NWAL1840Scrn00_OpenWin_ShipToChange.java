...
import static business.servlet.NWAL1840.constant.NWAL1840Constant.NWAM0671E;
 ...
 *</pre>
 */
public class NWAL1840Scrn00_OpenWin_ShipToChange extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.shipToCustLocCd)) {
            scrnMsg.shipToCustLocCd.setErrorInfo(1, NWAM0671E, new String[] {scrnMsg.shipToCustLocCd.getNameForMessage() });
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NWAL1840CommonLogic.getParamNWAL0140(scrnMsg);
