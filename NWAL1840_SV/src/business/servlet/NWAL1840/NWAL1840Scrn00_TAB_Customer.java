 ...
 *</pre>
 */
public class NWAL1840Scrn00_TAB_Customer extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        //if (TAB_CUSTOMER.equals(dplyTab) || TAB_LINES.equals(dplyTab) && ZYPCommonFunc.hasValue(scrnMsg.A.no(0).mdseCd_A)) {
        if (TAB_CUSTOMER.equals(dplyTab) || TAB_LINES.equals(dplyTab) && !ZYPCommonFunc.hasValue(scrnMsg.A.no(0).mdseCd_A)) {
