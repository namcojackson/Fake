 ...
 *</pre>
 */
public class NWAL1840Scrn00_OpenWin_SubstituteItem extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.A.no(selectIndex).mdseCd_A);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NWAL1840CommonLogic.getParamNWAL1130ForSbstItem(scrnMsg);
