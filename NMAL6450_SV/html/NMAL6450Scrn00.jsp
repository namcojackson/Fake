...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Payment Term Maintenance">
					...
					<ul>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="96%">
									<div>
										<li title="Price Category"			class="pTab_OFF" ><a href="./AMALxxxxScrn00.html">Price Category</a></li>
									</div>
								</td>
								<td></td>
							</tr>
														...
														<div id="topTBL" style="overflow-x:hidden; width:983; overflow-y:none; height:19;">
															<table border="1" cellpadding="1" cellspacing="0" align="center">
																...
																<tr>
																	...
																	<td class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'pmtTermSortNum_A1' )">Sort<br>Num<img id="sortIMG.pmtTermSortNum_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																	<td class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'pmtTermCd_A1' )">Code<img id="sortIMG.pmtTermCd_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																	<td class="pClothBs">Name</td>
																	<td class="pClothBs">Description Text</td>
																	<td class="pClothBs">Amount of Time</td>
