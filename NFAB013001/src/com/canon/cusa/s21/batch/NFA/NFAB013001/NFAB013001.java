 ...
 * 05/14/2014   CSAI            K.Uramori        Update          Modification for DS.
 * 04/04/2016   CSAI            K.Uramori        Update          Modification for CSA
 ...
 * 10/03/2018   Hitachi         E.Kameishi       Update          QC#28593
 * 2020/01/13   Fujitsu         Y.Matsui         Update          QC#55294
 * 2020/09/21   Hitachi         M.Kikushima      Update          QC#60112
 * </pre>
 */
public class NFAB013001 extends S21BatchMain implements NFAB013001Constant, ZYPConstant, NFACommonJrnlEntryConstant {
    ...
    public static void main(String[] args) {
        ...
        new NFAB013001().executeBatch(NFAB013001.class.getSimpleName());
    ...
    private Boolean doEntryToJournalEntry(List<Map> ssmResForGetAjePtrn) {
        ...
        queryParam.put("coaProjAcctTp_WIP", COA_PROJ_ACCT_TP.WIP);
        // END 2016/10/13 K.Kojima [QC#14586,ADD]
        // START 2016/10/14 K.Kojima [QC#14823,ADD]
        queryParam.put("coaProjAcctTp_CI", COA_PROJ_ACCT_TP.CUST_INTRNST);
        // END 2016/10/14 K.Kojima [QC#14823,ADD]
        // START 2022/09/21 M.Kikushima [QC#60112,ADD]
        queryParam.put("nonCanon", NON_CANON);
        queryParam.put("affiliteCd", AFFILITE_CD);
        queryParam.put("cusaGeneral", CUSA_GENERAL);
        // END 2022/09/21 M.Kikushima [QC#60112,ADD]

        Boolean checkEntryToJournalEntry = (Boolean) ssmBatchClient.queryObject("getAjeMdseReclsIntfcNotJrnlized", queryParam, new JrnlEntryHandler(ssmResForGetAjePtrn));
    ...
    private final class JrnlEntryHandler extends S21SsmBooleanResultSetHandlerSupport {
                ...
                while (rsAjeIntfcNotJrnlized.next()) {
                    ...
                    for (NFAC000101PMsg rsAjePtrnList : ajePtrnListByAjeIdAndIndTp) {
                        ...
                        try {
                            ...
                            // ** Amount ** //
                            // Debit
                            commonJrnlEntry.setFieldValue(jrnlEntry, "jrnlDealDrAmt", rsAjeIntfcNotJrnlized.getBigDecimal(RECLS_AMT));
                            commonJrnlEntry.setFieldValue(jrnlEntry, "jrnlFuncDrAmt", rsAjeIntfcNotJrnlized.getBigDecimal(RECLS_AMT));

                            // Credit
                            commonJrnlEntry.setFieldValue(jrnlEntry, "jrnlDealCrAmt", rsAjeIntfcNotJrnlized.getBigDecimal(RECLS_AMT));
                            commonJrnlEntry.setFieldValue(jrnlEntry, "jrnlFuncCrAmt", rsAjeIntfcNotJrnlized.getBigDecimal(RECLS_AMT));

                            // additional info
                            commonJrnlEntry.setFieldValue(jrnlEntry, "vndCd", rsAjeIntfcNotJrnlized.getString(VND_CD));
                            ...
                            setValue(jrnlEntry.jrnlEntryThirdRefTxt,  rsAjeIntfcNotJrnlized.getString("MDSE_COST_TP_CD"));
                            setValue(jrnlEntry.jrnlEntryThirdAttrbNm,  "Cost Type");
                            setValue(jrnlEntry.jrnlEntryFrthRefTxt,  rsAjeIntfcNotJrnlized.getBigDecimal("MDSE_INVTY_COST_PCT").toString());
        ...
        throws SQLException, EZDValidatorException {
            ...
            // START 2018/10/03 E.Kameishi [QC#28593, MOD]
            //if (!NFACommonJrnlEntryConstant.COA_SEG_LKUP_TP_LINK_VAL.equals(ptrnVal) && LOC_STS.LOAN.equalsIgnoreCase(rs.getString("LOC_STS_CD"))) {
            if (!NFACommonJrnlEntryConstant.COA_SEG_LKUP_TP_LINK_VAL.equals(ptrnVal) && LOC_STS.TRIAL_USE.equalsIgnoreCase(rs.getString("LOC_STS_CD"))) {
            // END 2018/10/03 E.Kameishi [QC#28593, ADD]
                if ("dr".equals(crOrDr)) {
            ...
            } else if (!NFACommonJrnlEntryConstant.COA_SEG_LKUP_TP_LINK_VAL.equals(ptrnVal) && isInTransitWH(rs.getString("LOC_STS_CD"))) {
                if ("dr".equals(crOrDr)) {
                ...
                // START 2016/10/14 K.Kojima [QC#14823,ADD]
            } else if (!NFACommonJrnlEntryConstant.COA_SEG_LKUP_TP_LINK_VAL.equals(ptrnVal) && LOC_STS.WAITING_FOR_INSTALLATION.equalsIgnoreCase(rs.getString("LOC_STS_CD"))) {
                if ("dr".equals(crOrDr)) {
        ...
        throws SQLException {
            ...
            commonJrnlEntry.setFieldValue(jrnlEntry, "ajeIntfcPk", rsAjeIntfcNotJrnlized.getBigDecimal(AJE_MDSE_RECLS_INTFC_PK));
            ...
            // deleted by logic change. Group by COA_PROD_CD, COA_AFFL_CD
        ...
        private void insertIntoJrnlOrCtrl(boolean checkCoaSegmentDetermination, ResultSet rs,
            ...
            commonJrnlEntry.setFieldValue(ajeIntfcCtrl, "ajeIntfcPk", rs.getBigDecimal(AJE_MDSE_RECLS_INTFC_PK));
