...
/*
 *NSBL0040_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSBL0040_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** XX_LINK_PROT_A1*/
	public final EZDCStringItem              xxLinkProt_A1;
    ...
    /** XX_LINK_PROT_A2*/
	public final EZDCStringItem              xxLinkProt_A2;

    /** XX_EXST_FLG_A1*/
	public final EZDCStringItem              xxExstFlg_A1;

    /** XX_LINK_PROT_A3*/
	public final EZDCStringItem              xxLinkProt_A3;
    ...
    /** XX_LINK_PROT_A4*/
	public final EZDCStringItem              xxLinkProt_A4;

    /** XX_EXST_FLG_A2*/
	public final EZDCStringItem              xxExstFlg_A2;

    /** SVC_BILL_TP_CD_A1*/
	public final EZDCStringItem              svcBillTpCd_A1;

    /** SVC_BILL_TP_NM_A1*/
	public final EZDCStringItem              svcBillTpNm_A1;
    ...
    /** XX_LINK_PROT_A5*/
	public final EZDCStringItem              xxLinkProt_A5;

    /** TECH_CD_A1*/
	public final EZDCStringItem              techCd_A1;

    /** ORIG_INV_CCY_CD_A1*/
	public final EZDCStringItem              origInvCcyCd_A1;

    /** SVC_LBOR_DEAL_AMT_A1*/
	public final EZDCBigDecimalItem              svcLborDealAmt_A1;
	...
	/**
	 * NSBL0040_ACMsg is constructor.
	 * The initialization when the instance of NSBL0040_ACMsg is generated.
	 */
	public NSBL0040_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSBL0040_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		xxLinkProt_A1 = (EZDCStringItem)newItem("xxLinkProt_A1");
		billToCustCd_A1 = (EZDCStringItem)newItem("billToCustCd_A1");
		locNm_A1 = (EZDCStringItem)newItem("locNm_A1");
		xxLinkProt_A2 = (EZDCStringItem)newItem("xxLinkProt_A2");
		xxExstFlg_A1 = (EZDCStringItem)newItem("xxExstFlg_A1");
		xxLinkProt_A3 = (EZDCStringItem)newItem("xxLinkProt_A3");
		svcTaskNum_A1 = (EZDCStringItem)newItem("svcTaskNum_A1");
		fsrNum_A1 = (EZDCStringItem)newItem("fsrNum_A1");
		xxLinkProt_A4 = (EZDCStringItem)newItem("xxLinkProt_A4");
		xxExstFlg_A2 = (EZDCStringItem)newItem("xxExstFlg_A2");
		svcBillTpCd_A1 = (EZDCStringItem)newItem("svcBillTpCd_A1");
		svcBillTpNm_A1 = (EZDCStringItem)newItem("svcBillTpNm_A1");
		...
		xxLinkProt_A5 = (EZDCStringItem)newItem("xxLinkProt_A5");
		techCd_A1 = (EZDCStringItem)newItem("techCd_A1");
		origInvCcyCd_A1 = (EZDCStringItem)newItem("origInvCcyCd_A1");
		svcLborDealAmt_A1 = (EZDCBigDecimalItem)newItem("svcLborDealAmt_A1");
	 ...
	 * @return NSBL0040_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSBL0040_ACMsgArray();
	}
