...
/*
 *NMAL6460_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL6460_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	public final EZDCStringItem              pmtTermCashDiscNm_A1;

    /** PMT_TERM_CASH_DISC_SORT_NUM_A1*/
	public final EZDCBigDecimalItem              pmtTermCashDiscSortNum_A1;

    /** PMT_TERM_CASH_DISC_DESC_TXT_A1*/
	public final EZDCStringItem              pmtTermCashDiscDescTxt_A1;
	...
	public final EZDCBigDecimalItem              ediCashDiscDueAot_A1;

    /** EDI_CASH_DISC_PCT_A1*/
	public final EZDCBigDecimalItem              ediCashDiscPct_A1;

    /** PMT_TERM_SEND_FAX_FLG_A1*/
	public final EZDCStringItem              pmtTermSendFaxFlg_A1;

    /** ISTL_PMT_TERM_FLG_A1*/
	public final EZDCStringItem              istlPmtTermFlg_A1;

    /** ACTL_EXCH_RATE_TP_NUM_A1*/
	public final EZDCStringItem              actlExchRateTpNum_A1;

    /** PMT_TERM_CONSL_FLG_A1*/
	public final EZDCStringItem              pmtTermConslFlg_A1;

    /** PMT_TERM_CONSL_LAST_DOM_FLG_A1*/
	public final EZDCStringItem              pmtTermConslLastDomFlg_A1;

    /** PMT_TERM_CONSL_DUE_DAY_A1*/
	public final EZDCStringItem              pmtTermConslDueDay_A1;

    /** PMT_TERM_CONSL_ADD_MTH_NUM_A1*/
	public final EZDCBigDecimalItem              pmtTermConslAddMthNum_A1;

    /** PMT_CASH_FLG_A1*/
	public final EZDCStringItem              pmtCashFlg_A1;

    /** PMT_CC_FLG_A1*/
	public final EZDCStringItem              pmtCcFlg_A1;
	...
	/**
	 * NMAL6460_ACMsg is constructor.
	 * The initialization when the instance of NMAL6460_ACMsg is generated.
	 */
	public NMAL6460_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL6460_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		pmtTermCashDiscNm_A1 = (EZDCStringItem)newItem("pmtTermCashDiscNm_A1");
		pmtTermCashDiscSortNum_A1 = (EZDCBigDecimalItem)newItem("pmtTermCashDiscSortNum_A1");
		pmtTermCashDiscDescTxt_A1 = (EZDCStringItem)newItem("pmtTermCashDiscDescTxt_A1");
		...
		ediCashDiscDueAot_A1 = (EZDCBigDecimalItem)newItem("ediCashDiscDueAot_A1");
		ediCashDiscPct_A1 = (EZDCBigDecimalItem)newItem("ediCashDiscPct_A1");
		pmtTermSendFaxFlg_A1 = (EZDCStringItem)newItem("pmtTermSendFaxFlg_A1");
		istlPmtTermFlg_A1 = (EZDCStringItem)newItem("istlPmtTermFlg_A1");
		actlExchRateTpNum_A1 = (EZDCStringItem)newItem("actlExchRateTpNum_A1");
		pmtTermConslFlg_A1 = (EZDCStringItem)newItem("pmtTermConslFlg_A1");
		pmtTermConslLastDomFlg_A1 = (EZDCStringItem)newItem("pmtTermConslLastDomFlg_A1");
		pmtTermConslDueDay_A1 = (EZDCStringItem)newItem("pmtTermConslDueDay_A1");
		pmtTermConslAddMthNum_A1 = (EZDCBigDecimalItem)newItem("pmtTermConslAddMthNum_A1");
		pmtCashFlg_A1 = (EZDCStringItem)newItem("pmtCashFlg_A1");
		pmtCcFlg_A1 = (EZDCStringItem)newItem("pmtCcFlg_A1");
	 ...
	 * @return NMAL6460_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL6460_ACMsgArray();
	}
