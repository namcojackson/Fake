...
/*
 *NFBL2060_SSMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NFBL2060_SSMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	public final EZDSStringItem              apInvCatgDescTxt_S1;

    /** XX_LINK_PROT_S1*/
	public final EZDSStringItem              xxLinkProt_S1;

    /** XX_LINK_PROT_S2*/
	public final EZDSStringItem              xxLinkProt_S2;

    /** INV_DT_S1*/
	public final EZDSDateItem              invDt_S1;

    /** INV_AUTH_DT_S1*/
	public final EZDSDateItem              invAuthDt_S1;

    /** PRNT_VND_CD_S1*/
	public final EZDSStringItem              prntVndCd_S1;

    /** DPLY_VND_NM_S1*/
	public final EZDSStringItem              dplyVndNm_S1;

    /** AP_VND_CD_S1*/
	public final EZDSStringItem              apVndCd_S1;

    /** INV_AMT_S1*/
	public final EZDSBigDecimalItem              invAmt_S1;

    /** INV_HDR_DESC_TXT_S1*/
	public final EZDSStringItem              invHdrDescTxt_S1;

    /** ACCT_INV_STS_DESC_TXT_S1*/
	public final EZDSStringItem              acctInvStsDescTxt_S1;

    /** PO_NUM_S1*/
	public final EZDSStringItem              poNum_S1;

    /** PO_APVL_DT_S1*/
	public final EZDSDateItem              poApvlDt_S1;

    /** XX_DPLY_TRX_NUM_TXT_S1*/
	public final EZDSStringItem              xxDplyTrxNumTxt_S1;

    /** VND_RTRN_SUBMT_DT_S1*/
	public final EZDSDateItem              vndRtrnSubmtDt_S1;

    /** ENT_PO_DTL_DEAL_NET_AMT_S1*/
	public final EZDSBigDecimalItem              entPoDtlDealNetAmt_S1;

    /** AP_PMT_CHK_NUM_S1*/
	public final EZDSStringItem              apPmtChkNum_S1;

    /** PMT_DT_S1*/
	public final EZDSDateItem              pmtDt_S1;

    /** VND_PMT_TERM_DESC_TXT_S1*/
	public final EZDSStringItem              vndPmtTermDescTxt_S1;

    /** AP_VND_INV_NUM_S1*/
	public final EZDSStringItem              apVndInvNum_S1;

    /** AP_VND_INV_SQ_NUM_S1*/
	public final EZDSStringItem              apVndInvSqNum_S1;
	...
	/**
	 * NFBL2060_SSMsg is constructor.
	 * The initialization when the instance of NFBL2060_SSMsg is generated.
	 */
	public NFBL2060_SSMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NFBL2060_SSMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		apInvCatgDescTxt_S1 = (EZDSStringItem)newItem("apInvCatgDescTxt_S1");
		xxLinkProt_S1 = (EZDSStringItem)newItem("xxLinkProt_S1");
		xxLinkProt_S2 = (EZDSStringItem)newItem("xxLinkProt_S2");
		invDt_S1 = (EZDSDateItem)newItem("invDt_S1");
		invAuthDt_S1 = (EZDSDateItem)newItem("invAuthDt_S1");
		prntVndCd_S1 = (EZDSStringItem)newItem("prntVndCd_S1");
		dplyVndNm_S1 = (EZDSStringItem)newItem("dplyVndNm_S1");
		apVndCd_S1 = (EZDSStringItem)newItem("apVndCd_S1");
		invAmt_S1 = (EZDSBigDecimalItem)newItem("invAmt_S1");
		invHdrDescTxt_S1 = (EZDSStringItem)newItem("invHdrDescTxt_S1");
		acctInvStsDescTxt_S1 = (EZDSStringItem)newItem("acctInvStsDescTxt_S1");
		poNum_S1 = (EZDSStringItem)newItem("poNum_S1");
		poApvlDt_S1 = (EZDSDateItem)newItem("poApvlDt_S1");
		xxDplyTrxNumTxt_S1 = (EZDSStringItem)newItem("xxDplyTrxNumTxt_S1");
		vndRtrnSubmtDt_S1 = (EZDSDateItem)newItem("vndRtrnSubmtDt_S1");
		entPoDtlDealNetAmt_S1 = (EZDSBigDecimalItem)newItem("entPoDtlDealNetAmt_S1");
		apPmtChkNum_S1 = (EZDSStringItem)newItem("apPmtChkNum_S1");
		pmtDt_S1 = (EZDSDateItem)newItem("pmtDt_S1");
		vndPmtTermDescTxt_S1 = (EZDSStringItem)newItem("vndPmtTermDescTxt_S1");
		apVndInvNum_S1 = (EZDSStringItem)newItem("apVndInvNum_S1");
		apVndInvSqNum_S1 = (EZDSStringItem)newItem("apVndInvSqNum_S1");
	 ...
	 * @return NFBL2060_SSMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NFBL2060_SSMsgArray();
	}
	...
	{"xxLinkProt_S2", "xxLinkProt_S2", "S2", null, TYPE_HANKAKUEISU, "1", null},
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"XX_LINK_PROT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxLinkProt_S2
