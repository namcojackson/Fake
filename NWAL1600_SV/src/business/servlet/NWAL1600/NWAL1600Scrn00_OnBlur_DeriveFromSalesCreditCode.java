 ...
 *</pre>
 */
public class NWAL1600Scrn00_OnBlur_DeriveFromSalesCreditCode extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(index).psnNum_A)) { // 2016/05/12 SA21_NA7861 Mod psnCd_A -> psnNum_A
            return null;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (bizMsg == null) {
            ...
            scrnMsg.setFocusItem(scrnMsg.A.no(index).psnNum_A); // 2016/05/12 SA21_NA7861 Mod psnCd_A -> psnNum_A
            return;
        }
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxCondCd.getValue())) {
            ...
            // 2016/05/12 SA21_NA7861 Mod psnCd_A -> psnNum_A
            List<Object[]> whereList = NWAL1600CommonLogic.setSlsrepWhereList(scrnMsg, scrnMsg.A.no(index).psnNum_A.getValue(), null);
