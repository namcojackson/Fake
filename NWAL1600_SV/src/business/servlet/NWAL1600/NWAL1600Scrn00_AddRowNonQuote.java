...
/**
 *<pre>
 * NWAL1600Scrn00_AddRowNonQuote
 *
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2015/09/18   Fujitsu         C.Yokoi         Create          N/A
 *</pre>
 */
public class NWAL1600Scrn00_AddRowNonQuote extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NWAL1600BMsg scrnMsg = (NWAL1600BMsg) bMsg;
        if (100 < scrnMsg.B.getValidCount()) {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int index = scrnMsg.B.getValidCount() - 1;
        scrnMsg.setFocusItem(scrnMsg.B.no(index).lineBizRoleTpCd_B);
    }
}
