...
// business.blap.NWAL1600.NWAL1600CMsg;
 ...
 * 05/12/2016   Fujitsu         T.Murai         Update          S21_NA#7861
 *</pre>
 */
public class NWAL1600Scrn00_OnBlur_DeriveFromSalesRepCode extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(index).psnNum_B)) { // 2016/05/12 SA21_NA7861 Mod psnCd_B -> psnNum_B
            return null;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int index = getButtonSelectNumber();
        if (bizMsg == null) {
            scrnMsg.setFocusItem(scrnMsg.B.no(index).psnNum_B); // 2016/05/12 SA21_NA7861 Mod psnCd_B -> psnNum_B
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxCondCd.getValue())) {
            ...
            // 2016/05/12 SA21_NA7861 Mod psnCd_B -> psnNum_B
            List<Object[]> whereList = NWAL1600CommonLogic.setSlsrepWhereList(scrnMsg, scrnMsg.B.no(index).psnNum_B.getValue(), null);
