 ...
 *</pre>
 */
public class NWAL1600Scrn00_OnBlur_DeriveFromSalesRepName extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(index).tocNm_B)) {
            return null;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxCondCd.getValue())) {
            ...
            List<Object[]> whereList = NWAL1600CommonLogic.setSlsrepWhereList(scrnMsg, null, scrnMsg.B.no(index).tocNm_B.getValue());
