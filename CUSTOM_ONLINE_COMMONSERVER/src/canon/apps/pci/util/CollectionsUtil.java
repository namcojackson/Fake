...
public class CollectionsUtil
{
	...
	public static Set/*<Character>*/ arrayToSet(char[]/*...*/array)
	{
		...
		for (int i=0;i<array.length;i++)
			toReturn.add(PrimWrap.wrapChar(array[i]));
		return toReturn;
	}
	...
	{
		if(array == null)
			return Collections./*emptySet()*/EMPTY_SET;
		if(array.length == 1)
			return Collections.singleton(PrimWrap.wrapChar(array[0]));
	...
	public static Set/*<Character>*/ strToSet(String str)
	{
		...
		for(int i=0;i<str.length();i++)
			set.add(PrimWrap.wrapChar(str.charAt(i)));
		return set;
	}
	...
	public static Set/*<Character>*/ strToUnmodifiableSet(String str)
	{
		if(str == null)
			return Collections./*emptySet()*/EMPTY_SET;
		if(str.length() == 1)
			return Collections.singleton(PrimWrap.wrapChar(str.charAt(0)));
