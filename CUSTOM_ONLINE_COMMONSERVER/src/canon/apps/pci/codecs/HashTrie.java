...
import canon.apps.pci.util.NullSafe;
import canon.apps.pci.util.PrimWrap;
...
public class HashTrie/*<T>*/ implements Map/*<CharSequence,T>*/
{
	private static class Entry/*<T>*/ implements Map.Entry/*<CharSequence,T>*/
	{
		...
		Entry(CharSequence key, /*T*/Object value)
		{
			this.key = key;
			this.value = value;
		}
		 ...
		 */
		static /*<T>*/ Entry/*<T>*/ newInstanceIfNeeded(CharSequence key, int keyLength, /*T*/Object value)
		{
		 ...
		 */
		static /*<T>*/ Entry/*<T>*/ newInstanceIfNeeded(CharSequence key, /*T*/Object value)
		{
			if(value == null || key == null)
				return null;
			return new Entry(key,value);
		...
		public /*CharSequence*/Object getKey()
		{
			return key;
		}
		...
		public /*T*/Object setValue(/*T*/Object value)
		{
	...
	private static class Node/*<T>*/
	{
		 ...
		 *	present.
		 */
		Node/*<T>*/ getNextNode(char ch)
		{
			return getNextNode(PrimWrap.wrapChar(ch));
		}
		 ...
		 * @param value The value for this key.
		 */
		/*T*/Object put(CharSequence key, int pos, /*T*/Object addValue)
		{
			Node/*<T>*/ nextNode;
			Character ch;
			/*T*/Object old;
			...
			ch = PrimWrap.wrapChar(key.charAt(pos));
			if(nextMap == null)
			{
				nextMap = newNodeMap();
				nextNode = new Node();
			...
			else if((nextNode = (Node)nextMap.get(ch))==null)
			{
				nextNode = new Node();
				nextMap.put(ch,nextNode);
			}
		 ...
		 *	none exists.
		 */
		/*T*/Object get(CharSequence key, int pos)
		{
			Node/*<T>*/ nextNode;
		 ...
		 *	match or null if none exists.
		 */
		Entry/*<T>*/ getLongestMatch(PushbackReader keyIn, StringBuffer key) throws IOException
		{
			Node/*<T>*/ nextNode;
			Entry/*<T>*/ ret;
			int c;
		...
		void remap()
		{
			...
			for(Iterator i = nextMap.values().iterator(); i.hasNext();)
			{
		 ...
		 * @param key StringBuffer with our key.
		 * @param keys Set to add to
		 * @return keys with additions
		 */
		Set/*<CharSequence>*/ keySet(StringBuffer key, Set/*<CharSequence>*/ keys)
		{
			int len = key.length();
			...
			if(nextMap != null && nextMap.size() > 0)
			{
				...
				for(Iterator i = nextMap.entrySet().iterator(); i.hasNext();)
				{
		 ...
		 */
		Set/*<Map.Entry<CharSequence,T>>*/ entrySet(StringBuffer key, Set/*<Map.Entry<CharSequence,T>>*/ entries)
		{
			int len = key.length();
	...
	public Map.Entry/*<CharSequence,T>*/ getLongestMatch(PushbackReader keyIn) throws IOException
	{
		if(root == null || keyIn == null)
			return null;
		return root.getLongestMatch(keyIn, new StringBuffer());
	}
	 ...
	 */
	public /*T*/Object remove(Object key) throws UnsupportedOperationException
	{
		throw new UnsupportedOperationException();
	}
	...
	public Set/*<CharSequence>*/ keySet()
	{
		...
		if(root == null)
			return keys;
		return root.keySet(new StringBuffer(), keys);
	}
	...
	public Set/*<Map.Entry<CharSequence,T>>*/ entrySet()
	{
		...
		if(root == null)
			return entries;
		return root.entrySet(new StringBuffer(), entries);
	}
