...
import canon.apps.pci.util.CollectionsUtil;
...
public class HTMLEntityCodec implements Codec
{
	...
	private static final HashMap characterToEntityMap;
    ...
    public String encode(char[] immune, String input) {
        ...
        for ( int i=0; input!=null && i<input.length(); i++ ) {
            encodeCharacter(immune==null?CodecUtil.EMPTY_CHARS:immune, input.charAt(i), b);
        }
        return b.toString();
    }
