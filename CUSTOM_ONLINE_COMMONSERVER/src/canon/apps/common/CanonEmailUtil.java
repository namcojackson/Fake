...
public class CanonEmailUtil {
	...
	public static Email init(Email email){
		System.out.println("in CanonEmailUtil ");
		String hostName = CanonCustomProfile.getUserProfileValue("CANON_EMAIL_SER_HOST_NAME");
		System.out.println("in CanonEmailUtil hostName is "+hostName);
		...
		try {
			...
			//email.setFrom("S21_Operation@cusa.canon.com", "S21 CSA"); added for  QC51405
			email.setFrom("noreply@csa.canon.com", "S21 CSA");
		} catch (EmailException e) {
			e.printStackTrace();
			System.out.println("in CanonEmailUtil error out");
		}
		return email;
	}
