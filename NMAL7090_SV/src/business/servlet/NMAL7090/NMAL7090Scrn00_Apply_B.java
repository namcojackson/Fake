...
import static business.servlet.NMAL7090.constant.NMAL7090Constant.EVENT_APPLY_B;
 ...
 * Function Name: Apply Filtering on Table B
 * </pre>
 * 
 * <pre>
 ...
 *</pre>
 */
public class NMAL7090Scrn00_Apply_B extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // set screen property
        NMAL7090CommonLogic.setScrnProp(this, scrnMsg, EVENT_APPLY_B);

        // Set Forcus on Button Apply B(ezid 57)
        scrnMsg.setFocusItemIndex(57);
    }
}
