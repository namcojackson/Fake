 ...
 *</pre>
 */
public class NMAL7090Scrn00_PageNext extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TABLE_A.equals(scrnMsg.xxModeInd.getValue())) {
            ...
            scrnMsg.xxPageShowFromNum_A.setValue(scrnMsg.xxPageShowToNum_A.getValueInt() + 1);
            scrnMsg.xxPageShowToNum_A.clear();
            scrnMsg.xxPageShowOfNum_A.clear();
        } else if (TABLE_B.equals(scrnMsg.xxModeInd.getValue())) {
            scrnMsg.xxPageShowFromNum_B.setValue(scrnMsg.xxPageShowToNum_B.getValueInt());
            scrnMsg.xxPageShowToNum_B.clear();
        } else if (TABLE_C.equals(scrnMsg.xxModeInd.getValue())) {
            // set values to items of pagenation for next page pagenation
            ZYPTableUtil.clear(scrnMsg.C);
            scrnMsg.xxPageShowFromNum_C.setValue(scrnMsg.xxPageShowToNum_C.getValueInt() + 1);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // screen property
        NMAL7090CommonLogic.setScrnProp(this, scrnMsg, EVENT_PAGE_NEXT);

        // set focus Search button ezid=15
        scrnMsg.setFocusItemIndex(15);
    }
}
