...
public class NMAL7090Scrn00_Search extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NMAL7090BMsg scrnMsg = (NMAL7090BMsg) bMsg;
        NMAL7090CommonLogic.checkSearchItem(scrnMsg);
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.xxPageShowFromNum_B.setValue(1);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NMAL7090CommonLogic.setScrnProp(this, scrnMsg, EVENT_SEARCH);
