...
import static business.servlet.NMAL7090.constant.NMAL7090Constant.EVENT_APPLY_A;
 ...
 * Function Name: Apply Filtering on Table A
 * </pre>
 * 
 * <pre>
 ...
 *</pre>
 */
public class NMAL7090Scrn00_Apply_A extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.xxPageShowFromNum_A.setValue(1);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // set screen property
        NMAL7090CommonLogic.setScrnProp(this, scrnMsg, EVENT_APPLY_A);

        // Set Forcus on Button Apply A(ezid 31)
        scrnMsg.setFocusItemIndex(31);
    }
}
