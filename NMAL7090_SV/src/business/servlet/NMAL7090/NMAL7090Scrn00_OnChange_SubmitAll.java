 ...
 * Function Name : OnChange Submit All
 * </pre>
 * 
 * <pre>
 ...
 *</pre>
 */
public class NMAL7090Scrn00_OnChange_SubmitAll extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        for (int i = 0; i < scrnMsg.B.getValidCount(); i++) {
            if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.submtFlg_BA.getValue())) {
                ZYPEZDItemValueSetter.setValue(scrnMsg.B.no(i).submtFlg_B, ZYPConstant.FLG_ON_Y);
                ZYPEZDItemValueSetter.setValue(scrnMsg.B.no(i).rqstDscdFlg_B, ZYPConstant.FLG_OFF_N);
                ZYPEZDItemValueSetter.setValue(scrnMsg.rqstDscdFlg_BA, ZYPConstant.FLG_OFF_N);
            } else {
