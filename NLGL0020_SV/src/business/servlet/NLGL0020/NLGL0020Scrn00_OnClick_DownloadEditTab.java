 ...
 *</pre>
 */
public class NLGL0020Scrn00_OnClick_DownloadEditTab extends S21CommonHandler implements NLGL0020Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (bizMsg.getMessageInfo() == null || (FLD_VALUE_BLANK.equals(bizMsg.getMessageInfo().getMessage()))) {
            ...
            NLGL0020CommonLogic.commonBtnControl_NLGL0020Scrn00_DNLD_TAB(this);
            ...
            if (ZYPConstant.FLG_OFF_N.equals(validCopyFlag)) {
                scrnMsg.xxSrchRqstDtTpCd_E2.setInputProtected(true);
                NLGL0020CommonLogic.inputFieldControl_NLGL0020Scrn00_Resend_Click(this, scrnMsg);
            }
            ZYPEZDItemValueSetter.setValue(scrnMsg.xxDplyTab, TAB_ID_DNLD);
        }
    }
}
