 ...
 *</pre>
 */
public class NLGL0020Scrn00_OnChange_SubmitList extends S21CommonHandler implements NLGL0020Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.xxSrchRqstDtTpCd_E2.getValue().equals(FLD_VALUE_COPY)) {
            NLGL0020CommonLogic.inputFieldControl_NLGL0020Scrn00_COPY_Click(this, scrnMsg);
        } else {
            NLGL0020CommonLogic.inputFieldControl_NLGL0020Scrn00_Resend_Click(this, scrnMsg);
        }
        scrnMsg.setFocusItem(scrnMsg.xxSrchRqstDtTpCd_E2);
    }
}
