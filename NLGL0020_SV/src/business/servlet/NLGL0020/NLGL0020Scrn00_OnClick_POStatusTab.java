 ...
 *</pre>
 */
public class NLGL0020Scrn00_OnClick_POStatusTab extends S21CommonHandler implements NLGL0020Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if ((bizMsg.getMessageInfo() == null) || (FLD_VALUE_BLANK.equals(bizMsg.getMessageInfo().getMessage()))) {
            NLGL0020CommonLogic.commonBtnControl_NLGL0020Scrn00_POSTATUS_TAB(this);
            NLGL0020CommonLogic.inputFieldControl_NLGL0020Scrn00_Header_Protect(this, scrnMsg);
            ZYPEZDItemValueSetter.setValue(scrnMsg.xxDplyTab, TAB_ID_STATUS);
        }
    }
}
