 ...
 *</pre>
 */
public class NLGL0020Scrn00_OnClick_UPL_CopyRow extends S21CommonHandler implements NLGL0020Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.I.getValidCount() == scrnMsg.I.length()) {
        ...
        if (outGetSelectedRows.size() > 1) {
            ...
            for (int i = 0; i < scrnMsg.I.getValidCount(); i++) {
                ...
                if (ZYPConstant.CHKBOX_ON_Y.equals(scrnMsg.I.no(i).xxChkBox_I1.getValue())) {
                    scrnMsg.addCheckItem(scrnMsg.I.no(i).xxChkBox_I1);
                    scrnMsg.I.no(i).xxChkBox_I1.setErrorInfo(FLD_VALUE_INT_1, NLGM0035E);
                }
            }
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLGL0020CommonLogic.inputFieldControl_NLGL0020Scrn00_Upload_COPY(scrnMsg);
    }
}
