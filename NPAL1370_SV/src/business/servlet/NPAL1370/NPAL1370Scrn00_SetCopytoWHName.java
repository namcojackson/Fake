 ...
 * Function Name :  Set Copy to WH Name
 * </pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NPAL1370Scrn00_SetCopytoWHName extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.rtlWhCd_TO.isError()) {
            scrnMsg.addCheckItem(scrnMsg.rtlWhCd_TO);
            scrnMsg.putErrorScreen();
        } else {
            scrnMsg.setFocusItem(scrnMsg.rtlWhCd_TO);
        }
    }
}
