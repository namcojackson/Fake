...
/*
 *NSBL0450_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSBL0450_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	public final EZDCStringItem              svcSupplTaskNum_A;

    /** SVC_SUPPL_TASK_TP_DESC_TXT_A*/
	public final EZDCStringItem              svcSupplTaskTpDescTxt_A;

    /** TECH_CD_A*/
	public final EZDCStringItem              techCd_A;

    /** TECH_PSN_NM_A*/
	public final EZDCStringItem              techPsnNm_A;

    /** MGR_NM_A*/
	public final EZDCStringItem              mgrNm_A;

    /** XX_CMNT_TXT_A*/
	public final EZDCStringItem              xxCmntTxt_A;

    /** SVC_SUPPL_FROM_DT_A*/
	public final EZDCDateItem              svcSupplFromDt_A;

    /** XX_DT_TM_A1*/
	public final EZDCStringItem              xxDtTm_A1;

    /** SVC_SUPPL_TO_DT_A*/
	public final EZDCDateItem              svcSupplToDt_A;
    ...
    /** XX_ALL_PSN_NM_A1*/
	public final EZDCStringItem              xxAllPsnNm_A1;
    ...
    /** XX_ALL_PSN_NM_A2*/
	public final EZDCStringItem              xxAllPsnNm_A2;

    /** UPD_DT_A*/
	public final EZDCDateItem              updDt_A;

    /** XX_DT_TM_A7*/
	public final EZDCStringItem              xxDtTm_A7;

    /** SVC_SUPPL_TASK_STS_CD_A*/
	public final EZDCStringItem              svcSupplTaskStsCd_A;
	...
	/**
	 * NSBL0450_ACMsg is constructor.
	 * The initialization when the instance of NSBL0450_ACMsg is generated.
	 */
	public NSBL0450_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSBL0450_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		svcSupplTaskNum_A = (EZDCStringItem)newItem("svcSupplTaskNum_A");
		svcSupplTaskTpDescTxt_A = (EZDCStringItem)newItem("svcSupplTaskTpDescTxt_A");
		techCd_A = (EZDCStringItem)newItem("techCd_A");
		techPsnNm_A = (EZDCStringItem)newItem("techPsnNm_A");
		mgrNm_A = (EZDCStringItem)newItem("mgrNm_A");
		xxCmntTxt_A = (EZDCStringItem)newItem("xxCmntTxt_A");
		svcSupplFromDt_A = (EZDCDateItem)newItem("svcSupplFromDt_A");
		xxDtTm_A1 = (EZDCStringItem)newItem("xxDtTm_A1");
		svcSupplToDt_A = (EZDCDateItem)newItem("svcSupplToDt_A");
		...
		xxAllPsnNm_A1 = (EZDCStringItem)newItem("xxAllPsnNm_A1");
		cratDt_A = (EZDCDateItem)newItem("cratDt_A");
		xxDtTm_A6 = (EZDCStringItem)newItem("xxDtTm_A6");
		xxAllPsnNm_A2 = (EZDCStringItem)newItem("xxAllPsnNm_A2");
		updDt_A = (EZDCDateItem)newItem("updDt_A");
		xxDtTm_A7 = (EZDCStringItem)newItem("xxDtTm_A7");
		svcSupplTaskStsCd_A = (EZDCStringItem)newItem("svcSupplTaskStsCd_A");
	 ...
	 * @return NSBL0450_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSBL0450_ACMsgArray();
	}
