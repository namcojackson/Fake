 ...
 *</pre>
 */
public class NMAL0100Scrn00_Sls_Mat_Group_Link_01 extends S21CommonHandler {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0100Scrn00_Sls_Mat_Group_Link_01");
		String selectStr = NMAL0100CommonLogic.setSelectForMaterialGroup(scrnMsg, getGlobalCompanyCode(), "1");
		List<Object[]> whereList = NMAL0100CommonLogic.setWhereListForMaterialGroup(scrnMsg.slsMatGrpCd_01.getValue(), scrnMsg.slsMatGrpDescTxt_01.getValue());
