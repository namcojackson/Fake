...
/*
 *NLCL1040_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLCL1040_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** RTL_WH_CATG_CD_A*/
	public final EZDSStringItem              rtlWhCatgCd_A;
    ...
    /** CUR_INVTY_QTY_A*/
	public final EZDSBigDecimalItem              curInvtyQty_A;

    /** CUR_INVTY_COST_AMT_A*/
	public final EZDSBigDecimalItem              curInvtyCostAmt_A;

    /** HIST_INVTY_TRX_QTY_A*/
	public final EZDSBigDecimalItem              histInvtyTrxQty_A;

    /** HIST_INVTY_TRX_COST_AMT_A*/
	public final EZDSBigDecimalItem              histInvtyTrxCostAmt_A;

    /** HIST_INVTY_TRX_REC_CNT_A*/
	public final EZDSBigDecimalItem              histInvtyTrxRecCnt_A;

    /** ABC_ANLS_CLS_NM_A*/
	public final EZDSStringItem              abcAnlsClsNm_A;

    /** ABC_ANLS_CLS_TAG_CD_A*/
	public final EZDSStringItem              abcAnlsClsTagCd_A;

    /** ABC_ANLS_RSLT_PK_A*/
	public final EZDSBigDecimalItem              abcAnlsRsltPk_A;

    /** ABC_ANLS_RSLT_DTL_PK_A*/
	public final EZDSBigDecimalItem              abcAnlsRsltDtlPk_A;

    /** DELETE_FLAG_IF_A*/
	public final EZDSStringItem              deleteFlagIf_A;

    /** PROCESSED_FLAG_A*/
	public final EZDSStringItem              processedFlag_A;

    /** INVTY_CTRL_FLG_A*/
	public final EZDSStringItem              invtyCtrlFlg_A;
	...
	/**
	 * NLCL1040_ASMsg is constructor.
	 * The initialization when the instance of NLCL1040_ASMsg is generated.
	 */
	public NLCL1040_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLCL1040_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		rtlWhCatgCd_A = (EZDSStringItem)newItem("rtlWhCatgCd_A");
		...
		curInvtyQty_A = (EZDSBigDecimalItem)newItem("curInvtyQty_A");
		curInvtyCostAmt_A = (EZDSBigDecimalItem)newItem("curInvtyCostAmt_A");
		histInvtyTrxQty_A = (EZDSBigDecimalItem)newItem("histInvtyTrxQty_A");
		histInvtyTrxCostAmt_A = (EZDSBigDecimalItem)newItem("histInvtyTrxCostAmt_A");
		histInvtyTrxRecCnt_A = (EZDSBigDecimalItem)newItem("histInvtyTrxRecCnt_A");
		abcAnlsClsNm_A = (EZDSStringItem)newItem("abcAnlsClsNm_A");
		abcAnlsClsTagCd_A = (EZDSStringItem)newItem("abcAnlsClsTagCd_A");
		abcAnlsRsltPk_A = (EZDSBigDecimalItem)newItem("abcAnlsRsltPk_A");
		abcAnlsRsltDtlPk_A = (EZDSBigDecimalItem)newItem("abcAnlsRsltDtlPk_A");
		deleteFlagIf_A = (EZDSStringItem)newItem("deleteFlagIf_A");
		processedFlag_A = (EZDSStringItem)newItem("processedFlag_A");
		invtyCtrlFlg_A = (EZDSStringItem)newItem("invtyCtrlFlg_A");
	 ...
	 * @return NLCL1040_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLCL1040_ASMsgArray();
	}
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"ABC_ANLS_RSLT_PK",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//abcAnlsRsltPk_A
