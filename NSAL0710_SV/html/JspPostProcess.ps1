...
# 7. Run script (F5)
#
$org_file = 'C:\S21_EZDeveloper\workspace\NSAL0710_SV\gen\jsp\NSAL0710Scrn00.jsp'
$dst_file = 'C:\S21_EZDeveloper\workspace\NSAL0710_SV\gen\jsp\NSAL0710Scrn00.jsp.tmp'
(Get-Content -Path $org_file) | ForEach-Object {
    $_ -replace 'ezfArrayNo="1"', 'ezfArrayNo="0"' `
