 ...
 *</pre>
 */
public class NSAL0380Scrn00_OpenWin_SrchIBThru extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSAL0380BMsg scrnMsg = (NSAL0380BMsg) bMsg;
        NSAL0380CommonLogic.setTargetItem(scrnMsg, NSAL0380Constant.EVENT_NM_IB_ID_THRU);
...
//        setArgForSubScreen(NSAL0380CommonLogic.setConfigSearchPopUpInputParam(ctx, scrnMsg));
        ...
        params[NSAL0380Constant.PARAM_INDEX_3] = scrnMsg.svcMachMstrPk_HT;
