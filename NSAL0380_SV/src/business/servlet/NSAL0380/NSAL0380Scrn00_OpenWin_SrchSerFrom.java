 ...
 *</pre>
 */
public class NSAL0380Scrn00_OpenWin_SrchSerFrom extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSAL0380BMsg scrnMsg = (NSAL0380BMsg) bMsg;
        NSAL0380CommonLogic.setTargetItem(scrnMsg, NSAL0380Constant.EVENT_NM_SER_NUM_FROM);
...
//        setArgForSubScreen(NSAL0380CommonLogic.setConfigSearchPopUpInputParam(ctx, scrnMsg));
        ...
        params[NSAL0380Constant.PARAM_INDEX_2] = scrnMsg.serNum_HF;
