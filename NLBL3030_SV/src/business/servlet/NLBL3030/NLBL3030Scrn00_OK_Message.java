 ...
 * </pre>
 */
public class NLBL3030Scrn00_OK_Message extends S21CommonHandler implements NLBL3030Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (arg instanceof Object[]) {
            ...
            if (params.length > 2) {
                ((EZDBStringItem) params[2]).setValue(scrnMsg.xxDsMultMsgDplyTxt.getValue());
            }
        }
