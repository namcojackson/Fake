...
/*
 *NLCL0640_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLCL0640_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** TECH_LOC_CD_A*/
	public final EZDSStringItem              techLocCd_A;
    ...
    /** RCV_SER_TAKE_FLG_A*/
	public final EZDSStringItem              rcvSerTakeFlg_A;

    /** CNT_INP_QTY_A*/
	public final EZDSBigDecimalItem              cntInpQty_A;
	...
	/**
	 * NLCL0640_ASMsg is constructor.
	 * The initialization when the instance of NLCL0640_ASMsg is generated.
	 */
	public NLCL0640_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLCL0640_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		techLocCd_A = (EZDSStringItem)newItem("techLocCd_A");
		...
		rcvSerTakeFlg_A = (EZDSStringItem)newItem("rcvSerTakeFlg_A");
		cntInpQty_A = (EZDSBigDecimalItem)newItem("cntInpQty_A");
		serNum_A = (EZDSStringItem)newItem("serNum_A");
	}

	/**
	 * get the type of array which is stored
	 * @return NLCL0640_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLCL0640_ASMsgArray();
	}
