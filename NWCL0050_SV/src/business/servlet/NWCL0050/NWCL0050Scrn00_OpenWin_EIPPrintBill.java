 ...
 *</pre>
 */
public class NWCL0050Scrn00_OpenWin_EIPPrintBill extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        try {
            ...
            // QC#63675 2024/03/07 End
            BigDecimal eipRptRqstPk = scrnMsg.A.no(idx).eipRptRqstPk_BL.getValue();
...
//                throw new S21AbendException("get report bytes failure");
        ...
        if (reportData != null) {
            // QC#63675 2024/03/07 Start
            String billNumber = scrnMsg.A.no(idx).conslBillNum_A.getValue();
            // execute file download
            //String tempFilePath = scrnMsg.xxFileData.getTempFilePath();
            //executeDownloadPdf(tempFilePath, true);
            String tempFilePath = scrnMsg.xxFileData.getTempFilePath();
            executeDownload(tempFilePath, true, billNumber + ".pdf");
            // QC#63675 2024/03/07 End
        }
