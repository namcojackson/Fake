...
/*
 *NMAL6700_FCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL6700_FCMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	public final EZDCBigDecimalItem              dsCustTrxRulePk_F1;

    /** DS_TRX_RULE_TP_CD_F1*/
	public final EZDCStringItemArray              dsTrxRuleTpCd_F1;

    /** DS_TRX_RULE_TP_NM_F2*/
	public final EZDCStringItemArray              dsTrxRuleTpNm_F2;

    /** DS_TRX_RULE_TP_CD_F3*/
	public final EZDCStringItem              dsTrxRuleTpCd_F3;

    /** DS_PO_REQ_FLG_F1*/
	public final EZDCStringItem              dsPoReqFlg_F1;

    /** HARD_COPY_REQ_FLG_F1*/
	public final EZDCStringItem              hardCopyReqFlg_F1;

    /** DS_BLKT_PO_NUM_F1*/
	public final EZDCStringItem              dsBlktPoNum_F1;

    /** DS_PO_EXPR_DT_F1*/
	public final EZDCDateItem              dsPoExprDt_F1;

    /** DS_DEF_BILL_TO_CD_F1*/
	public final EZDCStringItem              dsDefBillToCd_F1;

    /** DS_DEF_SHIP_TO_CD_F1*/
	public final EZDCStringItem              dsDefShipToCd_F1;

    /** CUST_EFF_LVL_CD_F1*/
	public final EZDCStringItemArray              custEffLvlCd_F1;

    /** CUST_EFF_LVL_NM_F2*/
	public final EZDCStringItemArray              custEffLvlNm_F2;

    /** CUST_EFF_LVL_CD_F3*/
	public final EZDCStringItem              custEffLvlCd_F3;

    /** DS_CR_CARD_REQ_FLG_F1*/
	public final EZDCStringItem              dsCrCardReqFlg_F1;

    /** DS_OVNGT_ALLW_FLG_F1*/
	public final EZDCStringItem              dsOvngtAllwFlg_F1;
	...
	/**
	 * NMAL6700_FCMsg is constructor.
	 * The initialization when the instance of NMAL6700_FCMsg is generated.
	 */
	public NMAL6700_FCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL6700_FCMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		xxChkBox_F1 = (EZDCStringItem)newItem("xxChkBox_F1");
		dsCustTrxRulePk_F1 = (EZDCBigDecimalItem)newItem("dsCustTrxRulePk_F1");
		dsTrxRuleTpCd_F1 = (EZDCStringItemArray)newItemArray("dsTrxRuleTpCd_F1");
		dsTrxRuleTpNm_F2 = (EZDCStringItemArray)newItemArray("dsTrxRuleTpNm_F2");
		dsTrxRuleTpCd_F3 = (EZDCStringItem)newItem("dsTrxRuleTpCd_F3");
		dsPoReqFlg_F1 = (EZDCStringItem)newItem("dsPoReqFlg_F1");
		hardCopyReqFlg_F1 = (EZDCStringItem)newItem("hardCopyReqFlg_F1");
		dsBlktPoNum_F1 = (EZDCStringItem)newItem("dsBlktPoNum_F1");
		dsPoExprDt_F1 = (EZDCDateItem)newItem("dsPoExprDt_F1");
		dsDefBillToCd_F1 = (EZDCStringItem)newItem("dsDefBillToCd_F1");
		dsDefShipToCd_F1 = (EZDCStringItem)newItem("dsDefShipToCd_F1");
		custEffLvlCd_F1 = (EZDCStringItemArray)newItemArray("custEffLvlCd_F1");
		custEffLvlNm_F2 = (EZDCStringItemArray)newItemArray("custEffLvlNm_F2");
		custEffLvlCd_F3 = (EZDCStringItem)newItem("custEffLvlCd_F3");
		dsCrCardReqFlg_F1 = (EZDCStringItem)newItem("dsCrCardReqFlg_F1");
		dsOvngtAllwFlg_F1 = (EZDCStringItem)newItem("dsOvngtAllwFlg_F1");
	 ...
	 * @return NMAL6700_FCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL6700_FCMsgArray();
	}
