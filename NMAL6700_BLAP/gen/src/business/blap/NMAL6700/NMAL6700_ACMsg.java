...
/*
 *NMAL6700_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL6700_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** XX_CHK_BOX_AP*/
	public final EZDCStringItem              xxChkBox_AP;

    /** XX_CHK_BOX_AH*/
	public final EZDCStringItem              xxChkBox_AH;

    /** XX_RELN_DS_ACCT_TXT_A1*/
	public final EZDCStringItem              xxRelnDsAcctTxt_A1;
    ...
    /** THIRD_LINE_ADDR_A1*/
	public final EZDCStringItem              thirdLineAddr_A1;

    /** FRTH_LINE_ADDR_A1*/
	public final EZDCStringItem              frthLineAddr_A1;

    /** CNTY_NM_A1*/
	public final EZDCStringItem              cntyNm_A1;

    /** PROV_NM_A1*/
	public final EZDCStringItem              provNm_A1;

    /** BILL_TO_EFF_FROM_DT_TXT_A1*/
	public final EZDCStringItem              billToEffFromDtTxt_A1;

    /** BILL_TO_EFF_THRU_DT_TXT_A1*/
	public final EZDCStringItem              billToEffThruDtTxt_A1;

    /** SHIP_TO_EFF_FROM_DT_TXT_A1*/
	public final EZDCStringItem              shipToEffFromDtTxt_A1;

    /** SHIP_TO_EFF_THRU_DT_TXT_A1*/
	public final EZDCStringItem              shipToEffThruDtTxt_A1;
	...
	/**
	 * NMAL6700_ACMsg is constructor.
	 * The initialization when the instance of NMAL6700_ACMsg is generated.
	 */
	public NMAL6700_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL6700_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		xxChkBox_AP = (EZDCStringItem)newItem("xxChkBox_AP");
		xxChkBox_AH = (EZDCStringItem)newItem("xxChkBox_AH");
		xxRelnDsAcctTxt_A1 = (EZDCStringItem)newItem("xxRelnDsAcctTxt_A1");
		...
		thirdLineAddr_A1 = (EZDCStringItem)newItem("thirdLineAddr_A1");
		frthLineAddr_A1 = (EZDCStringItem)newItem("frthLineAddr_A1");
		cntyNm_A1 = (EZDCStringItem)newItem("cntyNm_A1");
		provNm_A1 = (EZDCStringItem)newItem("provNm_A1");
		billToEffFromDtTxt_A1 = (EZDCStringItem)newItem("billToEffFromDtTxt_A1");
		billToEffThruDtTxt_A1 = (EZDCStringItem)newItem("billToEffThruDtTxt_A1");
		shipToEffFromDtTxt_A1 = (EZDCStringItem)newItem("shipToEffFromDtTxt_A1");
		shipToEffThruDtTxt_A1 = (EZDCStringItem)newItem("shipToEffThruDtTxt_A1");
	 ...
	 * @return NMAL6700_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL6700_ACMsgArray();
	}
