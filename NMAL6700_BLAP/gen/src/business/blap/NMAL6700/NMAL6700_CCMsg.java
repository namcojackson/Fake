...
/*
 *NMAL6700_CCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL6700_CCMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** DS_ACCT_RELN_PK_C1*/
	public final EZDCBigDecimalItem              dsAcctRelnPk_C1;

    /** DS_ACCT_RELN_PK_BK*/
	public final EZDCBigDecimalItem              dsAcctRelnPk_BK;

    /** DS_ACCT_RELN_TP_CD_C1*/
	public final EZDCStringItemArray              dsAcctRelnTpCd_C1;

    /** DS_ACCT_RELN_TP_NM_C2*/
	public final EZDCStringItemArray              dsAcctRelnTpNm_C2;

    /** DS_ACCT_RELN_TP_CD_C3*/
	public final EZDCStringItem              dsAcctRelnTpCd_C3;

    /** SELL_TO_CUST_PK_C1*/
	public final EZDCBigDecimalItem              sellToCustPk_C1;
    ...
    /** XX_CHK_BOX_CS*/
	public final EZDCStringItem              xxChkBox_CS;
	...
	/**
	 * NMAL6700_CCMsg is constructor.
	 * The initialization when the instance of NMAL6700_CCMsg is generated.
	 */
	public NMAL6700_CCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL6700_CCMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		dsAcctRelnPk_C1 = (EZDCBigDecimalItem)newItem("dsAcctRelnPk_C1");
		dsAcctRelnPk_BK = (EZDCBigDecimalItem)newItem("dsAcctRelnPk_BK");
		dsAcctRelnTpCd_C1 = (EZDCStringItemArray)newItemArray("dsAcctRelnTpCd_C1");
		dsAcctRelnTpNm_C2 = (EZDCStringItemArray)newItemArray("dsAcctRelnTpNm_C2");
		dsAcctRelnTpCd_C3 = (EZDCStringItem)newItem("dsAcctRelnTpCd_C3");
		sellToCustPk_C1 = (EZDCBigDecimalItem)newItem("sellToCustPk_C1");
		...
		xxChkBox_CS = (EZDCStringItem)newItem("xxChkBox_CS");
	 ...
	 * @return NMAL6700_CCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL6700_CCMsgArray();
	}
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"DS_ACCT_RELN_PK",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctRelnPk_C1
        {"DS_ACCT_RELN_PK",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctRelnPk_BK
        {"DS_ACCT_RELN_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctRelnTpCd_C1
        {"DS_ACCT_RELN_TP_NM",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctRelnTpNm_C2
        {"DS_ACCT_RELN_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctRelnTpCd_C3
        {"SELL_TO_CUST_PK",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//sellToCustPk_C1
