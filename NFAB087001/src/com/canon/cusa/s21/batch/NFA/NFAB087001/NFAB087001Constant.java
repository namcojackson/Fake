...
/**
 * Class name: NFAB087001Constant
 * <dd>The class explanation: Constant variable for NFAB087001.
 * <dd>Remarks:
 * @version 1.0
 * @author N. Sasaki
 */
public interface NFAB087001Constant {

    /** Fixed Value : Error Message Parameter. */
    static final String MSG_PARAM = "S21_ORG Snapshot";
    ...
    /** DB Item Column Name */
    static final String FRTH_ORG_CD = "FRTH_ORG_CD";
