 ...
 */
package com.canon.cusa.s21.batch.NFA.NFAB087001;
...
import business.db.TOC_MTH_SNAP_SHOTTMsg;
 ...
 * </pre>
 */
public class NFAB087001 extends S21BatchMain implements NFAB087001Constant, ZYPConstant, NFACommonJrnlEntryConstant {
    /** SSM Batch Clinent */
    ...
    public static void main(String[] args) {
        ...
        new NFAB087001().executeBatch(NFAB087001.class.getSimpleName());
    ...
    private class DBProc extends S21SsmBooleanResultSetHandlerSupport {
        ...
        protected Boolean doProcessQueryResult(ResultSet rs) throws SQLException {
            ...
            try {
                // Clear table
                TOC_MTH_SNAP_SHOTTMsg tMsgDelete = new TOC_MTH_SNAP_SHOTTMsg();
                ...
                while (rs.next()) {
                    ...
                    TOC_MTH_SNAP_SHOTTMsg tMsg = new TOC_MTH_SNAP_SHOTTMsg();

                    common.setFieldValue(tMsg, "glblCmpyCd", glblCmpyCd);
                    common.setFieldValue(tMsg, "cratYrMth", procYrMth);
