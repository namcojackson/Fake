 ...
 *</pre>
 */
public class NMAL2550Scrn00_Affiliate_Setting extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.coaAfflCd_H1)) {
            ...
            scrnMsg.coaAfflCd_H1.setErrorInfo(1, NMAL2550Constant.ZZM9000E, new String[] {scrnMsg.coaAfflCd_H1.getNameForMessage() });
