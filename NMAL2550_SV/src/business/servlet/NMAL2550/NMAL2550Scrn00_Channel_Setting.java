 ...
 *</pre>
 */
public class NMAL2550Scrn00_Channel_Setting extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.coaChCd_H1)) {
            ...
            scrnMsg.coaChCd_H1.setErrorInfo(1, NMAL2550Constant.ZZM9000E, new String[] {scrnMsg.coaChCd_H1.getNameForMessage() });
