 ...
 *</pre>
 */
public class NSXC003001CallTaxCalcAPIForBase {
     ...
     */
    public static NWZC036101PMsg callTaxCalcApi(CallTaxCalcAPIForBaseBean apiBean, final ONBATCH_TYPE onBatchType) {
        // START 2018/09/10 K.Kojima [QC#28107,ADD]
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForBase-callTaxCalcApi start");
        ...
        // START 2018/09/10 K.Kojima [QC#28107,ADD]
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForBase-callTaxCalcApi-callNWZC0361 start");
        // END 2018/09/10 K.Kojima [QC#28107,ADD]
        taxApi.execute(taxApiPmsg, onBatchType);
        // START 2018/09/10 K.Kojima [QC#28107,ADD]
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForBase-callTaxCalcApi-callNWZC0361 end");
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForBase-callTaxCalcApi end");
        // END 2018/09/10 K.Kojima [QC#28107,ADD]
        return taxApiPmsg;
    }

    private static NWZC036101PMsg setTaxCalcApiParams(CallTaxCalcAPIForBaseBean apiBean) {
...
//        NSXC003001CallTaxCalcAPICommon.setBillToInfoParams(taxApiPMsg, apiBean.getDsAcctNum());
//        NSXC003001CallTaxCalcAPICommon.setShipToInfoParams(taxApiPMsg, apiBean.getDsContrDtlTpCd(), apiBean.getSvcMachMstrPk(), apiBean.getDsAcctNum());
