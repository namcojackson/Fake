 ...
 * 01/22/2016   Hitachi         T.Aoyagi        Update          N/A
 ...
 *</pre>
 */
public class NSXC003001CallTaxCalcAPIForAddl {

    /** Mode : Distribute Tax */
    private static final String PROC_MODE_DISTRIBUTE_TAX = "D";

    /**
     * Call Tax Calc API For Additional
     * @param apiBean CallTaxCalcAPIForBaseBean
     * @param onBatchType ONBATCH_TYPE
     * @return NWZC036101PMsg
     */
    public static NWZC036101PMsg callTaxCalcApi(CallTaxCalcAPIForAddlBean apiBean, final ONBATCH_TYPE onBatchType) {
        // START 2018/09/10 K.Kojima [QC#28107,ADD]
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForAddl-callTaxCalcApi start");
        ...
        // START 2018/09/10 K.Kojima [QC#28107,ADD]
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForAddl-callTaxCalcApi-callNWZC0361 start");
        // END 2018/09/10 K.Kojima [QC#28107,ADD]
        taxApi.execute(taxApiPmsg, onBatchType);
        // START 2018/09/10 K.Kojima [QC#28107,ADD]
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForAddl-callTaxCalcApi-callNWZC0361 end");
        s21InfoLogOutputPrintln(apiBean.getLogOutputFlg(), "NSXC003001CallTaxCalcAPIForAddl-callTaxCalcApi end");
        // END 2018/09/10 K.Kojima [QC#28107,ADD]
        return taxApiPmsg;
    }

    private static NWZC036101PMsg setTaxCalcApiParams(CallTaxCalcAPIForAddlBean apiBean) {
...
//        NSXC003001CallTaxCalcAPICommon.setShipToInfoParams(taxApiPMsg, apiBean.getDsContrDtlTpCd(), apiBean.getSvcMachMstrPk(), apiBean.getDsAcctNum(), apiBean.getBaseBillToCustCd());
        ...
        // if (!hasValue(apiBean.getmdseCdForSvcAllocTp())) {
        //    NSXC003001CallTaxCalcAPICommon.setDsMdseInfoParams(taxApiPMsg.taxCalculateInputLine.no(0), apiBean.getGlblCmpyCd(), apiBean.getSvcPgmMdseCd());
        // } else {
        ...
        if (!hasValue(apiBean.getmdseCdForSvcAllocTp())) {
            NSXC003001CallTaxCalcAPICommon.setDsMdseInfoParams(taxApiPMsg.taxCalculateInputLine.no(0), apiBean.getGlblCmpyCd(), apiBean.getSvcPgmMdseCd());
        } else if (!hasValue(apiBean.getMdseCdForSvcAllocTpAddlChrg())) {
            NSXC003001CallTaxCalcAPICommon.setDsMdseInfoParams(taxApiPMsg.taxCalculateInputLine.no(0), apiBean.getGlblCmpyCd(), apiBean.getSvcPgmMdseCd(), apiBean.getmdseCdForSvcAllocTp());
        } else {
            NSXC003001CallTaxCalcAPICommon.setDsMdseInfoParams(taxApiPMsg.taxCalculateInputLine.no(0), apiBean.getGlblCmpyCd(), apiBean.getSvcPgmMdseCd(), apiBean.getmdseCdForSvcAllocTp(), apiBean.getMdseCdForSvcAllocTpAddlChrg());
        }
