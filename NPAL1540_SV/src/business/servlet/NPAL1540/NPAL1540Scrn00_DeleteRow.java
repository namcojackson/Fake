 ...
 *</pre>
 */
public class NPAL1540Scrn00_DeleteRow extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if ((scrnMsg.A.getValidCount() == 0 || (scrnMsg.A.getValidCount() > 0 && !scrnMsg.A.no(0).xxChkBox_A1.isError()))
                && !"E".equals(bizMsg.getMessageKind())) {
