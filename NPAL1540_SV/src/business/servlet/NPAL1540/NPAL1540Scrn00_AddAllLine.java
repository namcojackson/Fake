 ...
 *</pre>
 */
public class NPAL1540Scrn00_AddAllLine extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!scrnMsg.poOrdNum.isError() && !"E".equals(bizMsg.getMessageKind())) {
            NPAL1540CommonLogic.setScrnItemAttr(this, scrnMsg);
            NPAL1540CommonLogic.setTableScreen(scrnMsg);
            scrnMsg.setFocusItem(scrnMsg.A.no(0).asnQty_A1);
        }
    }
}
