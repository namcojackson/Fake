 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB079001;
...
import business.db.NSBI2190_01TMsg;
...
/**
 * <pre>
 * Web OMAL FQ Warehouse Items Batch
 * 
 ...
 * </pre>
 */
public class NSBB079001 extends S21BatchMain {
    ...
    /** RTL_SWH_CD */
    private static final String RTL_SWH_CD_G = "G";
    ...
    public static void main(String[] args) {
        new NSBB079001().executeBatch(NSBB079001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2190_01TMsg> inTMsgList = new ArrayList<NSBI2190_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2190_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2190_01TMsg> inMsgLst) {
        NSBI2190_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2190_01TMsg[inMsgLst.size()];
    ...
    private Map<String, Object> setSearchCondition() {
        ...
        inParam.put("locRoleTpCd", LOC_ROLE_TP.TECHNICIAN);
        inParam.put("mrpEnblFlg", ZYPConstant.FLG_ON_Y);
        inParam.put("mrpInfoRgtnStsCd", MRP_INFO_RGTN_STS.AVAILABLE);
        inParam.put("rtlSwhCd", RTL_SWH_CD_G);
        return inParam;
    }

    private NSBI2190_01TMsg setCreateValue(ResultSet rs) {

        NSBI2190_01TMsg inParam = new NSBI2190_01TMsg();
