...
/*
 *NLBL0090_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLBL0090_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** BOL_NUM_A1*/
	public final EZDSStringItem              bolNum_A1;
    ...
    /** POD_STS_DT_A1*/
	public final EZDSDateItem              podStsDt_A1;

    /** POD_STS_CD_A2*/
	public final EZDSStringItem              podStsCd_A2;

    /** POD_STS_NM_A1*/
	public final EZDSStringItem              podStsNm_A1;

    /** POD_STS_RSN_CD_A2*/
	public final EZDSStringItem              podStsRsnCd_A2;

    /** POD_STS_RSN_NM_A1*/
	public final EZDSStringItem              podStsRsnNm_A1;
	...
	public final EZDSStringItem              podStsTpForScrCd_A1;


	/**
	 * NLBL0090_ASMsg is constructor.
	 * The initialization when the instance of NLBL0090_ASMsg is generated.
	 */
	public NLBL0090_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLBL0090_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		bolNum_A1 = (EZDSStringItem)newItem("bolNum_A1");
		...
		podStsDt_A1 = (EZDSDateItem)newItem("podStsDt_A1");
		podStsCd_A2 = (EZDSStringItem)newItem("podStsCd_A2");
		podStsNm_A1 = (EZDSStringItem)newItem("podStsNm_A1");
		podStsRsnCd_A2 = (EZDSStringItem)newItem("podStsRsnCd_A2");
		podStsRsnNm_A1 = (EZDSStringItem)newItem("podStsRsnNm_A1");
		carrCd_A1 = (EZDSStringItem)newItem("carrCd_A1");
		carrTrkUrl_A1 = (EZDSStringItem)newItem("carrTrkUrl_A1");
		podStsTpForScrCd_A1 = (EZDSStringItem)newItem("podStsTpForScrCd_A1");
	}

	/**
	 * get the type of array which is stored
	 * @return NLBL0090_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLBL0090_ASMsgArray();
	}
