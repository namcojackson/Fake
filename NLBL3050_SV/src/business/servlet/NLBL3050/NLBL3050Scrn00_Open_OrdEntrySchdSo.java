 ...
 *</pre>
 */
public class NLBL3050Scrn00_Open_OrdEntrySchdSo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, scrnMsg.C.no(index).trxHdrNum_C1);
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxTblNm, NLBL3050Bean.C);
