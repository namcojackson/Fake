 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB075001;
...
import business.db.NSBI2150_01TMsg;
...
/**
 * <pre>
 * Web OMAL FG Modification Job Data Batch
 * 
 * Date         Company         Name            Create/Update   Defect No
 * 
 * ----------------------------------------------------------------------
 * 2016/06/01   Hitachi         T.Mizuki        Create          N/A
 * </pre>
 */
public class NSBB075001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB075001().executeBatch(NSBB075001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2150_01TMsg> inTMsgList = new ArrayList<NSBI2150_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2150_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2150_01TMsg> inMsgLst) {
        NSBI2150_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2150_01TMsg[inMsgLst.size()];
    ...
    private NSBI2150_01TMsg setCreateValue(ResultSet rs) {

        NSBI2150_01TMsg inParam = new NSBI2150_01TMsg();
