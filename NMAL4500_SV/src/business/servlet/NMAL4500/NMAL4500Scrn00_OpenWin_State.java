...
public class NMAL4500Scrn00_OpenWin_State extends S21CommonHandler implements NMAL4500Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.xxScrEventNm_01.setValue(POPUP_ACTION_STATE);

        // Init param
        NMAL4500CommonLogic.setInitParam_State(scrnMsg);
