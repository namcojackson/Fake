...
/*
 *ZZVL0020_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class ZZVL0020_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** MENU_PROC_NM_A1*/
	public final EZDCStringItem              menuProcNm_A1;

    /** UP_TAB_NM_A1*/
	public final EZDCStringItem              upTabNm_A1;

    /** BIZ_APP_NM_A1*/
	public final EZDCStringItem              bizAppNm_A1;

    /** UP_TAB_CD_A1*/
	public final EZDCStringItem              upTabCd_A1;


	/**
	 * ZZVL0020_ACMsg is constructor.
	 * The initialization when the instance of ZZVL0020_ACMsg is generated.
	 */
	public ZZVL0020_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public ZZVL0020_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		xxChkBox_A1 = (EZDCStringItem)newItem("xxChkBox_A1");
		menuProcNm_A1 = (EZDCStringItem)newItem("menuProcNm_A1");
		upTabNm_A1 = (EZDCStringItem)newItem("upTabNm_A1");
		bizAppNm_A1 = (EZDCStringItem)newItem("bizAppNm_A1");
		upTabCd_A1 = (EZDCStringItem)newItem("upTabCd_A1");
	}

	/**
	 * get the type of array which is stored
	 * @return ZZVL0020_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new ZZVL0020_ACMsgArray();
	}
