package com.canon.cusa.s21.api.NWZ.NWZC187001;
...
public class NWZC187001 extends S21ApiCommonBase {
    ...
    private void doProcess(NWXC005001ValidationBean param, S21ApiMessageMap msgMap) {
        ...
        if (!isHddErase(glblCmpyCd, cpoOrdNum, cpoDtlLineNum, cpoDtlLineSubNum)) {
            return;
        }

        if (existHddEraseHold(glblCmpyCd, cpoOrdNum, cpoDtlLineNum, cpoDtlLineSubNum)) {
            return;
        }
    ...
    private static boolean isHddErase(String glblCmpyCd, String cpoOrdNum, String cpoDtlLineNum, String cpoDtlLineSubNum) {
        ...
        if (dsCpoRtrnDtlTMsg != null) {
            if (HDD_RMV.HDD_ERASE.equals(dsCpoRtrnDtlTMsg.hddRmvCd.getValue())) {
                return true;
            }
        }
        return false;
    ...
    private static boolean existHddEraseHold(String glblCmpyCd, String cpoOrdNum, String cpoDtlLineNum, String cpoDtlLineSubNum) {
        ...
        hldTMsg.setConditionValue("hldRsnCd01", HLD_RSN.HDD_ERASE);
    ...
    private void setHldRsn(NWXC005001PMsg inMsg, String cpoOrdNum, String cpoDtlLineNum, String cpoDtlLineSubNum) {
        ...
        ZYPEZDItemValueSetter.setValue(inMsg.hldRsnCd, HLD_RSN.HDD_ERASE);
    }
