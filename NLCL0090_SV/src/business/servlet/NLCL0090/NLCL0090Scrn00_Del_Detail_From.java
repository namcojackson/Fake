 ...
 *</pre>
 */
public class NLCL0090Scrn00_Del_Detail_From extends S21CommonHandler implements NLCL0090Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (selectedRowsA.isEmpty()) {
            ...
            for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
                ...
                scrnMsg.A.no(i).xxChkBox_DF.setErrorInfo(1, NLBM0002E);
            }
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLCL0090BMsg scrnMsg = (NLCL0090BMsg) bMsg;
        NLCL0090CommonLogic.delTableFrom(scrnMsg);
