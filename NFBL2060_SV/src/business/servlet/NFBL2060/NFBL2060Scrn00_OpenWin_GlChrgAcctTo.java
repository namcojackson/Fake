 ...
 *</pre>
 */
public class NFBL2060Scrn00_OpenWin_GlChrgAcctTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NFBL2060CommonLogic.getParamForChargeAccount(scrnMsg, scrnMsg.xxCmntTxt_TO);

        scrnMsg.addCheckItem(scrnMsg.xxCmntTxt_TO);
        scrnMsg.putErrorScreen();

        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, OPENWIN_GL_CHRG_ACCT_TO);
