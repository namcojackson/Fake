 ...
 * 2016/05/23   Hitachi         T.Aoyagi        Update          QC#8547
 *</pre>
 */
public class NSAL9900Scrn00_PageNext extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        // START 2016/05/23 T.Aoyagi [QC#8547, ADD]
        NSAL9900BMsg scrnMsg = (NSAL9900BMsg) bMsg;
        NSAL9900CommonLogic.addCheckItem(scrnMsg);
        scrnMsg.putErrorScreen();
        // END 2016/05/23 T.Aoyagi [QC#8547, ADD]
    }
