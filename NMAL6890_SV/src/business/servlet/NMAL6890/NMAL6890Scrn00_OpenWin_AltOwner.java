 ...
 * Function Name : Open Window for Person Search(Alternate Owner)
 * 
 ...
 *</pre>
 */
public class NMAL6890Scrn00_OpenWin_AltOwner extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.fullPsnNm_G1, scrnMsg.fullPsnNm_O2);

        // Making of subscreen delivery information
        Object[] params = NMAL6890CommonLogic.setParamForAltOwnerPopup(scrnMsg);

        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_P1, EVENT_NM_NMAL6890SCRN00_OPEN_WIN_ALT_OWNR);
