 ...
 *</pre>
 */
public class NSAL0440Scrn00_Clear_MachCondVal extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.A.no(selectNumber).svcTermCondDataValCd_MS.clear();
        scrnMsg.A.no(selectNumber).svcTermAttrbMapValCd_M.clear();
