 ...
 *</pre>
 */
public class NFCL2610Scrn00_OpenWin_AttachFile extends S21CommonHandler {
...
//        String sqNum = scrnMsg.arRfRqstPk.getValue().toString();
...
//        params[5] = PARAMS_SIZE_KEY;
        ...
        sqNum.append(scrnMsg.arRfRqstPk.getValue());
        ...
        if (funcIdList == null || funcIdList.isEmpty()) {
            throw new S21AbendException("You can't operate AR Refund By Check Entry Screen(NFCL2610). UserID is -> " + getUserProfileService().getContextUserInfo().getUserId());
        }
