 ...
 *</pre>
 */
public class NLAL1100Scrn00_Search_NtfyGrp extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.A.no(index).rtrnTrkNtfyGrpCd_A1);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(index).rtrnTrkNtfyGrpCd_A1);
    }
}
