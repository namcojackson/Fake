 ...
 *</pre>
 */
public class NSAL0760Scrn00_ChargeDisp extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        setValue(scrnMsg.xxRowNum, BigDecimal.valueOf(targetRow));
        if (FLG_ON_Y.equals(scrnMsg.A.no(targetRow).xxBtnFlg_A1.getValue())) {
            setValue(scrnMsg.A.no(targetRow).xxBtnFlg_A1, FLG_OFF_N);
        } else {
            setValue(scrnMsg.A.no(targetRow).xxBtnFlg_A1, FLG_ON_Y);
        }
