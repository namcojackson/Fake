 ...
 *</pre>
 */
public class NSAL0760Scrn00_EffDisp extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (FLG_ON_Y.equals(scrnMsg.A.no(targetRow).xxBtnFlg_A2.getValue())) {
            setValue(scrnMsg.A.no(targetRow).xxBtnFlg_A2, FLG_OFF_N);
        } else {
            setValue(scrnMsg.A.no(targetRow).xxBtnFlg_A2, FLG_ON_Y);
        }
