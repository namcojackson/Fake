 ...
 *</pre>
 */
public class NLGL0050Scrn00_CMN_Clear extends S21CommonHandler implements NLGL0050Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (bizMsg == null) {
            scrnMsg.setFocusItem(scrnMsg.wmsCarrCd_T2);
            return;
        }
        EZDMsg.copy(bizMsg, null, scrnMsg, null);

        if (scrnMsg.wmsCarrCd_T2.isInputProtected()) {
            NLGL0050CommonLogic.commonBtnControl_NLGL0050Scrn00_CMN_ClearforEdit(this, scrnMsg);
        } else {
            NLGL0050CommonLogic.commonBtnControl_NLGL0050Scrn00_CMN_ClearforNew(this, scrnMsg);
        }
        scrnMsg.clearGUIAttribute(SCRN_ID, ZYPGUITableFocusRule.PREFIX_KEY + "A");
    }
}
