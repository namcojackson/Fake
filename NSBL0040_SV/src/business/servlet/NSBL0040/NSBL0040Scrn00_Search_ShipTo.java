 ...
 *</pre>
 */
public class NSBL0040Scrn00_Search_ShipTo extends S21CommonHandler implements NSBL0040Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.shipToCustCd)) {
            scrnMsg.shipToCustCd.setErrorInfo(1, ZZZM9024E, new String[] {"Ship to" });
        }
