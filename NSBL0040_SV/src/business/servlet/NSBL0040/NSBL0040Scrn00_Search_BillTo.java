 ...
 *</pre>
 */
public class NSBL0040Scrn00_Search_BillTo extends S21CommonHandler implements NSBL0040Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.billToCustCd)) {
            scrnMsg.billToCustCd.setErrorInfo(1, ZZZM9024E, new String[] {"Bill to" });
        }
