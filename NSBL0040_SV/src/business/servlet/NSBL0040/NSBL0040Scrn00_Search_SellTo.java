 ...
 *</pre>
 */
public class NSBL0040Scrn00_Search_SellTo extends S21CommonHandler implements NSBL0040Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.sellToCustCd)) {
            scrnMsg.sellToCustCd.setErrorInfo(1, ZZZM9024E, new String[] {"Sell to" });
        }
