...
//      ersb.setTableLongName(S21CodeTableAccessor.getLongName(eib.getTableName()));
      ersb.setTableLongName(S21GMDBAccessQuery.getInstance().getGmTableLongName(eib.getTableName()));
...
//      ersb.setColInfos(S21CodeTableAccessor.getColumnInfoAll(eib.getTableName()));
      ersb.setColInfos(S21GenericTableAccessor.getColumnInfoAll(eib.getTableName()));
