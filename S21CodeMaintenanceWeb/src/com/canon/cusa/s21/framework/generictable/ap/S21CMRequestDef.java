...
public class S21CMRequestDef {
    ...
    /**  HTTP Request:1ページあたりの表示件数 */
    public static final String REQ_DISPLAY_NUMBER = "displayNumber";
    
    /** テーブル検索時の検索方式 */
    public static final String REQ_SEARCH_TYPE = "searchType";
    
    /** テーブル検索方式名称(Table Name) */
    public static final String REQ_SEARCH_TABLE_NAME = "0";
    
    /** テーブル検索方式名称(Table Long Name) */
    public static final String REQ_SEARCH_TABLE_LONGNAME = "1";
    
    /** テーブル検索方式名称(Table Comment) */
    public static final String REQ_SEARCH_TABLE_COMMENT = "2";
