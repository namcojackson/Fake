					...
					<table width="100%">
						<tr>
							<td align=right width="95%">
								<c:out value='${screen.page}'/>/<c:out value='${screen.pageAll}'/>
					...
					<table width="100%">
						<tr>
							<td align=left width="50%">
								<input class="cBtn" type="button" value="Prev" onclick="funcS21NEPostPage('<c:out value='${s21nevo.reqID}'/>', '-1')" <c:if test="${screen.page==1}">disabled</c:if>>
								<input class="cBtn" type="button" value="Next" onclick="funcS21NEPostPage('<c:out value='${s21nevo.reqID}'/>', '1')" <c:if test="${screen.page==screen.pageAll}">disabled</c:if>>
							</td>
