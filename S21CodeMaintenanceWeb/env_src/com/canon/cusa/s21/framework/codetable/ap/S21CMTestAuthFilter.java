...
import com.canon.cusa.s21.framework.security.testenv.config.S21TestConfig;
import com.canon.cusa.s21.framework.security.testenv.config.S21TestConfigHolder;
 ...
 */
public class S21CMTestAuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2) throws IOException, ServletException {
        ...
        S21TestConfigHolder.setConfigFile("ezd-security-test.xml");
        ...
        try {
            ...
            if (sCtx == null) {
                S21TestConfig testCfg = S21TestConfigHolder.getInstance().getConfigMap().get(userId);
                //logger.debug("Test Config:" + testCfg.getSecurityConfig());
                if (testCfg == null) {
                    throw new S21AuthenticationException("Invalid configuration - no matching security config");
                }

                try {
                    sCtx = S21SecurityContextFactory.getContextFactory().getSecurityContext(testCfg.getSecurityConfig());
