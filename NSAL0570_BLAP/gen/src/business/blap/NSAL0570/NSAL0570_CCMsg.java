...
/*
 *NSAL0570_CCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0570_CCMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** CONTR_XS_COPY_PK_C*/
	public final EZDCBigDecimalItem              contrXsCopyPk_C;

    /** XS_MTR_COPY_QTY_C*/
	public final EZDCBigDecimalItem              xsMtrCopyQty_C;

    /** XS_MTR_AMT_RATE_C*/
	public final EZDCBigDecimalItem              xsMtrAmtRate_C;

    /** XS_MTR_FIRST_FLG_C*/
	public final EZDCStringItem              xsMtrFirstFlg_C;
	...
	/**
	 * NSAL0570_CCMsg is constructor.
	 * The initialization when the instance of NSAL0570_CCMsg is generated.
	 */
	public NSAL0570_CCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0570_CCMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		contrXsCopyPk_C = (EZDCBigDecimalItem)newItem("contrXsCopyPk_C");
		xsMtrCopyQty_C = (EZDCBigDecimalItem)newItem("xsMtrCopyQty_C");
		xsMtrAmtRate_C = (EZDCBigDecimalItem)newItem("xsMtrAmtRate_C");
		xsMtrFirstFlg_C = (EZDCStringItem)newItem("xsMtrFirstFlg_C");
	 ...
	 * @return NSAL0570_CCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0570_CCMsgArray();
	}
	...
	{"contrXsCopyPk_C", "contrXsCopyPk_C", "C", null, TYPE_SEISU_SYOSU, "28", "0"},
	{"xsMtrCopyQty_C", "xsMtrCopyQty_C", "C", null, TYPE_SEISU_SYOSU, "10", "0"},
	{"xsMtrAmtRate_C", "xsMtrAmtRate_C", "C", null, TYPE_SEISU_SYOSU, "19", "6"},
	{"xsMtrFirstFlg_C", "xsMtrFirstFlg_C", "C", null, TYPE_HANKAKUEISU, "1", null},
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"CONTR_XS_COPY_PK",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//contrXsCopyPk_C
        {"XS_MTR_COPY_QTY",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xsMtrCopyQty_C
        {"XS_MTR_AMT_RATE",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xsMtrAmtRate_C
        {"XS_MTR_FIRST_FLG",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xsMtrFirstFlg_C
