...
/**
 *<pre>
 * NWAL2170Scrn00_OnBlur_DeriveFromCustLocCd
 *
 ...
 *</pre>
 */
public class NWAL2170Scrn00_OnBlur_DeriveFromCustLocCd extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.A.no(selectIndex).soldToCustLocCd)) {
            scrnMsg.addCheckItem(scrnMsg.A.no(selectIndex).soldToCustLocCd);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(selectIndex).soldToCustLocCd)) {
            ...
            scrnMsg.setFocusItem(scrnMsg.A.no(selectIndex).xxBillToAcctNmSrchTxt);
            return;
        }
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(selectIndex).applyEquipBillToFlg);
