...
import static business.servlet.NWCL0140.constant.NWCL0140Constant.EVENT_NM_NWCL0140_ADD_LINE_ELIG_ORD_CATG;
 ...
 * Function Name : NWCL0140Scrn00_AddLineEligOrdCatg
 * </pre>
 * 
 * <pre>
 ...
 */
public class NWCL0140Scrn00_AddLineEligOrdCatg extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        bizMsg.xxScrEventNm.setValue(EVENT_NM_NWCL0140_ADD_LINE_ELIG_ORD_CATG);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.B.getValidCount() > 0) {
            scrnMsg.setFocusItem(scrnMsg.B.no(scrnMsg.B.getValidCount() - 1).dsOrdCatgDescTxt_EX);
        }
    }
}
