...
import static business.servlet.NWCL0140.constant.NWCL0140Constant.EVENT_NM_NWCL0140_PAGE_PREV_EL;
import static business.servlet.NWCL0140.constant.NWCL0140Constant.EVENT_NM_NWCL0140_PAGE_PREV_EX;
 ...
 * Function Name : NWCL0140Scrn00_PagePrev
 * </pre>
 * 
 * <pre>
 ...
 */
public class NWCL0140Scrn00_PagePrev extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TABLE_A.equals(tblNm)) {
            scrnMsg.xxScrEventNm.setValue(EVENT_NM_NWCL0140_PAGE_PREV_EL);
        } else if (TABLE_B.equals(tblNm)) {
            scrnMsg.xxScrEventNm.setValue(EVENT_NM_NWCL0140_PAGE_PREV_EX);
        }
