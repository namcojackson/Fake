...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NZZL0090Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Commissions Launcher Screen">
			<center>
									...
									<tr>
										<td height="28px" width="1070px" valign="bottom">
											<table class="pTab_UPPER_ON" border="0" cellpadding="0" cellspacing="0" >
												<tr title="Commissions">
													<td align="center" class="same">Commissions</td>
												</tr>
                                ...
                                <table border="0" cellPadding="0" cellSpacing="0" height="95%" width="100%">
                                    <tr align="center">
                                        <td valign="center" class="stab">
                                        	<ezf:anchor name="xxPopPrm" ezfName="xxPopPrm" onClick="window.open( this.href, '_blank', 'width=1050,height=760,scrollbars=yes,status=yes,resizable=yes' );return false;" >
                                        		<font size="7">Commissions</font>
                                        	</ezf:anchor>
                                        </td>
                                    </tr>
                                </table>
