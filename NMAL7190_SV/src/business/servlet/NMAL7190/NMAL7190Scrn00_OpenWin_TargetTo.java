...
import static business.servlet.NMAL7190.constant.NMAL7190Constant.POPUP_BTN_FLG_TO;
...
/**
 *<pre>
 * NMAL7190Scrn00_OpenWin_TargetTo
 *
 ...
 *</pre>
 */
public class NMAL7190Scrn00_OpenWin_TargetTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // 0:From 1:To
        scrnMsg.xxBtnFlg.setValue(POPUP_BTN_FLG_TO);

        Object[] params = NMAL7190CommonLogic.createPopPrm(scrnMsg, scrnMsg.A.no(index).prcGrpThruTxt_A1, scrnMsg.A.no(index).prcGrpFromTxt_CD, index, getGlobalCompanyCode());
