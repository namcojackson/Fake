...
/*
 *NFCL3080_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NFCL3080_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** INV_BOL_LINE_NUM_A*/
	public final EZDSStringItem              invBolLineNum_A;

    /** INV_LINE_NUM_A*/
	public final EZDSStringItem              invLineNum_A;

    /** INV_LINE_SUB_NUM_A*/
	public final EZDSStringItem              invLineSubNum_A;

    /** INV_LINE_SUB_TRX_NUM_A*/
	public final EZDSStringItem              invLineSubTrxNum_A;
	...
	public final EZDSStringItem              firstBllgAttrbValTxt_A;
    ...
    /** PREV_TOT_COPY_QTY_A*/
	public final EZDSBigDecimalItem              prevTotCopyQty_A;

    /** TOT_COPY_QTY_A*/
	public final EZDSBigDecimalItem              totCopyQty_A;

    /** TEST_COPY_QTY_A*/
	public final EZDSBigDecimalItem              testCopyQty_A;

    /** TEST_COPY_QTY_B*/
	public final EZDSBigDecimalItem              testCopyQty_B;

    /** CONTR_MTR_MULT_RATE_A*/
	public final EZDSBigDecimalItem              contrMtrMultRate_A;

    /** COPY_INCL_QTY_A*/
	public final EZDSBigDecimalItem              copyInclQty_A;

    /** BLLG_COPY_QTY_A*/
	public final EZDSBigDecimalItem              bllgCopyQty_A;
    ...
    /** MTR_CHRG_FUNC_AMT_A*/
	public final EZDSBigDecimalItem              mtrChrgFuncAmt_A;
    ...
    /** DS_INV_MTR_DTL_PK_A*/
	public final EZDSBigDecimalItem              dsInvMtrDtlPk_A;
	...
	public final EZDSBigDecimalItem              svcContrMtrBllgPk_A;
	...
	/**
	 * NFCL3080_ASMsg is constructor.
	 * The initialization when the instance of NFCL3080_ASMsg is generated.
	 */
	public NFCL3080_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NFCL3080_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		invNum_A = (EZDSStringItem)newItem("invNum_A");
		invBolLineNum_A = (EZDSStringItem)newItem("invBolLineNum_A");
		invLineNum_A = (EZDSStringItem)newItem("invLineNum_A");
		invLineSubNum_A = (EZDSStringItem)newItem("invLineSubNum_A");
		invLineSubTrxNum_A = (EZDSStringItem)newItem("invLineSubTrxNum_A");
		bllgPerFromDt_A = (EZDSDateItem)newItem("bllgPerFromDt_A");
		bllgPerThruDt_A = (EZDSDateItem)newItem("bllgPerThruDt_A");
		firstBllgAttrbValTxt_A = (EZDSStringItem)newItem("firstBllgAttrbValTxt_A");
		serNum_A = (EZDSStringItem)newItem("serNum_A");
		mtrLbDescTxt_A = (EZDSStringItem)newItem("mtrLbDescTxt_A");
		prevTotCopyQty_A = (EZDSBigDecimalItem)newItem("prevTotCopyQty_A");
		totCopyQty_A = (EZDSBigDecimalItem)newItem("totCopyQty_A");
		testCopyQty_A = (EZDSBigDecimalItem)newItem("testCopyQty_A");
		testCopyQty_B = (EZDSBigDecimalItem)newItem("testCopyQty_B");
		contrMtrMultRate_A = (EZDSBigDecimalItem)newItem("contrMtrMultRate_A");
		copyInclQty_A = (EZDSBigDecimalItem)newItem("copyInclQty_A");
		bllgCopyQty_A = (EZDSBigDecimalItem)newItem("bllgCopyQty_A");
		xsMtrAmtRate_A = (EZDSBigDecimalItem)newItem("xsMtrAmtRate_A");
		mtrChrgDealAmt_A = (EZDSBigDecimalItem)newItem("mtrChrgDealAmt_A");
		mtrChrgFuncAmt_A = (EZDSBigDecimalItem)newItem("mtrChrgFuncAmt_A");
		shipToCustCd_A = (EZDSStringItem)newItem("shipToCustCd_A");
		ccyCd_A = (EZDSStringItem)newItem("ccyCd_A");
		dsInvMtrDtlPk_A = (EZDSBigDecimalItem)newItem("dsInvMtrDtlPk_A");
		ezUpTime_A = (EZDSStringItem)newItem("ezUpTime_A");
		ezUpTimeZone_A = (EZDSStringItem)newItem("ezUpTimeZone_A");
		svcContrMtrBllgPk_A = (EZDSBigDecimalItem)newItem("svcContrMtrBllgPk_A");
		mtrLbCd_A = (EZDSStringItem)newItem("mtrLbCd_A");
	}

	/**
	 * get the type of array which is stored
	 * @return NFCL3080_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NFCL3080_ASMsgArray();
	}
