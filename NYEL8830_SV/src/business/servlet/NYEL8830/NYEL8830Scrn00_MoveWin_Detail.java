 ...
 *</pre>
 */
public class NYEL8830Scrn00_MoveWin_Detail extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(0).wfWrkItemPk_P, scrnMsg.A.no(selectedIndex).wfWrkItemPk_A);
