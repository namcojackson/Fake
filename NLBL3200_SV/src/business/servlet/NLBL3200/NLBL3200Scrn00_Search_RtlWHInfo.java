...
import static business.servlet.NLBL3200.constant.NLBL3200Constant.DISPLAY_RTL_WH_CD;
 ...
 *</pre>
 */
public class NLBL3200Scrn00_Search_RtlWHInfo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.xxRtrnInvtyLocSrchTxt_RW)) {

            scrnMsg.xxRtrnInvtyLocSrchTxt_RW.setErrorInfo(1, ZZZM9007E, new String[] {DISPLAY_RTL_WH_CD });
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.xxRtrnInvtyLocSrchTxt_RW.isError()) {
