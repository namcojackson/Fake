 ...
 *</pre>
 */
public class NLBL3200Scrn00_Open_Carrier_Popup extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLBL3200CommonLogic.setInitParamForCarrierPopup(scrnMsg);

        // Making of subscreen delivery information
        Object[] params = NLBL3200CommonLogic.setParamForCarrierPopup(scrnMsg);
