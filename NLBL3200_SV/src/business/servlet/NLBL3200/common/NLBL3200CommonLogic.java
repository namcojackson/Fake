 ...
 */
package business.servlet.NLBL3200.common;
...
import business.servlet.NLBL3200.NLBL3200_PBMsgArray;
import business.servlet.NLBL3200.NLBL3200_SBMsgArray;
...
public class NLBL3200CommonLogic {
     ...
     * @param scrnMsg NLBL3200BMsg
     * @param handler EZDCommonHandler
     * @param functionList List<String>
     */
    public static void ctrlScrnItemProtection(NLBL3200BMsg scrnMsg, EZDCommonHandler handler, List<String> functionList) {

        // clear html attribute
        scrnMsg.clearAllGUIAttribute(NLBL3200Constant.SCRN_ID);
     ...
     * @param functionList List<String>
     */
    public static void ctrlScrnItem(NLBL3200BMsg scrnMsg, EZDCommonHandler handler, List<String> functionList) {
        ...
        // Button activation
        handler.setButtonEnabled(NLBL3200Constant.BTN_SAVE_SEARCH, true);
        handler.setButtonEnabled(NLBL3200Constant.BTN_DELETE_SEARCH, true);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_RTL_WH, true);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_RTL_SWH, true);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_SHIP_TO_CUST, true);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_CARRIER, true);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_MDSE_INFO, true);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH, true);

        // Common button protection
        // 0 : inactive
        // 1 : active
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_SAVE[0], NLBL3200Constant.BTN_CMN_SAVE[1], NLBL3200Constant.BTN_CMN_SAVE[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_SUBMIT[0], NLBL3200Constant.BTN_CMN_SUBMIT[1], NLBL3200Constant.BTN_CMN_SUBMIT[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_APPLY[0], NLBL3200Constant.BTN_CMN_APPLY[1], NLBL3200Constant.BTN_CMN_APPLY[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_APPROVE[0], NLBL3200Constant.BTN_CMN_APPROVE[1], NLBL3200Constant.BTN_CMN_APPROVE[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_REJECT[0], NLBL3200Constant.BTN_CMN_REJECT[1], NLBL3200Constant.BTN_CMN_REJECT[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_DOWNLOAD[0], NLBL3200Constant.BTN_CMN_DOWNLOAD[1], NLBL3200Constant.BTN_CMN_DOWNLOAD[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_DETELE[0], NLBL3200Constant.BTN_CMN_DETELE[1], NLBL3200Constant.BTN_CMN_DETELE[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_CLEAR[0], NLBL3200Constant.BTN_CMN_CLEAR[1], NLBL3200Constant.BTN_CMN_CLEAR[2], 1, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_RESET[0], NLBL3200Constant.BTN_CMN_RESET[1], NLBL3200Constant.BTN_CMN_RESET[2], 1, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_RETURN[0], NLBL3200Constant.BTN_CMN_RETURN[1], NLBL3200Constant.BTN_CMN_RETURN[2], 1, null);
        ...
        if (NLBL3200Constant.TAB_SO_LIST.equals(scrnMsg.xxDplyTab.getValue())) {
            ...
            handler.setButtonEnabled(NLBL3200Constant.BTN_SELECT_ALL, false);
            handler.setButtonEnabled(NLBL3200Constant.BTN_UN_SELECT_ALL, false);
            handler.setButtonEnabled(NLBL3200Constant.BTN_PRINT, false);
            handler.setButtonEnabled(NLBL3200Constant.BTN_CANCLE, false);
            handler.setButtonProperties(NLBL3200Constant.BTN_SHIP[0], NLBL3200Constant.BTN_SHIP[1], NLBL3200Constant.BTN_SHIP[2], 0, null);
            handler.setButtonEnabled(NLBL3200Constant.BTN_SO_CLOSE, false);
            handler.setButtonEnabled(NLBL3200Constant.BTN_APPLY, false);
            // QC#18367 Add
            handler.setButtonEnabled(NLBL3200Constant.BTN_CUSTOM_DOC_PRINT, false);
            
            // tomimatsu ADD
            handler.setButtonEnabled(NLBL3200Constant.BTN_PICKING_DOC_PRINT, false);
            // tomimatsu ADD
            ...
            if (scrnMsg.A.getValidCount() > 0) {
                ...
                handler.setButtonEnabled(NLBL3200Constant.BTN_SELECT_ALL, true);
                handler.setButtonEnabled(NLBL3200Constant.BTN_UN_SELECT_ALL, true);
                handler.setButtonEnabled(NLBL3200Constant.BTN_PRINT, true);
                // QC#18367 Add.
                handler.setButtonEnabled(NLBL3200Constant.BTN_CUSTOM_DOC_PRINT, true);
                
                // tomimatsu ADD
                handler.setButtonEnabled(NLBL3200Constant.BTN_PICKING_DOC_PRINT, true);
                // tomimatsu ADD

                if (!inquiry) {

                    handler.setButtonEnabled(NLBL3200Constant.BTN_CANCLE, true);
                    handler.setButtonEnabled(NLBL3200Constant.BTN_SO_CLOSE, true);
                    handler.setButtonEnabled(NLBL3200Constant.BTN_APPLY, true);

                    handler.setButtonProperties(NLBL3200Constant.BTN_SHIP[0] //
                            , NLBL3200Constant.BTN_SHIP[1], NLBL3200Constant.BTN_SHIP[2], 1, null);
...
//                    }
            ...
            if (!inquiry) {
                ...
                handler.setButtonProperties(NLBL3200Constant.BTN_CMN_SUBMIT[0], NLBL3200Constant.BTN_CMN_SUBMIT[1], NLBL3200Constant.BTN_CMN_SUBMIT[2], 1, null);
            }
        }
    }
     ...
     * @param scrnMsg NLBL3200BMsg
     */
    public static void searchItemCheck(NLBL3200BMsg scrnMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.trxHdrNum_H1) && !ZYPCommonFunc.hasValue(scrnMsg.soNum_H1) && !ZYPCommonFunc.hasValue(scrnMsg.svcConfigMstrPk_H1)
            ...
            scrnMsg.trxHdrNum_H1.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.soNum_H1.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.dsSoLineStsCd_PS.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.sceOrdTpCd_PS.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.shpgSvcLvlCd_PS.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.svcConfigMstrPk_H1.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.xxRtrnInvtyLocSrchTxt_RW.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.xxRtrnInvtyLocSrchTxt_SW.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.shipToCustCd_H1.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.carrCd_H1.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.proNum_H1.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.mdseCd_H1.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.xxTrxDt_FR.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.xxTrxDt_TO.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.rddDt_FR.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.rddDt_TO.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.xxTrxDt_F3.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.xxTrxDt_T3.setErrorInfo(1, NLBL3200Constant.NLZM2276E);
            scrnMsg.setMessageInfo(NLBL3200Constant.ZZM9037E);
        }
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_FR) && ZYPCommonFunc.hasValue(scrnMsg.xxDtNm_F1)) {
            scrnMsg.xxTrxDt_FR.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Shipping Creation Date(From)"});
        }
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_TO) && ZYPCommonFunc.hasValue(scrnMsg.xxDtNm_T1)) {
            scrnMsg.xxTrxDt_TO.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Shipping Creation Date(From)"});
        }
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.rddDt_FR) && ZYPCommonFunc.hasValue(scrnMsg.xxDtNm_F2)) {
            scrnMsg.rddDt_FR.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Request Delivery Date(From)"});
        }
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.rddDt_TO) && ZYPCommonFunc.hasValue(scrnMsg.xxDtNm_T2)) {
            scrnMsg.rddDt_TO.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Request Delivery Date(To)"});
        }
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_F3) && ZYPCommonFunc.hasValue(scrnMsg.xxDtNm_F3)) {
            scrnMsg.xxTrxDt_F3.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Need By Date(From)"});
        }
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_T3) && ZYPCommonFunc.hasValue(scrnMsg.xxDtNm_T3)) {
            scrnMsg.xxTrxDt_T3.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Need By Date(To)"});
        }
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_FR) && ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_TO) && ZYPDateUtil.compare(scrnMsg.xxTrxDt_FR.getValue(), scrnMsg.xxTrxDt_TO.getValue()) > 0) {
            ...
            scrnMsg.xxTrxDt_FR.setErrorInfo(1, NLBL3200Constant.NLZM2277E, new String[] {NLBL3200Constant.DISPLAY_SHIP_ORD_DT_TO, NLBL3200Constant.DISPLAY_SHIP_ORD_DT_FROM });
            scrnMsg.xxTrxDt_TO.setErrorInfo(1, NLBL3200Constant.NLZM2277E, new String[] {NLBL3200Constant.DISPLAY_SHIP_ORD_DT_TO, NLBL3200Constant.DISPLAY_SHIP_ORD_DT_FROM });
            scrnMsg.setMessageInfo(NLBL3200Constant.ZZM9037E);
        }
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.rddDt_FR) && ZYPCommonFunc.hasValue(scrnMsg.rddDt_TO) && ZYPDateUtil.compare(scrnMsg.rddDt_FR.getValue(), scrnMsg.rddDt_TO.getValue()) > 0) {
            ...
            scrnMsg.rddDt_FR.setErrorInfo(1, NLBL3200Constant.NLZM2277E, new String[] {NLBL3200Constant.DISPLAY_RDD_DT_TO, NLBL3200Constant.DISPLAY_RDD_DT_FROM });
            scrnMsg.rddDt_TO.setErrorInfo(1, NLBL3200Constant.NLZM2277E, new String[] {NLBL3200Constant.DISPLAY_RDD_DT_TO, NLBL3200Constant.DISPLAY_RDD_DT_FROM });
            scrnMsg.setMessageInfo(NLBL3200Constant.ZZM9037E);
        }
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_F3) && ZYPCommonFunc.hasValue(scrnMsg.xxTrxDt_T3) && ZYPDateUtil.compare(scrnMsg.xxTrxDt_F3.getValue(), scrnMsg.xxTrxDt_T3.getValue()) > 0) {
            scrnMsg.xxTrxDt_F3.setErrorInfo(1, NLBL3200Constant.NLZM2277E, new String[] {NLBL3200Constant.DISPLAY_NEED_BY_DT_TO, NLBL3200Constant.DISPLAY_NEED_BY_DT_FROM });
            scrnMsg.xxTrxDt_T3.setErrorInfo(1, NLBL3200Constant.NLZM2277E, new String[] {NLBL3200Constant.DISPLAY_NEED_BY_DT_TO, NLBL3200Constant.DISPLAY_NEED_BY_DT_FROM });
            scrnMsg.setMessageInfo(NLBL3200Constant.ZZM9037E);
        }


        if (!ZYPCommonFunc.hasValue(scrnMsg.xxRtrnInvtyLocSrchTxt_RW) && ZYPCommonFunc.hasValue(scrnMsg.xxRtrnInvtyLocSrchTxt_SW)) {
            scrnMsg.xxRtrnInvtyLocSrchTxt_RW.setErrorInfo(1, NLBL3200Constant.NLBM1361E, null);
            scrnMsg.setMessageInfo(NLBL3200Constant.ZZM9037E);
        }
    }
    ...
    private static void checkTimeAndAmPm(EZDBStringItem timeHHMM, EZDBStringItem timeAMPM) {
        ...
        if (ZYPCommonFunc.hasValue(timeHHMM) && !ZYPCommonFunc.hasValue(timeAMPM)) {
            ...
            timeAMPM.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Time(AM/PM)"});
        }

        if (!ZYPCommonFunc.hasValue(timeHHMM) && ZYPCommonFunc.hasValue(timeAMPM)) {

            timeHHMM.setErrorInfo(1, NLBL3200Constant.ZZM9000E, new String[] {"Time"});
        }
        ...
        if (ZYPCommonFunc.hasValue(timeHHMM) && ZYPCommonFunc.hasValue(timeAMPM)) {
            ...
            if (!checkTime(timeHHMM.getValue(), timeAMPM.getValue())) {
                ...
                timeHHMM.setErrorInfo(1, NLBL3200Constant.NWAM0665E);
            }
        }
    }
    ...
    private static boolean checkTime(String timeHHMM, String timeAMPM) {
        ...
        if (0 <= timeHHMM.indexOf(":")) {
            ...
            if (timeHHMM.length() == NLBL3200Constant.HOUR_MINUTE_STR_LENGTH) {
                h = Integer.valueOf(timeHHMM.substring(0, 2));
                m = Integer.valueOf(timeHHMM.substring(2));
            } else if (timeHHMM.length() == NLBL3200Constant.HOUR_MINUTE_STR_LENGTH - 1) {
                timeHHMM = "0" + timeHHMM;
                h = Integer.valueOf(timeHHMM.substring(0, 2));
                m = Integer.valueOf(timeHHMM.substring(2));
            } else {
     ...
     * @param scrnMsg NLBL3200BMsg
     */
    public static void addCheckItemApply(NLBL3200BMsg scrnMsg) {
     ...
     */
    public static void ctrlScrnItemProtectionForSOList(NLBL3200BMsg scrnMsg, EZDCommonHandler handler, boolean inquiry) {
        ...
        for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
            ...
            if (i > 0) {
                ...
                // Visibility Item
                EZDGUIAttribute headChkBox = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_HEAD_CHK_BOX + i);
                EZDGUIAttribute ancher = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_SRC_ORDER_LINK + i);
                EZDGUIAttribute srcOrdNum = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_SRC_ORD_NUM + i);
                EZDGUIAttribute srcOrdLinerNum = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_SRC_ORD_LINE_NUM + i);
                EZDGUIAttribute soNum = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_SO_NUM + i);
                EZDGUIAttribute soLineNum = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_SO_LINE_NUM + i);
            ...
            if (!isProtectedOrder(scrnMsg.A.no(i), scrnMsg.glblCmpyCd.getValue())) {
                ...
                handler.setButtonEnabled(NLBL3200Constant.BTN_CARRIER, i, false);
                ...
                if (!inquiry) {
                    ...
                    if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.A.no(i).soLineOpenFlg_AH.getValue()) && !ZYPConstant.FLG_ON_Y.equals(scrnMsg.A.no(i).shipFlg_AH.getValue())) {
                        ...
                        handler.setButtonEnabled(NLBL3200Constant.BTN_CARRIER, i, true);
                    ...
                    if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.A.no(i).serNumTakeFlg_AH.getValue())) {
                        ...
                        if (scrnMsg.A.no(i).shpgQty_A1.getValue().abs().intValue() > 1) {
                            ...
                            handler.setButtonEnabled(NLBL3200Constant.BTN_SERIAL, i, true);
                            ...
                            handler.setButtonEnabled(NLBL3200Constant.BTN_SERIAL, i, false);
                        }
        ...
        if (0 < scrnMsg.A.getValidCount() && NLBL3200Constant.TAB_SO_LIST.equals(scrnMsg.xxDplyTab.getValue())) {

            // set alternate rows back-ground color
            S21TableColorController tblColor = new S21TableColorController(NLBL3200Constant.SCRN_ID, scrnMsg);
            tblColor.setAlternateRowsBG(NLBL3200Bean.A, scrnMsg.A);
        }
    }
     ...
     * @param inquiry boolean
     */
    public static void ctrlScrnItemProtectionForPickList(NLBL3200BMsg scrnMsg, EZDCommonHandler handler, boolean inquiry) {
        ...
        for (int i = 0; i < scrnMsg.B.getValidCount(); i++) {
            ...
            if (i > 0) {
                ...
                if (scrnMsg.B.no(i).soNum_HD.getValue().equals(scrnMsg.B.no(i - 1).soNum_HD.getValue())
                    ...
                    EZDGUIAttribute swhCd = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_RTL_SWH_CD_B1 + i);
                    swhCd.setVisibility(false);
                    scrnMsg.addGUIAttribute(swhCd);

                    EZDGUIAttribute mdseCd = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_MDSE_CD_B1 + i);
                    mdseCd.setVisibility(false);
                    scrnMsg.addGUIAttribute(mdseCd);

                    EZDGUIAttribute mdseNm = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_MDSE_NM_B1 + i);
                    mdseNm.setVisibility(false);
                    scrnMsg.addGUIAttribute(mdseNm);

                    EZDGUIAttribute shpgQty = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_SHPG_QTY_B1 + i);
                    shpgQty.setVisibility(false);
                    scrnMsg.addGUIAttribute(shpgQty);

                    EZDGUIAttribute shipQty = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_SHIP_QTY_B1 + i);
                ...
                if (scrnMsg.B.no(i).soNum_HD.getValue().equals(scrnMsg.B.no(i - 1).soNum_HD.getValue())) {
                    ...
                    EZDGUIAttribute whNm = new EZDGUIAttribute(NLBL3200Constant.SCRN_ID, NLBL3200Constant.HTML_ID_RTL_WH_NM_B1 + i);
        ...
        if (0 < scrnMsg.B.getValidCount() && NLBL3200Constant.TAB_PICK_LIST.equals(scrnMsg.xxDplyTab.getValue())) {
    ...
    public static boolean chkInquiryRole(List<String> functionList) {
        return !functionList.contains(NLBL3200Constant.ROLE_UPDATE);
    }
     ...
     * @param scrnMsg NLBL3200BMsg
     */
    public static void setInitParamForCarrierPopup(NLBL3200BMsg scrnMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxTblNm_P1, NLBL3200Constant.TBL_NM_FOR_OTBD_CARR_V);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxTblCdColNm_P1, NLBL3200Constant.TBL_CD_COL_NM_FOR_CARR_CD);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxTblNmColNm_P1, NLBL3200Constant.TBL_NM_COL_NM_FOR_CARR_NM);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxTblSortColNm_P1, NLBL3200Constant.TBL_SORT_COL_NM_FOR_CARR_SORT_NUM);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrNm_P1, NLBL3200Constant.SCR_NM_FOR_PRNT_CARRIER);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxHdrCdLbNm_P1, NLBL3200Constant.HDR_CD_LB_NM_FOR_CARRIER_CD);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxHdrNmLbNm_P1, NLBL3200Constant.HDR_NM_LB_NM_FOR_CARRIER_NM);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxDtlCdLbNm_P1, NLBL3200Constant.DTL_CD_LB_NM_FOR_CARRIER_CD);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxDtlNmLbNm_P1, NLBL3200Constant.DTL_NM_LB_NM_FOR_CARRIER_NM);
    }
     ...
     * @return Object[]
     */
    public static Object[] setParamForCarrierPopup(NLBL3200BMsg scrnMsg) {
     ...
     */
    public static Object[] setLocationPopupParam(NLBL3200BMsg scrnMsg, boolean isRtlWhLink) {
     ...
     */
    public static Object[] setMdseInfoPopupParam(NLBL3200BMsg scrnMsg) {

        scrnMsg.P.clear();
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(0).xxPopPrm, scrnMsg.mdseCd_H1);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(9).xxPopPrm, NLBL3200Constant.MDSE_CD_TARGET_ALL);
     ...
     * @param scrnMsg NLBL3200BMsg
     * @param scrnMsgALine NLBL3200_ABMsg
     * @param inquiry boolean
     * @return NLBL3200_SBMsgArray
     */
    public static NLBL3200_SBMsgArray setSerNumEntryPopupParam(NLBL3200BMsg scrnMsg, NLBL3200_ABMsg scrnMsgALine, boolean inquiry) {
     ...
     * @return LocationPopup Param (NMAL6800) Object[]
     */
    public static Object[] setShipToCustPopupParam(NLBL3200BMsg scrnMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(12).xxPopPrm, NLBL3200Constant.DISP_HRCH_ACCT_CD_SHIP);
     ...
     * @param scrnMsg NLBL3200BMsg
     */
    public static void addCheckTableItem(NLBL3200BMsg scrnMsg) {
        ...
        } else if (NLBL3200Constant.TAB_PICK_LIST.equals(scrnMsg.xxDplyTab.getValue())) {
     ...
     * @param handler EZDCommonHandler
     */
    public static void protectFullScreenItem(NLBL3200BMsg scrnMsg, EZDCommonHandler handler) {

        // screen item
        scrnMsg.setInputProtected(true);

        // button activation
        handler.setButtonEnabled(NLBL3200Constant.BTN_SAVE_SEARCH, false);
        handler.setButtonEnabled(NLBL3200Constant.BTN_DELETE_SEARCH, false);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_RTL_WH, false);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_RTL_SWH, false);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_SHIP_TO_CUST, false);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_CARRIER, false);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH_MDSE_INFO, false);
        handler.setButtonEnabled(NLBL3200Constant.BTN_SEARCH, false);
        ...
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_DOWNLOAD[0], NLBL3200Constant.BTN_CMN_DOWNLOAD[1], NLBL3200Constant.BTN_CMN_DOWNLOAD[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_DETELE[0], NLBL3200Constant.BTN_CMN_DETELE[1], NLBL3200Constant.BTN_CMN_DETELE[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_CLEAR[0], NLBL3200Constant.BTN_CMN_CLEAR[1], NLBL3200Constant.BTN_CMN_CLEAR[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_RESET[0], NLBL3200Constant.BTN_CMN_RESET[1], NLBL3200Constant.BTN_CMN_RESET[2], 0, null);
        handler.setButtonProperties(NLBL3200Constant.BTN_CMN_RETURN[0], NLBL3200Constant.BTN_CMN_RETURN[1], NLBL3200Constant.BTN_CMN_RETURN[2], 0, null);
    }

    /**
     * Popup array.
     * @param p NLBL3200_PBMsgArray
     * @param size int
     * @return Object[]
     */
    public static Object[] toArrayPopup(NLBL3200_PBMsgArray p, int size) {
    ...
    /**
     * addCheckItemSoDetail NLBL3200BMsg so line format check.
     * @param scrnMsg
     */
    public static void addCheckItemSoDetail(NLBL3200BMsg scrnMsg) {
    ...
    public static boolean isProtectedOrder(NLBL3200_ABMsg abMsg, String glblCmpyCd) {

        String protectOrdListTxt = ZYPCodeDataUtil.getVarCharConstValue("NLBL3200_PROTECT_ORD", glblCmpyCd);
