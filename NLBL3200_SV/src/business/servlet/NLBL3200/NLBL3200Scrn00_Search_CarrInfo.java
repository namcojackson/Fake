...
import static business.servlet.NLBL3200.constant.NLBL3200Constant.DISPLAY_CARR_CD;
 ...
 *</pre>
 */
public class NLBL3200Scrn00_Search_CarrInfo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.carrCd_H1)) {

            scrnMsg.carrCd_H1.setErrorInfo(1, ZZZM9007E, new String[] {DISPLAY_CARR_CD });
        }
