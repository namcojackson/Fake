...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NLBL3200Scrn00">
			<!-- Set Page Name -->
...
<!-- #################################################### DETAIL ################################################### -->
<%@ page import="business.servlet.NLBL3200.NLBL3200BMsg" %>
<%@ page import="business.servlet.NLBL3200.NLBL3200_ABMsg" %>
<%  NLBL3200BMsg bMsg = (NLBL3200BMsg)databean.getEZDBMsg(); %>
					<table width="100%">
						<col valign="top">
						<tr>
							<td>
																...
																<div style="float:left"> <!-- right table -->
																	<div id='rightTblHead' style="width:1070px; display:block; overflow:hidden; margin:0px;padding:0px;">
																		...
																		<table border="1" cellpadding="0" cellspacing="0" id="AHEAD" width="" style="table-layout: fixed">
																			...
																			<col align="center" width="65">		<!-- Shipment # -->
																			...
																			<tr height="43">
																				...
																				<td id="AH31" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'carrNm_A1' )">Actual Carrier<img id="sortIMG.carrNm_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH32" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'actlShpgSvcLvlCd_A1' )">Actual Service Level<img id="sortIMG.actlShpgSvcLvlCd_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH33" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'proNum_A2' )">Master Tracking#<img id="sortIMG.proNum_A2" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH34" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'proNum_A1' )">Tracking#<img id="sortIMG.proNum_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH35" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'xxYesNoCd_A2' )">Shipping<br/>Instructions<img id="sortIMG.xxYesNoCd_A2" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH36" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'sceOrdTpNm_A1' )">Shipping Order<br/>Source<img id="sortIMG.sceOrdTpNm_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH37" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'svcConfigMstrPk_A1' )">Config ID<img id="sortIMG.svcConfigMstrPk_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH38" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'pickSvcConfigMstrPk_A1' )">Pick Config ID<img id="sortIMG.pickSvcConfigMstrPk_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH39" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'fromStkStsCd_A1' )">SS<img id="sortIMG.fromStkStsCd_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH40" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'inEachQty_A1' )">UOM Each<br/>Qty<img id="sortIMG.inEachQty_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH41" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'shipToLocNm_A1' )">Ship to Customer<img id="sortIMG.shipToLocNm_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																				<td id="AH42" class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'prtShipNum_A1' )">Shipment #<img id="sortIMG.prtShipNum_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																			</tr>
																		</table>
																	...
																	<div  id="rightTbl" style="width:1087px; height:220px; display:block; overflow:scroll; margin:0px; padding:0px;">
																		...
																		<table border="1" cellpadding="0" cellspacing="0" id="A" width="4130px" style="table-layout: fixed">
																			<col align="center" width="25">		<!-- Check Box 1 -->
																			<col align="center" width="25">		<!-- Check Box 2 -->
																			<col align="center" width="65">		<!-- Source Order# -->
																			<col align="center" width="55">		<!-- Line# -->
																			...
																			<col align="center" width="133">	<!-- Ship to Customer -->
																			<col align="center" width="65">		<!-- Shiping # -->
																			...
																			<ezf:row ezfHyo="A">
																				<tr height="28" id="A_rightTBLRow#{EZF_ROW_NUMBER}">
																					...
																					<td><ezf:label name="prtShipNum_A1" ezfName="prtShipNum_A1" ezfHyo="A" ezfArrayNo="0" otherAttr=" id=\"prtShipNum{EZF_ROW_NUMBER}\""/></td>
																					<td class="pAuditInfo">
														...
														<td>
															<table border="0" cellpadding="1" cellspacing="1">
																...
																<tr>
																	...
																	<td align="left">
																		<ezf:inputButton name="Picking" value="Picking Doc Print" htmlClass="pBtn9" />
																	</td>
																</tr>
																<tr>
																	<td>
