...
import static business.servlet.NZZL0010.constant.NZZL0010Constant.*;
import com.canon.cusa.s21.framework.ZYP.common.ZYPEZDItemValueSetter;
import com.canon.cusa.s21.framework.online.servlet.S21CommonHandler;

/** 
 *<pre>
 * Business ID : NZZL0010 ASCC Launcher Screen
 *</pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NZZL0010_INIT extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NZZL0010BMsg scrnMsg = (NZZL0010BMsg) bMsg;
        ...
        boolean authTarget = getUserProfileService().isFunctionGranted(user, ASCC_FUNCTION_ID);
        if (authScreen && authTarget) {
	        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, ASCC_FUNCTION_ID);
        } else {
