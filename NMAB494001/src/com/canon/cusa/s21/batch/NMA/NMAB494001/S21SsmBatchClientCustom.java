 ...
 * ---------------------------------------------------------------------- 
 * 2018/07/05   Fujitsu         Mz.Takahashi    Create          QC#25339
 *</pre>
 * <p>
 ...
 * statement usage by themselves.. The main features of
 * S21SsmBatchClientCustom are,
 * <ul>
 * <li>Create SQL statement dynamically by applying given query
 ...
 * well-known Apache SQLMap, meaning the .S21SsmResultSetHandler
...
public class S21SsmBatchClientCustom extends S21SsmBatchClient {
     ...
     * cached.
     * @param useClass
     * @return S21SsmBatchClientCustom object
     */
