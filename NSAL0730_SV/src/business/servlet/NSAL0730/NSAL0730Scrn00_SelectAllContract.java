 ...
 *</pre>
 */
public class NSAL0730Scrn00_SelectAllContract extends S21CommonHandler {
...
//            ZYPTableUtil.selectAll(scrnMsg.A, "xxChkBox_D1", ZYPConstant.CHKBOX_ON_Y);
            NSAL0730CommonLogic.selectAllContract(scrnMsg);
            // END 2019/01/10 K.Kitachi [QC#26928, MOD]
        } else {
            ZYPTableUtil.unSelectAll(scrnMsg.A, "xxChkBox_D1");
        }
    }
}
