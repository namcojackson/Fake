 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB081001;
...
import business.db.NSBI2210_01TMsg;
...
/**
 * <pre>
 * Web OMAL G0 Configuration Component Batch
 * 
 ...
 * </pre>
 */
public class NSBB081001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB081001().executeBatch(NSBB081001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2210_01TMsg> inTMsgList = new ArrayList<NSBI2210_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2210_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2210_01TMsg> inMsgLst) {
        NSBI2210_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2210_01TMsg[inMsgLst.size()];
    ...
    private NSBI2210_01TMsg setCreateValue(ResultSet rs) {

        NSBI2210_01TMsg inParam = new NSBI2210_01TMsg();
