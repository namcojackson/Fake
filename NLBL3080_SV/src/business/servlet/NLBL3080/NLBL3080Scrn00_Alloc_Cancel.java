 ...
 *</pre>
 */
public class NLBL3080Scrn00_Alloc_Cancel extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NLBL3080BMsg scrnMsg = (NLBL3080BMsg) bMsg;
        NLBL3080CommonLogic.addCheckItemOrderLine(scrnMsg, false);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        //    NLBL3080CommonLogic.controlSubmitWarning(getUserProfileService(), this, scrnMsg, bizMsg.getUserID());
        //}
        NLBL3080CommonLogic.addCheckItemOrderLine(scrnMsg, false);
        scrnMsg.putErrorScreen();
