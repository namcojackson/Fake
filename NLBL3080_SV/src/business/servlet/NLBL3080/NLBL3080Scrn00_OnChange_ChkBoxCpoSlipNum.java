...
//import static business.servlet.NLBL3080.constant.NLBL3080Constant.BIZ_ID;
 ...
 *</pre>
 */
public class NLBL3080Scrn00_OnChange_ChkBoxCpoSlipNum extends S21CommonHandler {
...
//        scrnMsg.setFocusItem(scrnMsg.B.no(eventLine).xxChkBox_B2);
        if (TAB_ID_ORD.equals(scrnMsg.xxDplyTab.getValue())) {
            scrnMsg.setFocusItem(scrnMsg.A.no(eventLine).xxChkBox_A2);
