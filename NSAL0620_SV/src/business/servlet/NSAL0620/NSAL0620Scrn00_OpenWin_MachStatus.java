 ...
 *</pre>
 */
public class NSAL0620Scrn00_OpenWin_MachStatus extends S21CommonHandler {
    ...
    private static Object[] setPopupParameter(NSAL0620BMsg scrnMsg, String glblCmpyCd) {
        ...
        String suffix = "";
        // 1:Screen Name
        String screenName = "Machine Status Popup";
        // 2:Table Name
        ...
        tableName.append("      SVC_MACH_MSTR_STS_DESC_TXT");
        tableName.append("     ,MOD_DPLY_SORT_NUM");
        tableName.append("     ,GLBL_CMPY_CD");
        tableName.append("     ,EZCANCELFLAG");
        tableName.append(" FROM");
        tableName.append("     SVC_MACH_MSTR_STS");
        ...
        whereArray[0] = "Machine Status";
        whereArray[1] = "SVC_MACH_MSTR_STS_DESC_TXT";
        whereArray[2] = ""; // not used
        whereArray[3] = "Y"; // allow LIKE
        whereList.add(whereArray);

        Object[] columnArray = new Object[4];
        columnArray[0] = "Machine Status";
        columnArray[1] = "SVC_MACH_MSTR_STS_DESC_TXT";
        ...
        sortConditionArray[0] = "MOD_DPLY_SORT_NUM";
        sortConditionArray[1] = "ASC";
        sortConditionList.add(sortConditionArray);

        String[] valueList = scrnMsg.xxComnScrColValTxt_H4.getValue().split(";", 0);
