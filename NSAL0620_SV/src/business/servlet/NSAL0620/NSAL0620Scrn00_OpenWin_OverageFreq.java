 ...
 *</pre>
 */
public class NSAL0620Scrn00_OpenWin_OverageFreq extends S21CommonHandler {
    ...
    private static Object[] setPopupParameter(NSAL0620BMsg scrnMsg, String glblCmpyCd) {
        ...
        String suffix = "";
        // 1:Screen Name
        String screenName = "Overage Frequency Popup";
        // 2:Table Name
        ...
        whereArray[0] = "Overage Frequency";
        ...
        columnArray[0] = "Overage Frequency";
        ...
        String[] valueList = scrnMsg.xxComnScrColValTxt_H6.getValue().split(";", 0);
