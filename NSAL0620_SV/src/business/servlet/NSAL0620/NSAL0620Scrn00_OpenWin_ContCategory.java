 ...
 *</pre>
 */
public class NSAL0620Scrn00_OpenWin_ContCategory extends S21CommonHandler {
    ...
    private static Object[] setPopupParameter(NSAL0620BMsg scrnMsg, String glblCmpyCd) {
        ...
        String suffix = "";
        // 1:Screen Name
        String screenName = "Contract Category Popup";
        // 2:Table Name
        ...
        tableName.append("      DS_CONTR_CLS_DESC_TXT");
        tableName.append("     ,DS_CONTR_CLS_SORT_NUM");
        tableName.append("     ,GLBL_CMPY_CD");
        tableName.append("     ,EZCANCELFLAG");
        tableName.append(" FROM");
        tableName.append("     DS_CONTR_CLS");
        ...
        whereArray[0] = "Contract Category";
        whereArray[1] = "DS_CONTR_CLS_DESC_TXT";
        whereArray[2] = ""; // not used
        whereArray[3] = "Y"; // allow LIKE
        whereList.add(whereArray);

        Object[] columnArray = new Object[4];
        columnArray[0] = "Contract Category";
        columnArray[1] = "DS_CONTR_CLS_DESC_TXT";
        ...
        sortConditionArray[0] = "DS_CONTR_CLS_SORT_NUM";
        sortConditionArray[1] = "ASC";
        sortConditionList.add(sortConditionArray);

        String[] valueList = scrnMsg.xxComnScrColValTxt_H3.getValue().split(";", 0);
