...
public class ZZIL0110Scrn01_CMN_Return extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        this.setButtonProperties(ZZIL0110Constant.CMN_BTN7[0], ZZIL0110Constant.CMN_BTN7[1], ZZIL0110Constant.CMN_BTN7[2], 0, null);
