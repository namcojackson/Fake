 ...
 *</pre>
 */
public class NSAL0300Scrn00_Add_Price extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        int addBtnIdx = getButtonSelectNumber();
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxRowNum_BA, BigDecimal.valueOf(addBtnIdx));
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.xxRowNum_BA)) {
            int addIdx = scrnMsg.xxRowNum_BA.getValueInt();
            if (addIdx >= 0) {
                scrnMsg.setFocusItem(scrnMsg.B.no(addIdx).xsMtrCopyQty_B);
            }
        }
    }
}
