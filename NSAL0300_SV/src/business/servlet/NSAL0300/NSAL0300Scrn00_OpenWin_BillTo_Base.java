 ...
 *</pre>
 */
public class NSAL0300Scrn00_OpenWin_BillTo_Base extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue("OpenWin_BillTo_Base");
...
//        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_01, LOC_ROLE_TP.BILL_TO);
        ...
        setValue(scrnMsg.xxPopPrm_15, scrnMsg.B.no(idx).baseBillToCustCd_B);
//        Object[] prm = new Object[15];
        Object[] prm = new Object[24];
//        prm[0] = scrnMsg.B.no(idx).baseBillToCustCd_B;
