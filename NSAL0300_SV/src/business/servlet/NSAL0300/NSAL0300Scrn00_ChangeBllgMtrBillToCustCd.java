...
import static business.servlet.NSAL0300.constant.NSAL0300Constant.DISP_HRCH_ACCT_CD_BILL;
import static business.servlet.NSAL0300.constant.NSAL0300Constant.PERCENT;
 ...
 *</pre>
 */
public class NSAL0300Scrn00_ChangeBllgMtrBillToCustCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxSetFlg.getValue())) {
            ...
            setValue(scrnMsg.xxScrEventNm, "OpenWin_BillTo_Meter");
            int idx = getButtonSelectNumber();
            setValue(scrnMsg.xxRowNum, BigDecimal.valueOf(idx));
            setValue(scrnMsg.xxPopPrm_12, DISP_HRCH_ACCT_CD_BILL);
            setValue(scrnMsg.xxPopPrm_15, scrnMsg.B.no(idx).bllgMtrBillToCustCd_B.getValue().concat(PERCENT));
...
//        scrnMsg.setFocusItem(scrnMsg.B.no(rowNum).xxPsnNm_BM);
        scrnMsg.setFocusItem(scrnMsg.B.no(rowNum).ctacPsnFirstNm_BM);
