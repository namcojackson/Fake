 ...
 *</pre>
 */
public class NSAL0300Scrn00_OpenWin_Contact_Meter extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NSAL0300BMsg scrnMsg = (NSAL0300BMsg) bMsg;
        int rowNum = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(rowNum).bllgMtrBillToCustCd_B)) {
            scrnMsg.B.no(rowNum).bllgMtrBillToCustCd_B.setErrorInfo(1, ZZM9000E, new String[] {"Bill To" });
        }
        scrnMsg.addCheckItem(scrnMsg.B.no(rowNum).bllgMtrBillToCustCd_B);
...
//        NSAL0300CMsg bizMsg = (NSAL0300CMsg) cMsg;
        ...
        scrnMsg.xxScrEventNm.setValue("OpenWin_Contact_Meter");
        int rowNum = getButtonSelectNumber();

        Object[] params = new Object[21];
        // START 2018/06/18 K.Kitachi [QC#18591, ADD]
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_06, scrnMsg.B.no(rowNum).ctacPsnFirstNm_BM);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_07, scrnMsg.B.no(rowNum).ctacPsnLastNm_BM);
...
//        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_01, CTAC_TP.BILL_TO_CONTACT);
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_20, scrnMsg.B.no(rowNum).bllgMtrBillToCustCd_B);
        // START 2018/06/18 K.Kitachi [QC#18591, DEL]
//        NSAL0300CommonLogic.setContactName(scrnMsg.B.no(rowNum).xxPsnNm_BM, scrnMsg.xxPopPrm_06, scrnMsg.xxPopPrm_07);
...
//        params[19] = scrnMsg.ctacPsnPk_CP;
        params[19] = scrnMsg.B.no(rowNum).ctacPsnPk_BM;
