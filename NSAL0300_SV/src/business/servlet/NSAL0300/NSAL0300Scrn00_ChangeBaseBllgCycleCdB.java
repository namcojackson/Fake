 ...
 * ----------------------------------------------------------------------
 * 2016/05/17   Hitachi         T.Kanasaka      Create          QC#2184
 * 2016/07/28   Hitachi         T.Kanasaka      Update          QC#4806
 *</pre>
 */
public class NSAL0300Scrn00_ChangeBaseBllgCycleCdB extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.B.no(rowNum).baseDplyPerEndDay_B);
    }
}
