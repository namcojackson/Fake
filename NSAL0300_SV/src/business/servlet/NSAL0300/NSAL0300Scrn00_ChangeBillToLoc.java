 ...
 * ----------------------------------------------------------------------
 * 2016/02/16   Hitachi         T.Aoyagi        Create          QC2947
 ...
 *</pre>
 */
public class NSAL0300Scrn00_ChangeBillToLoc extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxSetFlg.getValue())) {
            ...
            if (!("%").equals(scrnMsg.altPayerCustCd.getValue())) {
                altPayerCustCd = scrnMsg.altPayerCustCd.getValue().concat(PERCENT);
            }
...
//        scrnMsg.setFocusItem(scrnMsg.xxPsnNm_CP);
        scrnMsg.setFocusItem(scrnMsg.ctacPsnFirstNm_CP);
