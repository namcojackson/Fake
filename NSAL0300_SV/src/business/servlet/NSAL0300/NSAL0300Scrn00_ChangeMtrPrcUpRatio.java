 ...
 * ----------------------------------------------------------------------
 * 2016/03/18   Hitachi         T.Tomita        Create          QC#4085
 * 2016/07/28   Hitachi         T.Kanasaka      Update          QC#4806
 *</pre>
 */
public class NSAL0300Scrn00_ChangeMtrPrcUpRatio extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.befEndRnwDaysAot);
    }
}
