 ...
 *</pre>
 */
public class NSAL0300Scrn00_OpenWin_ShipTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue("OpenWin_ShipTo");
        ...
        setValue(scrnMsg.xxPopPrm_16, scrnMsg.B.no(idx).shipToCustCd_B);
