 ...
 * ----------------------------------------------------------------------
 * 2015/12/11   Hitachi         T.Kanasaka      Create          QC1824
 *</pre>
 */
public class NSAL0300Scrn00_ChangeDurationPeriod extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.contrDurnAot)) {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.contrVrsnEffThruDt);
    }
}
