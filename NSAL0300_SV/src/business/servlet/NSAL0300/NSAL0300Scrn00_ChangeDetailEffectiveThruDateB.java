 ...
 *</pre>
 */
public class NSAL0300Scrn00_ChangeDetailEffectiveThruDateB extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.B.no(rowNum).contrEffThruDt_B)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(rowNum).contrEffThruDt_B);
        }
