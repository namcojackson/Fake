 ...
 *</pre>
 */
public class NSAL0300Scrn00_ChangeDetailEffectiveFromDateA extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.A.no(rowNum).contrEffFromDt_A)) {
            scrnMsg.addCheckItem(scrnMsg.A.no(rowNum).contrEffFromDt_A);
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(rowNum).contrEffThruDt_A);
    }
}
