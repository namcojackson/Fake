 ...
 *</pre>
 */
public class NSAL0300Scrn00_ChangeBaseBillToCustCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxSetFlg.getValue())) {
            ...
            setValue(scrnMsg.xxScrEventNm, "OpenWin_BillTo_Base");
            int idx = getButtonSelectNumber();
            setValue(scrnMsg.xxRowNum, BigDecimal.valueOf(idx));
            setValue(scrnMsg.xxPopPrm_12, DISP_HRCH_ACCT_CD_BILL);
            setValue(scrnMsg.xxPopPrm_15, scrnMsg.B.no(idx).baseBillToCustCd_B.getValue().concat(PERCENT));
...
//        scrnMsg.setFocusItem(scrnMsg.B.no(rowNum).xxPsnNm_BB);
        scrnMsg.setFocusItem(scrnMsg.B.no(rowNum).ctacPsnFirstNm_BB);
