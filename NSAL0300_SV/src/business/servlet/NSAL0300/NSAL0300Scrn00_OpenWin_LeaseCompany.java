 ...
 *</pre>
 */
public class NSAL0300Scrn00_OpenWin_LeaseCompany extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue("OpenWin_LeaseCompany");
...
//        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_01, LOC_ROLE_TP.SELL_TO);
        ...
        setValue(scrnMsg.xxPopPrm_08, DISP_RELN_ACCT_CD_LEASE_BILL);
