 ...
 *</pre>
 */
public class NSAL0300Scrn00_ChangeUsgChrgToLeaseCmpyFlg extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.usgChrgToLeaseCmpyFlg.getValue())) {
            for (int i = 0; i < scrnMsg.B.getValidCount(); i++) {
                ZYPEZDItemValueSetter.setValue(scrnMsg.B.no(i).bllgMtrBillToCustCd_B, scrnMsg.leaseCmpyCd);
            }
        }
