...
/*
 *ZZXL0050_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class ZZXL0050_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** XX_DSPL_TP_TXT_A*/
	public final EZDCStringItem              xxDsplTpTxt_A;

    /** DT_PROC_CD_A*/
	public final EZDCStringItem              dtProcCd_A;

    /** DT_MGT_PGM_ID_A*/
	public final EZDCStringItem              dtMgtPgmId_A;

    /** MGT_DT_A*/
	public final EZDCDateItem              mgtDt_A;
	...
	/**
	 * ZZXL0050_ACMsg is constructor.
	 * The initialization when the instance of ZZXL0050_ACMsg is generated.
	 */
	public ZZXL0050_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public ZZXL0050_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		xxChkBox_A = (EZDCStringItem)newItem("xxChkBox_A");
		xxDsplTpTxt_A = (EZDCStringItem)newItem("xxDsplTpTxt_A");
		dtProcCd_A = (EZDCStringItem)newItem("dtProcCd_A");
		dtMgtPgmId_A = (EZDCStringItem)newItem("dtMgtPgmId_A");
		mgtDt_A = (EZDCDateItem)newItem("mgtDt_A");
	 ...
	 * @return ZZXL0050_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new ZZXL0050_ACMsgArray();
	}
