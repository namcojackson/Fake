...
/*
 *NWAL2400_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NWAL2400_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** RTL_DIV_CD_A*/
	public final EZDSStringItem              rtlDivCd_A;
    ...
    /** CONTR_GRP_CD_A*/
	public final EZDSStringItem              contrGrpCd_A;
	...
	public final EZDSBigDecimalItem              dsRtlDlrInfoPk_A;


	/**
	 * NWAL2400_ASMsg is constructor.
	 * The initialization when the instance of NWAL2400_ASMsg is generated.
	 */
	public NWAL2400_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NWAL2400_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		rtlDivCd_A = (EZDSStringItem)newItem("rtlDivCd_A");
		...
		contrGrpCd_A = (EZDSStringItem)newItem("contrGrpCd_A");
		effFromDt_A = (EZDSDateItem)newItem("effFromDt_A");
		effThruDt_A = (EZDSDateItem)newItem("effThruDt_A");
		dsRtlDlrInfoPk_A = (EZDSBigDecimalItem)newItem("dsRtlDlrInfoPk_A");
	}

	/**
	 * get the type of array which is stored
	 * @return NWAL2400_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NWAL2400_ASMsgArray();
	}
