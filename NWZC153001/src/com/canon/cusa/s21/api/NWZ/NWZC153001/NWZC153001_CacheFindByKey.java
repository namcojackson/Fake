 ...
 *</pre>
 */
public final class NWZC153001_CacheFindByKey {
    /** Parameter delimiter */
     ...
     */
    private static final String INSTANCE_KEY = NWZC153001_CacheFindByKey.class.getName();
     ...
     * singleton
     */
    private NWZC153001_CacheFindByKey() {

    }

    /* 01/13/2012 CSAI T.Hakodate Update #1601 START */
     ...
     */
    public static NWZC153001_CacheFindByKey getInstance() {
        NWZC153001_CacheFindByKey myInstance = (NWZC153001_CacheFindByKey) S21ApplicationCacheHolder.get(INSTANCE_KEY);
        if (myInstance == null) {
            myInstance = new NWZC153001_CacheFindByKey();
     ...
     * bulk update
     * </pre>
     * @param tMsg update TMsg(need to contains not to update culomn data)
     */
     ...
     * @return true: normal end. false: error
     */
    public boolean logicalRemoveWithCache(EZDTMsg tMsg) {
        String key = makeKey(tMsg);
        cacheLockMap.put(key, null);
     ...
     * @return true: normal end. false: error
     */
    public boolean removeWithCache(EZDTMsg tMsg) {
        String key = makeKey(tMsg);
        cacheLockMap.put(key, null);
        cacheMap.put(key, null);
