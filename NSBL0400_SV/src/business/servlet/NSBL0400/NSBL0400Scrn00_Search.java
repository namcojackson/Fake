 ...
 *</pre>
 */
public class NSBL0400Scrn00_Search extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NSBL0400BMsg scrnMsg = (NSBL0400BMsg) bMsg;
        NSBL0400CommonLogic.commonAddCheckItem(scrnMsg);
        scrnMsg.putErrorScreen();
        NSBL0400CommonLogic.inputCheckMondatory(scrnMsg);
        scrnMsg.putErrorScreen();
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.A.getValidCount() > 0) {
            NSBL0400CommonLogic.protectFields(this, scrnMsg);
            NSBL0400CommonLogic.setRowColors(scrnMsg);
        }
        scrnMsg.putErrorScreen();
