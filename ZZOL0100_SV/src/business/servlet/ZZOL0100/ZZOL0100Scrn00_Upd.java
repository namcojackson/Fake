...
public class ZZOL0100Scrn00_Upd extends S21CommonHandler implements ZZOL0100Constant {
	...
	protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        BigDecimal infoPk = scrnMsg.menuInfoPk.getValue();
        if((infoPk == null) || (infoPk.compareTo(new BigDecimal("0")) <= 0)){
            scrnMsg.setMessageInfo("ZZZM9006E", new String[] {"MENU_INFO"});
        }
    }
