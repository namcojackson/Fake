...
/**
 *<pre>
 * NMAL7130Scrn00_OnChange_PrcTermCondVrsnNum
 *
 ...
 *</pre>
 */
public class NMAL7130Scrn00_OnChange_PrcTermCondVrsnNum extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.prcTermCondVrsnNum_E1)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.prcTermCondVrsnNum_E1, scrnMsg.prcTermCondVrsnNum_L1.no(0));
        }
    }
