 ...
 *</pre>
 */
public class NWAL1500Scrn00_Line_Config_Add extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (NWAL1500CommonLogic.isOrderCredit(scrnMsg)) {
            String ordEntryActNm = NWAL1500CommonLogicForOrderEntryAction.getOrdEntryActNm(scrnMsg, ORD_ENTRY_ACT.ADD_CONFIG);
