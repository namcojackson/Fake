 ...
 *</pre>
 */
public class NWAL1500Scrn00_TAB_Line_Config extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TAB_LINE_CONFIG.equals(dplyTab) || (TAB_RMA.equals(dplyTab) && !ZYPCommonFunc.hasValue(scrnMsg.D.no(0).mdseCd_RL))) {
            return;
        }
