 ...
 * ----------------------------------------------------------------------
 * 2016/08/10   Fujitsu         Y.Taoka         Create          S21_NA#8388
 *</pre>
 */
public class NWAL1500Scrn00_OnChange_DclnSvcCdConfig extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(scrnMsg.xxCellIdx.getValueInt()).dclnSvcCd_LC);
