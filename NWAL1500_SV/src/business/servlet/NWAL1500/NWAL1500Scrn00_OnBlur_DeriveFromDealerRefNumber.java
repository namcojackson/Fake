 ...
 * </pre>
 */
public class NWAL1500Scrn00_OnBlur_DeriveFromDealerRefNumber extends S21CommonHandler {
...
//        if (!ZYPCommonFunc.hasValue(scrnMsg.dlrRefNum)) {
//            return null;
//        }
        if (cellIdx < 0) {
            if (!ZYPCommonFunc.hasValue(scrnMsg.dlrRefNum)) {
...
//                if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(cellIdx).dlrRefNum_LC)) {
//                    return null;
//                }
//            } else if (TAB_RMA.equals(dplyTab)) {
//                if (!ZYPCommonFunc.hasValue(scrnMsg.C.no(cellIdx).dlrRefNum_RC)) {
//                    return null;
//                }
...
//        scrnMsg.setFocusItem(scrnMsg.ordSgnDt);
        ...
        if (cellIdx < 0) {
            ...
            if (TAB_LINE_CONFIG.equals(dplyTab)) {
                ...
                if (!ZYPCommonFunc.hasValue(lineConfigMsg.dlrRefNum_LC)) {
                    scrnMsg.setFocusItem(lineConfigMsg.csmpContrNum_LC);
                    return;
                }

                scrnMsg.addCheckItem(lineConfigMsg.csmpContrNum_LC);
                scrnMsg.addCheckItem(lineConfigMsg.dlrRefNum_LC);
                scrnMsg.putErrorScreen();
                ...
                if (!ZYPCommonFunc.hasValue(rmaConfigMsg.dlrRefNum_RC)) {
                    scrnMsg.setFocusItem(rmaConfigMsg.csmpContrNum_RC);
                    return;
                }

                scrnMsg.addCheckItem(rmaConfigMsg.csmpContrNum_RC);
                scrnMsg.addCheckItem(rmaConfigMsg.dlrRefNum_RC);
                scrnMsg.putErrorScreen();
