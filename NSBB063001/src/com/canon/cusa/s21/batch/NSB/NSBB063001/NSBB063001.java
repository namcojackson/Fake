 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB063001;
...
import business.db.NSBI2030_01TMsg;
...
/**
 * <pre>
 * Web OMAL F4 Parts Usage Batch
 * 
 * Date         Company         Name            Create/Update   Defect No
 * 
 * ----------------------------------------------------------------------
 * 2016/06/01   Hitachi         O.Okuma         Create          N/A
 * 2016/10/28   Hitachi         T.Mizuki        Update          QC#15568
 * </pre>
 */
public class NSBB063001 extends S21BatchMain {
    ...
    private static final String CASH_DISC_PCT = "0000";

    /** OMAL DATA TYPE */
    private static final String FILL_1_TXT_02 = "A";

    /** PREV_FSR_VISIT_NUM : 1 */
    private static final int PREV_FSR_VISIT_NUM_01 = 1;
    ...
    public static void main(String[] args) {
        new NSBB063001().executeBatch(NSBB063001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2030_01TMsg> inTMsgList = new ArrayList<NSBI2030_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2030_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2030_01TMsg> inMsgLst) {
        NSBI2030_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2030_01TMsg[inMsgLst.size()];
    ...
    private Map<String, Object> setSearchCondition() {
        ...
        inParam.put("cashDiscPct", CASH_DISC_PCT);
        inParam.put("fill1Txt_02", FILL_1_TXT_02);
        inParam.put("prevFsrVisitNum_1", PREV_FSR_VISIT_NUM_01);
    ...
    private NSBI2030_01TMsg setCreateValue(ResultSet rs) {

        NSBI2030_01TMsg inParam = new NSBI2030_01TMsg();
