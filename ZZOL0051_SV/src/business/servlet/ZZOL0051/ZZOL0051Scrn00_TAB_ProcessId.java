...
public class ZZOL0051Scrn00_TAB_ProcessId extends S21CommonHandler implements ZZOL0051Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // Display TAB = Detail
        scrnMsg.xxDplyTab.setValue( TAB_PROCID );
        setButtonEnabled(CMN_SEARCH, false);
        setButtonEnabled(CMN_BTN2[0], scrnMsg.P.getValidCount() > 0);
        setButtonEnabled(CMN_BTN7[0], scrnMsg.P.getValidCount() > 0);
