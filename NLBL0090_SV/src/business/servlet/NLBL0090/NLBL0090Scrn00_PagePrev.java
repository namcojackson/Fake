...
import static business.servlet.NLBL0090.constant.NLBL0090Constant.PAGENATION_PREV;
 ...
 *</pre>
 */
public class NLBL0090Scrn00_PagePrev extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TBL_NAME_A.equals(scrnMsg.xxTblNm_Z1.getValue())) {
            ...
            NLBL0090CommonLogic.clearPagenationTableA(scrnMsg, PAGENATION_PREV);
        } else {
            NLBL0090CommonLogic.clearPagenationTableB(scrnMsg, PAGENATION_PREV);
        }
