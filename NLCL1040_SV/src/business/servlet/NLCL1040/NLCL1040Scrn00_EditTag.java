 ...
 * Function Name : NLCL1040Scrn00_EditTag
 * </pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NLCL1040Scrn00_EditTag extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (EZDMessageInfo.MSGTYPE_ERROR == scrnMsg.getMessageType()) {
            // START 2018/11/26 T.Ogura [QC#29124,DEL]
//            scrnMsg.putErrorScreen();
            // END   2018/11/26 T.Ogura [QC#29124,DEL]
            return;
        }
