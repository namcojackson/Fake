...
import static business.servlet.NLCL1040.constant.NLCL1040Constant.EVENT_NM_ITEM_SEARCH;
 ...
 * Function Name : NLCL1040Scrn00_ItemSearch
 * </pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NLCL1040Scrn00_ItemSearch extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.mdseCd)) {
            scrnMsg.mdseCd.setErrorInfo(1, "ZZZM9025E", new String[] {"Item Number"});
        }
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxMntEventNm, EVENT_NM_ITEM_SEARCH);
