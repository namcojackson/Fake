...
/*
 *NPAL1070_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NPAL1070_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	public final EZDSBigDecimalItem              ovrdMaxInvtyQty_A1;
    ...
    /** PROCR_TP_CD_AS*/
	public final EZDSStringItem              procrTpCd_AS;

    /** PROCR_TP_DESC_TXT_A1*/
	public final EZDSStringItem              procrTpDescTxt_A1;

    /** SRC_LOC_CD_A1*/
	public final EZDSStringItem              srcLocCd_A1;
    ...
    /** RPLSH_DLY_FLG_A1*/
	public final EZDSStringItem              rplshDlyFlg_A1;

    /** RPLSH_MON_FLG_A1*/
	public final EZDSStringItem              rplshMonFlg_A1;

    /** RPLSH_TUE_FLG_A1*/
	public final EZDSStringItem              rplshTueFlg_A1;

    /** RPLSH_WED_FLG_A1*/
	public final EZDSStringItem              rplshWedFlg_A1;

    /** RPLSH_THU_FLG_A1*/
	public final EZDSStringItem              rplshThuFlg_A1;

    /** RPLSH_FRI_FLG_A1*/
	public final EZDSStringItem              rplshFriFlg_A1;

    /** SUPD_FLG_A1*/
	public final EZDSStringItem              supdFlg_A1;

    /** XX_SEL_FLG_A1*/
	public final EZDSStringItem              xxSelFlg_A1;

    /** MRP_INFO_CMNT_TXT_A1*/
	public final EZDSStringItem              mrpInfoCmntTxt_A1;

    /** MRP_INFO_RGTN_STS_CD_A1*/
	public final EZDSStringItem              mrpInfoRgtnStsCd_A1;

    /** XX_RSLT_FLG_A1*/
	public final EZDSStringItem              xxRsltFlg_A1;
	...
	/**
	 * NPAL1070_ASMsg is constructor.
	 * The initialization when the instance of NPAL1070_ASMsg is generated.
	 */
	public NPAL1070_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NPAL1070_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		rplshDlyFlg_A1 = (EZDSStringItem)newItem("rplshDlyFlg_A1");
		rplshMonFlg_A1 = (EZDSStringItem)newItem("rplshMonFlg_A1");
		rplshTueFlg_A1 = (EZDSStringItem)newItem("rplshTueFlg_A1");
		rplshWedFlg_A1 = (EZDSStringItem)newItem("rplshWedFlg_A1");
		rplshThuFlg_A1 = (EZDSStringItem)newItem("rplshThuFlg_A1");
		rplshFriFlg_A1 = (EZDSStringItem)newItem("rplshFriFlg_A1");
		supdFlg_A1 = (EZDSStringItem)newItem("supdFlg_A1");
		xxSelFlg_A1 = (EZDSStringItem)newItem("xxSelFlg_A1");
		mrpInfoCmntTxt_A1 = (EZDSStringItem)newItem("mrpInfoCmntTxt_A1");
		mrpInfoRgtnStsCd_A1 = (EZDSStringItem)newItem("mrpInfoRgtnStsCd_A1");
		xxRsltFlg_A1 = (EZDSStringItem)newItem("xxRsltFlg_A1");
	 ...
	 * @return NPAL1070_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NPAL1070_ASMsgArray();
	}
