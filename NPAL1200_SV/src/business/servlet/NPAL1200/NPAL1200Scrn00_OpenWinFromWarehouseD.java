 ...
 *</pre>
 */
public class NPAL1200Scrn00_OpenWinFromWarehouseD extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.eventNm, "OpenWinFromWarehouseD");
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.rtlWhCd_DF)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_P6, LIKE_CHAR + scrnMsg.rtlWhCd_DF.getValue() + LIKE_CHAR);
        } else {
