...
import static business.servlet.NPAL1200.constant.NPAL1200Constant.POP_PARAM_02;
 ...
 *</pre>
 */
public class NPAL1200Scrn00_OpenWinToWarehouseH extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.eventNm, "OpenWinToWarehouseH");
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm, POP_PARAM_02);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.rtlWhCd_HT)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_P6, LIKE_CHAR + scrnMsg.rtlWhCd_HT.getValue() + LIKE_CHAR);
        } else {
