 ...
 *</pre>
 */
public class NPAL1200Scrn00_OpenWinToWarehouseD extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.eventNm, "OpenWinToWarehouseD");
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.rtlWhCd_DT)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_P6, LIKE_CHAR + scrnMsg.rtlWhCd_DT.getValue() + LIKE_CHAR);
        } else {
