 ...
 *</pre>
 */
public class ZZVL0000Scrn01_PagePrev extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPageShowFromNum_B, BigDecimal.valueOf(scrnMsg.xxPageShowFromNum_B.getValueInt() - scrnMsg.B.length() - 1));
