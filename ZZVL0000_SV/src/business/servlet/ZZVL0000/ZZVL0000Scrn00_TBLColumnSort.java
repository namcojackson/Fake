 ...
 *</pre>
 */
public class ZZVL0000Scrn00_TBLColumnSort extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if ("A".equals(sortTblNm)) {
            if (scrnMsg.A.getValidCount() > 0) {
                ...
                ZYPEZDItemValueSetter.setValue(scrnMsg.xxSortTblNm_A, sortTblNm);
                ZYPEZDItemValueSetter.setValue(scrnMsg.xxSortItemNm_A, sortItemNm);
                ZYPEZDItemValueSetter.setValue(scrnMsg.xxSortOrdByTxt_A, sortOrderBy);
