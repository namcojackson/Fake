 ...
 *</pre>
 */
public class NLBL3150Scrn00_AddNewRow extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLBL3150CommonLogic.changeTableBackGroundColor(scrnMsg);
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(index - 1).mdseCd_A);
    }
}
