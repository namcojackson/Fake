 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB067001;
...
import business.db.NSBI2070_01TMsg;
...
/**
 * <pre>
 * Web OMAL F8 Technician Data Batch
 * 
 * Date         Company         Name            Create/Update   Defect No
 * 
 * ----------------------------------------------------------------------
 * 2016/06/01   Hitachi         O.Okuma         Create          N/A
 * 2016/12/16   Hitachi         K.Kojima        Update          QC#15653
 * 2016/12/21   Hitachi         K.Kojima        Update          QC#15653
 * </pre>
 */
public class NSBB067001 extends S21BatchMain {
    ...
    /** TECH_LOC_CD For Technician */
    private static final String TECH_LOC_CD_TECH = "G";
    ...
    public static void main(String[] args) {
        new NSBB067001().executeBatch(NSBB067001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2070_01TMsg> inTMsgList = new ArrayList<NSBI2070_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2070_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2070_01TMsg> inMsgLst) {
        NSBI2070_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2070_01TMsg[inMsgLst.size()];
    ...
    private Map<String, Object> setSearchCondition() {
        ...
        inParam.put("techLocCd_tech", TECH_LOC_CD_TECH);
        ...
        inParam.put("flgY", ZYPConstant.FLG_ON_Y);
        // END 2016/12/21 K.Kojima [QC#15653,ADD]
        return inParam;
    }

    private NSBI2070_01TMsg setCreateValue(ResultSet rs) {

        NSBI2070_01TMsg inParam = new NSBI2070_01TMsg();
