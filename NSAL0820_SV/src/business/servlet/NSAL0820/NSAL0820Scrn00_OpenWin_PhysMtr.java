 ...
 *</pre>
 */
public class NSAL0820Scrn00_OpenWin_PhysMtr extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setValue(scrnMsg.xxScrEventNm, OPENWIN_PHYSMTR);
        setArgForSubScreen(setCommonPopUpParam(ctx, scrnMsg));
    }

    private Object[] setCommonPopUpParam(EZDApplicationContext ctx, NSAL0820BMsg scrnMsg) {
        ...
        params[i++] = "";
        // Window title
        params[i++] = "Physical Meter Search Popup";
        // Table SQL
    ...
    private static String getSqlStr(NSAL0820BMsg scrnMsg) {
        ...
        sql = sql.replaceAll("#mtrLbTpCd#", MTR_LB_TP.REGULAR_METER);
        sql = sql.replaceAll("#slsDt#", scrnMsg.slsDt.getValue());
        return sql;
    }

    private List<Object[]> getWhereList(NSAL0820BMsg scrnMsg) {
        ...
        h0[WLIST_OBJ_VALUE] = scrnMsg.A.no(idx).physMtrLbCd_A.getValue();
        ...
        h1[WLIST_OBJ_VALUE] = scrnMsg.A.no(idx).mtrLbDescTxt_AP.getValue();
