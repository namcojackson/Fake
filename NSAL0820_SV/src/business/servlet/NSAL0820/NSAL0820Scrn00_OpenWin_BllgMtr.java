 ...
 *</pre>
 */
public class NSAL0820Scrn00_OpenWin_BllgMtr extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setValue(scrnMsg.xxScrEventNm, OPENWIN_BLLGMTR);
    ...
    private List<Object[]> getWhereList(NSAL0820BMsg scrnMsg) {
        ...
        h1[WLIST_OBJ_VALUE] = scrnMsg.A.no(idx).mtrLbDescTxt_AB.getValue();
