 ...
 *</pre>
 */
public class NMAL7050Scrn00_LINK_SVC_MTR_PAC_SET_UP extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(0).xxPopPrm, scrnMsg.A.no(index).prcMtrPkgPk_A1.getValue().toString());
