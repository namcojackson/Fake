 ...
 */
package com.canon.cusa.s21.batch.NWA.NWAB245001.constant;
 ...
 * 01/31/2017   Fujitsu         M.Ohno          Update          QC#17297
 * 02/08/2017   Fujitsu         M.Ohno          Update          QC#17302
 * 11/24/2017   Fujitsu         T.Murai         Update          QC#21722
 * 02/26/2018   Fujitsu         Hd.Sugawara     Update          QC#22967
 * 01/08/2019   Fujitsu         S.Kosaka        Update          QC#29753
 * </pre>
 */
public class NWAB245001Constant {
    /** Program ID */
    ...
    /** DB VALUE : GLBL_CMPY_CD */
    public static final String VAL_GLBL_CMPY_CD_CSA = "ADB";

    /** DB VALUE : EDI_CUST_TP_NM */
    public static final String VAL_EDI_CUST_TP_NM = "SHIPTO";

    /** DB VALUE : VAL_PRNT_MDSE */
    public static final String VAL_PRNT_MDSE = "1";
    ...
    /** VALUE : 001 */
    public static final String DEF_SUB_LINE_NUM = "001";
    ...
    /** DB COLUMN : IS_PRNT_MDSE */
    public static final String COL_IS_PRNT_MDSE = "IS_PRNT_MDSE";
    ...
    // 2017/11/24 S21_NA#21722 Add Start
    /** DB COLUMN : SVC_DLR_COMP_AMT */
    public static final String COL_SVC_DLR_COMP_AMT = "SVC_DLR_COMP_AMT";
    // 2017/11/24 S21_NA#21722 Add End
    ...
    /** DB COLUMN : PRCH_AVAL_FLG */
    public static final String COL_PRCH_AVAL_FLG = "PRCH_AVAL_FLG";
