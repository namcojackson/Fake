...
System.out.println("Inside lineInclude.jsp::::::::::::::::::");
    ...
    if("Y".equalsIgnoreCase(save_flag)){
        ...
        switch(tab_index){
            case TAB_MAIN:
                ...
                if(line_numbers!=null && line_numbers.length>0){
                    for(int i=0;i<line_numbers.length;i++){
                        ...
                        BigDecimal p_install_credit=CanonE580ITTWorkbenchUtil.toBigDecimal(install_credits[i], false);
                        BigDecimal p_item_purchase_price=CanonE580ITTWorkbenchUtil.toBigDecimal(purchase_prices[i], false);
                        BigDecimal p_finder_fee=CanonE580ITTWorkbenchUtil.toBigDecimal(finder_fees[i],false);
                        String p_serial_number=serial_numbers[i];
                        String p_reason_code=reason_codes[i];
                        String p_po_number=po_numbers[i];
            ...
            case TAB_MAINTENANCE:
                boolean service_package_change_flag="Y".equals(request.getParameter("service_package_change_flag"));
                ...
                String [] service_packages=request.getParameterValues("service_package");
                ...
                String last_service_package=null;
                ...
                for(int i=0;models!=null && i<models.length;i++){
                	...
                	String service_package=sameModel? last_service_package : service_packages[i];
                    if(service_package_change_flag){
                    	if(!sameModel){
                    		dao.ittMeterTypeDtls(p_itt_number,p_so_number,p_equip_model,service_package);
                    	}
                    }else{
                    ...
                    last_service_package=service_package;
                }
    ...
    try{
        ...
        System.out.println(" total_record  is "+CanonE580ITTWorkbenchUtil.third(result) );
    ...
    if(exportExcel){
        pageContext.setAttribute("export-excel-detail", 
                CanonE580ITTWorkbenchUtil.createLineDetailInfo(list, pricingList, notesList, timestamp),
...
<form name="lineDetailForm" id="lineDetailForm" method="post" action="canonE580LineDetailInclude.jsp">
    ...
    <input type="hidden" name="service_package_change_flag"  id="service_package_change_flag" /> 
        ...
        <table border="0" width="80%" cellspacing="1" cellpadding="2" id="itt_maintenance_table" class="supplies-table" style="margin-left:-10px;border:none;background:white">
            ...
            <%
                ...
                for(int j=0;j<pricingList.size();j++){
					...
					String svc_meter_pkg=pd.getSvcMeterPkg();
                    
                    
                    if(!sameModel){
                        result = dao.ittSvcMtrPkgLov(model);
                        List svcMtrPkgLovList = CanonE580ITTWorkbenchUtil.first(result)!=null ? (List) CanonE580ITTWorkbenchUtil.first(result) : Collections.EMPTY_LIST;
            ...
            <tr >
                ...
                <td align="center">
                     <select name="service_package" class="service_package" data-val="<%=CanonE580ITTWorkbenchUtil.nonNullify(svc_meter_pkg)%>">
                        <option value=""></option>
                        <% for (int i = 0; i < svcMtrPkgLovList.size(); i++) {
                                String service_package_lov = (String) svcMtrPkgLovList.get(i);
                        %>
                        <option value="<%=service_package_lov%>"  <%=service_package_lov.equalsIgnoreCase(svc_meter_pkg) ? "SELECTED" : ""%> > <%=service_package_lov%> </option>
                        <%}%>
                     </select>									
                </td>
                <td align="center">
                ...
                <td align="center">
                    <div>
                        <input name="term"  class="term" type="text" value ="<%=term==null?"":term.toString()%>" style="width:100%">
                    </div>    
                </td>
                <td align="center">
                    <div>
                        <input name="base_price"  class="currency" type="text" value ="<%=CanonE580ITTWorkbenchUtil.formatBigDecimal(base_price)%>"  style="width:100%">
                    </div>    
                </td>
                <td align="center">
                     <select name="base_bill_cycle">
                        <option value=""></option>
                ...
                <td align="center">
                     <select name="overage_bill_cycle">
                        <option value=""></option>
                        <% for (int i = 0; i < billCycleList.size(); i++) {
                                String bill_cycle_lov = (String) billCycleList.get(i);
                        %>
            ...
            <tr id="itt_tbl_first">
                ...
                <th align="center">Hard Counter Name</td>
            ...
            <tr >
                ...
                <td align="center"><%=CanonE580ITTWorkbenchUtil.nonNullify(pd.getHardMeterCounter())%></td>
                <td align="center">
                    <div>
                        <input name="overage_rate"  class="rate" type="text" value ="<%=CanonE580ITTWorkbenchUtil.formatBigDecimal3(overage_rate)%>" style="width:100%">
                    </div>    
                </td>
                <td align="center">
                    <div>
                       <input type="text" name="copy_inclusion" class="autoInteger" value ="<%=CanonE580ITTWorkbenchUtil.formatBigDecimal2(copy_inclusion)%>" style="width:100%">
                    </div>    
                </td>
                <td align="center">
                    <div>
                        <input type="text" name="multiplier" class="autoMultiplier"  value ="<%=CanonE580ITTWorkbenchUtil.formatBigDecimal2(multiplier)%>" style="width:100%">
                    </div>    
                </td>
                <td align="center"></td>
                <td align="center"></td>
