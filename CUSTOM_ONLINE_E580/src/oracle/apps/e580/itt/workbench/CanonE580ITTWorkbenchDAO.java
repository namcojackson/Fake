...
public class CanonE580ITTWorkbenchDAO {
    ...
    public static final String ITT_SVC_MTR_PKG_LOV= "{call CANON_E580_ITT_UTIL_PKG.ITT_SVC_MTR_PKG_LOV(?,?)}";
    public static final String ITT_METER_TYPE_DTLS= "{call CANON_E580_ITT_UTIL_PKG.ITT_METER_TYPE_DTLS(?,?,?,?)}";
    ...
    */
    public static class LineDetailItem {
       ...
       private String productSourcedBy;
        ...
        public String toString() {
            return "LineDetailItem{" + "rowNum="+rowNum+", lineId="+lineId+", merchandise="+merchandise+", ittNumber="+ittNumber+", lineNumber="+lineNumber+", soLineType="+soLineType+", ittStatus="+ittStatus+", item="+item+", itemDescription="+itemDescription+", orderedQuantity="+orderedQuantity+", itemPurchasePrice="+itemPurchasePrice+", finderFee="+finderFee+", installCredit="+installCredit+", lineStatusCode="+lineStatusCode+", deliveryScheduledDate="+deliveryScheduledDate+", reasonCode="+reasonCode+", serialNumber="+serialNumber+", lotNumber="+lotNumber+", cusaPoNumber="+cusaPoNumber+", ittLineType="+ittLineType+", productSourcedBy="+productSourcedBy+'}';
        }
    }
    ...
    */
    public static class PricingDetail {
       ...
       private String svcMeterPkg;
       private String hardMeterCounter;
        ...
        public PricingDetail(BigDecimal rowNum, 
            ...
            this.svcMeterPkg=svcMeterPkg;
            this.hardMeterCounter=hardMeterCounter;
        ...
        public String getSvcMeterPkg() {
			return svcMeterPkg;
		}
		public void setSvcMeterPkg(String svcMeterPkg) {
			this.svcMeterPkg = svcMeterPkg;
		}
		public String getHardMeterCounter() {
			return hardMeterCounter;
		}
		public void setHardMeterCounter(String hardMeterCounter) {
			this.hardMeterCounter = hardMeterCounter;
		}
		public static CanonE580RowMapper getRowMapper(){
            return new CanonE580RowMapper() {
                public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                    return new PricingDetail(
                        ...
                        rs.getString("SVC_METER_PKG"),
                        rs.getString("HARD_METER_COUNTER")
                    );
                }
            };
        }
		public String toString() {
			return "PricingDetail [rowNum=" + rowNum + ", equipModel=" + equipModel + ", quantity=" + quantity
					+ ", contractType=" + contractType + ", meterType=" + meterType + ", overageRate=" + overageRate
					+ ", planType=" + planType + ", term=" + term + ", basePrice=" + basePrice + ", baseBillCycle="
					+ baseBillCycle + ", overageBillCycle=" + overageBillCycle + ", copyInclusion=" + copyInclusion
					+ ", multiplier=" + multiplier + ", svcMeterPkg=" + svcMeterPkg + ", hardMeterCounter="
					+ hardMeterCounter + "]";
		}
    }
   ...
   public static Object[] ittUpdatePricing(String p_itt_number,
    ...
    BigDecimal p_multiplier){
        System.out.println("in ittUpdatePricing "+p_itt_number+"|"+p_user_name+"|"+p_equip_model+"|"+p_meter_type+"|"+p_contract_type+"|"+p_overage_rate+"|"+p_plan_type+"|"+p_term+"|"+p_base_price+"|"+p_base_bill_cycle+"|"+p_overage_bill_cycle+"|"+p_copy_inclusion+"|"+p_multiplier);
        CallableStatement statement = null;
        Connection connection = null;
        try {
            connection = TransactionScope.getConnection();
    ...
    */
    public static class PDFMaintInfo {
       ...
       private String lob;
		...
		public String toString() {
			return "PDFMaintInfo [equipModel=" + equipModel + ", meterType=" + meterType + ", quantity=" + quantity
					+ ", basePrice=" + basePrice + ", copyInclusion=" + copyInclusion + ", overageRate=" + overageRate
					+ ", term=" + term + ", baseBillCycle=" + baseBillCycle + ", overageBillCycle=" + overageBillCycle
					+ ", contractType=" + contractType + ", multiplier=" + multiplier + ", lob=" + lob + "]";
		}
   ...
   */
   ...
   public static Object[] ittSvcMtrPkgLov(String p_model_name){
       System.out.println("in ittSvcMtrPkgLov " +p_model_name);
       CallableStatement statement = null;
       Connection connection = null;
       try {
           connection = TransactionScope.getConnection();
           if (connection != null) {
               statement = (CallableStatement) connection.prepareCall(ITT_SVC_MTR_PKG_LOV);
               if (statement != null) {
                   statement.setObject(1, p_model_name, OracleTypes.VARCHAR);
                   statement.registerOutParameter(2, OracleTypes.CURSOR);
                   statement.execute();
                   return new Object[]{cursorToList((ResultSet)statement.getObject(2),stringRowMapper())};
               } else {
   ...
   public static Object[] ittMeterTypeDtls(String p_itt_number,
		    String p_order_number,
		    String p_model_name,
		    String p_svc_pkg_name){
		        System.out.println("in ittMeterTypeDtls "+p_itt_number+"|"+p_order_number+"|"+p_model_name+"|"+p_svc_pkg_name);
		        CallableStatement statement = null;
		        Connection connection = null;
		        try {
		            connection = TransactionScope.getConnection();
		            if (connection != null) {
		                statement = (CallableStatement) connection.prepareCall(ITT_METER_TYPE_DTLS);
		                if (statement != null) {
		                    statement.setObject(1, p_itt_number, OracleTypes.VARCHAR);
		                    statement.setObject(2, p_order_number, OracleTypes.VARCHAR);
		                    statement.setObject(3, p_model_name, OracleTypes.VARCHAR);
		                    statement.setObject(4, p_svc_pkg_name, OracleTypes.VARCHAR);
