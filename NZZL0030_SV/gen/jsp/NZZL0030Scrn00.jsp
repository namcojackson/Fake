...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NZZL0030Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Item Creation Workbench launcher Screen">

<%@include file="../common/common.jsp" %>
<%
    //EXTNE307T010
    String functionID = ((business.servlet.NZZL0030.NZZL0030Bean)databean).getXxScrEventNm();
%>
			<center>
									...
									<tr>
										<td height="28px" width="1070px" valign="bottom">
											<table class="pTab_UPPER_ON" border="0" cellpadding="0" cellspacing="0" >
												<tr title="Item Creation Workbench">
													<td align="center" class="same">Item Creation Workbench</td>
												</tr>
...
<% if (functionID != null && !"".equals(functionID)) {%>
		                                    <a href="<%=getCustomAppURL(functionID)%>" target="ItemMasterWorkbench" onclick="f_open_window_max(this.href, 'ItemMasterWorkbench')"><font size="7">Item Creation Workbench</font></a>
<% } else { %>
                                            <font size="7">Item Creation Workbench</font>
<% } %>
                                        </td>
                                    </tr>
                                </table>
