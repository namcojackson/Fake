...
import static business.servlet.NZZL0030.constant.NZZL0030Constant.*;
import business.servlet.NZZL0030.NZZL0030BMsg;
...
/** 
 *<pre>
 * Business ID : NZZL0030 Item Creation Workbench launcher Screen
 *</pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NZZL0030_INIT extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NZZL0030BMsg scrnMsg = (NZZL0030BMsg) bMsg;
        ...
        boolean authTarget = getUserProfileService().isFunctionGranted(user, ITEM_CREATION_WB_FUNCTION_ID);
        if (authScreen && authTarget) {
	        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, ITEM_CREATION_WB_FUNCTION_ID);
        } else {
