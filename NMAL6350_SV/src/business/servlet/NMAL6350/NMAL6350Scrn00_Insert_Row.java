...
public class NMAL6350Scrn00_Insert_Row extends S21CommonHandler implements NMAL6350Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(scrnMsg.A.getValidCount() - 1).pkgUomCd_A1);
	}
