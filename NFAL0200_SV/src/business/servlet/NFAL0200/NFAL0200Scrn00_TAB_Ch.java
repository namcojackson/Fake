 ...
 * ----------------------------------------------------------------------
 * 2016/03/02   CSAI            K.Uramori       Create          N/A
 *</pre>
 */
public class NFAL0200Scrn00_TAB_Ch extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (NFAL0200CommonLogic.isNeedSearch(scrnMsg, NFAL0200Constant.CH_TAB)) {
