...
public class CanonE404SFReqRsltRec implements java.sql.SQLData, java.io.Serializable {
        ...
        public CanonE404SFReqRsltRec() {
        }

        public CanonE404SFReqRsltRec(String status,
                String sfdcid,
                String message,
                String instanceid,
                String jobId) {
        ...
        public String getSQLTypeName() throws SQLException {
            return "CANON_E404_SF_REQ_RSLT_REC";
        }
        ...
        public static oracle.sql.ARRAY canonE404SFReqRsltTblListToArray(List<CanonE404SFReqRsltRec> list, Connection connection) throws SQLException {
        ...
        public String toString() {
            return "CanonE404SFReqRsltRec{" + "status=" + status + ", sfdcid=" + sfdcid + ", message=" + message + ", instanceid=" + instanceid + ", jobId=" + jobId +'}';
        }
    }
