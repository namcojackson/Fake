 ...
 * Date: Jul 8, 2009
 */
package business.servlet.ZZSL1110.constant;

/**
 * The Interface ZZSL1110Constant.
 * @author $Author: Satheesh Sangaraju $
 * @version $Revision: 1.1 $ $Date: 2009/07/08 18:36:24 $
 */
public interface ZZSL1110Constant {
    ...
    /** The Constant BTN_PREV. */
    public static final String[] BTN_PREV = {"Prev", "Prev", "Prev" };

    /** The Constant BTN_NEXT. */
    public static final String[] BTN_NEXT = {"Next", "Next", "Next" };

    /** The Constant BTN_VIEW. */
    public static final String[] BTN_VIEW = {"View", "View", "View" };
    
    /** The Constant BTN_MODIFY. */
    public static final String[] BTN_MODIFY = {"Modify", "Modify", "Modify" };
    /**
