 ...
 *</pre>
 */
public class NSAL0810Scrn00_OpenWin_LeaseCustNum extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_SE, SELECT_POPUP_LEASE);
        Object[] params = new Object[PARAM_LENGTH_NMAL6760];
        int index = getButtonSelectNumber();
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_15, scrnMsg.A.no(index).leaseCmpyCd_A);
