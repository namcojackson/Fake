 ...
 */
package business.servlet.NSAL0810.constant;
 ...
 *</pre>
 */
public final class NSAL0810Constant {
    ...
    /** Reference authority */
    public static final String AUTH_REFERENCE = "NSAL0810T010";

    /** Update authority */
    public static final String AUTH_UPDATE = "NSAL0810T020";
    ...
    /** mode (After upload) */
    public static final String MODE_AFTER_UPLOAD = "03";
...
//    public static final int CUR_LOC_NUM_LENGTH = 30;
    ...
    // START 2016/06/24 [QC#10826, ADD]
    /** Got an error while validation data. Please correct it and try again. */
    public static final String NSAM0541E = "NSAM0541E";
    // END   2016/06/24 [QC#10826, ADD]

    // START 2016/05/20 [QC#4061, MOD]
    /** file extension */
    public static final String[] FILE_EXTENSION = {"csv", "txt", "xls", "xlsx"};
    // END   2016/05/20 [QC#4061, MOD]
    /** select popup : Cust Account */
    public static final String SELECT_POPUP_CUST = "C";

    /** select popup : Bill To Cust */
    public static final String SELECT_POPUP_BILL = "B";

    /** select popup : Lease Cust */
    public static final String SELECT_POPUP_LEASE = "L";

    /** PARAM_LENGTH_NMAL6760 */
    public static final int PARAM_LENGTH_NMAL6760 = 24;

    /** PARAM_LENGTH_NMAL6770 */
    public static final int PARAM_LENGTH_NMAL6770 = 18;
    ...
    // START 2016/06/24 [QC#10826, DEL]
    ///** MESSAGE_ID_LENGTH */
    //public static final int MESSAGE_ID_LENGTH = 9;
    // END   2016/06/24 [QC#10826, DEL]

    /** Screen ID */
    public static final String SCREEN_ID = "NSAL0810Scrn00";
