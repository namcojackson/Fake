...
public class NWZC150001CpouLocalDataCacheBase {

    protected String createCacheKey(NWZC150001CpouFindCondition findCondition) {
    ...
    private EZDTMsg createRequestTMsg(EZDTMsg reqTMsg, NWZC150001CpouFindCondition findCondition) {
    ...
    protected EZDTMsgArray getTMsgArray(Class tMsgClass, NWZC150001CpouFindCondition findCondition, S21LRUMap<String, EZDTMsgArray> cacheMap) {
    ...
    protected EZDTMsgArray getTMsgArrayForUpdate(Class tMsgClass, NWZC150001CpouFindCondition findCondition, S21LRUMap<String, EZDTMsgArray> cacheMap) {
