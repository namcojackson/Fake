/***********************************************************************
*  FileName : CanonE618AssetsConcProg.java
*
...
public class CanonE618AssetsConcProg {

	public static final String ASSETS_EXTRACT= "{call CANON_E618_ASSETS_STG_PKG.MAIN(?,?,?,?)}";



    public  void assetsExtract(String p_date_from, String p_date_to){
        System.out.println("in Asset extract "+p_date_from+"|"+p_date_to);
        ...
        try {
            ...
            if (connection != null) {
                ...
                statement = (CallableStatement) connection.prepareCall(ASSETS_EXTRACT);
                if (statement != null) {
    ...
    public static void main(String args[]) throws Exception {
    	...
    	CanonE618AssetsConcProg CanonE618AssetsConcProg=new CanonE618AssetsConcProg();
    	CanonE618AssetsConcProg.assetsExtract(fromDate, toDate);

    	System.out.println("CanonE618AssetsConcProg called:");
