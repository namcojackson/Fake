 ...
 *</pre>
 */
public class NSAL1140Scrn00_CMN_Submit extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.svcSplyContrStsCd_1V);
        scrnMsg.addCheckItem(scrnMsg.xxChkBox_F);
        scrnMsg.addCheckItem(scrnMsg.ovwrtAbuseFlg_2V);
        scrnMsg.addCheckItem(scrnMsg.psnCd_1V);
        scrnMsg.addCheckItem(scrnMsg.abuseOvwrtRsnCd_1V);
        scrnMsg.addCheckItem(scrnMsg.svcSplyExprDt);
        scrnMsg.addCheckItem(scrnMsg.abuseVarPct);
        scrnMsg.addCheckItem(scrnMsg.abuseActCd_1V);
        scrnMsg.addCheckItem(scrnMsg.abuseActCmntTxt);
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        bizMsg.setFunctionCode(FUNCTION_UPDATE);
