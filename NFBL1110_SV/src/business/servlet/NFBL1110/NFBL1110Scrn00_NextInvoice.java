 ...
 */
public class NFBL1110Scrn00_NextInvoice extends S21CommonHandler implements NFBL1110Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
            ...
            if (ZYPConstant.FLG_OFF_N.equals(scrnMsg.A.no(i).xxGrpFlg_A1.getValue())) {
                // Mod End 2016/08/22 QC#12830
                if (scrnMsg.A.no(i).startDt_A1.getValue().compareTo(scrnMsg.A.no(i).endDt_A1.getValue()) > 0) {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        this.setButtonEnabled(BTN_NORMAL_PREV_INVOICE, true); // [Prev] Button
