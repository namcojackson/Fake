 ...
 * </pre>
 */
public class NFBL1110Scrn00_UnselectAll extends S21CommonHandler implements NFBL1110Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.A.no(i).xxChkBox_A1, ZYPConstant.FLG_OFF_N);
        }
