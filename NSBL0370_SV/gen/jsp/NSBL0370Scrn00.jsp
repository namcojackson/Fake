...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NSBL0370Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Hourly Level Report">
<center>
					...
					<ul>
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="96%">
									<div>
										<li title="Group Level Report" class="pTab_ON"><a href="#">Hour Lvl Rpt</a></li>
									</div>
								</td>
							...
							<td>
								...
								<table border="0" cellpadding="0" cellspacing="0" width="1080" height="450" rules="none">
									<tr>
											...
											<div id="Right1TBL_Top" style="overflow-x:hidden; overflow-y:hidden; width:95; float:left;">
												<table border="1" cellpadding="1" cellspacing="0" style="table-layout: fixed;" id="" width="95">
													...
													<tr height="32" valign="middle">
														<ezf:row ezfHyo="B">
														<td class="pClothBs"><ezf:anchor name="orgDescTxt_B" ezfName="orgDescTxt_B" ezfHyo="B" ezfArrayNo="0" ezfEmulateBtn="1" ezfGuard="Link_HstryLvRpt2" otherAttr=" id=\"orgDescTxt_B#{EZF_ROW_NUMBER}\""><font color="#ffffff"><ezf:label name="orgDescTxt_B" ezfName="orgDescTxt_B" ezfHyo="B" ezfArrayNo="0" /></font></ezf:anchor></td>
														</ezf:row>
													</tr>
												</table>
											</div>
										...
										<td align="left" valign="top">
											<!-- Right TBL Top -->
											<div id="RightTBL_Top" style="overflow-x:hidden; overflow-y:hidden; width:820; float:left;" onScroll="synchroScrollLeft(this.id, new Array('RightTBL'));">
												<table border="1" cellpadding="1" cellspacing="0" style="table-layout: fixed;" id="" width="100">
													...
													<tr height="32" valign="middle">
														<ezf:row ezfHyo="A">
														<td class="pClothBs"><ezf:anchor name="orgDescTxt_A" ezfName="orgDescTxt_A" ezfHyo="A" ezfArrayNo="0" ezfEmulateBtn="1" ezfGuard="Link_HstryLvRpt" otherAttr=" id=\"orgDescTxt_A#{EZF_ROW_NUMBER}\""><font color="#ffffff"><ezf:label name="xxDtTm_A3" ezfName="xxDtTm_A3" ezfHyo="A" ezfArrayNo="0" /></font></ezf:anchor></td>
														</ezf:row>
														<ezf:skip>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">09:00AM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">10:00AM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">11:00AM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">00:00PM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">01:00PM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">02:00PM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">03:00PM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">04:00PM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">05:00PM</a></td>
														<td class="pClothBs"><a href="#" class="stab" name="orgDescTxt" onclick="sendServer('OpenWin_Branch')">06:00PM</a></td>
														</ezf:skip>
													</tr>
												</table>
											</div>
