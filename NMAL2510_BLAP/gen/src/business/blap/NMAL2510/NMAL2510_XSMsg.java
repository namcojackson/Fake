...
/*
 *NMAL2510_XSMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL2510_XSMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** TOC_CD_X1*/
	public final EZDSStringItem              tocCd_X1;
    ...
    /** TOC_CD_X2*/
	public final EZDSStringItem              tocCd_X2;

    /** ORG_CHNG_RQST_PK_X2*/
	public final EZDSBigDecimalItem              orgChngRqstPk_X2;
    ...
    /** TOC_CD_X3*/
	public final EZDSStringItem              tocCd_X3;

    /** PSN_CD_X3*/
	public final EZDSStringItem              psnCd_X3;

    /** EFF_FROM_DT_X3*/
	public final EZDSDateItem              effFromDt_X3;
	...
	/**
	 * NMAL2510_XSMsg is constructor.
	 * The initialization when the instance of NMAL2510_XSMsg is generated.
	 */
	public NMAL2510_XSMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL2510_XSMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		orgStruTpCd_X1 = (EZDSStringItem)newItem("orgStruTpCd_X1");
		tocCd_X1 = (EZDSStringItem)newItem("tocCd_X1");
		...
		tocCd_X2 = (EZDSStringItem)newItem("tocCd_X2");
		orgChngRqstPk_X2 = (EZDSBigDecimalItem)newItem("orgChngRqstPk_X2");
		ezUpTime_X2 = (EZDSStringItem)newItem("ezUpTime_X2");
		ezUpTimeZone_X2 = (EZDSStringItem)newItem("ezUpTimeZone_X2");
		tocCd_X3 = (EZDSStringItem)newItem("tocCd_X3");
		psnCd_X3 = (EZDSStringItem)newItem("psnCd_X3");
		effFromDt_X3 = (EZDSDateItem)newItem("effFromDt_X3");
	 ...
	 * @return NMAL2510_XSMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL2510_XSMsgArray();
	}
