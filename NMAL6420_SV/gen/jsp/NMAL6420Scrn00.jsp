...
<fmt:setBundle basename="I18N_NMAL6420Scrn00" var="I18N_SCREEN_ID" scope="request" />
...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="<fmt:message key="i18n.NMAL6420Scrn00.title" bundle="${I18N_SCREEN_ID}">Location Role Type Maintenance</fmt:message>">
														...
														<div id="topTBL" style="overflow-x:hidden; width:983; overflow-y:none; height:19;">
															<table border="1" cellpadding="1" cellspacing="0" align="center">
																...
																<tr>
																	...
																	<td class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'locRoleTpSortNum_A1' )"><fmt:message key="i18n.NMAL6420Scrn00.label.1" bundle="${I18N_SCREEN_ID}">Sort<br>Num</fmt:message><img id="sortIMG.locRoleTpSortNum_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																	<td class="pClothBs"><a href="#" class="pSortCol" onclick="columnSort( 'A', 'locRoleTpCd_A1' )"><fmt:message key="i18n.NMAL6420Scrn00.label.2" bundle="${I18N_SCREEN_ID}">Code</fmt:message><img id="sortIMG.locRoleTpCd_A1" border="0" src="./img/tableSort/asc.gif" style="{visibility:hidden}"></a></td>
																	<td class="pClothBs"><fmt:message key="i18n.NMAL6420Scrn00.label.3" bundle="${I18N_SCREEN_ID}">Name</fmt:message></td>
																	<td class="pClothBs"><fmt:message key="i18n.NMAL6420Scrn00.label.4" bundle="${I18N_SCREEN_ID}">Description Text</fmt:message></td>
																	<td class="pClothBs"><fmt:message key="i18n.NMAL6420Scrn00.label.5" bundle="${I18N_SCREEN_ID}">Account Code Flag</fmt:message></td>
																	<td class="pClothBs"><fmt:message key="i18n.NMAL6420Scrn00.label.6" bundle="${I18N_SCREEN_ID}">Location Group Flag</fmt:message></td>
																</tr>
															</table>
														</div>
														<%-- ### TOP TABLE E ### --%>
																...
																<tr height="28" class="pEvenNumberBGcolor">
																	...
																	<td>
																		<ezf:select name="acctCdFlg_A1" ezfName="acctCdFlg_A1" ezfHyo="A" ezfArrayNo="0" >
																			<ezf:option value="Y" ><fmt:message key="i18n.NMAL6420Scrn00.option.1" bundle="${I18N_SCREEN_ID}">Y</fmt:message></ezf:option>
																			<ezf:option value="N" ><fmt:message key="i18n.NMAL6420Scrn00.option.2" bundle="${I18N_SCREEN_ID}">N</fmt:message></ezf:option>
																		</ezf:select>
																	</td>
																	<td>
																...
																<tr height="28">
																	...
																	<td>
																		<select class="pHsu" name="cstmReqFlg_A1" ezfname="cstmReqFlg_A1" ezfhyo="A">
																			<option value="Y"><fmt:message key="i18n.NMAL6420Scrn00.option.1" bundle="${I18N_SCREEN_ID}">Y</fmt:message></option>
																			<option value="N"><fmt:message key="i18n.NMAL6420Scrn00.option.2" bundle="${I18N_SCREEN_ID}">N</fmt:message></option>
																		</select>
																	</td>
																	<td>
