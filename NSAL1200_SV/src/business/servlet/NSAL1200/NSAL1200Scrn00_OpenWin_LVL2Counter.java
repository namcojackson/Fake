 ...
 *</pre>
 */
public class NSAL1200Scrn00_OpenWin_LVL2Counter extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        String bllgMtrLbCd = scrnMsg.A.no(rowIndex).bllgMtrLbCd_L2.getValue();
        String mtrLbDescTxt = scrnMsg.A.no(rowIndex).mtrLbDescTxt_L2.getValue();
