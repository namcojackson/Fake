 ...
 *</pre>
 */
public class NSAL1200Scrn00_OpenWin_LVL1Counter extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        String bllgMtrLbCd = scrnMsg.A.no(rowIndex).bllgMtrLbCd_L1.getValue();
        String mtrLbDescTxt = scrnMsg.A.no(rowIndex).mtrLbDescTxt_L1.getValue();
