 ...
 *</pre>
 */
public class NSAL1200Scrn00_OpenWin_FLTCounter extends S21CommonHandler {
...
//        String mtrLbCd = scrnMsg.A.no(rowIndex).fleetMtrLbCd_A.getValue();
//        String mtrLbDescTxt = scrnMsg.A.no(rowIndex).mtrLbDescTxt_FL.getValue();
//        setArgForSubScreen(NSAL1200CommonLogic.createMtrLbListPopupParameter(scrnMsg, MTR_LB_TP.REGULAR_METER, MTR_IDX.FLEET, mtrLbCd, mtrLbDescTxt));
