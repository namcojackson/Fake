 ...
 * ----------------------------------------------------------------------
 * 09/14/2016   Fujitsu         T.Ishii         Create          N/A
 * 09/30/2016   SRAA            K.Aratani       Update          S21_NA#14929
 * </pre>
 */
public final class NWXC412001SomWebService {
    ...
    private enum MESSAGE_ID {
        ...
        /**
         * SOM web service has ended abnormally.
         */
        NWAM4120E,
    ...
    public static String review(String ordSrcRefNum, String userId, String note) {
        ...
        return updateSomStatus(ordSrcRefNum, REVIEW, userId, note);
    }
    ...
    public static String reject(String ordSrcRefNum, String userId, String note) {
        ...
        return updateSomStatus(ordSrcRefNum, REJECT, userId, note);
    }
    ...
    public static String approve(String ordSrcRefNum, String userId, String note) {
        ...
        return updateSomStatus(ordSrcRefNum, APPROVE, userId, note);
    }
    ...
    public static String orderCreated(String ordSrcRefNum, String cpoOrdNum, String userId, String note) {
        ...
        try {
            ...
            if (userProfSvc != null) {
                if (S21StringUtil.isEquals(ZYPCodeDataUtil.getVarCharConstValue("SKIP_SOM_WEB_SERVICE", userProfSvc.getGlobalCompanyCode()), ZYPConstant.FLG_ON_Y)) {
    ...
    private static String updateSomStatus(String ordSrcRefNum, int statusId, String userId, String note) {
