 ...
 *</pre>
 */
public class NFBL2080Scrn00_Click_Cancel extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!NFBL2080CommonLogic.checkDetailVndInvProcStsCd(scrnMsg, "Cancel", VND_INV_PROC_STS.ERROR, "Error")){
            throw new EZDFieldErrorException();
        }
