...
/*
 *NSBL0310_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSBL0310_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** SVC_MGR_PSN_CD_A*/
	public final EZDSStringItem              svcMgrPsnCd_A;

    /** PSN_FIRST_NM_A*/
	public final EZDSStringItem              psnFirstNm_A;
	...
	public final EZDSBigDecimalItem              prevOpenTaskCnt_A;

    /** INPROC_TASK_CNT_A*/
	public final EZDSBigDecimalItem              inprocTaskCnt_A;

    /** CLO_TASK_CNT_A*/
	public final EZDSBigDecimalItem              cloTaskCnt_A;

    /** CANC_TASK_CNT_A*/
	public final EZDSBigDecimalItem              cancTaskCnt_A;

    /** REJ_TASK_CNT_A*/
	public final EZDSBigDecimalItem              rejTaskCnt_A;

    /** SVC_RSP_TM_NUM_A*/
	public final EZDSBigDecimalItem              svcRspTmNum_A;

    /** XX_RCV_TM_A*/
	public final EZDSStringItem              xxRcvTm_A;

    /** TO_BE_OPTM_TASK_CNT_A*/
	public final EZDSBigDecimalItem              toBeOptmTaskCnt_A;

    /** SCHD_TASK_CNT_A*/
	public final EZDSBigDecimalItem              schdTaskCnt_A;

    /** ASG_TASK_CNT_A*/
	public final EZDSBigDecimalItem              asgTaskCnt_A;

    /** OPEN_TASK_CNT_A*/
	public final EZDSBigDecimalItem              openTaskCnt_A;

    /** HLD_TASK_CNT_A*/
	public final EZDSBigDecimalItem              hldTaskCnt_A;

    /** ESCL_TASK_CNT_A*/
	public final EZDSBigDecimalItem              esclTaskCnt_A;

    /** VIP_TASK_CNT_A*/
	public final EZDSBigDecimalItem              vipTaskCnt_A;

    /** ATTN_TASK_CNT_A*/
	public final EZDSBigDecimalItem              attnTaskCnt_A;
	...
	/**
	 * NSBL0310_ASMsg is constructor.
	 * The initialization when the instance of NSBL0310_ASMsg is generated.
	 */
	public NSBL0310_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSBL0310_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		svcMgrPsnCd_A = (EZDSStringItem)newItem("svcMgrPsnCd_A");
		psnFirstNm_A = (EZDSStringItem)newItem("psnFirstNm_A");
		psnLastNm_A = (EZDSStringItem)newItem("psnLastNm_A");
		mgrNm_A = (EZDSStringItem)newItem("mgrNm_A");
		prevOpenTaskCnt_A = (EZDSBigDecimalItem)newItem("prevOpenTaskCnt_A");
		inprocTaskCnt_A = (EZDSBigDecimalItem)newItem("inprocTaskCnt_A");
		cloTaskCnt_A = (EZDSBigDecimalItem)newItem("cloTaskCnt_A");
		cancTaskCnt_A = (EZDSBigDecimalItem)newItem("cancTaskCnt_A");
		rejTaskCnt_A = (EZDSBigDecimalItem)newItem("rejTaskCnt_A");
		svcRspTmNum_A = (EZDSBigDecimalItem)newItem("svcRspTmNum_A");
		xxRcvTm_A = (EZDSStringItem)newItem("xxRcvTm_A");
		toBeOptmTaskCnt_A = (EZDSBigDecimalItem)newItem("toBeOptmTaskCnt_A");
		schdTaskCnt_A = (EZDSBigDecimalItem)newItem("schdTaskCnt_A");
		asgTaskCnt_A = (EZDSBigDecimalItem)newItem("asgTaskCnt_A");
		openTaskCnt_A = (EZDSBigDecimalItem)newItem("openTaskCnt_A");
		hldTaskCnt_A = (EZDSBigDecimalItem)newItem("hldTaskCnt_A");
		esclTaskCnt_A = (EZDSBigDecimalItem)newItem("esclTaskCnt_A");
		vipTaskCnt_A = (EZDSBigDecimalItem)newItem("vipTaskCnt_A");
		attnTaskCnt_A = (EZDSBigDecimalItem)newItem("attnTaskCnt_A");
	 ...
	 * @return NSBL0310_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSBL0310_ASMsgArray();
	}
