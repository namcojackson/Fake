 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB086001;
...
import business.db.NSBI2260_01TMsg;
...
/**
 * <pre>
 * Web OMAL FMM Meter File Exceptions Batch
 * 
 * Date         Company         Name            Create/Update   Defect No
 * 
 * ----------------------------------------------------------------------
 * 2016/06/02   Hitachi         T.Mizuki        Create          N/A
 * </pre>
 */
public class NSBB086001 extends S21BatchMain {
    ...
    /** FSR_STS_CD : 95 */
    private static final String FSR_STS_CD = "95";

    /** ROWNUM: 1 */
    private static final int ROWNUM = 1;

    /** METER_IN_OUT_INDICATOR: I */
    private static final String METER_IN_OUT_INDICATOR = "I";

    /** UNIT_OF_MEASURE: 001 */
    private static final String UNIT_OF_MEASURE = "001";
    ...
    public static void main(String[] args) {
        new NSBB086001().executeBatch(NSBB086001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2260_01TMsg> inTMsgList = new ArrayList<NSBI2260_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2260_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2260_01TMsg> inMsgLst) {
        NSBI2260_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2260_01TMsg[inMsgLst.size()];
    ...
    private Map<String, Object> setSearchCondition() {
        ...
        inParam.put("fsrStsCd", this.FSR_STS_CD);
        inParam.put("slsDt", this.salesDate);
        inParam.put("addMonth", this.WEB_OMAL_MONTH);
        inParam.put("meterInOutIndicator", this.METER_IN_OUT_INDICATOR);
        inParam.put("unitOfMeasure", this.UNIT_OF_MEASURE);
        inParam.put("rowNum", this.ROWNUM);
        return inParam;
    }

    private NSBI2260_01TMsg setCreateValue(ResultSet rs) {

        NSBI2260_01TMsg inParam = new NSBI2260_01TMsg();
