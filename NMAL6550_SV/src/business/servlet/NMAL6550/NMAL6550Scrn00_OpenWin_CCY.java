...
public class NMAL6550Scrn00_OpenWin_CCY extends S21CommonHandler implements NMAL6550Constant {
    ...
    private List<EZDBStringItem> createNMAL6050Parameters(NMAL6550BMsg scrnMsg, int line) {
        ...
        paramItem.setValue(new CCYTMsg().getTableName());
        param.add(paramItem);
        ...
        paramItem.setValue("Currency Search");
        param.add(paramItem);

        // [5]:HDR_CD_LB_NM
        paramItem = scrnMsg.xxHdrCdLbNm_PP;
        paramItem.setValue("Currency Code");
        param.add(paramItem);

        // [6]:HDR_NM_LB_NM
        paramItem = scrnMsg.xxHdrNmLbNm_PP;
        paramItem.setValue("Currency Name");
        param.add(paramItem);
        ...
        paramItem.setValue(scrnMsg.A.no(line).stdCcyCd_A1.getValue());
        param.add(paramItem);
