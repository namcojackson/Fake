...
public class NMAL6550Scrn00_OpenWin_CTRY extends S21CommonHandler implements NMAL6550Constant {
    ...
    private List<EZDBStringItem> createNMAL6050Parameters(NMAL6550BMsg scrnMsg, int line) {
        ...
        paramItem.setValue(new CTRYTMsg().getTableName());
        param.add(paramItem);
        ...
        paramItem.setValue("Country Search");
        param.add(paramItem);

        // [5]:HDR_CD_LB_NM
        paramItem = scrnMsg.xxHdrCdLbNm_PP;
        paramItem.setValue("Country Code");
        param.add(paramItem);

        // [6]:HDR_NM_LB_NM
        paramItem = scrnMsg.xxHdrNmLbNm_PP;
        paramItem.setValue("Country Name");
        param.add(paramItem);
        ...
        paramItem.setValue(scrnMsg.A.no(line).ctryCd_A1.getValue());
        param.add(paramItem);
