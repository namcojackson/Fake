...
public class NMAL6550Scrn00_Search_COA_AFFL extends S21CommonHandler implements NMAL6550Constant {
	...
	protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.A.no(eventOccuredLine).coaAfflCd_A1);
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.A.setCheckParam(new String[]{NMAL6550Bean.coaAfflCd_A1}, 1);
        scrnMsg.putErrorScreen();

        scrnMsg.setFocusItem(scrnMsg.A.no(0).coaAfflCd_A1);
        if ("E".equals(bizMsg.getMessageKind()) || ZYPCommonFunc.hasValue(scrnMsg.getMessageCode())) {
            return;
        }
        
        scrnMsg.setFocusItem(scrnMsg.A.no(scrnMsg.xxNum.getValueInt()).coaAfflCd_A1);
