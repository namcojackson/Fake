...
public class NWXL0010Scrn00_Search extends S21CommonHandler implements NWXL0010Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.rptSqlId);
        scrnMsg.addCheckItem(scrnMsg.rptSqlNm);
        scrnMsg.addCheckItem(scrnMsg.rptSqlDescTxt);
