...
public class NWXL0010Scrn01_CMN_Download extends S21CommonHandler implements NWXL0010Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        final String tempFilePath = scrnMsg.xxFileData.getTempFilePath();
        super.executeDownload(tempFilePath, true, ZYPCSVOutFile.getDialogFileName(tempFilePath));
    }
