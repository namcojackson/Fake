...
public class NWXL0010Scrn01_CMN_Submit extends S21CommonHandler implements NWXL0010Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.rptSqlNm_01);
        scrnMsg.addCheckItem(scrnMsg.rptSqlFuncId_01);
        scrnMsg.addCheckItem(scrnMsg.rptSqlDataTmgTxt_01);
        scrnMsg.addCheckItem(scrnMsg.rptSqlReqPsnCd_01);
        scrnMsg.addCheckItem(scrnMsg.rptSqlReqDt_01);
        scrnMsg.addCheckItem(scrnMsg.rptSqlRgtnPsnCd_01);
        scrnMsg.addCheckItem(scrnMsg.rptSqlRgtnDt_01);
        scrnMsg.addCheckItem(scrnMsg.rptSqlDescTxt_01);
        scrnMsg.addCheckItem(scrnMsg.xxRptSqlTxt_01);
