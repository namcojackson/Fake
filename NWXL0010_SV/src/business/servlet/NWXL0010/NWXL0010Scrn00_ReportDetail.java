...
public class NWXL0010Scrn00_ReportDetail extends S21CommonHandler implements NWXL0010Constant {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        // event line.
        scrnMsg.rptSqlId_01.setValue(scrnMsg.A.no(getButtonSelectNumber()).rptSqlId_A.getValue());

        // set 'Screen Event Name'.
        scrnMsg.xxScrEventNm.setValue(this.getClass().getSimpleName());
