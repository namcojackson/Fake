 ...
 *</pre>
 */
public class NSAL0990Scrn00_OpenWin_ShipTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int i = 0;
        setValue(scrnMsg.xxPopPrm_P0, scrnMsg.curLocAcctNum);
        ...
        // Ship To's Only
        setValue(scrnMsg.xxPopPrm_PC, NSAL0990Constant.DISP_HRCH_ACCT_CD_SHIP);
...
//        setValue(scrnMsg.xxPopPrm_PG, scrnMsg.curLocNum);
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.curLocAcctNum)) {
