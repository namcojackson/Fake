...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NZZL0050Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Special Billing Search launcher Screen">

<%@include file="../common/common.jsp" %>
<%
    //EXTNE307T010
    String functionID = ((business.servlet.NZZL0050.NZZL0050Bean)databean).getXxScrEventNm();
%>
			<center>
									...
									<tr>
										<td height="28px" width="1070px" valign="bottom">
											<table class="pTab_UPPER_ON" border="0" cellpadding="0" cellspacing="0" >
												<tr title="Special Billing Search">
													<td align="center" class="same">Special Billing Search</td>
												</tr>
...
<% if (functionID != null && !"".equals(functionID)) {%>
		                                    <a href="<%=getCustomAppURL(functionID)%>" target="SpecialBillingSearch" onclick="f_open_window_max(this.href, 'SpecialBillingSearch')"><font size="7">Special Billing Search</font></a>
<% } else { %>
                                            <font size="7">Special Billing Search</font>
<% } %>
                                        </td>
                                    </tr>
                                </table>
