 ...
 */
package business.servlet.NZZL0050.constant;
 ...
 * ----------------------------------------------------------------------
 * 02/16/2017   SRAA            K.Aratani       Create          N/A
 *</pre>
 */
public class NZZL0050Constant {
    /**
     * Business ID -- NZZL0050
     */
    public static final String BUSINESS_ID = "NZZL0050";

    /**
     * Screen Function ID -- NZZL0050T010
     */
    public static final String SCREEN_FUNCTION_ID = BUSINESS_ID + "T010";
     
    /**
     * Special Billing Search Function ID -- EXTNE479T010
     */
    public static final String SPECIAL_BILLING_SEARCH_FUNCTION_ID = "EXTNE479T010";
