 ...
 *</pre>
 */
public class NFDL0040Scrn00_OnClick_DisputeAdd extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NFDL0040BMsg scrnMsg = (NFDL0040BMsg) bMsg;
        scrnMsg.addCheckItem(scrnMsg.dealCltDsptAmt_BH);
        scrnMsg.addCheckItem(scrnMsg.cltDsptRsnCd_BH);
