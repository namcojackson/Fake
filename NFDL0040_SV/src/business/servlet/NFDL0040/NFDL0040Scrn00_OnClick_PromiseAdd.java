 ...
 *</pre>
 */
public class NFDL0040Scrn00_OnClick_PromiseAdd extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NFDL0040BMsg scrnMsg = (NFDL0040BMsg) bMsg;
        // START 2017/01/16 H.Ikeda [QC#16810,ADD]
        NFDL0040CommonLogic.checkPromiseAddBtn(scrnMsg);
        // END   2017/01/16 H.Ikeda [QC#16810,ADD]
        scrnMsg.addCheckItem(scrnMsg.dealCltPrmsAmt_AH);
        scrnMsg.addCheckItem(scrnMsg.cltPrmsDt_AH);
