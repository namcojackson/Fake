 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB066001;
...
import business.db.NSBI2060_01TMsg;
...
/**
 * <pre>
 * Web OMAL F7 Modifications File Batch
 * 
 ...
 * </pre>
 */
public class NSBB066001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB066001().executeBatch(NSBB066001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2060_01TMsg> inTMsgList = new ArrayList<NSBI2060_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2060_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2060_01TMsg> inMsgLst) {
        NSBI2060_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2060_01TMsg[inMsgLst.size()];
    ...
    private NSBI2060_01TMsg setCreateValue(ResultSet rs) {

        NSBI2060_01TMsg inParam = new NSBI2060_01TMsg();
