 ...
 * Function Name : Button Action to Assign Tab
 * </pre>
 * 
 *<pre>
 ...
 *</pre>
 */
public class NLBL3090Scrn00_TAB_Assign extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TAB_COORDINATION.equals(scrnMsg.xxDplyTab.getValue())) {
            scrnMsg.xxDplyTab.setValue(TAB_ASSIGN);
            if (ZYPCommonFunc.hasValue(scrnMsg.rtlWhCd_H1)) {
                scrnMsg.xxDplyTab_O.setValue(TAB_COORDINATION);
