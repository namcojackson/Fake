 ...
 *</pre>
 */
public class NLBL3090Scrn00_AddNewCoord extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TAB_ASSIGN.equals(scrnMsg.xxDplyTab.getValue())) {
            NLBL3090CommonLogic.chkSupervisorCheck(scrnMsg);
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if ((TAB_ASSIGN.equals(scrnMsg.xxDplyTab.getValue())) && ("E".equals(bizMsg.getMessageKind()))) {
            NLBL3090CommonLogic.addCheckHeader(scrnMsg);
