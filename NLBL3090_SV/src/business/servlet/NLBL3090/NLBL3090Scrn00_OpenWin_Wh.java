 ...
 *</pre>
 */
public class NLBL3090Scrn00_OpenWin_Wh extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxPopPrm_X.setValue("WH");

        NLBL3090CommonLogic.setInitParamForLocationPopup(scrnMsg);
        Object[] params = NLBL3090CommonLogic.setParamForLocationPopup(scrnMsg);
