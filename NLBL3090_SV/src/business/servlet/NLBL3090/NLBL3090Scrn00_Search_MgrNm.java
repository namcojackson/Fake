 ...
 *</pre>
 */
public class NLBL3090Scrn00_Search_MgrNm extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NLBL3090BMsg scrnMsg = (NLBL3090BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.mgrPsnCd_H1)) {
            scrnMsg.mgrPsnCd_H1.setErrorInfo(1, NLAM0001E);
            scrnMsg.fullPsnNm_HM.clear();
        }
