...
/**
 *<pre>
 * NSAL1320Scrn00_OnBlur_DeriveFromCustLocCd
 *
 ...
 *</pre>
 */
public class NSAL1320Scrn00_OnBlur_DeriveFromCustLocCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(selectIndex).soldToCustLocCd)) {
            ...
            scrnMsg.setFocusItem(scrnMsg.A.no(selectIndex).xxGenlFldAreaTxt_BI);
            return;
        }
