...
/**
 *<pre>
 * NSAL1320Scrn00_OnBlur_DeriveFromSvcPgmCd
 *
 ...
 *</pre>
 */
public class NSAL1320Scrn00_OnBlur_DeriveFromSvcPgmCd extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.A.no(selectIndex).svcPgmMdseCd)) {
            scrnMsg.addCheckItem(scrnMsg.A.no(selectIndex).svcPgmMdseCd);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int selectIndex = getButtonSelectNumber();
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(selectIndex).svcPgmMdseCd)) {
            scrnMsg.A.no(selectIndex).mdseDescShortTxt.clear();
            return;
        }
