...
/**
 *<pre>
 * NSAL1320Scrn00_OnChange_ContractType
 *
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2017/08/15   Hitachi         Y.Takeno        Create          QC#20378-2
 *</pre>
 */
public class NSAL1320Scrn00_OnChange_ContractType extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(ix).prcSvcContrTpCd);
