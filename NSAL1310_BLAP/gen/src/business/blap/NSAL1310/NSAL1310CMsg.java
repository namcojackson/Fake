...
/*
 *NSAL1310CMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL1310CMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	public final EZDCStringItem              svcCovTmplTpCd_SV;

    /** SVC_COV_TMPL_TP_CD_CD*/
	public final EZDCStringItemArray              svcCovTmplTpCd_CD;

    /** SVC_COV_TMPL_TP_DESC_TXT_SC*/
	public final EZDCStringItemArray              svcCovTmplTpDescTxt_SC;

    /** SVC_TERM_ATTRB_DESC_TXT_H*/
	public final EZDCStringItem              svcTermAttrbDescTxt_H;
    ...
    /** A*/
	public final business.blap.NSAL1310.NSAL1310_ACMsgArray              A;
	...
	/**
	 * NSAL1310CMsg is constructor.
	 * The initialization when the instance of NSAL1310CMsg is generated.
	 */
	public NSAL1310CMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL1310CMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		svcCovTmplTpCd_SV = (EZDCStringItem)newItem("svcCovTmplTpCd_SV");
		svcCovTmplTpCd_CD = (EZDCStringItemArray)newItemArray("svcCovTmplTpCd_CD");
		svcCovTmplTpDescTxt_SC = (EZDCStringItemArray)newItemArray("svcCovTmplTpDescTxt_SC");
		svcTermAttrbDescTxt_H = (EZDCStringItem)newItem("svcTermAttrbDescTxt_H");
		...
		A = (business.blap.NSAL1310.NSAL1310_ACMsgArray)newMsgArray("A");
	 ...
	 * @return NSAL1310CMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL1310CMsgArray();
	}
	...
	{"A", "A", null, "100", "business.blap.NSAL1310.NSAL1310_ACMsgArray", null, null},
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"SVC_COV_TMPL_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcCovTmplTpCd_SV
        {"SVC_COV_TMPL_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcCovTmplTpCd_CD
        {"SVC_COV_TMPL_TP_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcCovTmplTpDescTxt_SC
        {"SVC_TERM_ATTRB_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//svcTermAttrbDescTxt_H
