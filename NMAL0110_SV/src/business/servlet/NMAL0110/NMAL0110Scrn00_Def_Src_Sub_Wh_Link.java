 ...
 *</pre>
 */
public class NMAL0110Scrn00_Def_Src_Sub_Wh_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Def_Src_Sub_Wh_Link");
		//QC#10449
		String selectStr = NMAL0110CommonLogic.setSelectFromStr(scrnMsg, getGlobalCompanyCode(), ZYPDateUtil.getSalesDate());
		List<Object[]> whereList = NMAL0110CommonLogic.setWhereList(scrnMsg);
		List<Object[]> tblColumnList = NMAL0110CommonLogic.setTblColumnList(scrnMsg);
		List<Object[]> sortCondList = NMAL0110CommonLogic.setSortList(scrnMsg);
        params[0] = "O1";                   
