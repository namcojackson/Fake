 ...
 *</pre>
 */
public class NMAL0110Scrn00_Asm_Ctry_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(9).xxPopPrm.setValue(scrnMsg.asmInCtryCd_H1.getValue());
		scrnMsg.P.no(10).xxPopPrm.setValue(scrnMsg.ctryNm_AI.getValue());
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Asm_Ctry_Link");
