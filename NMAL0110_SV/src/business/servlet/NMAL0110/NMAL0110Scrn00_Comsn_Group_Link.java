 ...
 *</pre>
 */
public class NMAL0110Scrn00_Comsn_Group_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Comsn_Group_Link");
		String selectStr = NMAL0110CommonLogic.setSelectForCommisionGroup(scrnMsg, getGlobalCompanyCode());
		List<Object[]> whereList = NMAL0110CommonLogic.setWhereListForCommisionGroup(scrnMsg.dsCmsnGrpCd_H1.getValue(), scrnMsg.dsCmsnGrpDescTxt_H1.getValue());
		List<Object[]> tblColumnList = NMAL0110CommonLogic.setTblColumnListForCommisionGroup(scrnMsg);
		List<Object[]> sortCondList = NMAL0110CommonLogic.setSortListForCommisionGroup(scrnMsg);
        params[0] = "O1";                   
        params[1] = "Commision Group Search Popup";    //1.Screen Title
