 ...
 *</pre>
 */
public class NMAL0110Scrn00_Product_Line_Group_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Product_Line_Group_Link");
		String selectStr = NMAL0110CommonLogic.setSelectForZerothProdHerch(scrnMsg, getGlobalCompanyCode());
		List<Object[]> whereList = NMAL0110CommonLogic.setWhereListForZerothProdHerch(scrnMsg.zerothProdCtrlCd_H1.getValue(), scrnMsg.zerothProdCtrlNm_H1.getValue());
		List<Object[]> tblColumnList = NMAL0110CommonLogic.setTblColumnListForZerothProdHerch(scrnMsg);
		List<Object[]> sortCondList = NMAL0110CommonLogic.setSortListForZerothProdHerch(scrnMsg);
        params[0] = "O1";
