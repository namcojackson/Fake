 ...
 *</pre>
 */
public class NMAL0110Scrn00_DeleteRow_RELN_MDSE extends S21CommonHandler implements NMAL0110Constant {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NMAL0110BMsg scrnMsg = (NMAL0110BMsg) bMsg;
        List<Integer> selectedRows = ZYPTableUtil.getSelectedRows(scrnMsg.D, "xxChkBox_D1", ZYPConstant.FLG_ON_Y);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NMAL0110BMsg scrnMsg = (NMAL0110BMsg) bMsg;
        List<Integer> selectedRows = ZYPTableUtil.getSelectedRows(scrnMsg.D, "xxChkBox_D1", ZYPConstant.FLG_ON_Y);
        ZYPTableUtil.deleteRows(scrnMsg.D, selectedRows);
        // Button Control.
