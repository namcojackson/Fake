 ...
 *</pre>
 */
public class NMAL0110Scrn00_Bundle_Item_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(0).xxPopPrm.setValue(scrnMsg.bdlMaintMdseCd_H1.getValue());
		//scrnMsg.P.no(7).xxPopPrm.setValue(scrnMsg.mdseDescShortTxt_H1.getValue());
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Bundle_Item_Link");
