 ...
 *</pre>
 */
public class NMAL0110Scrn00_Save_Tmpl extends S21CommonHandler implements NMAL0110Constant {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NMAL0110BMsg scrnMsg = (NMAL0110BMsg) bMsg;
        System.out.println(scrnMsg.mdseCratTmplNm_BK.getValue());
        NMAL0110CommonLogic.checkInput_SaveTmpl(ctx, scrnMsg);
