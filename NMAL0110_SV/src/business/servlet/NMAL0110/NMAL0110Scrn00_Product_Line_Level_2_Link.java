 ...
 *</pre>
 */
public class NMAL0110Scrn00_Product_Line_Level_2_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Product_Line_Level_2_Link");
		String selectStr = NMAL0110CommonLogic.setSelectForScdProdHerch(scrnMsg, getGlobalCompanyCode());
		List<Object[]> whereList = NMAL0110CommonLogic.setWhereListForScdProdHerch(scrnMsg.scdProdCtrlCd_H1.getValue(), scrnMsg.scdProdCtrlNm_H1.getValue());
		List<Object[]> tblColumnList = NMAL0110CommonLogic.setTblColumnListForScdProdHerch(scrnMsg);
		List<Object[]> sortCondList = NMAL0110CommonLogic.setSortListForScdProdHerch(scrnMsg);
        params[0] = "O1";
        params[1] = "Product Level 3 Search Popup";    //1.Screen Title
