 ...
 *</pre>
 */
public class NMAL0110Scrn00_Sls_Mat_Group_Link_02 extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Sls_Mat_Group_Link_02");
		String selectStr = NMAL0110CommonLogic.setSelectForMaterialGroup(scrnMsg, getGlobalCompanyCode(), "2");
		List<Object[]> whereList = NMAL0110CommonLogic.setWhereListForMaterialGroup(scrnMsg.slsMatGrpCd_02.getValue(), scrnMsg.slsMatGrpDescTxt_02.getValue());
