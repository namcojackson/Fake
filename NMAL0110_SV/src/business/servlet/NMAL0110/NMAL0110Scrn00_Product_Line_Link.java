 ...
 *</pre>
 */
public class NMAL0110Scrn00_Product_Line_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Product_Line_Link");
		String selectStr = NMAL0110CommonLogic.setSelectForFirstProdHerch(scrnMsg, getGlobalCompanyCode());
		List<Object[]> whereList = NMAL0110CommonLogic.setWhereListForFirstProdHerch(scrnMsg.firstProdCtrlCd_H1.getValue(), scrnMsg.firstProdCtrlNm_H1.getValue());
		List<Object[]> tblColumnList = NMAL0110CommonLogic.setTblColumnListForFirstProdHerch(scrnMsg);
		List<Object[]> sortCondList = NMAL0110CommonLogic.setSortListForFirstProdHerch(scrnMsg);
        params[0] = "O1";
