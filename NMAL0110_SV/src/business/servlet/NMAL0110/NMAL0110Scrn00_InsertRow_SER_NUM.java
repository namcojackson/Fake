 ...
 *</pre>
 */
public class NMAL0110Scrn00_InsertRow_SER_NUM extends S21CommonHandler implements NMAL0110Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.A.no(row).fromSerNum_A1.clear();
        scrnMsg.A.no(row).thruSerNum_A1.clear();
        scrnMsg.A.no(row).lgSerNum_A1.clear();
        NMAL0110CommonLogic.changeActivation_Detail(this, getUserProfileService(), scrnMsg);
        // Button Control.
        NMAL0110CommonLogic.rowButtonControl(scrnMsg, this, TABLE_Serial_A);
        // Table Color
        NMAL0110CommonLogic.changeTableColorController(scrnMsg);
        // Focus.
        scrnMsg.setFocusItem(scrnMsg.A.no(row).fromSerNum_A1);
