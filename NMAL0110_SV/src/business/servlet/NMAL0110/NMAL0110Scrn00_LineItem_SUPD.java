 ...
 *</pre>
 */
public class NMAL0110Scrn00_LineItem_SUPD extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(0).xxPopPrm.setValue(scrnMsg.C.no(getButtonSelectNumber()).supdToMdseCd_C1.getValue());
		scrnMsg.P.no(7).xxPopPrm.setValue(scrnMsg.C.no(getButtonSelectNumber()).mdseDescShortTxt_C1.getValue());
//		scrnMsg.P.no(9).xxPopPrm.setValue("08");
//		scrnMsg.P.no(9).xxPopPrm.setValue("AL");
		scrnMsg.P.no(28).xxPopPrm.setValue(String.valueOf(getButtonSelectNumber()));
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_LineItem_SUPD");
