 ...
 *</pre>
 */
public class NMAL0110Scrn00_Accrual_Link extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(9).xxPopPrm.setValue(scrnMsg.acrlCoaAcctCd_H1.getValue());
		scrnMsg.P.no(10).xxPopPrm.setValue(scrnMsg.coaAcctNm_AC.getValue());
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_Accrual_Link");
