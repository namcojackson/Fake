 ...
 *</pre>
 */
public class NMAL0110Scrn00_LineItem_RELN_MDSE extends S21CommonHandler implements NMAL0110Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(0).xxPopPrm.setValue(scrnMsg.D.no(getButtonSelectNumber()).relnMdseCd_D1.getValue());
		scrnMsg.P.no(7).xxPopPrm.setValue(scrnMsg.D.no(getButtonSelectNumber()).mdseDescShortTxt_D1.getValue());
		scrnMsg.P.no(28).xxPopPrm.setValue(String.valueOf(getButtonSelectNumber()));
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL0110Scrn00_LineItem_RELN_MDSE");
