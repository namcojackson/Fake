 ...
 *</pre>
 */
public class NWAL1890Scrn00_OpenWin_LineStatus extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (LINE_CONFIG_MODE.equals(scrnMsg.xxModeCd.getValue())) {
            params = NWAL1890CommonLogic.getParamForLineStatus(scrnMsg, glblCmpyCd, cpoOrdNum);
        } else {
            params = NWAL1890CommonLogic.getParamForRMALineStatus(scrnMsg, glblCmpyCd, cpoOrdNum);
        }
