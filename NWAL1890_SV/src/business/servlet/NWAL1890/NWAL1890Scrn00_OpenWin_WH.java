 ...
 *</pre>
 */
public class NWAL1890Scrn00_OpenWin_WH extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (LINE_CONFIG_MODE.equals(scrnMsg.xxModeCd.getValue())) {
            params = NWAL1890CommonLogic.getParamForWarehouse(scrnMsg, glblCmpyCd, cpoOrdNum);
        } else {
            params = NWAL1890CommonLogic.getParamForRMAWarehouse(scrnMsg, glblCmpyCd, cpoOrdNum);
        }
