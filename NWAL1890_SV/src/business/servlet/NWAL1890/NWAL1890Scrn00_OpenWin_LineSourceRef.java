 ...
 *</pre>
 */
public class NWAL1890Scrn00_OpenWin_LineSourceRef extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (LINE_CONFIG_MODE.equals(scrnMsg.xxModeCd.getValue())) {
            params = NWAL1890CommonLogic.getParamForLineSourceRef(scrnMsg, glblCmpyCd, cpoOrdNum);
        } else {
            params = NWAL1890CommonLogic.getParamForRMALineSourceRef(scrnMsg, glblCmpyCd, cpoOrdNum);
        }
