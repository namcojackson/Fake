 ...
 *</pre>
 */
public class NWAL1890Scrn00_OpenWin_SubWH extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (LINE_CONFIG_MODE.equals(scrnMsg.xxModeCd.getValue())) {
            params = NWAL1890CommonLogic.getParamForSubWarehouse(scrnMsg, glblCmpyCd, cpoOrdNum);
        } else {
            params = NWAL1890CommonLogic.getParamForRMASubWarehouse(scrnMsg, glblCmpyCd, cpoOrdNum);
        }
