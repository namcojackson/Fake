 ...
 * Function Name : Open Window Manager Pop Up
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 01/11/2016   CITS            Keiichi Masaki  Create          N/A
 *</pre>
 */
public class NPAL1520Scrn00_OpenWin_Manager extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NPAL1520CommonLogic.setInitParamForManagerPopup(scrnMsg);

        // Making of sub screen delivery information
        Object[] params = NPAL1520CommonLogic.setParamForManagerPopup(scrnMsg);
