 ...
 *</pre>
 */
public class NSAL1390Scrn00_OpenWin_BranchLine extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(cellIdx).svcContrBrDescTxt_A)) {
            setResult(ZYPConstant.FLG_ON_Y);
            Object[] params = NSAL1390CommonLogic.getParamNWAL1130ForBranch(scrnMsg, scrnMsg.A.no(cellIdx).svcContrBrCd_A.getValue());
