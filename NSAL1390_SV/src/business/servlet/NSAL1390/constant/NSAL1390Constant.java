 ...
 */
package business.servlet.NSAL1390.constant;
 ...
 * ----------------------------------------------------------------------
 * 2017/08/15   Fujitsu         T.Murai         Create          S21_NA#8661(Sol#004)
 * 2017/12/01   Hitachi         T.Tomita        Create          QC#18362
 *</pre>
 */
public class NSAL1390Constant {

    /** Business ID */
    public static final String BUSINESS_ID = "NSAL1390";

    /** Screen ID */
    public static final String SCREEN_ID_00 = "NSAL1390Scrn00";

    // Mod Start 2017/12/03 QC#18362
    /** Function Inquiry */
    public static final String FUNC_ID_T010 = "NSAL1390T010";
    // Mod End 2017/12/03 QC#18362

    /** Function Edit */
    public static final String FUNC_ID_T020 = "NSAL1390T020";
    ...
    /** Button (OpenWin_RegionLine) */
    public static final String BTN_OPEN_REGION_LINE = "OpenWin_RegionLine";

    /** Button (OpenWin_BranchLine) */
    public static final String BTN_OPEN_BRANCH_LINE = "OpenWin_BranchLine";
