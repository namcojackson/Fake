 ...
 * Function Name : OnBlur_UnitPrice
 * OnChange_LineType
 ...
 *</pre>
 */
public class NPAL1280Scrn00_OnBlur_UnitPrice extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.A.no(lineNum).entDealNetUnitPrcAmt_A1) && ZYPCommonFunc.hasValue(scrnMsg.A.no(lineNum).prchReqDispQty_A1)) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.A.no(lineNum).entDealNetUnitPrcAmt_HD, scrnMsg.A.no(lineNum).entDealNetUnitPrcAmt_A1);
    }
}
