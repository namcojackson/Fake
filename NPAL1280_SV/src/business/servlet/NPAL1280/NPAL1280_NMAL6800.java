 ...
 *</pre>
 */
public class NPAL1280_NMAL6800 extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(bizMsg.A.no(lineIndex).mdseCd_A1, scrnMsg.xxPopPrm_P0);
        ZYPEZDItemValueSetter.setValue(bizMsg.A.no(lineIndex).mdseDescShortTxt_A1, scrnMsg.xxPopPrm_P1);
