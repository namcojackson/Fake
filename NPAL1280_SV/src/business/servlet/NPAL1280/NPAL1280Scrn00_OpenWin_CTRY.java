 ...
 *</pre>
 */
public class NPAL1280Scrn00_OpenWin_CTRY extends S21CommonHandler {
     ...
     */
    private Object[] getPopupParam(NPAL1280BMsg scrnMsg) {
        ...
        whereArray1[IDX_2] = scrnMsg.shipToStCd_HS.getValue();
        ...
        whereArray3[IDX_2] = scrnMsg.shipToCtryCd_HS.getValue();
