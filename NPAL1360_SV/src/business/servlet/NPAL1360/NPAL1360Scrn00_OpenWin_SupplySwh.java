 ...
 * Function Name : Open Supply Sub Warehouse
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 05/13/2016   CITS            Keiichi Masaki  Create          N/A
 *</pre>
 */
public class NPAL1360Scrn00_OpenWin_SupplySwh extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.eventNm, EVENT_OPEN_WIN_SUPPLY_SWH);

        int eventRowIndex = getButtonSelectNumber();

        Object[] params = NPAL1360CommonLogic.setLocationPopupParam(scrnMsg, eventRowIndex);
