...
import static business.servlet.NPAL1360.constant.NPAL1360Constant.ZZZM9007E;
 ...
 * Function Name : Set SWH Name
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 05/17/2016   CITS            Keiichi Masaki  Create          N/A
 *</pre>
 */
public class NPAL1360Scrn00_SetSwhName extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.cpltRtlSwhCd)) {
            scrnMsg.rtlSwhNm.clear();
            scrnMsg.cpltRtlSwhCd.setErrorInfo(1, ZZZM9007E, new String[] {DISPLAY_COMP_SWH});
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.cpltRtlSwhCd.isError()) {
            scrnMsg.rtlSwhNm.clear();
            scrnMsg.addCheckItem(scrnMsg.cpltRtlSwhCd);
            scrnMsg.putErrorScreen();
        }
