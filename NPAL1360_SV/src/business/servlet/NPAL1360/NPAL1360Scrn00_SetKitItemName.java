 ...
 * Function Name : Set Kit Item Name
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 05/17/2016   CITS            Keiichi Masaki  Create          N/A
 *</pre>
 */
public class NPAL1360Scrn00_SetKitItemName extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.fnshGoodsMdseCd)) {
            scrnMsg.fnshMdseDescShortTxt.clear();
            scrnMsg.fnshGoodsMdseCd.setErrorInfo(1, ZZZM9007E, new String[] {DISPLAY_KIT_ITEM});
        }
