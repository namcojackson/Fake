 ...
 *</pre>
 */
public class NWAL1610Scrn00_OpenWin_BillTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue(OPENWIN_BILL_TO);
        // Del Start 2017/11/16 QC#17322(Sol#174)
        //ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(0).xxPopPrm_P, DS_ACCT_RELN_TP.BILL_TO);
        // Del End 2017/11/16 QC#17322(Sol#174)

        Object[] params = NWAL1610CommonLogic.getOpenWinBillToParam(scrnMsg);
