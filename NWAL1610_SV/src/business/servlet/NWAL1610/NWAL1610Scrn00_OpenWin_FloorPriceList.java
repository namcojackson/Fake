...
import static business.servlet.NWAL1610.constant.NWAL1610Constant.OPENWIN_FLR_PRC_LIST;
...
/**
 *<pre>
 * NWAL1610Scrn00_OpenWin_FloorPriceList
 *
 ...
 *</pre>
 */
public class NWAL1610Scrn00_OpenWin_FloorPriceList extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue(OPENWIN_FLR_PRC_LIST);

        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(1).xxPopPrm_P, PRC_CTX_TP.FLOOR_PRICE);
