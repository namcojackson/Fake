 <!-- $Header: canon_E193_csEIServiceLineDetails.jsp $ -->
<%--========================================================================
 |
 | FILE 
 |	canon_E193_csEIServiceLineDetails.jsp - Service line details
 |   
 | DESCRIPTION
...
<%
	...
	if (hPath == null)
		hPath = strServiceLineDetailsT1;
	else
		if(hPath.indexOf(strServiceLineDetailsT1) < 0)
			hPath = hPath + " -> " + strServiceLineDetailsT1;
...
<script language="JavaScript">
	function action_func1() {
		resetErroMsg();
		var objForm = document.serviceLineForm;
	...
	function fnGetReasonCode() {
		var val = document.serviceLineForm.hParentCatCode.value;
...
<div id="main_content">
	<div id="page_top">
	   	<h1 style="padding-top:20px;" id="headerText">Customer Care - <%=strServiceLineDetailsT1%></h1>
		<div class="breadcrumb"><%=hPath%></div>		
	</div>	
 	
	<form name="serviceLineForm" action="canon_E193_csTicketSummaryB1Controller.jsp" method="post">

	<input type="hidden" name="hPageFrom" value="EIServiceLineDetails">
