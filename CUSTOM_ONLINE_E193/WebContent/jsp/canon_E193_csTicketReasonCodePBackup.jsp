...
function action_func1() {
	...
	if(!isSelected) {
		...
		alert("objForm.reasonCode.value:"+objForm.reasonCode.value+"   Val:"+objForm.reasonCode.value);
...
%>
	...
	<div style="margin-left:30px;"><select name="reasonCode" id="reasonCode" size="1" class="searchBarLink" onChange="javascript:fnRefresh();">
								...
								/* ITG# 74988  - End */  					   				
					   			%>
		   					</select><a class="btn_red" href="javascript:action_func1()" style="margin-left:20px;">Select</a></div>
		   					<table cellspacing="1" class="supplies-table" style="width:70%;margin-left:30px;">
		 					 <tr>
				 				<th>&nbsp;</th>
								<th>CI Reason</th>
				...
				<a class="btn_red" href="javascript:action_func1();">Select</a>				
				</td>
				</tr>
	     		</table> 	
	</form>	
