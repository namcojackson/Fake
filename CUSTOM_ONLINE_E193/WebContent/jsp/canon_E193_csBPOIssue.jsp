<!-- $Header: canon_E193_csPOIssue.jsp $ -->
<%--========================================================================
 |
 | FILE 
 |	canon_E193_csPOIssue.jsp - Purchase order issues.
 |   
 | DESCRIPTION
...
<%
	...
	if (hPath == null)
		...
		if(hPath.indexOf(strPOIssueT1) < 0)
			hPath = hPath + " -> " + strPOIssueT1;
...
<script language="JavaScript">
	...
	function action_func1() {
		...
		if(objForm.iLineId.value != '' && objForm.iLineId.value != '0') {
			...
			if(objForm.newPurchageOrd.value == '') {
				displayErrorMsg("Plase enter New PO#");
				objForm.newPurchageOrd.focus();
			}else if(notes == '') {
...
%> 
   <div id="main_content">
		<div id="page_top">
			<h1 style="padding-top:20px;" id="headerText">Customer Care - <%=strPOIssueT1 %></h1>
			<div class="breadcrumb"><%=hPath%></div>
		</div>	
	
	<form name="taxIssueForm" action="canon_E193_csTicketSummaryB2Controller.jsp" method="post">

	<input type="hidden" name="hPageFrom" value="POIssue">
	...
	<input type="hidden" name="strPurchageOrd" value="<%=strPurchageOrd%>">
...
%>		
		<tr>
			...
			<td align="left">
				<font class="promptReadOnly"><b><%=strPOReqFlag%></b></font>
			</td>
		</tr>
		<!-- <tr><td height="3" colspan="3"></td></tr> -->
   		<tr>
		...
		<tr>
			...
			<td align="left" >
				<input name="newPurchageOrd" type="text" value="<%=request.getParameter("newPurchageOrd")==null?"":request.getParameter("newPurchageOrd")%>" size="12" maxlength="30" class="inTxt">
			</td>
		</tr>  		
		<!-- <tr><td height="3" colspan="3"></td></tr> -->
   		<tr>
		...
		<!-- <tr><td height="10" colspan="3"></td></tr> -->
  		...
  		%>
			<tr>
				<td width="10"></td>
				<td colspan="2"><textarea name="notesDisplay" rows="10" wrap="OFF" class="inTxt required" style="background-color:#ffff00;height:auto; width:800px;" readonly="readonly"><%=strNotesDisplay%></textarea></td>		
			</tr>
		<%	}  %>
		<tr>
			<td width="10"></td>
