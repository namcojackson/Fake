...
/**
 * Title:      CanonE389DffUtilityBean<br>
...
public class CanonE389DffUtilityBean {
  ...
  public CanonE389DffUtilityBean()
  {
  }
...
public String toString() {
	return "CanonE389DffUtilityBean [seqNumber=" + seqNumber + ", prompt="
			+ prompt + ", attributeId=" + attributeId + ", requiredFlag="
  ...
  public static ArrayList getDffDetails (String sourceContext) throws SQLException
  {
    ...
    //	System.out.println("!!!!!!!!!Inside getDffDetails");
     ...
     // System.out.println("!!!!!!!!!After calling cstmt.execute()");
      ...
      while(rs.next())
      {
        CanonE389DffUtilityBean objRepData = new CanonE389DffUtilityBean();
        objRepData.setseqNumber(rs.getString(1));
        objRepData.setprompt(rs.getString(2));
        objRepData.setattributeId(rs.getString(3));
        objRepData.setrequiredFlag(rs.getString(4));
        objRepData.setenabledFlag(rs.getString(5));
        objRepData.setdisplayFlag(rs.getString(6));
        objRepData.setsecurityEnabledFlag(rs.getString(7));
        objRepData.setvalueSetName(rs.getString(8));
        objRepData.setdefaultType(rs.getString(9));
        objRepData.setdefaultValue(rs.getString(10));
        objRepData.setdisplaySize(rs.getString(11));
