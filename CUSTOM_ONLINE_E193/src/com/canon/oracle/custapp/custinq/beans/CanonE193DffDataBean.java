...
public class CanonE193DffDataBean
{
    ...
    try
    {
     ...
     // cs   = (OracleCallableStatement)conn.prepareCall(sbCall.toString());
      ...
      for (int i = 0; i < vAttrIds.size(); i++)
      {
        ...
        obj1 = (CanonE193DffDataBean)vAttrIds.elementAt(i);
        strAttributeIds[i] = obj1.getattributeId();

        CanonE193DffDataBean obj2 = new CanonE193DffDataBean();
        obj2 = (CanonE193DffDataBean)vAttrValues.elementAt(i);
