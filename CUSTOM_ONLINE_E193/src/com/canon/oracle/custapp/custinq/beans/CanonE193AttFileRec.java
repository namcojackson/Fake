...
public class CanonE193AttFileRec implements SQLData{

	private String strBusinessId;
	private String strAttGrpTxt;
	private int fileId;
	private String strfileName;
	private String strFileNameWithPath;
	private int id;
	
	
	public CanonE193AttFileRec() {
		// TODO Auto-generated constructor stub
	}

	public CanonE193AttFileRec(String strBusinessId, String strAttGrpTxt,
			int fileId, String strfileName, String strFileNameWithPath, int id // Id is for deletion of CSA website files
			) {
		super();
		...
		this.strFileNameWithPath = strFileNameWithPath;
		this.id = id;
	}
	public CanonE193AttFileRec(String strBusinessId, String strAttGrpTxt,
	...
	public String getStrFileNameWithPath() {
		return strFileNameWithPath;
	}

	public void setStrFileNameWithPath(String strFileNameWithPath) {
		this.strFileNameWithPath = strFileNameWithPath;
	}
