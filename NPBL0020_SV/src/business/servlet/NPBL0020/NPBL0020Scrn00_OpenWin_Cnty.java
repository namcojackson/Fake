 ...
 *</pre>
 */
public class NPBL0020Scrn00_OpenWin_Cnty extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
    	...
    	NPBL0020BMsg scrnMsg = (NPBL0020BMsg) bMsg;
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_P1, "OpenWin_Cnty");
        scrnMsg.xxScrEventNm.setValue("OpenWin_Cnty");
