...
import static business.servlet.NPBL0020.constant.NPBL0020Constant.DISPLAY_NM_DEST_RTL_SWH_CD;
 ...
 * Function Name : Button Action to Get_DestSwhH
 * </pre>
 * 
 * <pre>
 ...
 *</pre>
 */
public class NPBL0020Scrn00_Get_DestSwhH extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.destRtlSwhCd)) {
            scrnMsg.destRtlSwhCd.setErrorInfo(1, ZZZM9025E, new String[] {DISPLAY_NM_DEST_RTL_SWH_CD });
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // set focus
        scrnMsg.setFocusItem(scrnMsg.rtlSwhNm_DS);
