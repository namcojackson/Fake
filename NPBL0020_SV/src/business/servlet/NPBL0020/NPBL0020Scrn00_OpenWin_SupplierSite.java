 ...
 *</pre>
 */
public class NPBL0020Scrn00_OpenWin_SupplierSite extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // set popup parameter
        Object[] params = NPBL0020CommonLogic.setSupplierSearchParam(scrnMsg);
        scrnMsg.xxScrEventNm.setValue("OpenWin_SupplierSite");
