 ...
 *</pre>
 */
public class NPBL0020Scrn00_OpenWin_SrcWHForLine extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NPBL0020CommonLogic.setInitParamForSrcWarehouseForLinePopup(scrnMsg, eventRowIndex);

        // Making of subscreen delivery information
        Object[] params = NPBL0020CommonLogic.setParamForSrcWarehouseForLinePopup(scrnMsg, eventRowIndex);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(IDX_12).xxPopPrm, SOURCE_WAREHOUSE_FOR_LINE);
