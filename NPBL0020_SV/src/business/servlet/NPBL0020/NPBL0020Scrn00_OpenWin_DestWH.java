 ...
 *</pre>
 */
public class NPBL0020Scrn00_OpenWin_DestWH extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        Object[] params = NPBL0020CommonLogic.setParamForDestWarehousePopup(scrnMsg, -1);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(IDX_12).xxPopPrm, DESTINATION_WAREHOUSE);
