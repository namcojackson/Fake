...
import static business.servlet.NPBL0020.constant.NPBL0020Constant.DISPLAY_NM_VND_CD;
 ...
 * Function Name : Button Action to Get_ShipToSplyH
 * </pre>
 * 
 * <pre>
 ...
 *</pre>
 */
public class NPBL0020Scrn00_Get_ShipToSplyH extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.vndCd)) {
            scrnMsg.vndCd.setErrorInfo(1, ZZZM9025E, new String[] {DISPLAY_NM_VND_CD});
        }
