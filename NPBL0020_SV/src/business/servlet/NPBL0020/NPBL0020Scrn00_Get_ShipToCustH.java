...
import static business.servlet.NPBL0020.constant.NPBL0020Constant.DISPLAY_NM_SHIP_TO_CUST_CD;
 ...
 * Function Name : Button Action to Get_ShipToCustH
 * </pre>
 * 
 * <pre>
 ...
 *</pre>
 */
public class NPBL0020Scrn00_Get_ShipToCustH extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.shipToCustCd_EO)) {
            scrnMsg.shipToCustCd_EO.setErrorInfo(1, ZZZM9025E, new String[] {DISPLAY_NM_SHIP_TO_CUST_CD });
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // set focus
        scrnMsg.setFocusItem(scrnMsg.shipToLocNm_EO);
