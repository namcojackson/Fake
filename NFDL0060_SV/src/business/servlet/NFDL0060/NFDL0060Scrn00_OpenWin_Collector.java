 ...
 *</pre>
 */
public class NFDL0060Scrn00_OpenWin_Collector extends S21CommonHandler {
    ...
    private Object[] setPopupParameter(NFDL0060BMsg scrnMsg) {
        ...
        if (scrnMsg.cltDispTpCd_H3.getValue().equals(CLT_DISP_TP.MYGROUP)) {
            sb.append(" SELECT ");
