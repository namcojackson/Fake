...
/*
 *NMAL6700_EBMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL6700_EBMsg extends EZDBMsg implements EZDSchemaItemDefines {
	...
	public final EZDBBigDecimalItem              dsAcctGrpAsgPk_E1;
    ...
    /** DS_BIZ_AREA_NM_E2*/
	public final EZDBStringItemArray              dsBizAreaNm_E2;

    /** DS_BIZ_AREA_CD_E3*/
	public final EZDBStringItem              dsBizAreaCd_E3;

    /** DS_ACCT_GRP_CD_E3*/
	public final EZDBStringItem              dsAcctGrpCd_E3;

    /** DS_ACCT_GRP_DESC_TXT_E3*/
	public final EZDBStringItem              dsAcctGrpDescTxt_E3;
	...
	/**
	 * NMAL6700_EBMsg is constructor.
	 * The initialization when the instance of NMAL6700_EBMsg is generated.
	 */
	public NMAL6700_EBMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL6700_EBMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		dsAcctGrpAsgPk_E1 = (EZDBBigDecimalItem)newItem("dsAcctGrpAsgPk_E1");
		xxChkBox_E1 = (EZDBStringItem)newItem("xxChkBox_E1");
		dsBizAreaCd_E1 = (EZDBStringItemArray)newItemArray("dsBizAreaCd_E1");
		dsBizAreaNm_E2 = (EZDBStringItemArray)newItemArray("dsBizAreaNm_E2");
		dsBizAreaCd_E3 = (EZDBStringItem)newItem("dsBizAreaCd_E3");
		dsAcctGrpCd_E3 = (EZDBStringItem)newItem("dsAcctGrpCd_E3");
		dsAcctGrpDescTxt_E3 = (EZDBStringItem)newItem("dsAcctGrpDescTxt_E3");
	 ...
	 * @return NMAL6700_EBMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL6700_EBMsgArray();
	}
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"DS_ACCT_GRP_ASG_PK",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctGrpAsgPk_E1
        ...
        {"DS_BIZ_AREA_NM",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsBizAreaNm_E2
        {"DS_BIZ_AREA_CD", YES,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsBizAreaCd_E3
        {"DS_ACCT_GRP_CD", YES,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctGrpCd_E3
        {"DS_ACCT_GRP_DESC_TXT", YES,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsAcctGrpDescTxt_E3
        {"EFF_FROM_DT", YES,  null,null,"1", NO, NO, NO, NO,null,null,UNI, SEIREKI4,  NO, YES},	//effFromDt_E1
