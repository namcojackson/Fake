 ...
 * ----------------------------------------------------------------------
 * 2015/11/25   Hitachi         Y.Tsuchimoto    Update          N/A
 *</pre>
 */
public class NMAL6700Scrn00_Search extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (NMAL6700Constant.TAB_HIERARCHY.equals(scrnMsg.xxDplyTab.getValue())) {
            scrnMsg.setTreeView(null);
            if (bizMsg.B.getValidCount() > 0) {
                NMAL6700CommonLogic.setHirarchyTreeView(scrnMsg, bizMsg);
            }
        }
    }
}
