 ...
 *</pre>
 */
public class NMAL6700Scrn00_GetCltCustTpNm extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NMAL6700BMsg scrnMsg = (NMAL6700BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.cltCustTpCd_U1)) {
            scrnMsg.cltCustTpCd_U1.setErrorInfo(1, ZZM9000E, new String[] {scrnMsg.cltCustTpCd_U1.getNameForMessage() });
