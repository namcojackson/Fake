 ...
 * ----------------------------------------------------------------------
 * 2016/02/18   Fujitsu         N.Sugiura       Create          N/A
 *</pre>
 */
public class NMAL6700Scrn00_GetDsAcctNm extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        NMAL6700_CBMsg cBMsg = scrnMsg.C.no(selectIdx);
        scrnMsg.addCheckItem(cBMsg.dsAcctNum_C1);
