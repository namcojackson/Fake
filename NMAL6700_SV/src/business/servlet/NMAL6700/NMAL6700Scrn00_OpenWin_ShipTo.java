 ...
 *</pre>
 */
public class NMAL6700Scrn00_OpenWin_ShipTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // if (0 <= index) {
        //    ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(16).xxPopPrm, scrnMsg.F.no(index).dsDefShipToCd_F1.getValue());
        // }
        // END 2017/09/08 J.Kim [QC#20359,DEL]
        // START 2017/09/08 J.Kim [QC#20359,MOD]
        // scrnMsg.P.no(12).xxPopPrm.setValue("03"); // Ship To Only
        scrnMsg.P.no(8).xxPopPrm.setValue(NMAL6700Constant.DISP_RELN_ACCT_CD_SHIP);  // Display Related Accts:Ship To's Only
        scrnMsg.P.no(12).xxPopPrm.setValue(NMAL6700Constant.DISP_HRCH_ACCT_CD_SHIP); // Display Hierarchy Account:Ship To Only
