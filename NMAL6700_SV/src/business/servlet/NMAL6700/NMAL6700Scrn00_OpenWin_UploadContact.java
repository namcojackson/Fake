 ...
 *</pre>
 */
public class NMAL6700Scrn00_OpenWin_UploadContact extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.P.clear();
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(0).xxPopPrm, NMAL6700Constant.CSV_UPD_ID_CTAC);
