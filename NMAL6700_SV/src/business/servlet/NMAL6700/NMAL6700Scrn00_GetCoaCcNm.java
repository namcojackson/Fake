 ...
 *</pre>
 */
public class NMAL6700Scrn00_GetCoaCcNm extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NMAL6700BMsg scrnMsg = (NMAL6700BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.coaCcCd_F1)) {
            scrnMsg.coaCcCd_F1.setErrorInfo(1, ZZM9000E, new String[] {scrnMsg.coaCcCd_F1.getNameForMessage() });
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.coaCcCd_F1);
    }
}
