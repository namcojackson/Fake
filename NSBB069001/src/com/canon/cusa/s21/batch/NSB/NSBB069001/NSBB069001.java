 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB069001;
...
import business.db.NSBI2090_01TMsg;
...
/**
 * <pre>
 * Web OMAL FA Item Master Batch
 * 
 * Date         Company         Name            Create/Update   Defect No
 * 
 * ----------------------------------------------------------------------
 * 2016/06/02   Hitachi         O.Okuma         Create          N/A
 * </pre>
 */
public class NSBB069001 extends S21BatchMain {
    ...
    /** MDSE_ITEM_TP_CD List */
    private static final String[] MDSE_ITEM_TP_CD_LIST = {MDSE_ITEM_TP.SUPPLY, MDSE_ITEM_TP.PARTS };
    ...
    public static void main(String[] args) {
        new NSBB069001().executeBatch(NSBB069001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2090_01TMsg> inTMsgList = new ArrayList<NSBI2090_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2090_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2090_01TMsg> inMsgLst) {
        NSBI2090_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2090_01TMsg[inMsgLst.size()];
    ...
    private Map<String, Object> setSearchCondition() {
        ...
        inParam.put("mdseItemTpCdList", MDSE_ITEM_TP_CD_LIST);
        return inParam;
    }

    private NSBI2090_01TMsg setCreateValue(ResultSet rs) {

        NSBI2090_01TMsg inParam = new NSBI2090_01TMsg();
