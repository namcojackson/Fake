 ...
 *</pre>
 */
public class NSAL0010Scrn00_CMN_Submit extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TAB_ADDL_ATTRB.equals(scrnMsg.xxDplyTab_01.getValue())) {
            NSAL0010CommonLogic.getScrnTm(scrnMsg);
        }
        NSAL0010CommonLogic.checkInputItemsAttribute(scrnMsg);
