 ...
 *</pre>
 */
public class NSAL0010Scrn00_OpenWin_BillToCust extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, OPENWIN_BILLTOCUST);
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_00, scrnMsg.billToAcctNum_M2);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_12, PARAMS_BILL_TO_ONLY);
        // START 2016/05/16 T.Tomita [QC#4578, MOD]
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_02, scrnMsg.indBillToLocNum_M2);
