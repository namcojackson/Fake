 ...
 *</pre>
 */
public class NSAL0010Scrn00_OpenWin_SerialNum extends S21CommonHandler {
...
//        setArgForSubScreen(setCommonPopUpParam(ctx, scrnMsg));
        ...
        setValue(scrnMsg.xxScrEventNm, OPENWIN_SERIALNUM);
...
//        h10[WLIST_DSP_OBJ_NM] = "Shipped Date";
//        h10[WLIST_OBJ_ID] = "SHIP_DT";
//        h10[WLIST_OBJ_VALUE] = "";
//        h10[WLIST_WHERE_FLG] = ZYPConstant.FLG_OFF_N;
//        whereList.add(h10);
//
//        return whereList;
//    }
