 ...
 * ----------------------------------------------------------------------
 * 2016/01/12   Hitachi         T.Tomita        Create          QC#2866
 *</pre>
 */
public class NSAL0010Scrn00_MoveWin_AcctSoldTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        params[0] = scrnMsg.G.no(rowNum).sellToCustCd_G;
        params[1] = null;
