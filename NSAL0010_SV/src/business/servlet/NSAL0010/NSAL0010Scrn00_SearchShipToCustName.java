 ...
 *</pre>
 */
public class NSAL0010Scrn00_SearchShipToCustName extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
//        NSAL0010BMsg scrnMsg = (NSAL0010BMsg) bMsg;
//        scrnMsg.addCheckItem(scrnMsg.shipToCustCd_H1);
//        if (!ZYPCommonFunc.hasValue(scrnMsg.shipToCustCd_H1.getValue())) {
//            scrnMsg.shipToCustCd_H1.setErrorInfo(1, NSAL0010Constant.NSAM0006E);
//        }
...
//        } else {
//            scrnMsg.shipToCustLocNm_H1.clear();
//        }
//        scrnMsg.addCheckItem(scrnMsg.shipToCustCd_H1);
//        scrnMsg.putErrorScreen();
//
