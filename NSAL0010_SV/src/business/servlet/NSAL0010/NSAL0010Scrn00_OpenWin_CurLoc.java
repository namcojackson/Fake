 ...
 *</pre>
 */
public class NSAL0010Scrn00_OpenWin_CurLoc extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, OPENWIN_CURLOC);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_00, scrnMsg.curLocAcctNum_M3);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_12, PARAMS_SHIP_TO_ONLY);
        // START 2016/05/16 T.Tomita [QC#4578, MOD]
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_02, scrnMsg.indCurLocNum_M3);
...
//        scrnMsg.xxPopPrm_00.setValue(DS_ACCT_RELN_TP.SHIP_TO);
//        scrnMsg.xxPopPrm_02.setValue(scrnMsg.curLocNum_M3.getValue());
//        scrnMsg.xxPopPrm_04.setValue(scrnMsg.curLocAcctNum_M3.getValue());
