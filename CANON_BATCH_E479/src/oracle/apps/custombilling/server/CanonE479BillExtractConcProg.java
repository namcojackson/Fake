...
public class CanonE479BillExtractConcProg  implements JavaConcurrentProgram {
	...
	public void runProgram(CpContext ctx) {
    	...
    	CanonE479BillExtractDAO.stagingExtract(
    			p_customer_group, 
    			p_parent_customer, 
    			p_customer, 
    			p_bill_to_location, 
    ...
    public static void main(String args[]) throws Exception {
    	...
    	JavaConcurrentProgram c=new CanonE479BillExtractConcProg();
