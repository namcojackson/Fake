...
public class CanonCustomBillingServerInvoiceHelperBase{
...
static public class ExcelBase implements ExcelConstants, ExcelTreeConstants {
    ...
    public static class SimpleName extends Name {
        ...
        public String toString() {
            return "SimpleName{" + super.toString() + " value=" + value + " type=" + (value==null?"null": value.getClass().toString())+ '}';
        }
    }
    ...
    public static class ExcelTemplate {
        ...
        public static ExcelTemplate getInstance(String filename,InputStream is) {
        ...
        public ExcelTemplate load(String filename,InputStream is) throws Exception {
            workbook = canon.excel.cells.CellsHelper.newWorkbook();
            workbook.open(is, FileFormatType.EXCEL97TO2003);
            String tmpl = scan(workbook);
            log("======");
            log(tmpl);
            log("======");
...
//            root.dump("");
        ...
        public ExcelTemplate load(Workbook workbook) throws Exception {
...
//            root.dump("");
        ...
        public String scan(Workbook wb) {
...
//            log("in getPropertyValue " + bean + "(" + bean.getClass() + ")" + propName);
    ...
    public static class CellTask implements Task {
        ...
        public void execute(Object o) {
            ...
            node.copyCell(source, target, context, prefix, true);
        }
    }
    ...
    public static class WorkBookContext implements Assert, ExcelTool{
        ...
        private void gotoSheet(int tmplSheetIndex, int trgtSheetIndex, int cloneSheetFrom) {
            ...
            if (this.targetSheetIndex >= target.getWorksheets().size()) {
        ...
        private void moveToNextSheet(int sheetIndex) {
            ...
            log("sourceSheetIndex " + templateSheetIndex);
        ...
        public Cell moveTo(int sheetIndex, int r, int c) {
            ...
            if (currentView != null) {
                ...
                gotoSheet(sheetIndex, sheetIndex, sheetIndex);
