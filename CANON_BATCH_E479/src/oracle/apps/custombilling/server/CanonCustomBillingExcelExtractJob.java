...
public class CanonCustomBillingExcelExtractJob {
    ...
    public static void main(String args[]) throws Exception {
    	...
    	CanonCustomBillingExcelExtractJob obj=new CanonCustomBillingExcelExtractJob();
    	String errFlag = obj.createExcelFile(p_source,inputParam2,inputParam3,inputParam4,inputParam5,inputParam6,inputParam7);
    	System.out.println("createExcelFile called:"+ errFlag);
    ...
    public static String checkdate() throws ParseException
    {
	    ...
	    Integer nextmonth = cal.get(Calendar.MONTH)+2;
    ...
    public static String createExcelFile(String p_source,String p_customer_group,String p_parent_customer,String p_customer,String p_bill_to_location,String p_from_date,String p_to_date ) throws ParseException{
        //clearException();
        System.out.println("in createExcelFile "+p_source);
        CallableStatement statement = null;
        Connection connection = null;
        
        String dt = checkdate(); //"2017-11-08";  // Start date
       ...
       // String yourString = "2013-03-19";
        //System.out.println("From Date "+ dt);
