...
public class CanonCustomBillingServerDetailBean {
   ...
   private Timestamp lastUpdateDate;
    ...
    public CanonCustomBillingServerDetailBean(){
    }
    public CanonCustomBillingServerDetailBean(BigDecimal invId, 
            BigDecimal seqNo, 
            String controlType, 
            String tabName, 
            String field1, 
    ...
    public static CanonCustomBillingServerRowMapper getRowMapper(){
        return new CanonCustomBillingServerRowMapper() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                return new CanonCustomBillingServerDetailBean(
