...
public class CanonE479InvoiceMasterConcProg  implements JavaConcurrentProgram {
	...
	public void runProgram(CpContext ctx) {
        ...
        String p_to_date = (String) params.get("to_date");
                CanonE479InvoiceMasterDAO.createExcelFile(
    			p_customer_group, 
    			p_parent_customer, 
    			p_customer, 
    			p_bill_to_location, 
    ...
    public static void main(String args[]) throws Exception {
    	...
    	JavaConcurrentProgram c=new CanonE479InvoiceMasterConcProg();
