...
public class CanonCustomBillingServerControlBean {
   ...
   private Timestamp lastUpdateDate;
    ...
    public CanonCustomBillingServerControlBean(){
    }
    public CanonCustomBillingServerControlBean(String urnNmuber,
            BigDecimal invId, 
            BigDecimal seqNo, 
            String controlType, 
            String tabName, 
    ...
    public static CanonCustomBillingServerRowMapper getRowMapper(){
        return new CanonCustomBillingServerRowMapper() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                return new CanonCustomBillingServerControlBean(
