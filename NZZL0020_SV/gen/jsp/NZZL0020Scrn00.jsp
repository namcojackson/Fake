...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NZZL0020Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="ITT-WB launcher Screen">

<%@include file="../common/common.jsp" %>
<%
    //EXTNE307T010
    String functionID = ((business.servlet.NZZL0020.NZZL0020Bean)databean).getXxScrEventNm();
%>
			<center>
									...
									<tr>
										<td height="28px" width="1070px" valign="bottom">
											<table class="pTab_UPPER_ON" border="0" cellpadding="0" cellspacing="0" >
												<tr title="ITT-WB">
													<td align="center" class="same">ITT-WB</td>
												</tr>
...
<% if (functionID != null && !"".equals(functionID)) {%>
		                                    <a href="<%=getCustomAppURL(functionID)%>" target="ITT-WB" onclick="f_open_window_max(this.href, 'ITT-WB')"><font size="7">ITT-WB</font></a>
<% } else { %>
                                            <font size="7">ITT-WB</font>
<% } %>
                                        </td>
                                    </tr>
                                </table>
