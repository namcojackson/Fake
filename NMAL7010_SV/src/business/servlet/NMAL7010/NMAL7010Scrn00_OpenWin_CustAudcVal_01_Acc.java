 ...
 *</pre>
 */
public class NMAL7010Scrn00_OpenWin_CustAudcVal_01_Acc extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm_DH, "OpenWin_CustAudcVal_01_Acc");
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxCellIdx, new BigDecimal(idx));

        setArgForSubScreen(NMAL7010CommonLogic.createArgumentNMWAL6760(scrnMsg.X.no(idx).xxScrItem30Txt_X1, scrnMsg.X.no(idx).xxRecNmTxt_X1));
