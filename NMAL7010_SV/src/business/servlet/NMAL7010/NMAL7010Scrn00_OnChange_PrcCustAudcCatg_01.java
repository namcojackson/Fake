...
/**
 *<pre>
 * NMAL7010Scrn00_OnChange_PrcCustAudcCatg_01
 *
 ...
 *</pre>
 */
public class NMAL7010Scrn00_OnChange_PrcCustAudcCatg_01 extends S21CommonHandler {
...
//        NMAL7010CommonLogic.prcCustAudcCatgCtrl(this, NMAL7010Constant.BTN_PRC_CUST_AUDC_01, selectIdx, scrnMsg.X.no(selectIdx).prcCustAudcCatgCd_X1.getValue(), scrnMsg);
        boolean updateAuthFlg = NMAL7010CommonLogic.updateAuthority(getUserProfileService());
        NMAL7010CommonLogic.prcCustAudcCatgCtrl(this, NMAL7010Constant.BTN_PRC_CUST_AUDC_01, selectIdx, scrnMsg.X.no(selectIdx).prcCustAudcCatgCd_X1.getValue(), scrnMsg, updateAuthFlg);
