...
public class NWDL0260Scrn00_OnClick_LineCheckbox extends S21CommonHandler implements NWDL0260Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // set focus.
        scrnMsg.setFocusItem(scrnMsg.A.no(getButtonSelectNumber()).xxChkBox_A1);
	}
