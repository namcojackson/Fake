...
/**
 * It is AR_RCPT_UPLD_RCV_WRK Table Layout Message class.
 * @author
 * @version XLA200710010c
 */
public class AR_RCPT_UPLD_RCV_WRKFMsg extends EZDFMsg implements EZDSchemaItemDefines {
	...
	/**
	 * AR_RCPT_UPLD_RCV_WRKFMsg is constructor.
	 * The initialization when the instance of AR_RCPT_UPLD_RCV_WRKFMsg is generated.
	 */
	public AR_RCPT_UPLD_RCV_WRKFMsg() {
		this(false, -1);
	}
	 ...
	 */
	public AR_RCPT_UPLD_RCV_WRKFMsg(boolean child, int eleNo) {
		super(child, eleNo);
	 ...
	 * @return AR_RCPT_UPLD_RCV_WRKFMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new AR_RCPT_UPLD_RCV_WRKFMsgArray();
	}
	...
	private static final String[][] DB_CONTENTS = {
		...
		{"UPLD_HDR_NUM",  NO, null},  // upldHdrNum
	 ...
	 * Database Table Name
	 */
	private static final String TABLE_NAME = "AR_RCPT_UPLD_RCV_WRK";
