...
/*
 *NFBL0130F00FMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
...
/**
 * It is NFBL0130F00 File Layout Message class.
 * @author
 * @version XLA200710010
 */
public class NFBL0130F00FMsg extends EZDFMsg implements EZDSchemaItemDefines {
    ...
    /** CM_CNTNR_BOL_NM*/
	public final EZDFStringItem              cmCntnrBolNm;
    ...
    /** ACCT_INV_STS_NM*/
	public final EZDFStringItem              acctInvStsNm;

    /** INV_OC_ORIG_COST_AMT*/
	public final EZDFBigDecimalItem              invOcOrigCostAmt;

    /** AC_OC_TOT_COST_AMT_AC*/
	public final EZDFBigDecimalItem              acOcTotCostAmt_AC;

    /** AC_OC_FOB_COST_AMT_AC*/
	public final EZDFBigDecimalItem              acOcFobCostAmt_AC;

    /** AC_OC_FRT_COST_AMT_AC*/
	public final EZDFBigDecimalItem              acOcFrtCostAmt_AC;

    /** AC_OC_INS_COST_AMT_AC*/
	public final EZDFBigDecimalItem              acOcInsCostAmt_AC;

    /** AC_OC_DTY_COST_AMT_AC*/
	public final EZDFBigDecimalItem              acOcDtyCostAmt_AC;

    /** AC_OC_OTH_COST_AMT_AC*/
	public final EZDFBigDecimalItem              acOcOthCostAmt_AC;
    ...
    /** XX_GENL_FLD_AREA_TXT_W1*/
	public final EZDFStringItem              xxGenlFldAreaTxt_W1;


	/**
	 * NFBL0130F00FMsg is constructor.
	 * The initialization when the instance of NFBL0130F00FMsg is generated.
	 */
	public NFBL0130F00FMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NFBL0130F00FMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		cmCntnrBolCd = (EZDFStringItem)newItem("cmCntnrBolCd");
		cmCntnrBolNm = (EZDFStringItem)newItem("cmCntnrBolNm");
		...
		acctInvStsNm = (EZDFStringItem)newItem("acctInvStsNm");
		invOcOrigCostAmt = (EZDFBigDecimalItem)newItem("invOcOrigCostAmt");
		acOcTotCostAmt_AC = (EZDFBigDecimalItem)newItem("acOcTotCostAmt_AC");
		acOcFobCostAmt_AC = (EZDFBigDecimalItem)newItem("acOcFobCostAmt_AC");
		acOcFrtCostAmt_AC = (EZDFBigDecimalItem)newItem("acOcFrtCostAmt_AC");
		acOcInsCostAmt_AC = (EZDFBigDecimalItem)newItem("acOcInsCostAmt_AC");
		acOcDtyCostAmt_AC = (EZDFBigDecimalItem)newItem("acOcDtyCostAmt_AC");
		acOcOthCostAmt_AC = (EZDFBigDecimalItem)newItem("acOcOthCostAmt_AC");
		...
		xxGenlFldAreaTxt_W1 = (EZDFStringItem)newItem("xxGenlFldAreaTxt_W1");
	}

	/**
	 * get the type of array which is stored
	 * @return NFBL0130F00FMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NFBL0130F00FMsgArray();
	}
	...
	{"cmCntnrBolNm", "cmCntnrBolNm", null, null, TYPE_HANKAKUEISU, "30", null},
	...
	{"acctInvStsNm", "acctInvStsNm", null, null, TYPE_HANKAKUEISU, "30", null},
	{"invOcOrigCostAmt", "invOcOrigCostAmt", null, null, TYPE_SEISU_SYOSU, "19", "4"},
	{"acOcTotCostAmt_AC", "acOcTotCostAmt_AC", "AC", null, TYPE_SEISU_SYOSU, "19", "4"},
	{"acOcFobCostAmt_AC", "acOcFobCostAmt_AC", "AC", null, TYPE_SEISU_SYOSU, "19", "4"},
	{"acOcFrtCostAmt_AC", "acOcFrtCostAmt_AC", "AC", null, TYPE_SEISU_SYOSU, "19", "4"},
	{"acOcInsCostAmt_AC", "acOcInsCostAmt_AC", "AC", null, TYPE_SEISU_SYOSU, "19", "4"},
	{"acOcDtyCostAmt_AC", "acOcDtyCostAmt_AC", "AC", null, TYPE_SEISU_SYOSU, "19", "4"},
	{"acOcOthCostAmt_AC", "acOcOthCostAmt_AC", "AC", null, TYPE_SEISU_SYOSU, "19", "4"},
	...
	{"xxGenlFldAreaTxt_W1", "xxGenlFldAreaTxt_W1", "W1", null, TYPE_HANKAKUEISU, "1000", null},
	};
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"CM_CNTNR_BOL_NM",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//cmCntnrBolNm
        ...
        {"ACCT_INV_STS_NM",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//acctInvStsNm
        {"INV_OC_ORIG_COST_AMT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//invOcOrigCostAmt
        {"AC_OC_TOT_COST_AMT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//acOcTotCostAmt_AC
        {"AC_OC_FOB_COST_AMT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//acOcFobCostAmt_AC
        {"AC_OC_FRT_COST_AMT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//acOcFrtCostAmt_AC
        {"AC_OC_INS_COST_AMT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//acOcInsCostAmt_AC
        {"AC_OC_DTY_COST_AMT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//acOcDtyCostAmt_AC
        {"AC_OC_OTH_COST_AMT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//acOcOthCostAmt_AC
        ...
        {"XX_GENL_FLD_AREA_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxGenlFldAreaTxt_W1
	};
