...
import static business.servlet.NMAL7410.constant.NMAL7410Constant.*;
 ...
 *</pre>
 */
public class NMAL7410Scrn00_CMN_Submit extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (scrnMsg.A.getValidCount() > 0) {
            scrnMsg.setFocusItem(scrnMsg.A.no(scrnMsg.A.getValidCount() - 1).crListTxt_A);
            return;
        }
