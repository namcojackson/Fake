...
public class NLCL0180_NMAL6030 extends S21CommonHandler implements NLCL0180Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLCL0180CommonLogic.commonBtnControl_NLCL0180_NMAL6030(this);

        NLCL0180CommonLogic.scrnItemControl_NLCL0180_NMAL6030(scrnMsg);

        if (ZYPCommonFunc.hasValue(scrnMsg.mdseNm_OT)) {
            scrnMsg.mdseNm.setValue(scrnMsg.mdseNm_OT.getValue());
        } else {
            // do nothing
        }
