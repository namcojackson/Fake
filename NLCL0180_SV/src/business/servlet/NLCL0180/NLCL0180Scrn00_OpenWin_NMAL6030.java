...
public class NLCL0180Scrn00_OpenWin_NMAL6030 extends S21CommonHandler implements NLCL0180Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLCL0180CommonLogic.commonBtnControl_NLCL0180Scrn00_OpenWin_NMAL6030(this);

        NLCL0180CommonLogic.scrnItemControl_NLCL0180Scrn00_OpenWin_NMAL6030(scrnMsg);

        for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
            scrnMsg.A.no(i).mdseNm_A1.setInputProtected(true);
        }

        scrnMsg.mdseNm_OT.clear();
        Object[] params = NLCL0180CommonLogic.otherBusConnectTo_NLCL0180Scrn00_OpenWin_NMAL6030(scrnMsg);
