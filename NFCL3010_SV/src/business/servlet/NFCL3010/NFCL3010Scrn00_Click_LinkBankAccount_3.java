 ...
 * ----------------------------------------------------------------------
 * 2016/02/11   Fijitsu         T.Tanaka        Create          N/A
 *</pre>
 */
public class NFCL3010Scrn00_Click_LinkBankAccount_3 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue("Click_LinkBankAccount_3");

        scrnMsg.dsBankAcctNm_P.clear();
        scrnMsg.dsBankBrNm_P.clear();
        scrnMsg.bankRteNum_P.clear();
        scrnMsg.dsBankAcctNum_P.clear();
        ZYPEZDItemValueSetter.setValue(scrnMsg.bankRteNum_P, scrnMsg.bankRteNum_H.getValue());
        ...
        whereArray1[0] = "Bank Branch Name";
        ...
        whereArray3[0] = "Bank Account Number";
        ...
        columnArray0[0] = "Bank Account Name";
        ...
        columnArray1[0] = "Bank Branch Name";
        ...
        columnArray3[0] = "Bank Account Number";
