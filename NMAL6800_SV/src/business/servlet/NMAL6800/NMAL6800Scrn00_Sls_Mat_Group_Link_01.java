 ...
 *</pre>
 */
public class NMAL6800Scrn00_Sls_Mat_Group_Link_01 extends S21CommonHandler {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL6800Scrn00_Sls_Mat_Group_Link_01");
		String selectStr = NMAL6800CommonLogic.setSelectForMaterialGroup(scrnMsg, getGlobalCompanyCode(), "1");
		List<Object[]> whereList = NMAL6800CommonLogic.setWhereListForMaterialGroup(scrnMsg.slsMatGrpCd_01.getValue(), scrnMsg.slsMatGrpDescTxt_01.getValue());
