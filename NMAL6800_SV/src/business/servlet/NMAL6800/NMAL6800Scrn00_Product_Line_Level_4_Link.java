...
/**
 *<pre>
 * NMAL6800Scrn00_Product_Line_Level_4_Link
 *
 ...
 *</pre>
 */
public class NMAL6800Scrn00_Product_Line_Level_4_Link extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL6800Scrn00_Product_Line_Level_4_Link");
		String selectStr = NMAL6800CommonLogic.setSelectForProdCtrl(getGlobalCompanyCode(), MDSE_STRU_ELMNT_TP.PRODUCT_LEVEL_4);
		List<Object[]> whereList = NMAL6800CommonLogic.setWhereListForProdCtrl(scrnMsg.frthProdCtrlNm_H1.getValue(), MDSE_STRU_ELMNT_TP.PRODUCT_LEVEL_4);
		List<Object[]> tblColumnList = NMAL6800CommonLogic.setTblColumnListForProdCtrl(MDSE_STRU_ELMNT_TP.PRODUCT_LEVEL_4);
