 ...
 * ----------------------------------------------------------------------
 * 2018/08/01   Fujitsu         S.Ohki          Create          QC#27222
 *</pre>
 */
public class NMAL6730Scrn00_TAB_Taxing extends S21CommonHandler {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		NMAL6730CommonLogic.initialControlScreen(getUserProfileService(), this,
