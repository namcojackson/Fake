 ...
 *</pre>
 */
public class NMAL6730Scrn00_GetCltCustTpNm extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NMAL6730BMsg scrnMsg = (NMAL6730BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.cltCustTpCd_F1)) {
            scrnMsg.cltCustTpCd_F1.setErrorInfo(1, ZZM9000E, new String[] {scrnMsg.cltCustTpCd_F1.getNameForMessage() });
