 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB078001;
...
import business.db.NSBI2180_01TMsg;
...
/**
 * <pre>
 * Web OMAL FJ Action Codes Batch
 * 
 ...
 * </pre>
 */
public class NSBB078001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB078001().executeBatch(NSBB078001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2180_01TMsg> inTMsgList = new ArrayList<NSBI2180_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2180_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2180_01TMsg> inMsgLst) {
        NSBI2180_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2180_01TMsg[inMsgLst.size()];
    ...
    private NSBI2180_01TMsg setCreateValue(ResultSet rs) {

        NSBI2180_01TMsg inParam = new NSBI2180_01TMsg();
