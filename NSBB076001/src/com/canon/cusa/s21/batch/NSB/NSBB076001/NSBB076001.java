 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB076001;
...
import business.db.NSBI2160_01TMsg;
...
/**
 * <pre>
 * Web OMAL FH CAS Cards Codes Batch
 * 
 ...
 * </pre>
 */
public class NSBB076001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB076001().executeBatch(NSBB076001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2160_01TMsg> inTMsgList = new ArrayList<NSBI2160_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2160_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2160_01TMsg> inMsgLst) {
        NSBI2160_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2160_01TMsg[inMsgLst.size()];
    ...
    private NSBI2160_01TMsg setCreateValue(ResultSet rs) {

        NSBI2160_01TMsg inParam = new NSBI2160_01TMsg();
