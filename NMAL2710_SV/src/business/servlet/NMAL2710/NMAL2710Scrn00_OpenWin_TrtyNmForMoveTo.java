...
/**
 *<pre>
 * NMAL2710Scrn00_OpenWin_TrtyNmForMoveTo
 *
 ...
 *</pre>
 */
public class NMAL2710Scrn00_OpenWin_TrtyNmForMoveTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, scrnMsg.orgNm_DC); // Territory Name
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, OPENWIN_TRTYNMFORMOVETO);
