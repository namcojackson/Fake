 ...
 *</pre>
 */
public class NSAL0610Scrn00_NewCollapse extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.N.no(eventLine).xxBtnFlg_N.getValue())) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.N.no(eventLine).xxBtnFlg_N, ZYPConstant.FLG_OFF_N);
        } else {
            ZYPEZDItemValueSetter.setValue(scrnMsg.N.no(eventLine).xxBtnFlg_N, ZYPConstant.FLG_ON_Y);
        }
