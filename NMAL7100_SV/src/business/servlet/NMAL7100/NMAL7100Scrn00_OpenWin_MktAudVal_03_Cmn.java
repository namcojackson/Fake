 ...
 *</pre>
 */
public class NMAL7100Scrn00_OpenWin_MktAudVal_03_Cmn extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        //
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm_H1, EVT_OPENWIN_MKTAUDVAL_03_CMN);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxCellIdx_H1, NMAL7100CommonLogic.convToBigDecimal(rowIdx));
        String mktPrmoAudcCatgCd = scrnMsg.X.no(rowIdx).mktPrmoAudcCatgCd_X3.getValue();
