 ...
 *</pre>
 */
public class NMAL7100Scrn00_OpenWin_Prmo_Item extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm_H1, EVT_OPENWIN_PRMO_ITEM);
...
//        Object[] argParam = NMAL7100CommonLogic.createArgumentNMWAL6800(scrnMsg, scrnMsg.A.no(rowIdx).mdseNm_DA, scrnMsg.A.no(rowIdx).mdseCd_DA);
        Object[] argParam = NMAL7100CommonLogic.createArgumentNMWAL6800(scrnMsg, scrnMsg.A.no(rowIdx).mdseDescShortTxt_DA, scrnMsg.A.no(rowIdx).mdseCd_DA);
