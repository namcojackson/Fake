 ...
 *</pre>
 */
public class NMAL7100Scrn00_Add_Detail extends S21CommonHandler {
...
//        NMAL7100CommonLogic.checkDetail(this, scrnMsg);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int selectIdx = bizMsg.A.getValidCount() - 1;
        NMAL7100CommonLogic.scrnAllGUIControl(this, scrnMsg, getUserProfileService()); // 2020/01/08 QC#55221 Add
        scrnMsg.setFocusItem(scrnMsg.A.no(selectIdx).prcMktPrmoCd_DA);
