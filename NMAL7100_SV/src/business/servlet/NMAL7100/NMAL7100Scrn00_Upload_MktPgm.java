 ...
 *</pre>
 */
public class NMAL7100Scrn00_Upload_MktPgm extends S21CommonHandler {
...
//            if (!ZYPUploadFileValidator.isAuthorizedExtension(scrnMsg.xxFileData_DH, Arrays.asList(new String[] {"csv", "txt" }))) {
            if (!ZYPUploadFileValidator.isAuthorizedExtension(scrnMsg.xxFileData_DH, Arrays.asList(new String[] {"txt", "csv", "xlsx", "xls" }))) {
