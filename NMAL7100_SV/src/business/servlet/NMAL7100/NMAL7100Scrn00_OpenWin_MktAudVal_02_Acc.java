...
import static business.servlet.NMAL7100.constant.NMAL7100Constant.EVT_OPENWIN_MKTAUDVAL_02_ACC;
 ...
 *</pre>
 */
public class NMAL7100Scrn00_OpenWin_MktAudVal_02_Acc extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm_H1, EVT_OPENWIN_MKTAUDVAL_02_ACC);
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxCellIdx_H1, NMAL7100CommonLogic.convToBigDecimal(rowIdx));

        Object[] argParam = NMAL7100CommonLogic.createArgumentNMWAL6760(scrnMsg.X.no(rowIdx).xxScrItem30Txt_X2, scrnMsg.X.no(rowIdx).xxRecNmTxt_X2);
