 ...
 *</pre>
 */
public class NPAL1500Scrn00_CMN_Submit extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        List unselectList = ZYPTableUtil.getUnSelectedRows(scrnMsg.A, NPAL1500Bean.xxChkBox_A1, ZYPConstant.CHKBOX_ON_Y);
        if (unselectList == null || unselectList.isEmpty()) {
            bizMsg.xxNum.setValue(0);
        } else {
            bizMsg.xxNum.setValue(unselectList.size());
        }
