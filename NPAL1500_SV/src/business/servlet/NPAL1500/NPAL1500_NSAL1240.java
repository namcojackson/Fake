 ...
 *</pre>
 */
public class NPAL1500_NSAL1240 extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.svcConfigMstrPk_P0)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.svcConfigMstrPk, scrnMsg.svcConfigMstrPk_P0.getValue());
        }
