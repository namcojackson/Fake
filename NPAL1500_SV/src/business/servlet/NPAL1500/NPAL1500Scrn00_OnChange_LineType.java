 ...
 * ----------------------------------------------------------------------
 * 12/22/2017   CITS            K.Ogino         Create          N/A
 * 2018/12/19   Fujitsu         S.Takami        Update          QC#29456
 *</pre>
 */
public class NPAL1500Scrn00_OnChange_LineType extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.setFocusItem(scrnMsg.A.no(getButtonSelectNumber()).poLineTpCd_A1);
    }
}
