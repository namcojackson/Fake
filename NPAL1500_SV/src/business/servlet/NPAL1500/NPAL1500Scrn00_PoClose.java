...
/** 
 *<pre>
 * NPAL1500Scrn00_PoClose
 * 
 * Event change: Close => PoClose
 *</pre>
 *<pre>
 ...
 *</pre>
 */
public class NPAL1500Scrn00_PoClose extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NPAL1500BMsg scrnMsg = (NPAL1500BMsg) bMsg;

        NPAL1500CommonLogic.inputCheckForCancel(scrnMsg);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if ("E".equals(bizMsg.getMessageKind())) {
            ...
            scrnMsg.putErrorScreen();
        } else if ("W".equals(bizMsg.getMessageKind())) {
