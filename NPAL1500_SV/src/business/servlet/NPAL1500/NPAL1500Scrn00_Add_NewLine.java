...
import static business.servlet.NPAL1500.constant.NPAL1500Constant.NPAM0077E;
 ...
 * ----------------------------------------------------------------------
 * 01/11/2016   CITS            N Akaishi       Create          N/A
 *</pre>
 */
public class NPAL1500Scrn00_Add_NewLine extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if ("E".equals(bizMsg.getMessageKind())) {
            ...
            scrnMsg.setFocusItem(scrnMsg.A.no(scrnMsg.A.getValidCount() - 1).poLineTpCd_A1);
        }
