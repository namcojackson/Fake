 ...
 * 2023/04/21   Hitachi         T.Kuroda        Update          QC#61166
 *</pre>
 */
public class NLBL3060Scrn00_Delete_Row extends S21CommonHandler implements NLBL3060Constant {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // START 2023/04/21 T.Kuroda [QC#61166, MOD]
//        if (bizMsg.A.getValidCount() <= 0) {
        if (bizMsg.A.getValidCount() <= 0 && "E".equals(bizMsg.getMessageKind())) {
            this.setButtonEnabled(BTN_CMN_SUBMIT[0], false);
        }
        // END   2023/04/21 T.Kuroda [QC#61166, MOD]
        scrnMsg.addCheckItem(scrnMsg.A);
        scrnMsg.A.setCheckParam(new String[] {NLBL3060Bean.xxChkBox_A1 }, 1);
