 ...
 *</pre>
 */
public class NLBL3060Scrn00_Btn_GroupName extends S21CommonHandler {
    ...
    private Object[] setPopupParameter(NLBL3060BMsg scrnMsg) {
        ...
        scrnMsg.xxScrEventNm.setValue("Btn_GroupName");
        scrnMsg.P.clear();
        ...
        String whereSt  = "";
        if(scrnMsg.A.no(scrnMsg.xxNum.getValueInt()).physWhCd_A1.getValue().isEmpty()){
            
            whereSt = "%";
        }else {
            whereSt = scrnMsg.A.no(scrnMsg.xxNum.getValueInt()).physWhCd_A1.getValue();
        }
