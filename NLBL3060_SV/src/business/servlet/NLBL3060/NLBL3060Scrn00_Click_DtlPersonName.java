 ...
 *</pre>
 */
public class NLBL3060Scrn00_Click_DtlPersonName extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.A.no(selectIdx).schdCoordPsnCd_A1);
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(selectIdx).schdCoordPsnCd_A1)) {
            scrnMsg.A.no(selectIdx).schdCoordPsnCd_A1.setErrorInfo(1, "NLAM0173E", new String[]{"Person Code"});
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.A.no(scrnMsg.xxNum.getValueInt()).schdCoordPsnCd_A1);
        scrnMsg.putErrorScreen();
    }
}
