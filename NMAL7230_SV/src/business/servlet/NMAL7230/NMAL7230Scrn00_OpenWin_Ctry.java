...
import static business.servlet.NMAL7230.constant.NMAL7230Constant.POPUP_NM_COUNTRY_SORT;
 ...
 *</pre>
 */
public class NMAL7230Scrn00_OpenWin_Ctry extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        int i = 0;
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_CTRY_TABLE_NM);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_CODE);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_NAME);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_SORT);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_SEARCH_POPUP);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_CODE_DISPLAY);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_NAME_DISPLAY);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_CODE_DISPLAY);
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, POPUP_NM_COUNTRY_NAME_DISPLAY);
        scrnMsg.P.setValidCount(i);
        params[NAML6050_PRM_CODE_NUM] = scrnMsg.A.no(index).shipToCtryCd_A1;
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, EVENT_NM_OPENWIN_CTRY);
