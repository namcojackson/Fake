...
/**
 *<pre>
 * NMAL7230Scrn00_OpenWin_MultiPrcGrp
 *
 ...
 *</pre>
 */
public class NMAL7230Scrn00_OpenWin_MultiPrcGrp extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        String[] prcGrpNmList = scrnMsg.xxDsMultMsgDplyTxt_HG.getValue().split(",", 0);
        for (int i = 0; i < prcGrpNmList.length; i++) {
            scrnMsg.P.no(i).xxComnScrColValTxt_0.setValue(prcGrpNmList[i]);
        }
        scrnMsg.P.setValidCount(prcGrpNmList.length);
        params[6] = scrnMsg.P;

        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, EVENT_NM_OPENWIN_MULTICUSTGRP);
    ...
    private List<Object> getSearchConditionSetting() {
        ...
        Object[] whereObj1 = {POPUP_NM_CUSTGRP_NAME_DISPLAY, POPUP_NM_CUSTGRP_NAME, null, ZYPConstant.FLG_ON_Y };
