...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NMAL7230Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Freight Zone Setup">
											...
											<td>
												<table border="0">
													...
													<tr height="20">
														...
														<td><ezf:inputText name="shipToFromPostCd" ezfName="shipToFromPostCd" value="99999-9999" otherAttr=" size=\"10\" maxlength=\"10\" ezftoupper=\"\""/></td>
													</tr>
													<tr height="20">
														...
														<td><ezf:inputText name="shipToThruPostCd" ezfName="shipToThruPostCd" value="99999-9999" otherAttr=" size=\"10\" maxlength=\"10\" ezftoupper=\"\""/></td>
													</tr>
													<tr height="20">
														<td class="stab"><ezf:anchor name="xxLinkAncr_HS" ezfName="xxLinkAncr_HS" ezfEmulateBtn="1" ezfGuard="OpenWin_MultiSt" otherAttr=" id=\"xxLinkAncr_HS\"">State</ezf:anchor></td>
														<td><ezf:inputText name="xxDsMultMsgDplyTxt_HS" ezfName="xxDsMultMsgDplyTxt_HS" value="NY" otherAttr=" size=\"50\" maxlength=\"4000\" ezftoupper=\"\""/></td>
														<td>&nbsp;</td>
														<td>&nbsp;</td>
														<td>&nbsp;</td>
													</tr>
													<tr height="20">
														<td class="stab"><ezf:anchor name="xxLinkAncr_HC" ezfName="xxLinkAncr_HC" ezfEmulateBtn="1" ezfGuard="OpenWin_MultiCtry" otherAttr=" id=\"xxLinkAncr_HC\"">Country</ezf:anchor></td>
														<td><ezf:inputText name="xxDsMultMsgDplyTxt_HC" ezfName="xxDsMultMsgDplyTxt_HC" value="U.S.A" otherAttr=" size=\"50\" maxlength=\"4000\" ezftoupper=\"\""/></td>
														<td>&nbsp;</td>
													...
													<tr height="20">
														<td class="stab"><ezf:anchor name="xxLinkAncr_HA" ezfName="xxLinkAncr_HA" ezfEmulateBtn="1" ezfGuard="OpenWin_MultiCust" otherAttr=" id=\"xxLinkAncr_HA\"">Customer</ezf:anchor></td>
														<td><ezf:inputText name="xxDsMultMsgDplyTxt_HA" ezfName="xxDsMultMsgDplyTxt_HA" value="U.S.A" otherAttr=" size=\"50\" maxlength=\"4000\" ezftoupper=\"\""/></td>
														<td>&nbsp;</td>
													...
													<tr height="20">
														<td class="stab"><ezf:anchor name="xxLinkAncr_HG" ezfName="xxLinkAncr_HG" ezfEmulateBtn="1" ezfGuard="OpenWin_MultiPrcGrp" otherAttr=" id=\"xxLinkAncr_HG\"">Customer Group</ezf:anchor></td>
														<td><ezf:inputText name="xxDsMultMsgDplyTxt_HG" ezfName="xxDsMultMsgDplyTxt_HG" value="U.S.A" otherAttr=" size=\"50\" maxlength=\"4000\" ezftoupper=\"\""/></td>
														<td>&nbsp;</td>
									...
									<tr>
										<td>
											<table border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td>
														<table style="table-layout:fixed;" border="1" cellpadding="1" cellspacing="0">
															...
															<col width="125" align="center">	<!-- Line of Business -->
															<col width="230" align="center">	<!-- Customer -->
															<col width="140" align="center">	<!-- Customer Group -->
															<col width="40" align="center">		<!-- Zone -->
															<col width="75" align="center">		<!-- State -->
															<col width="80" align="center">		<!-- Country -->
															<col width="80" align="center">		<!-- Postal From -->
															<col width="80" align="center">		<!-- Postal To -->
															...
															<tr height="28">
																...
																<td class="pClothBs">Postal From</td>
																<td class="pClothBs">Postal To</td>
												...
												<tr>
													<td>
														<div style="height:300px; display:block; overflow-y:scroll; overflow-x:none; margin:0px; padding:0px;" >
															<table id="A" style="table-layout:fixed;" border="1" cellpadding="1" cellspacing="0">
																<col width="30" align="center">		<!-- checkBox -->
																<col width="125" align="left">		<!-- Line of Business -->
																<col width="230" align="left">		<!-- Customer -->
																<col width="140" align="center">	<!-- Customer Group -->
																<col width="40" align="center">		<!-- Zone -->
																<col width="75" align="center">		<!-- State -->
																<col width="80" align="center">		<!-- Country -->
																<col width="80" align="left">		<!-- Postal From -->
																<col width="80" align="left">		<!-- Postal To -->
																...
																<ezf:row ezfHyo="A">
																	<tr id="id_row${EZF_ROW_NUMBER}">
																		...
																		<td>
																			...
																			<ezf:inputText name="lineBizTpDescTxt_A1" ezfName="lineBizTpDescTxt_A1" value="123456789A123456789B123456789C123456789D123456789E" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"10\" maxlength=\"50\" ezftoupper=\"\""/>
																		</td>
																		<td>
																			<ezf:inputButton name="OpenWin_Cust" value="CUST" ezfHyo="A" ezfArrayNo="0" htmlClass="pBtn2" />
																			<ezf:inputText name="dsAcctNm_A1" ezfName="dsAcctNm_A1" value="123456789A123456789B123456789C123456789D" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"25\" maxlength=\"360\" ezftoupper=\"\""/>
																		</td>
																		<td>
																			<ezf:inputButton name="OpenWin_PrcGrp" value="GRP" ezfHyo="A" ezfArrayNo="0" htmlClass="pBtn2" />
																			<ezf:inputText name="prcGrpNm_A1" ezfName="prcGrpNm_A1" value="123456789A123456789B123456789C123456789D123456789E" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"12\" maxlength=\"50\" ezftoupper=\"\""/>
																		</td>
																		...
																		<td>
																			<ezf:inputButton name="OpenWin_St" value="ST" ezfHyo="A" ezfArrayNo="0" htmlClass="pBtn2" />
																			<ezf:inputText name="shipToStCd_A1" ezfName="shipToStCd_A1" value="NY" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"2\" maxlength=\"2\" ezftoupper=\"\""/>
																		</td>
																		<td>
																			<ezf:inputButton name="OpenWin_Ctry" value="CTRY" ezfHyo="A" ezfArrayNo="0" htmlClass="pBtn2" />
																			<ezf:inputText name="shipToCtryCd_A1" ezfName="shipToCtryCd_A1" value="MX" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"3\" maxlength=\"3\" ezftoupper=\"\""/>
																		</td>
																		<td><ezf:inputText name="shipToFromPostCd_A1" ezfName="shipToFromPostCd_A1" value="99999-9999" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"10\" maxlength=\"10\" ezftoupper=\"\""/></td>
																		<td><ezf:inputText name="shipToThruPostCd_A1" ezfName="shipToThruPostCd_A1" value="99999-9999" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"10\" maxlength=\"10\" ezftoupper=\"\""/></td>
																		<td>
																			<ezf:inputText name="effFromDt_A1" ezfName="effFromDt_A1" value="01/01/9999" ezfHyo="A" ezfArrayNo="0" otherEvent1=" onpaste=\"return fPaste(this);\"" otherAttr=" size=\"10\" maxlength=\"10\" ezftoupper=\"\""/>
    ...
    for (cnt = offset; cnt < document.forms[0].elements.length && targetCt < arrayClip.length; cnt ++) {
        if(arrayClip[targetCt].length != 0 && document.forms[0].elements[cnt].name == obj.name){
            ...
            switch (obj.name) {
                ...
                case 'shipToCtryCd_A1':
                    cnt = cnt + 1;
                    if (tabClip.length > tabCt) {
                        document.forms[0].elements[cnt].value = tabClip[tabCt++].toUpperCase();
                    }
                case 'shipToFromPostCd_A1':
                    cnt = cnt + 1;
                    if (tabClip.length > tabCt) {
                        document.forms[0].elements[cnt].value = tabClip[tabCt++].toUpperCase();
                    }
                case 'shipToThruPostCd_A1':
                    cnt = cnt + 1;
                    if (tabClip.length > tabCt) {
                        document.forms[0].elements[cnt].value = tabClip[tabCt++].toUpperCase();
                    }
