...
public class NWAL2040Scrn00_Change_DsOrdCatgPulldown extends S21CommonHandler implements NWAL2040Constant {
	...
	protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.xxCellIdx_H1.setValue(selectIndex);
...
//		NWAL2040CommonLogic.setPage(scrnMsg, 1);
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.setFocusItem(scrnMsg.B.no(getButtonSelectNumber()).dsOrdCatgCd_B1);
