 ...
 *</pre>
 */
public class NWAL2040Scrn00_LineItem_OTBD_SCD_ON_HND_CHK_SWH extends S21CommonHandler implements NWAL2040Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NWAL2040Scrn00_LineItem_OTBD_SCD_ON_HND_CHK_SWH");
		String selectStr = NWAL2040CommonLogic.setSelectFromStrForRtlSwh(scrnMsg, getGlobalCompanyCode());
		List<Object[]> whereList = NWAL2040CommonLogic.setWhereListForRtlSwh(scrnMsg, scrnMsg.A.no(getButtonSelectNumber()).otbdScdOnHndChkSwhCd_A1.getValue(), scrnMsg.A.no(getButtonSelectNumber()).rtlSwhNm_02.getValue());
