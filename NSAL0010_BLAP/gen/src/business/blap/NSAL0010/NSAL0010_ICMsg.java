...
/*
 *NSAL0010_ICMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0010_ICMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	public final EZDCBigDecimalItem              svcMachMstrTrkPk_I;

    /** TRX_RGTN_DT_I*/
	public final EZDCDateItem              trxRgtnDt_I;

    /** MACH_HIST_ATTRB_LONG_NM_I*/
	public final EZDCStringItem              machHistAttrbLongNm_I;

    /** OLD_VAL_TXT_I*/
	public final EZDCStringItem              oldValTxt_I;

    /** NEW_VAL_TXT_I*/
	public final EZDCStringItem              newValTxt_I;

    /** UPD_USR_ID_I*/
	public final EZDCStringItem              updUsrId_I;

    /** XX_YES_NO_CD_IA*/
	public final EZDCStringItem              xxYesNoCd_IA;

    /** XX_YES_NO_CD_I*/
	public final EZDCStringItem              xxYesNoCd_I;


	/**
	 * NSAL0010_ICMsg is constructor.
	 * The initialization when the instance of NSAL0010_ICMsg is generated.
	 */
	public NSAL0010_ICMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0010_ICMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		svcMachMstrTrkPk_I = (EZDCBigDecimalItem)newItem("svcMachMstrTrkPk_I");
		trxRgtnDt_I = (EZDCDateItem)newItem("trxRgtnDt_I");
		machHistAttrbLongNm_I = (EZDCStringItem)newItem("machHistAttrbLongNm_I");
		oldValTxt_I = (EZDCStringItem)newItem("oldValTxt_I");
		newValTxt_I = (EZDCStringItem)newItem("newValTxt_I");
		updUsrId_I = (EZDCStringItem)newItem("updUsrId_I");
		xxYesNoCd_IA = (EZDCStringItem)newItem("xxYesNoCd_IA");
		xxYesNoCd_I = (EZDCStringItem)newItem("xxYesNoCd_I");
	}

	/**
	 * get the type of array which is stored
	 * @return NSAL0010_ICMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0010_ICMsgArray();
	}
