...
/*
 *NSAL0350_JSMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0350_JSMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	public final EZDSBigDecimalItem              dsContrBllgSchdPk_J1;
	...
	public final EZDSStringItem              dsContrBllgSchdLvlNum_J1;

    /** DS_CONTR_PRC_EFF_SQ_NUM_J1*/
	public final EZDSBigDecimalItem              dsContrPrcEffSqNum_J1;

    /** SKIP_RECOV_TP_CD_J3*/
	public final EZDSStringItem              skipRecovTpCd_J3;
    ...
    /** NEXT_BLLG_DT_J1*/
	public final EZDSDateItem              nextBllgDt_J1;

    /** NEXT_BLLG_DT_J2*/
	public final EZDSDateItem              nextBllgDt_J2;

    /** RVS_SCHD_DT_J1*/
	public final EZDSDateItem              rvsSchdDt_J1;

    /** BASE_PRC_DEAL_AMT_J1*/
	public final EZDSBigDecimalItem              basePrcDealAmt_J1;

    /** MTR_ENTRY_CPLT_FLG_J1*/
	public final EZDSStringItem              mtrEntryCpltFlg_J1;

    /** DS_BLLG_SCHD_STS_CD_J1*/
	public final EZDSStringItem              dsBllgSchdStsCd_J1;

    /** DS_BLLG_SCHD_STS_DESC_TXT_J1*/
	public final EZDSStringItem              dsBllgSchdStsDescTxt_J1;

    /** SVC_INV_NUM_J1*/
	public final EZDSStringItem              svcInvNum_J1;

    /** EIP_RPT_RQST_PK_J1*/
	public final EZDSBigDecimalItem              eipRptRqstPk_J1;

    /** INV_DT_J1*/
	public final EZDSDateItem              invDt_J1;

    /** BASE_ACTL_PRC_DEAL_AMT_J1*/
	public final EZDSBigDecimalItem              baseActlPrcDealAmt_J1;

    /** DEAL_TAX_AMT_J1*/
	public final EZDSBigDecimalItem              dealTaxAmt_J1;
	...
	/**
	 * NSAL0350_JSMsg is constructor.
	 * The initialization when the instance of NSAL0350_JSMsg is generated.
	 */
	public NSAL0350_JSMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0350_JSMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		dsContrBllgSchdPk_J1 = (EZDSBigDecimalItem)newItem("dsContrBllgSchdPk_J1");
		...
		dsContrBllgSchdLvlNum_J1 = (EZDSStringItem)newItem("dsContrBllgSchdLvlNum_J1");
		dsContrPrcEffSqNum_J1 = (EZDSBigDecimalItem)newItem("dsContrPrcEffSqNum_J1");
		skipRecovTpCd_J3 = (EZDSStringItem)newItem("skipRecovTpCd_J3");
		bllgSchdFromDt_J1 = (EZDSDateItem)newItem("bllgSchdFromDt_J1");
		bllgSchdThruDt_J1 = (EZDSDateItem)newItem("bllgSchdThruDt_J1");
		nextBllgDt_J1 = (EZDSDateItem)newItem("nextBllgDt_J1");
		nextBllgDt_J2 = (EZDSDateItem)newItem("nextBllgDt_J2");
		rvsSchdDt_J1 = (EZDSDateItem)newItem("rvsSchdDt_J1");
		basePrcDealAmt_J1 = (EZDSBigDecimalItem)newItem("basePrcDealAmt_J1");
		mtrEntryCpltFlg_J1 = (EZDSStringItem)newItem("mtrEntryCpltFlg_J1");
		dsBllgSchdStsCd_J1 = (EZDSStringItem)newItem("dsBllgSchdStsCd_J1");
		dsBllgSchdStsDescTxt_J1 = (EZDSStringItem)newItem("dsBllgSchdStsDescTxt_J1");
		svcInvNum_J1 = (EZDSStringItem)newItem("svcInvNum_J1");
		eipRptRqstPk_J1 = (EZDSBigDecimalItem)newItem("eipRptRqstPk_J1");
		invDt_J1 = (EZDSDateItem)newItem("invDt_J1");
		baseActlPrcDealAmt_J1 = (EZDSBigDecimalItem)newItem("baseActlPrcDealAmt_J1");
		dealTaxAmt_J1 = (EZDSBigDecimalItem)newItem("dealTaxAmt_J1");
	 ...
	 * @return NSAL0350_JSMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0350_JSMsgArray();
	}
