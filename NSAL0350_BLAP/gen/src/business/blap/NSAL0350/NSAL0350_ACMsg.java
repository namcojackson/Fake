...
/*
 *NSAL0350_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0350_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	public final EZDCBigDecimalItem              dsContrBllgSchdPk_A1;
	...
	public final EZDCStringItem              dsContrBllgSchdLvlNum_A1;

    /** DS_CONTR_PRC_EFF_SQ_NUM_A1*/
	public final EZDCBigDecimalItem              dsContrPrcEffSqNum_A1;

    /** SKIP_RECOV_TP_CD_A3*/
	public final EZDCStringItem              skipRecovTpCd_A3;
    ...
    /** NEXT_BLLG_DT_A2*/
	public final EZDCDateItem              nextBllgDt_A2;

    /** RVS_SCHD_DT_A1*/
	public final EZDCDateItem              rvsSchdDt_A1;

    /** BASE_PRC_DEAL_AMT_A1*/
	public final EZDCBigDecimalItem              basePrcDealAmt_A1;

    /** MTR_ENTRY_CPLT_FLG_A1*/
	public final EZDCStringItem              mtrEntryCpltFlg_A1;

    /** DS_BLLG_SCHD_STS_CD_A1*/
	public final EZDCStringItem              dsBllgSchdStsCd_A1;

    /** DS_BLLG_SCHD_STS_DESC_TXT_A1*/
	public final EZDCStringItem              dsBllgSchdStsDescTxt_A1;
	...
	public final EZDCBigDecimalItem              baseActlPrcDealAmt_A1;

    /** DEAL_TAX_AMT_A1*/
	public final EZDCBigDecimalItem              dealTaxAmt_A1;
	...
	/**
	 * NSAL0350_ACMsg is constructor.
	 * The initialization when the instance of NSAL0350_ACMsg is generated.
	 */
	public NSAL0350_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0350_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		dsContrBllgSchdPk_A1 = (EZDCBigDecimalItem)newItem("dsContrBllgSchdPk_A1");
		...
		dsContrBllgSchdLvlNum_A1 = (EZDCStringItem)newItem("dsContrBllgSchdLvlNum_A1");
		dsContrPrcEffSqNum_A1 = (EZDCBigDecimalItem)newItem("dsContrPrcEffSqNum_A1");
		skipRecovTpCd_A3 = (EZDCStringItem)newItem("skipRecovTpCd_A3");
		...
		nextBllgDt_A2 = (EZDCDateItem)newItem("nextBllgDt_A2");
		rvsSchdDt_A1 = (EZDCDateItem)newItem("rvsSchdDt_A1");
		basePrcDealAmt_A1 = (EZDCBigDecimalItem)newItem("basePrcDealAmt_A1");
		mtrEntryCpltFlg_A1 = (EZDCStringItem)newItem("mtrEntryCpltFlg_A1");
		dsBllgSchdStsCd_A1 = (EZDCStringItem)newItem("dsBllgSchdStsCd_A1");
		dsBllgSchdStsDescTxt_A1 = (EZDCStringItem)newItem("dsBllgSchdStsDescTxt_A1");
		...
		baseActlPrcDealAmt_A1 = (EZDCBigDecimalItem)newItem("baseActlPrcDealAmt_A1");
		dealTaxAmt_A1 = (EZDCBigDecimalItem)newItem("dealTaxAmt_A1");
	 ...
	 * @return NSAL0350_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0350_ACMsgArray();
	}
