...
/*
 *NSAL0350_BCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0350_BCMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	public final EZDCBigDecimalItem              dsContrBllgSchdPk_B1;
	...
	public final EZDCStringItem              dsContrBllgSchdLvlNum_B1;

    /** DS_CONTR_PRC_EFF_SQ_NUM_B1*/
	public final EZDCBigDecimalItem              dsContrPrcEffSqNum_B1;

    /** SKIP_RECOV_TP_CD_B3*/
	public final EZDCStringItem              skipRecovTpCd_B3;
    ...
    /** NEXT_BLLG_DT_B1*/
	public final EZDCDateItem              nextBllgDt_B1;

    /** NEXT_BLLG_DT_B2*/
	public final EZDCDateItem              nextBllgDt_B2;

    /** RVS_SCHD_DT_B1*/
	public final EZDCDateItem              rvsSchdDt_B1;

    /** BASE_PRC_DEAL_AMT_B1*/
	public final EZDCBigDecimalItem              basePrcDealAmt_B1;

    /** MTR_ENTRY_CPLT_FLG_B1*/
	public final EZDCStringItem              mtrEntryCpltFlg_B1;

    /** DS_BLLG_SCHD_STS_CD_B1*/
	public final EZDCStringItem              dsBllgSchdStsCd_B1;

    /** DS_BLLG_SCHD_STS_DESC_TXT_B1*/
	public final EZDCStringItem              dsBllgSchdStsDescTxt_B1;

    /** SVC_INV_NUM_B1*/
	public final EZDCStringItem              svcInvNum_B1;

    /** EIP_RPT_RQST_PK_B1*/
	public final EZDCBigDecimalItem              eipRptRqstPk_B1;

    /** INV_DT_B1*/
	public final EZDCDateItem              invDt_B1;

    /** BASE_ACTL_PRC_DEAL_AMT_B1*/
	public final EZDCBigDecimalItem              baseActlPrcDealAmt_B1;

    /** DEAL_TAX_AMT_B1*/
	public final EZDCBigDecimalItem              dealTaxAmt_B1;
	...
	/**
	 * NSAL0350_BCMsg is constructor.
	 * The initialization when the instance of NSAL0350_BCMsg is generated.
	 */
	public NSAL0350_BCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0350_BCMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		dsContrBllgSchdPk_B1 = (EZDCBigDecimalItem)newItem("dsContrBllgSchdPk_B1");
		...
		dsContrBllgSchdLvlNum_B1 = (EZDCStringItem)newItem("dsContrBllgSchdLvlNum_B1");
		dsContrPrcEffSqNum_B1 = (EZDCBigDecimalItem)newItem("dsContrPrcEffSqNum_B1");
		skipRecovTpCd_B3 = (EZDCStringItem)newItem("skipRecovTpCd_B3");
		bllgSchdFromDt_B1 = (EZDCDateItem)newItem("bllgSchdFromDt_B1");
		bllgSchdThruDt_B1 = (EZDCDateItem)newItem("bllgSchdThruDt_B1");
		nextBllgDt_B1 = (EZDCDateItem)newItem("nextBllgDt_B1");
		nextBllgDt_B2 = (EZDCDateItem)newItem("nextBllgDt_B2");
		rvsSchdDt_B1 = (EZDCDateItem)newItem("rvsSchdDt_B1");
		basePrcDealAmt_B1 = (EZDCBigDecimalItem)newItem("basePrcDealAmt_B1");
		mtrEntryCpltFlg_B1 = (EZDCStringItem)newItem("mtrEntryCpltFlg_B1");
		dsBllgSchdStsCd_B1 = (EZDCStringItem)newItem("dsBllgSchdStsCd_B1");
		dsBllgSchdStsDescTxt_B1 = (EZDCStringItem)newItem("dsBllgSchdStsDescTxt_B1");
		svcInvNum_B1 = (EZDCStringItem)newItem("svcInvNum_B1");
		eipRptRqstPk_B1 = (EZDCBigDecimalItem)newItem("eipRptRqstPk_B1");
		invDt_B1 = (EZDCDateItem)newItem("invDt_B1");
		baseActlPrcDealAmt_B1 = (EZDCBigDecimalItem)newItem("baseActlPrcDealAmt_B1");
		dealTaxAmt_B1 = (EZDCBigDecimalItem)newItem("dealTaxAmt_B1");
	 ...
	 * @return NSAL0350_BCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0350_BCMsgArray();
	}
