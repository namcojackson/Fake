...
/*
 *NLCL0610_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLCL0610_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** PHYS_INVTY_NUM_A*/
	public final EZDSStringItem              physInvtyNum_A;
    ...
    /** PHYS_INVTY_DT_A*/
	public final EZDSDateItem              physInvtyDt_A;

    /** PHYS_INVTY_CTRL_NM_A*/
	public final EZDSStringItem              physInvtyCtrlNm_A;

    /** PHYS_INVTY_STS_NM_A*/
	public final EZDSStringItem              physInvtyStsNm_A;

    /** PHYS_INVTY_START_TS_A*/
	public final EZDSStringItem              physInvtyStartTs_A;

    /** PHYS_INVTY_CTRL_DESC_NM_A*/
	public final EZDSStringItem              physInvtyCtrlDescNm_A;

    /** XX_SCR_ITEM_20_TXT_A*/
	public final EZDSStringItem              xxScrItem20Txt_A;


	/**
	 * NLCL0610_ASMsg is constructor.
	 * The initialization when the instance of NLCL0610_ASMsg is generated.
	 */
	public NLCL0610_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLCL0610_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		physInvtyNum_A = (EZDSStringItem)newItem("physInvtyNum_A");
		...
		physInvtyDt_A = (EZDSDateItem)newItem("physInvtyDt_A");
		physInvtyCtrlNm_A = (EZDSStringItem)newItem("physInvtyCtrlNm_A");
		physInvtyStsNm_A = (EZDSStringItem)newItem("physInvtyStsNm_A");
		physInvtyStartTs_A = (EZDSStringItem)newItem("physInvtyStartTs_A");
		physInvtyCtrlDescNm_A = (EZDSStringItem)newItem("physInvtyCtrlDescNm_A");
		xxScrItem20Txt_A = (EZDSStringItem)newItem("xxScrItem20Txt_A");
	}

	/**
	 * get the type of array which is stored
	 * @return NLCL0610_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLCL0610_ASMsgArray();
	}
