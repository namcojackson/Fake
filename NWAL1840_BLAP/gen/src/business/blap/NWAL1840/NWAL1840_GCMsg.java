...
/*
 *NWAL1840_GCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NWAL1840_GCMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** MDSE_CD_G*/
	public final EZDCStringItem              mdseCd_G;

    /** MDSE_DESC_SHORT_TXT_G*/
	public final EZDCStringItem              mdseDescShortTxt_G;

    /** SCHD_ALLW_QTY_G*/
	public final EZDCBigDecimalItem              schdAllwQty_G;

    /** ORD_QTY_G*/
	public final EZDCBigDecimalItem              ordQty_G;

    /** SHIP_QTY_G*/
	public final EZDCBigDecimalItem              shipQty_G;


	/**
	 * NWAL1840_GCMsg is constructor.
	 * The initialization when the instance of NWAL1840_GCMsg is generated.
	 */
	public NWAL1840_GCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NWAL1840_GCMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		mdseCd_G = (EZDCStringItem)newItem("mdseCd_G");
		mdseDescShortTxt_G = (EZDCStringItem)newItem("mdseDescShortTxt_G");
		schdAllwQty_G = (EZDCBigDecimalItem)newItem("schdAllwQty_G");
		ordQty_G = (EZDCBigDecimalItem)newItem("ordQty_G");
		shipQty_G = (EZDCBigDecimalItem)newItem("shipQty_G");
	}

	/**
	 * get the type of array which is stored
	 * @return NWAL1840_GCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NWAL1840_GCMsgArray();
	}
