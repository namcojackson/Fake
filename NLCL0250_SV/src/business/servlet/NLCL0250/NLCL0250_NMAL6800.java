 ...
 *</pre>
 */
public class NLCL0250_NMAL6800 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!NLCL0250Constant.EVENT_NM_CMN_CLOSE.equals(getLastGuard())) {
            ...
            ZYPEZDItemValueSetter.setValue(scrnMsg.xxMdseSrchTxt_H1, scrnMsg.P.no(0).srchOptTxt_P.getValue());
        }

        // Set Focus
        scrnMsg.setFocusItem(scrnMsg.xxMdseSrchTxt_H1);
    }
}
