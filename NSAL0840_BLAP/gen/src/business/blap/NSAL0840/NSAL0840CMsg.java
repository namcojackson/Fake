...
/*
 *NSAL0840CMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0840CMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** A*/
	public final business.blap.NSAL0840.NSAL0840_ACMsgArray              A;
    ...
    /** CHRG_LVL_TP_CD_AL*/
	public final EZDCStringItemArray              chrgLvlTpCd_AL;

    /** CHRG_LVL_TP_DESC_TXT_AL*/
	public final EZDCStringItemArray              chrgLvlTpDescTxt_AL;

    /** ADDL_CHRG_TP_CD_AT*/
	public final EZDCStringItemArray              addlChrgTpCd_AT;

    /** ADDL_CHRG_TP_DESC_TXT_AT*/
	public final EZDCStringItemArray              addlChrgTpDescTxt_AT;

    /** BLLG_CYCLE_CD_AB*/
	public final EZDCStringItemArray              bllgCycleCd_AB;

    /** BLLG_CYCLE_DESC_TXT_AB*/
	public final EZDCStringItemArray              bllgCycleDescTxt_AB;

    /** ADDL_CHRG_INV_TP_CD_AI*/
	public final EZDCStringItemArray              addlChrgInvTpCd_AI;

    /** ADDL_CHRG_INV_TP_DESC_TXT_AI*/
	public final EZDCStringItemArray              addlChrgInvTpDescTxt_AI;
    ...
    /** T*/
	public final business.blap.NSAL0840.NSAL0840_TCMsgArray              T;

    /** P*/
	public final business.blap.NSAL0840.NSAL0840_PCMsgArray              P;


	/**
	 * NSAL0840CMsg is constructor.
	 * The initialization when the instance of NSAL0840CMsg is generated.
	 */
	public NSAL0840CMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0840CMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		A = (business.blap.NSAL0840.NSAL0840_ACMsgArray)newMsgArray("A");
		...
		chrgLvlTpCd_AL = (EZDCStringItemArray)newItemArray("chrgLvlTpCd_AL");
		chrgLvlTpDescTxt_AL = (EZDCStringItemArray)newItemArray("chrgLvlTpDescTxt_AL");
		addlChrgTpCd_AT = (EZDCStringItemArray)newItemArray("addlChrgTpCd_AT");
		addlChrgTpDescTxt_AT = (EZDCStringItemArray)newItemArray("addlChrgTpDescTxt_AT");
		bllgCycleCd_AB = (EZDCStringItemArray)newItemArray("bllgCycleCd_AB");
		bllgCycleDescTxt_AB = (EZDCStringItemArray)newItemArray("bllgCycleDescTxt_AB");
		addlChrgInvTpCd_AI = (EZDCStringItemArray)newItemArray("addlChrgInvTpCd_AI");
		addlChrgInvTpDescTxt_AI = (EZDCStringItemArray)newItemArray("addlChrgInvTpDescTxt_AI");
		...
		T = (business.blap.NSAL0840.NSAL0840_TCMsgArray)newMsgArray("T");
		P = (business.blap.NSAL0840.NSAL0840_PCMsgArray)newMsgArray("P");
	}

	/**
	 * get the type of array which is stored
	 * @return NSAL0840CMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0840CMsgArray();
	}
	...
	{"A", "A", null, "50", "business.blap.NSAL0840.NSAL0840_ACMsgArray", null, null},
	...
	{"T", "T", null, "200", "business.blap.NSAL0840.NSAL0840_TCMsgArray", null, null},
	
	{"P", "P", null, "200", "business.blap.NSAL0840.NSAL0840_PCMsgArray", null, null},
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"CHRG_LVL_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//chrgLvlTpCd_AL
        {"CHRG_LVL_TP_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//chrgLvlTpDescTxt_AL
        {"ADDL_CHRG_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//addlChrgTpCd_AT
        {"ADDL_CHRG_TP_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//addlChrgTpDescTxt_AT
        {"BLLG_CYCLE_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//bllgCycleCd_AB
        {"BLLG_CYCLE_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//bllgCycleDescTxt_AB
        {"ADDL_CHRG_INV_TP_CD",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//addlChrgInvTpCd_AI
        {"ADDL_CHRG_INV_TP_DESC_TXT",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//addlChrgInvTpDescTxt_AI
