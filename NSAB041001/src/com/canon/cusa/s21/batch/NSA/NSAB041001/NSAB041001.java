 ...
 */
package com.canon.cusa.s21.batch.NSA.NSAB041001;

import static com.canon.cusa.s21.batch.NSA.NSAB041001.constant.NSAB041001Constant.*;
...
import business.db.CFS_MTR_READTMsg;
 ...
 * 2016/05/17   Hitachi         O.Okuma         Update          QC#8240
 ...
 *</pre>
 */
public class NSAB041001 extends S21BatchMain {
...
// START 2016/09/27 N.Arai [QC#12670, MOD]
    /** cfs bat proc pk */
    private BigDecimal cfsBatProcPkSq = null;

    /** Sales Date */
    private String slsDt = null;
// END 2016/09/27 N.Arai [QC#12670, MOD]
    ...
    public static void main(String[] args) {
        new NSAB041001().executeBatch(NSAB041001.class.getSimpleName());
    }
...
// START 2016/09/27 N.Arai [QC#12670, ADD]
    ...
    private String insertCfsBatProc() {
        ...
        setValue(insTMsg.cfsBatTpCd, CFS_BAT_TP.INVOICE);
...
// END 2016/09/27 N.Arai [QC#12670, ADD]
    ...
    private boolean insertCfsMtrRead(ResultSet rs) throws SQLException {

        CFS_MTR_READTMsg tMsg = new CFS_MTR_READTMsg();

        setValue(tMsg.glblCmpyCd, glblCmpyCd);
        setValue(tMsg.cfsMtrReadPk, ZYPOracleSeqAccessor.getNumberBigDecimal(ZYPOracleSeqConstant.CFS_MTR_READ_SQ));
        ...
        setValue(tMsg.totCopyQty, rs.getBigDecimal(TOT_COPY_QTY));
        setValue(tMsg.prevTotCopyQty, rs.getBigDecimal(PREV_TOT_COPY_QTY));
        setValue(tMsg.testCopyQty, rs.getBigDecimal(TEST_COPY_QTY));
        ...
        setValue(tMsg.svcPhysMtrReadGrpSq, rs.getBigDecimal(SVC_PHYS_MTR_READ_GRP_SQ));
        ...
        if (!S21FastTBLAccessor.RTNCD_NORMAL.equals(tMsg.getReturnCode())) {
            ...
            this.errMsgList.add(S21MessageFunc.clspGetMessage(NSAM0469E, new String[] {TBL_NM_CFS_MTR_READ, message }));
            return false;
        }
