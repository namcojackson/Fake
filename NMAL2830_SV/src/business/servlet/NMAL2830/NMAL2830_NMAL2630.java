 ...
 *</pre>
 */
public class NMAL2830_NMAL2630 extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (BTN_CMN_CLOSE_EVENT_NM.equals(getLastGuard())) {
            ...
            ZYPEZDItemValueSetter.setValue(scrnMsg.orgNm_TN, scrnMsg.xxPopPrm_02);
            scrnMsg.setFocusItem(scrnMsg.orgNm_ON);
            return null;
        }
    }
