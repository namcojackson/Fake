...
/**
 *<pre>
 * NMAL2830Scrn00_RetrieveRequestedMergeTo
 *
 ...
 *</pre>
 */
public class NMAL2830Scrn00_RetrieveRequestedMergeTo extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (getButtonSelectNumber() != 0) {
            scrnMsg.setFocusItem(scrnMsg.A.no(getButtonSelectNumber() - 1).locNum_M);
        }
    }
}
