...
# Project Name    : S21
# SubSystem Name  : NLB
# JOB NET         : S21SWD_SLBNA0030
# JOB ID          : S21SWD_SLBJ0070010
# Creator         : S.Murakami
# Date            : 2009/11/17
# Summary         : S21-MW MQ  Receiving(PKT)
# Type            : Scheduled
# Cycle           : Every 15 min.
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SLBNA0030'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLBJ0070010'; export JOBSCH_JOBID
PROGRAM_ID='NLBB027001'; export PROGRAM_ID
...
# Interface ID
INTERFACE_ID='NLBI0030'; export INTERFACE_ID
