...
# Project Name    : S21
# SubSystem Name  : NLB
# JOB NET         : S21SWD_SLBND0070
# JOB ID          : S21SWD_SLBJ0220013
# Creator         : M.Takahashi
# Date            : 01/01/2016
# Summary         : Update SO Confirmation(Proc #4) (Night Time)
# Type            : Scheduled
# Cycle           : Daily(Night)
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SLBND0070'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLBJ0220013'; export JOBSCH_JOBID
PROGRAM_ID='NLBB005001'; export PROGRAM_ID
SUBSYSTEM_CD='NLB'; export SUBSYSTEM_CD
...
# User Variables
VAR_USER1='NLBI0020'; export VAR_USER1
VAR_USER2='4'; export VAR_USER2
VAR_USER3=''; export VAR_USER3
VAR_USER4=''; export VAR_USER4
VAR_USER5=''; export VAR_USER5

# Interface ID
INTERFACE_ID='NLBI0020'; export INTERFACE_ID
