#!/usr/bin/ksh
# All Rights Reserved. Copyright  Canon U.S.A., Inc., 2016
#-------------------------------------------------------------------
# Project Name    : S21
# SubSystem Name  : NSA
# JOB NET         : S21SWD_SSAND0270
# JOB ID          : S21SWD_SSAJ0670010
# Creator         : S.Nakai
# Date            : 2016/06/28
# Summary         : CFS Contract Uplift
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SSAND0270'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSAJ0670010'; export JOBSCH_JOBID
PROGRAM_ID='NSAB047001'; export PROGRAM_ID
