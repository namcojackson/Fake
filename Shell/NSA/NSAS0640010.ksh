...
# Project Name    : S21
# SubSystem Name  : NSA
# JOB NET         : S21SWD_SSANP0450
# JOB ID          : S21SWD_SSAJ0640010
# Creator         : T.Tomita
# Date            : 2016/06/23
# Summary         : Request Batch Activation Control for Machine Master Solution Upload
# Type            : Scheduled
# Cycle           : every 5 minites
# Version         : 1
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SSANP0450'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSAJ0640010'; export JOBSCH_JOBID
PROGRAM_ID='ZZBB002001'; export PROGRAM_ID
SUBSYSTEM_CD='NSA'; export SUBSYSTEM_CD
...
# User Variables
VAR_USER1='P'; export VAR_USER1
VAR_USER2='S21SWD_SSANP0450'; export VAR_USER2
