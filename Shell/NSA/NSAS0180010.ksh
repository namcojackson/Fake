...
# Project Name    : S21
# SubSystem Name  : NSA
# JOB NET         : S21SWD_SSAND0200
# JOB ID          : S21SWD_SSAJ0180010
# Creator         : T.Tomita
# Date            : 2015/04/08
# Summary         : Batch Fax
# Type            : Scheduled
...
JOBSCH_JOBNET='S21SWD_SSAND0200'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSAJ0180010'; export JOBSCH_JOBID
PROGRAM_ID='NSAB013001'; export PROGRAM_ID
...
# Interface ID
INTERFACE_ID='NSAI0010'; export INTERFACE_ID
...
DEBUG_LEVEL='1'
COMMIT_TRANCNT='1000'
RECORDLOCK_RETRYCNT='3'
RECORDLOCK_RETRYINTERVAL='3'
