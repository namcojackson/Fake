...
# Project Name    : S21
# SubSystem Name  : ZZB
# JOB NET         : S21SWD_ZZBND0170
# JOB ID          : S21SWD_ZZBJ0170010
# Creator         : Y.Fujii
# Date            : 2017/07/03
# Summary         : BCV#2 Split
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1
# InputParameter1 : BCV2 user@host for ssh specify
# InputParameter2 : BCV2 shell name on the host
# InputParameter3 : 
# InputParameter4 : 
# InputParameter5 : 
...
JOBSCH_JOBNET='S21SWD_ZZBND0170'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_ZZBJ0170010'; export JOBSCH_JOBID
...
if [[ $? -eq 0 ]]; then
  echo "EMC-BCV copy BCV2 split is done successfully with ${VAR_INPUT_PARAM1}" >> ${LOGFILE}
fi
