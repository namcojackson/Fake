...
# Project Name    : S21
# SubSystem Name  : NLC
# JOB NET         : S21SWD_SLCNM0050
# JOB ID          : S21SWD_SLCJ0290030
# Creator         : M.Takahashi
# Date            : 01/01/2016
# Summary         : SCM/DB Daily Inventory Result To Canon,Inc (WE125)[Monthly]
# Type            : Scheduled
# Cycle           : Monthly
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SLCNM0050'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLCJ0290030'; export JOBSCH_JOBID
PROGRAM_ID='NLCB017001'; export PROGRAM_ID
...
# User Variables
VAR_USER1='WE125M'; export VAR_USER1
VAR_USER2=''; export VAR_USER2
VAR_USER3='1000'; export VAR_USER3
VAR_USER4=''; export VAR_USER4
VAR_USER5=''; export VAR_USER5

# Interface ID
INTERFACE_ID='NLCI0170'; export INTERFACE_ID
