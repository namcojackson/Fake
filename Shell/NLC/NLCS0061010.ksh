...
# Project Name    : S21
# SubSystem Name  : NLC
# JOB NET         : S21SWD_SLCND0030
# JOB ID          : S21SWD_SLCJ0061010
# Creator         : M.Takahashi
# Date            : 01/01/2016
# Summary         : Inventory Discrepancy Report Batch for Serial/config ID
# Type            : Scheduled
# Cycle           : Daily(This is executed after of the Inventory Master Snapshot )
# Version         : 1.0
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SLCND0030'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLCJ0061010'; export JOBSCH_JOBID
PROGRAM_ID='NLCB109001'; export PROGRAM_ID
SUBSYSTEM_CD='NLC'; export SUBSYSTEM_CD
...
# User Variables
VAR_USER1='17434'; export VAR_USER1
VAR_USER2='100'; export VAR_USER2
VAR_USER3=''; export VAR_USER3
VAR_USER4=''; export VAR_USER4
VAR_USER5=''; export VAR_USER5

# Interface ID
INTERFACE_ID='NLCI0050'; export INTERFACE_ID

# Report ID
REPORT_ID='NLCF0010EN'; export REPORT_ID
