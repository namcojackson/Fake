...
# Project Name    : S21
# SubSystem Name  : NLC
# JOB NET         : S21SWD_SLCNM1050
# JOB ID          : S21SWD_SLCJ0071030
# Creator         : K.Lee
# Date            : 02/22/2016
# Summary         : Inventory Detail Snapshot Batch(Monthly)
# Type            : Scheduled
# Cycle           : Daily(before batch process date update job)
# Version         : 1.0
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SLCNM1050'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLCJ0071030'; export JOBSCH_JOBID
PROGRAM_ID='NLCB024001'; export PROGRAM_ID
...
# User Variables
VAR_USER1='2'; export VAR_USER1
VAR_USER2=''; export VAR_USER2
VAR_USER3='8000'; export VAR_USER3
VAR_USER4='3000'; export VAR_USER4
