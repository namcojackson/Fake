...
# Project Name    : S21
# SubSystem Name  : ZZO
# JOB NET         : S21SWD_ZZONA0040
# JOB ID          : S21SWD_ZZOJ0040010
# Creator         : C.Ogaki
# Date            : 03/08/2019
# Summary         : Update Table Statistics(During Nightly Batch)
# Type            : Scheduled
# Cycle           : every 30 min.(Run while Nightly Batch SZZND9010)
# Version         : 1
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_ZZONA0040'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_ZZOJ0040010'; export JOBSCH_JOBID
PROGRAM_ID='ZZOB002001'; export PROGRAM_ID
SUBSYSTEM_CD='ZZO'; export SUBSYSTEM_CD
...
# User Variables
VAR_USER1='S21_CSA_APPS'; export VAR_USER1
VAR_USER2='ALL'; export VAR_USER2
VAR_USER3='NIGHTLY'; export VAR_USER3
VAR_USER4='True'; export VAR_USER4
