...
# Project Name    : S21
# SubSystem Name  : NLD
# JOB NET         : S21SWD_SLDND0010
# JOB ID          : S21SWD_SLDJ0001010
# Creator         : Igarashi
# Date            : 2013/04/01
# Summary         : Technician Inventory Automatic Update Daily batch
# Type            : Scheduled
# Cycle           : every 30 min
# Version         : 1
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SLDND0010'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLDJ0001010'; export JOBSCH_JOBID
PROGRAM_ID='NLDB001001'; export PROGRAM_ID
SUBSYSTEM_CD='NLD'; export SUBSYSTEM_CD
