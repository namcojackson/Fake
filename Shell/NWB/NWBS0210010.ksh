...
# Project Name    : S21
# SubSystem Name  : NWB
# JOB NET         : S21SWD_SWBNP0050
# JOB ID          : S21SWD_SWBJ0210010
# Creator         : OM3R)Eun
# Date            : 2009/12/01
# Summary         : Request batch activation control job(Receiving Report Serial# Upload)
# Type            : Scheduled
# Cycle           : 
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SWBNP0050'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SWBJ0210010'; export JOBSCH_JOBID
PROGRAM_ID='ZZBB002001'; export PROGRAM_ID
SUBSYSTEM_CD='NWB'; export SUBSYSTEM_CD
...
VAR_USER2='S21SWD_SWBNP0050'; export VAR_USER2
