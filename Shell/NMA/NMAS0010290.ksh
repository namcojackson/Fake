...
# Project Name    : S21
# SubSystem Name  : NMA
# JOB NET         : S21SWD_SMAND0290
# JOB ID          : S21SWD_SMAJ0010290
# Creator         : q14192
# Date            : 03/01/2021
# Summary         : Canon E633 Close SVC Calls Delete Extract
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SMAND0290'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SMAJ0010290'; export JOBSCH_JOBID
PROGRAM_ID='CanonE633ExtractConcProg'; export PROGRAM_ID
SUBSYSTEM_CD='NMA'; export SUBSYSTEM_CD

VAR_INPUT_PARAM1='Closed SVC Calls Delete'; export VAR_INPUT_PARAM1
...
# User Variables
VAR_USER1='Closed SVC Calls Delete'; export VAR_USER1
...
#-------------------------------------------------
PROGRAM_TYPE=NMA
PROCESS1=oracle.apps.e633.server.${PROGRAM_ID}
