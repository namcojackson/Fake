...
# Project Name    : S21
# SubSystem Name  : NMA
# JOB NET         : S21SWD_SMAND9330
# JOB ID          : S21SWD_SMAJ8009330
# Creator         : q05381
# Date            : 10/24/2017
# Summary         : Canon E404 Prospect Merge Extract
# Type            : Scheduled
# Cycle           : Nightly
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SMAND9330'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SMAJ8009330'; export JOBSCH_JOBID
PROGRAM_ID='CanonE404ExtractConcProg'; export PROGRAM_ID
SUBSYSTEM_CD='NMA'; export SUBSYSTEM_CD

VAR_INPUT_PARAM1='PROSPECT_MERGE'; export VAR_INPUT_PARAM1
...
# User Variables
VAR_USER1='PROSPECT_MERGE'; export VAR_USER1
...
#-------------------------------------------------
PROGRAM_TYPE=NMA
PROCESS1=oracle.apps.e404.server.${PROGRAM_ID}
