...
# Project Name    : S21
# SubSystem Name  : NMA
# JOB NET         : S21SWD_SMAND8990
# JOB ID          : S21SWD_SMAJ8000990
# Creator         : q05381
# Date            : 3/13/2017
# Summary         : CFS Credit Appl Apex Batach Job for Salesforce 
# Type            : Scheduled
# Cycle           : everyday 10pm
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SMAND8990'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SMAJ8000990'; export JOBSCH_JOBID
PROGRAM_ID='CanonE404SFBatchProgramClient'; export PROGRAM_ID
SUBSYSTEM_CD='NMA'; export SUBSYSTEM_CD

VAR_INPUT_PARAM1='Identify CFS CSA Account Update'; export VAR_INPUT_PARAM1
...
# User Variables
VAR_USER1='Identify CFS CSA Account Update'; export VAR_USER1
