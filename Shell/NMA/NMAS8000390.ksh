...
# Project Name    : S21
# SubSystem Name  : NMA
# JOB NET         : S21SWD_SMAND8390
# JOB ID          : S21SWD_SMAJ8000390
# Creator         : q10243
# Date            : 7/27/2016
# Summary         : Apex Batach Job for Salesforce 
# Type            : Scheduled
# Cycle           : everyday 10pm
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SMAND8390'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SMAJ8000390'; export JOBSCH_JOBID
PROGRAM_ID='CanonE404SFBatchProgramClient'; export PROGRAM_ID
SUBSYSTEM_CD='NMA'; export SUBSYSTEM_CD

VAR_INPUT_PARAM1='Lead Development Identify Notification Recipients'; export VAR_INPUT_PARAM1
...
# User Variables
VAR_USER1='Lead Development Identify Notification Recipients'; export VAR_USER1
VAR_USER2='20000000'; export V7R_USER2
...
PROCESS1=canon.salesforce.batch.${PROGRAM_ID}
#-------------------------------------------------
# EXECUTE PROCESS
#-------------------------------------------------
if [ $PRC -eq 0 ];
