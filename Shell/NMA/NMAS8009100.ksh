...
# Project Name    : S21
# SubSystem Name  : NMA
# JOB NET         : S21SWD_SMAND9100
# JOB ID          : S21SWD_SMAJ8009100
# Creator         : q05381
# Date            : 8/7/2017
# Summary         : Canon E633 LFSPPS MeterReads Extract
# Type            : Scheduled
# Cycle           : Nightly
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SMAND9100'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SMAJ8009100'; export JOBSCH_JOBID
PROGRAM_ID='CanonE633ExtractConcProg'; export PROGRAM_ID
SUBSYSTEM_CD='NMA'; export SUBSYSTEM_CD

VAR_INPUT_PARAM1='Meter Reads'; export VAR_INPUT_PARAM1
...
# User Variables
VAR_USER1='Meter Reads'; export VAR_USER1
