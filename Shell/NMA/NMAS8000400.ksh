...
# Project Name    : S21
# SubSystem Name  : NMA
# JOB NET         : S21SWD_SMAND8400
# JOB ID          : S21SWD_SMAJ8000400
# Creator         : q10243
# Date            : 7/27/2016
...
JOBSCH_JOBNET='S21SWD_SMAND8400'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SMAJ8000400'; export JOBSCH_JOBID
PROGRAM_ID='CanonE404SFBatchProgramClient'; export PROGRAM_ID
SUBSYSTEM_CD='NMA'; export SUBSYSTEM_CD

VAR_INPUT_PARAM1='Lead Development Notify Recipients'; export VAR_INPUT_PARAM1
...
# User Variables
VAR_USER1='Lead Development Notify Recipients'; export VAR_USER1
