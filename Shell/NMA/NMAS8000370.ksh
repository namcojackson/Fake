...
# Project Name    : S21
# SubSystem Name  : NMA
# JOB NET         : S21SWD_SMAND8370
# JOB ID          : S21SWD_SMAJ8000370
# Creator         : q10243
# Date            : 7/27/2016
...
JOBSCH_JOBNET='S21SWD_SMAND8370'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SMAJ8000370'; export JOBSCH_JOBID
PROGRAM_ID='CanonE404SFBatchProgramClient'; export PROGRAM_ID
SUBSYSTEM_CD='NMA'; export SUBSYSTEM_CD

VAR_INPUT_PARAM1='Change Owner Task for Custom'; export VAR_INPUT_PARAM1
...
# User Variables
VAR_USER1='Change Owner Task for Custom'; export VAR_USER1
