#!/usr/bin/ksh
# All Rights Reserved. Copyright  Canon U.S.A., Inc., 2018
#-------------------------------------------------------------------
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SWCND0230
# JOB ID          : S21SWD_SSBJ9000200
# Creator         : T.Ogura
# Date            : 07/24/2018
# Summary         : Temporary Entitlement Consolidate
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SWCND0230'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9000200'; export JOBSCH_JOBID
PROGRAM_ID='NSBB097001'; export PROGRAM_ID
...
# User Variables
VAR_USER1='NSBB0970M001'; export VAR_USER1
