...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBNA9120
# JOB ID          : S21SWD_SSBJ9000120
# Creator         : Q10243
# Date            : 02/15/2017
# Summary         : 
# Type            : Scheduled
...
JOBSCH_JOBNET='S21SWD_SSBNA9120'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9000120'; export JOBSCH_JOBID
PROGRAM_ID='CanonEMSDE618SqlServerSyncProgram'; export PROGRAM_ID
...
PROCESS1=oracle.apps.emsde618.sync.${PROGRAM_ID}
#-------------------------------------------------
# EXECUTE PROCESS
#-------------------------------------------------
if [ $PRC -eq 0 ];
