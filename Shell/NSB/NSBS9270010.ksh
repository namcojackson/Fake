...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBNA9270
# JOB ID          : S21SWD_SSBJ9270010
# Creator         : H.Doniparthi
# Date            : 11/8/2018
# Summary         : Service call email notification to be sent out to the customer email address(es). 
# Type            : Scheduled
# Cycle           : every 5 min.
# Version         : 1
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SSBNA9270'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9270010'; export JOBSCH_JOBID
PROGRAM_ID='CanonE663ServiceEmailProg'; export PROGRAM_ID
...
#-------------------------------------------------
PROGRAM_TYPE=NSB
#PROCESS1=oracle.apps.e663.server.${PROGRAM_TYPE}.${PROGRAM_ID}.${PROGRAM_ID}
PROCESS1=oracle.apps.e663.server.${PROGRAM_ID}
