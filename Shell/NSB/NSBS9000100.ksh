...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBND9100
# JOB ID          : S21SWD_SSBJ9000100
# Creator         : Q10243
# Date            : 12/2/2016
# Summary         : UGW MACHINE ERRORS EMAILS
# Type            : Scheduled
...
JOBSCH_JOBNET='S21SWD_SSBND9100'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9000100'; export JOBSCH_JOBID
PROGRAM_ID='CanonE307UGWErrorsInboxReader'; export PROGRAM_ID
...
PROCESS1=oracle.apps.e307.server.${PROGRAM_ID}
#-------------------------------------------------
# EXECUTE PROCESS
#-------------------------------------------------
if [ $PRC -eq 0 ];
