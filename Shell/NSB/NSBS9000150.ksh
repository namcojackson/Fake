...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBNA9150
# JOB ID          : S21SWD_SSBJ9000150
# Creator         : Q08025
# Date            : 05/04/2018
# Summary         : Email Service Request Interface for Rote-Aid
# Type            : Scheduled
...
JOBSCH_JOBNET='S21SWD_SSBNA9150'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9000150'; export JOBSCH_JOBID
PROGRAM_ID='CanonE621SRUpdateInboxReader'; export PROGRAM_ID
...
PROCESS1=oracle.apps.e621.server.${PROGRAM_ID}
#-------------------------------------------------
# EXECUTE PROCESS
#-------------------------------------------------
if [ $PRC -eq 0 ];
