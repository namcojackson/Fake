...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBNA9900
# JOB ID          : S21SWD_SSBJ9900010
# Creator         : K.Lee
# Date            : 3/21/2024
# Summary         : Walmart API Outbound Interface Connectivity Test
# Type            : Scheduled
# Cycle           : On Demand
# Version         : 1
# InputParameter1 : 
...
#-------------------------------------------------
export LD_LIBRARY_PATH=/opt/mqm8/java/lib64:$LD_LIBRARY_PATH
...
JOBSCH_JOBNET='S21SWD_SSBNA9900'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9900010'; export JOBSCH_JOBID
PROGRAM_ID='NSBB104001'; export PROGRAM_ID
