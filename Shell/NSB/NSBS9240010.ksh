...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBND9240
# JOB ID          : S21SWD_SSBJ9240010
# Creator         : P.Chandran
# Date            : 2018/08/10
# Summary         : E193 Data Management Inbox Reader.
# Type            : Scheduled
...
JOBSCH_JOBNET='S21SWD_SSBND9240'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9240010'; export JOBSCH_JOBID
PROGRAM_ID='CanonE193UpdateCloseStuckTicketBJob'; export PROGRAM_ID
...
# Report ID
REPORT_ID='S21SWD_SSBJ9240010'; export REPORT_ID
...
#-------------------------------------------------
PROGRAM_TYPE=ZZP
PROCESS1=com.canon.oracle.custapp.util.${PROGRAM_ID}
