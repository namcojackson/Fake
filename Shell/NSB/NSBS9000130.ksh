...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBNA9130
# JOB ID          : S21SWD_SSBJ9000130
# Creator         : Q10243
# Date            : 03/24/2017
# Summary         : Meter Read Entry from Email Interface 
# Type            : Scheduled
...
JOBSCH_JOBNET='S21SWD_SSBNA9130'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9000130'; export JOBSCH_JOBID
PROGRAM_ID='CanonE503MeterReadEntryInboxReader'; export PROGRAM_ID
...
PROCESS1=oracle.apps.e503.server.${PROGRAM_ID}
#-------------------------------------------------
# EXECUTE PROCESS
#-------------------------------------------------
if [ $PRC -eq 0 ];
