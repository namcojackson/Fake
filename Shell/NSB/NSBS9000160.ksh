...
# Project Name    : S21
# SubSystem Name  : NSB
# JOB NET         : S21SWD_SSBND9160
# JOB ID          : S21SWD_SSBJ9000160
# Creator         : Q03715
# Date            : 04/25/2018
# Summary         : Call Center Transition Interface 
# Type            : Scheduled
# Cycle           : Once in a day
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SSBND9160'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SSBJ9000160'; export JOBSCH_JOBID
PROGRAM_ID='CanonE165CallCntrTrnstnProg'; export PROGRAM_ID
...
PROCESS1=oracle.apps.e165.server.${PROGRAM_ID}
#-------------------------------------------------
# EXECUTE PROCESS
#-------------------------------------------------
if [ $PRC -eq 0 ];
