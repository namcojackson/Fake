...
# Project Name    : S21
# SubSystem Name  : NFA
# JOB NET         : S21SWD_SFANM0130
# JOB ID          : S21SWD_SFAJ3110020
# Creator         : T.Tsuchida
# Date            : 2023/05/30
# Summary         : Meter Accrual AJE Interface from IDS
# Type            : Scheduled
# Cycle           : 1st Day am 7:00
# Version         : 1
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SFANM0130'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SFAJ3110020'; export JOBSCH_JOBID
PROGRAM_ID='NFAB311001'; export PROGRAM_ID
SUBSYSTEM_CD='NFA'; export SUBSYSTEM_CD
...
# Interface ID
INTERFACE_ID='NFAI0140'; export INTERFACE_ID
