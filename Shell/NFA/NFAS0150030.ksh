...
# JOB ID          : S21SWD_SFAJ0150030
# Creator         : T.Wada
# Date            : 2019/06/25
# Summary         : Monthly AJE Analyze & Shrink
# Type            : Scheduled
# Cycle           : Monthly
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBID='S21SWD_SFAJ0150030'; export JOBSCH_JOBID
PROGRAM_ID='./dvlp/40dbobject/bin/analyzeArchivedTablesByOwner.ksh ACCT 1'; export PROGRAM_ID
