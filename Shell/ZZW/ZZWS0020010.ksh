...
# Project Name    : S21
# SubSystem Name  : ZZW
# JOB NET         : S21SWD_ZZWND0020
# JOB ID          : S21SWD_ZZWJ0020010
# Creator         : Rohit Chandramohan
# Date            : 1/20/2010
# Summary         : Number of active process definition with no live process instance
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_ZZWND0020'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_ZZWJ0020010'; export JOBSCH_JOBID
PROGRAM_ID='ZZWB002001'; export PROGRAM_ID
SUBSYSTEM_CD='ZZW'; export SUBSYSTEM_CD
