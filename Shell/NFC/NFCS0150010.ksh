...
# Project Name    : S21
# SubSystem Name  : NFC
# JOB NET         : S21SWD_SFCNA0070
# JOB ID          : S21SWD_SFCJ0150010
# Creator         : K.Onodera
# Date            : 2010/05/20
# Summary         : Vendor Return Data Interface (Entry) On Demand
# Type            : Scheduled
# Cycle           : On Demand
# Version         : V5.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SFCNA0070'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SFCJ0150010'; export JOBSCH_JOBID
PROGRAM_ID='NFCB003001'; export PROGRAM_ID
