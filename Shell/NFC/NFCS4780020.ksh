...
# Project Name    : S21
# SubSystem Name  : NFC
# JOB NET         : S21SWD_SFCND4780
# JOB ID          : S21SWD_SFCJ4780020
# Date            : 2017/11/21
# Summary         : S21SWD SPECIAL BILLING REGENERATION EXCEL EXTRACT JOB 
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SFCND4780'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SFCJ4780020'; export JOBSCH_JOBID
PROGRAM_ID='CanonCustomBillingExcelExtractJob'; export PROGRAM_ID
SUBSYSTEM_CD='NFC'; export SUBSYSTEM_CD
unset DISPLAY
#-------------------------------------------------
# (optional)If any parameter for batch program needed.
#-------------------------------------------------
VAR_INPUT_PARAM1='RE-GENERATE'; export VAR_INPUT_PARAM1
