...
# Project Name    : S21
# SubSystem Name  : NFC
# JOB NET         : S21SWD_SFBNA1090
# JOB ID          : S21SWD_SFCJ3050010
# Creator         : H.Ikeda
# Date            : 2018/04/17
# Summary         : Send AR Refund information for CFS Misdirected payment
# Type            : Scheduled
# Cycle           : 9:00,12:00,15:00
# Version         : V1.0
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SFBNA1090'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SFCJ3050010'; export JOBSCH_JOBID
PROGRAM_ID='NFCB305001'; export PROGRAM_ID
...
# User Variables
VAR_USER1='15'; export VAR_USER1
VAR_USER2='i106_incbs'; export VAR_USER2
VAR_USER3=''; export VAR_USER3
VAR_USER4=''; export VAR_USER4
VAR_USER5=''; export VAR_USER5

# Interface ID
INTERFACE_ID='NFCI1130'; export INTERFACE_ID
