...
# JOB ID          : S21SWD_SFCJ0510111
# Creator         : Y.Miyauchi
# Date            : 2016/04/14
# Summary         : Create backup for AR Receive receipt Interface file for lockbox(BoA for SAP)) WMB
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBID='S21SWD_SFCJ0510111'; export JOBSCH_JOBID
...
# User Variables
VAR_USER1='BOA_SAP'; export VAR_USER1
