...
# Project Name    : S21
# SubSystem Name  : NWC
# JOB NET         : S21SWD_SWCNA0260
# JOB ID          : S21SWD_SWCJ0360020
# Creator         : M.Yamada
# Date            : 2017/06/02
# Summary         : Invoice Interface from EMSD Tool (Copy from IF to Biz Table)
# Type            : Scheduled
...
JOBSCH_JOBNET='S21SWD_SWCNA0260'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SWCJ0360020'; export JOBSCH_JOBID
PROGRAM_ID='NWCB036001'; export PROGRAM_ID
...
# Interface ID
INTERFACE_ID='NWCI0130'; export INTERFACE_ID
