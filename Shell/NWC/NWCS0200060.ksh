...
# Project Name    : S21
# SubSystem Name  : NWC
# JOB NET         : S21SWD_SWCNA0200
# JOB ID          : S21SWD_SWCJ0200060
# Creator         : K.Aratani
# Date            : 12/9/2016
# Summary         : Invoice Reprint Request(PDF)
# Type            : Scheduled
# Cycle           : Runs every 10 minutes
# Version         : 1.0
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SWCNA0200'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SWCJ0200060'; export JOBSCH_JOBID
PROGRAM_ID='NWCB011001'; export PROGRAM_ID
SUBSYSTEM_CD='NWC'; export SUBSYSTEM_CD
...
# User Variables
VAR_USER1='02'; export VAR_USER1
VAR_USER2='REPRINT'; export VAR_USER2
...
# Report ID
REPORT_ID='NWCF0100'; export REPORT_ID
