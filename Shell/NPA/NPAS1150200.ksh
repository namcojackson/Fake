...
# Project Name    : S21
# SubSystem Name  : NPA
# JOB NET         : S21SWD_SPANW1400
# JOB ID          : S21SWD_SPAJ1150200
# Creator         : S.Ikeda
# Date            : 2013/09/04
# Summary         : PR Release Batch (Nightly Processing #4)[Loc-Split,Thu Loc]
# Type            : Scheduled
# Cycle           : Thursday 23 o'clock.And run after NPAND1310 jobnet completes.
# Version         : 1.2
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SPANW1400'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SPAJ1150200'; export JOBSCH_JOBID
...
VAR_USER2='THU'; export VAR_USER2
