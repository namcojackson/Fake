...
# Project Name    : S21
# SubSystem Name  : NPA
# JOB NET         : S21SWD_SPANW1410
# JOB ID          : S21SWD_SPAJ1150210
# Creator         : S.Ikeda
# Date            : 2013/09/04
# Summary         : PR Release Batch (Nightly Processing #5)[Loc-Split,Fri Loc]
# Type            : Scheduled
# Cycle           : Friday 23 o'clock.And run after NPAND1310 jobnet completes.
# Version         : 1.2
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SPANW1410'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SPAJ1150210'; export JOBSCH_JOBID
...
VAR_USER2='FRI'; export VAR_USER2
