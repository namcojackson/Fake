...
# Project Name    : S21
# SubSystem Name  : NPA
# JOB NET         : S21SWD_SPANA1480
# JOB ID          : S21SWD_SPAJ1480010
# Creator         : S.Ikeda
# Date            : 2013/09/09
# Summary         : Merchandise Export PO Send to S21
# Type            : Scheduled
# Cycle           : every 15 minutes. And run after NPANA1120 jobnet completes.
# Version         : 1.2
# InputParameter1 : 
# InputParameter2 : 
# InputParameter3 : 
...
JOBSCH_JOBNET='S21SWD_SPANA1480'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SPAJ1480010'; export JOBSCH_JOBID
PROGRAM_ID='NPAB126001'; export PROGRAM_ID
...
# User Variables
VAR_USER1='ITRL_ID_CSA_CUSA_WS'; export VAR_USER1
VAR_USER2='W'; export VAR_USER2
VAR_USER3=''; export VAR_USER3
VAR_USER4=''; export VAR_USER4
VAR_USER5=''; export VAR_USER5

# Interface ID
INTERFACE_ID='NPAA0050'; export INTERFACE_ID
