...
# Project Name    : S21
# SubSystem Name  : NLA
# JOB NET         : S21SWD_SLAND1350
# JOB ID          : S21SWD_SLAJ1350020
# Creator         : M,Takahashi
# Date            : 01/01/2016
# Summary         : Receive Invoice Information for CUSA Domestic Parts
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SLAND1350'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLAJ1350020'; export JOBSCH_JOBID
PROGRAM_ID='NLAB302001'; export PROGRAM_ID
SUBSYSTEM_CD='NLA'; export SUBSYSTEM_CD
...
# User Variables
VAR_USER1='ITRL_ID_CUSA_PRT_CSA'; export VAR_USER1
VAR_USER2='CANONY'; export VAR_USER2
VAR_USER3=''; export VAR_USER3
VAR_USER4=''; export VAR_USER4
VAR_USER5=''; export VAR_USER5

# Interface ID
INTERFACE_ID='USDA0300'; export INTERFACE_ID
