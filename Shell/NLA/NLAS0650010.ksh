...
# Project Name    : S21
# SubSystem Name  : NLA
# JOB NET         : S21SWD_SLAND0250
# JOB ID          : S21SWD_SLAJ0650010
# Creator         : K.Lee
# Date            : 2009/11/16
# Summary         : RWS Complete (Night Time) :S21-MW MQ request Receiving
# Type            : Scheduled
# Cycle           : Daily
# Version         : 1.0
# InputParameter1 : 
...
JOBSCH_JOBNET='S21SWD_SLAND0250'; export JOBSCH_JOBNET
JOBSCH_JOBID='S21SWD_SLAJ0650010'; export JOBSCH_JOBID
PROGRAM_ID='NLAB039001'; export PROGRAM_ID
...
# Interface ID
INTERFACE_ID='NLAI0310'; export INTERFACE_ID
