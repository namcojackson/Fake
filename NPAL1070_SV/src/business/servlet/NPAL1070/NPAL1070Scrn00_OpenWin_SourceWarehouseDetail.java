 ...
 * Function Name : Open Window Source Warehouse Detail
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 01/24/2016   CITS            Keiichi Masaki  Create          N/A
 *</pre>
 */
public class NPAL1070Scrn00_OpenWin_SourceWarehouseDetail extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_EV, EVENT_OPEN_WIN_SOURCE_SUB_WAREHOUSE_DETAIL);
        int eventRowIndex = getButtonSelectNumber();

        Object[] params = NPAL1070CommonLogic.setLocationPopupParam(scrnMsg, eventRowIndex);
