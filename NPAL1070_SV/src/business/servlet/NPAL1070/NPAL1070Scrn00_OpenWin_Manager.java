 ...
 * Function Name : Open Window Manager
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 01/24/2016   CITS            Keiichi Masaki  Create          N/A
 *</pre>
 */
public class NPAL1070Scrn00_OpenWin_Manager extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NPAL1070CommonLogic.setInitParamForManagerPopup(scrnMsg);

        // Making of sub screen delivery information
        Object[] params = NPAL1070CommonLogic.setParamForManagerPopup(scrnMsg);
