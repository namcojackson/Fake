 ...
 * Function Name : Set Manager Name
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 01/24/2016   CITS            Keiichi Masaki  Create          N/A
 *</pre>
 */
public class NPAL1070Scrn00_SetManagerName extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.whMgrPsnCd)) {
            scrnMsg.fullPsnNm.clear();
            scrnMsg.whMgrPsnCd.setErrorInfo(1, ZZZM9007E, new String[] {DISPLAY_NM_WH_MGR_PSN_CD });
        }
