...
/**
 *<pre>
 * OpenWin_VndCode Inventory Transaction Inqiury
 *
 ...
 *</pre>
 */
public class NLCL0280Scrn00_Search_ProdInfo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.coaProdCd_H1)) {
            scrnMsg.coaProdCd_H1.setErrorInfo(1, ZZM9000E, new String[] {"Product" });
