...
/**
 *<pre>
 * NLCL0280Scrn00_Search_RtlWHInfo Inventory Transaction Inqiury
 *
 ...
 *</pre>
 */
public class NLCL0280Scrn00_Search_RtlWHInfo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.rtlWhCd_H1)) {
            scrnMsg.rtlWhCd_H1.setErrorInfo(1, ZZM9000E, new String[] {"Warehouse" });
