...
/**
 *<pre>
 * NLCL0280Scrn00_Search_RtlSWHInfo Inventory Transaction Inqiury
 *
 ...
 *</pre>
 */
public class NLCL0280Scrn00_Search_RtlSWHInfo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.rtlSwhCd_H1)) {
            scrnMsg.rtlSwhCd_H1.setErrorInfo(1, ZZM9000E, new String[] {"Sub Warehouse" });
