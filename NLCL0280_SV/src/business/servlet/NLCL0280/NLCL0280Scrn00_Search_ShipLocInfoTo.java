...
/**
 *<pre>
 * NLCL0280Scrn00_Search_ShipLocInfoTo Inventory Transaction Inqiury
 *
 ...
 *</pre>
 */
public class NLCL0280Scrn00_Search_ShipLocInfoTo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        // null check
        if (!ZYPCommonFunc.hasValue(scrnMsg.shipToLocCustCd_H1)) {
            scrnMsg.shipToLocCustCd_H1.setErrorInfo(1, ZZM9000E, new String[] {"Ship To Location" });
