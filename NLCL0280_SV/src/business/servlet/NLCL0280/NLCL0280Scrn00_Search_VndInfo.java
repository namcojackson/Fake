...
/**
 *<pre>
 * NLCL0280Scrn00_Search_VndInfo Inventory Transaction Inqiury
 *
 ...
 *</pre>
 */
public class NLCL0280Scrn00_Search_VndInfo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.vndCd_H1)) {
            scrnMsg.vndCd_H1.setErrorInfo(1, ZZM9000E, new String[] {"Supplier" });
