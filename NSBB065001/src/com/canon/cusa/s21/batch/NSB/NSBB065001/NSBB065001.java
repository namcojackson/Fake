 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB065001;
...
import business.db.NSBI2050_01TMsg;
...
/**
 * <pre>
 * Web OMAL F6 Machine Population File Batch
 * 
 ...
 * </pre>
 */
public class NSBB065001 extends S21BatchMain {
    ...
    private static final String SRCH_COND_FROM_TIME = "000000000";

    /** SVC_MACH_MSTR_STS_CD_LIST */
    private static final String[] SVC_MACH_MSTR_STS_LIST = new String[] {SVC_MACH_MSTR_STS.INSTALLED, SVC_MACH_MSTR_STS.REMOVED, SVC_MACH_MSTR_STS.DEALER_SERVICE };
    ...
    /** MAX_LENGTH_62 : 62 */
    private static final int MAX_LENGTH_62 = 62;
    ...
    public static void main(String[] args) {
        new NSBB065001().executeBatch(NSBB065001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2050_01TMsg> inTMsgList = new ArrayList<NSBI2050_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2050_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2050_01TMsg> inMsgLst) {
        NSBI2050_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2050_01TMsg[inMsgLst.size()];
    ...
    private Map<String, Object> setSearchCondition() {
        ...
        inParam.put("effThruDt", SRCH_COND_FROM_TIME);
        inParam.put("svcMachMstrStsCdList", SVC_MACH_MSTR_STS_LIST);
        inParam.put("dsContrCtrlStsCdList", DS_CONTR_CTRL_STS_LIST);
        inParam.put("dsContrCatgCd_Warranty", DS_CONTR_CATG.WARRANTY);
        inParam.put("svcCovFeatCd_bill_cd", SVC_COV_FEAT.BILL_CD);
        inParam.put("svcCtacTp_svc_key_operator", SVC_CTAC_TP.SVC_KEY_OPERATOR);
        inParam.put("bizAreaOrgCd_service", BIZ_AREA_ORG.SERVICE);
        inParam.put("slsDt", this.salesDate);
        inParam.put("addMonth", WEB_OMAL_MONTH);
        // mod start 2016/10/28 CSA QC#15568
        inParam.put("maxLength_62", MAX_LENGTH_62);
        // mod end 2016/10/28 CSA QC#15568
    ...
    private NSBI2050_01TMsg setCreateValue(ResultSet rs) {

        NSBI2050_01TMsg inParam = new NSBI2050_01TMsg();
