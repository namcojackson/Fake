...
/*
 *NSAL1090_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL1090_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** XX_THRU_DT_A*/
	public final EZDCDateItem              xxThruDt_A;

    /** XX_INV_AMT_A1*/
	public final EZDCBigDecimalItem              xxInvAmt_A1;

    /** XX_INV_AMT_A2*/
	public final EZDCBigDecimalItem              xxInvAmt_A2;

    /** XX_INV_AMT_A3*/
	public final EZDCBigDecimalItem              xxInvAmt_A3;

    /** XX_CHK_BOX_A*/
	public final EZDCStringItem              xxChkBox_A;

    /** REBIL_SVC_INV_NUM_A*/
	public final EZDCStringItem              rebilSvcInvNum_A;

    /** CR_SVC_INV_NUM_A*/
	public final EZDCStringItem              crSvcInvNum_A;
	...
	public final EZDCBigDecimalItem              svcCrRebilBaseBllgPk_A;

    /** SVC_CR_REBIL_MTR_BLLG_PK_A*/
	public final EZDCBigDecimalItem              svcCrRebilMtrBllgPk_A;
	...
	/**
	 * NSAL1090_ACMsg is constructor.
	 * The initialization when the instance of NSAL1090_ACMsg is generated.
	 */
	public NSAL1090_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL1090_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		xxThruDt_A = (EZDCDateItem)newItem("xxThruDt_A");
		xxInvAmt_A1 = (EZDCBigDecimalItem)newItem("xxInvAmt_A1");
		xxInvAmt_A2 = (EZDCBigDecimalItem)newItem("xxInvAmt_A2");
		xxInvAmt_A3 = (EZDCBigDecimalItem)newItem("xxInvAmt_A3");
		xxChkBox_A = (EZDCStringItem)newItem("xxChkBox_A");
		rebilSvcInvNum_A = (EZDCStringItem)newItem("rebilSvcInvNum_A");
		crSvcInvNum_A = (EZDCStringItem)newItem("crSvcInvNum_A");
		svcCrRebilDtlPk_A = (EZDCBigDecimalItem)newItem("svcCrRebilDtlPk_A");
		dsContrDtlPk_A = (EZDCBigDecimalItem)newItem("dsContrDtlPk_A");
		svcCrRebilBaseBllgPk_A = (EZDCBigDecimalItem)newItem("svcCrRebilBaseBllgPk_A");
		svcCrRebilMtrBllgPk_A = (EZDCBigDecimalItem)newItem("svcCrRebilMtrBllgPk_A");
	 ...
	 * @return NSAL1090_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL1090_ACMsgArray();
	}
