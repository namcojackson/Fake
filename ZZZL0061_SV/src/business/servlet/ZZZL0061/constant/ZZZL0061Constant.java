package business.servlet.ZZZL0061.constant;

import parts.common.EZDApplicationContextConst;

public interface ZZZL0061Constant extends EZDApplicationContextConst{
    ...
    static final String[] BTN_CMN_CLOSE = {"btn10", "CMN_Close", "Close" };
     ...
     * Screen ID
     */
    static final String SCREEN_ID = "ZZZL0061Scrn00";
}
