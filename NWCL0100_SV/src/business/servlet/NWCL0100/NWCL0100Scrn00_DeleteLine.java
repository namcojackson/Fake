 ...
 *</pre>
 */
public class NWCL0100Scrn00_DeleteLine extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
            scrnMsg.addCheckItem(scrnMsg.A.no(i).effFromDt_A0);
            scrnMsg.addCheckItem(scrnMsg.A.no(i).effThruDt_A0);
        }
