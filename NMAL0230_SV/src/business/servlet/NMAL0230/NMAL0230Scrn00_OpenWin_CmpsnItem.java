...
/**
 *<pre>
 * NMAL0230Scrn00_OpenWin_CmpsnItem
 *
 ...
 *</pre>
 */
public class NMAL0230Scrn00_OpenWin_CmpsnItem extends S21CommonHandler {
...
//        params[0] = "";
//        params[1] = "Component Item Search Popup";
//
//        params[2] = "ALL_MDSE_V";
//
...
//        whereArray0[2] = scrnMsg.childMdseCd_CO.getValue();
//        whereArray0[3] = "Y";
...
//        params[6] = scrnMsg.P;
//
//        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, CMPSN_ITEM_POPUP);
//
//        setArgForSubScreen(params);
    	
		ZYPTableUtil.clear(scrnMsg.O);
		scrnMsg.O.no(0).xxPopPrm.setValue(scrnMsg.childMdseCd_CO.getValue());
		//scrnMsg.O.no(7).xxPopPrm.setValue(scrnMsg.mdseDescShortTxt_H1.getValue());
		scrnMsg.O.no(29).xxPopPrm.setValue("NMAL0230Scrn00_OpenWin_CmpsnItem");
