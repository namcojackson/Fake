...
/**
 *<pre>
 * NMAL0230Scrn00_OpenWin_BomItem
 *
 ...
 *</pre>
 */
public class NMAL0230Scrn00_OpenWin_BomItem extends S21CommonHandler {
...
//        params[0] = "";
//        params[1] = "BOM Item Search Popup";
//
//        StringBuilder sb = new StringBuilder();
//        sb.append("SELECT ");
//        sb.append("MV.MDSE_CD, ");
//        sb.append("MV.MDSE_NM, ");
//        sb.append("MV.GLBL_CMPY_CD, ");
//        sb.append("MV.EZCANCELFLAG ");
//        sb.append("FROM ");
//        sb.append("ALL_MDSE_V MV ");
//        sb.append("WHERE ");
//        sb.append("MV.GLBL_CMPY_CD = '").append(getGlobalCompanyCode()).append("' ");
//        sb.append("AND MV.EZCANCELFLAG = '0' ");
//        sb.append("AND ( MV.MDSE_ITEM_TP_CD = '").append(MDSE_ITEM_TP.SET).append("' ");
//        sb.append("OR MV.MDSE_ITEM_TP_CD = '").append(MDSE_ITEM_TP.KIT).append("' ) ");
...
//        whereArray0[2] = scrnMsg.mdseCd_BO.getValue();
//        whereArray0[3] = "Y";
...
//        params[6] = scrnMsg.P;
//
//        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, BOM_ITEM_POPUP);
//
//        setArgForSubScreen(params);
        
		ZYPTableUtil.clear(scrnMsg.O);
		scrnMsg.O.no(0).xxPopPrm.setValue(scrnMsg.mdseCd_BO.getValue());
		//scrnMsg.O.no(7).xxPopPrm.setValue(scrnMsg.mdseDescShortTxt_H1.getValue());
		scrnMsg.O.no(29).xxPopPrm.setValue("NMAL0230Scrn00_OpenWin_BomItem");
