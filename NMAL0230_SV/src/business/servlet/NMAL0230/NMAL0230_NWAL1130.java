 ...
 *</pre>
 */
public class NMAL0230_NWAL1130 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (BOM_ITEM_POPUP.equals(scrnMsg.xxScrEventNm.getValue())) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.mdseCd_BO, scrnMsg.P.no(0).xxComnScrColValTxt.getValue());
            scrnMsg.setFocusItem(scrnMsg.mdseCd_BO);
        } else if (CMPSN_ITEM_POPUP.equals(scrnMsg.xxScrEventNm.getValue())) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.childMdseCd_CO, scrnMsg.P.no(0).xxComnScrColValTxt.getValue());
