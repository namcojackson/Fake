 ...
 *</pre>
 */
public class NMAL0230Scrn00_OpenWin_CmpsnProdCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.O.no(9).xxPopPrm.setValue(scrnMsg.coaProdCd_CO.getValue());
        scrnMsg.O.no(10).xxPopPrm.setValue(scrnMsg.coaProdNm_CO.getValue());
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, CMPSN_PROD_POPUP);
