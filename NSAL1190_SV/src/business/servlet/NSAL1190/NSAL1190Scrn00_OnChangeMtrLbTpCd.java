 ...
 *</pre>
 */
public class NSAL1190Scrn00_OnChangeMtrLbTpCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSAL1190CommonLogic.changeMtrLbTpCd(scrnMsg);
        scrnMsg.setFocusItem(scrnMsg.A.no(eventLine).mtrLbTpCd_A);
    }
}
