 ...
 *</pre>
 */
public class NSAL1190Scrn00_Search extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NSAL1190BMsg scrnMsg = (NSAL1190BMsg) bMsg;
        NSAL1190CommonLogic.addCheckItemForSearch(scrnMsg);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSAL1190CommonLogic.controlScreenFieldsForSearch(this, scrnMsg);
