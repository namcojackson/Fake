 ...
 *</pre>
 */
public class NMAL0170Scrn00_SetItemDescriptionTo extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(idx).supdToMdseCd_A1)) {
            scrnMsg.A.no(idx).supdToMdseCd_A1.setErrorInfo(1, NMAM0041E, new String[] {"Item Number" });
            scrnMsg.addCheckItem(scrnMsg.A.no(idx).supdToMdseCd_A1);
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.A.no(scrnMsg.xxCellIdx.getValueInt()).supdToMdseCd_A1);
        scrnMsg.putErrorScreen();
    }
}
