 ...
 *</pre>
 */
public class NLCL1030Scrn00_OpenWin_SubWarehouse extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        params = NLCL1030CommonLogic.setParamForLocationPopup(scrnMsg, scrnMsg.rtlWhCdSrchTxt_RW, scrnMsg.rtlWhNmSrchTxt_RW, scrnMsg.rtlSwhCdSrchTxt_SW, scrnMsg.rtlWhCatgCd_H1, ZYPConstant.FLG_OFF_N);

        // Set Event Name.
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm, EVENT_NM_NLCL1030SCRN00_OPEN_WIN_SWH);
