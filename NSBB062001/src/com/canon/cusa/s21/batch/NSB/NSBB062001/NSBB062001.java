 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB062001;
...
import business.db.NSBI2020_01TMsg;
...
/**
 * <pre>
 * Web OMAL F3 Closed Job Work Hours Batch
 * 
 * Date         Company         Name            Create/Update   Defect No
 * 
 * ----------------------------------------------------------------------
 * 2016/06/03   Hitachi         O.Okuma         Create          N/A
 * </pre>
 */
public class NSBB062001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB062001().executeBatch(NSBB062001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2020_01TMsg> inTMsgList = new ArrayList<NSBI2020_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2020_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2020_01TMsg> inMsgLst) {
        NSBI2020_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2020_01TMsg[inMsgLst.size()];
    ...
    private NSBI2020_01TMsg setCreateValue(ResultSet rs) {

        NSBI2020_01TMsg inParam = new NSBI2020_01TMsg();
