...
/**
 *<pre>
 * NLAL2030Scrn00_RWS_Create
 *
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2015/12/16   Fujitsu         Y.Taoka         Create          N/A
 *</pre>
 */
public class NLAL2030Scrn00_RWS_Create extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NLAL2030BMsg scrnMsg = (NLAL2030BMsg) bMsg;
        NLAL2030CommonLogic.addCheckItemOrder(scrnMsg);
    }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NLAL2030CommonLogic.addCheckItemOrder(scrnMsg);
        NLAL2030CommonLogic.addCheckItemOrderCheckBox(scrnMsg);
