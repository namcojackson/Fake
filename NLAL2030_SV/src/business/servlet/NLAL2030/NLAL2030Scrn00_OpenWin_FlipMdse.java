...
/**
 *<pre>
 * NLAL2030Scrn00_OpenWin_FlipMdse
 *
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 06/09/2016   CSAI            Y.Imazu         Create          QC#7977
 *</pre>
 */
public class NLAL2030Scrn00_OpenWin_FlipMdse extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(i++).xxPopPrm, scrnMsg.flipMdseCd);
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxMntEventNm, NLAL2030Constant.EVENT_NM_OPENWIN_FLIP_MDSE);
