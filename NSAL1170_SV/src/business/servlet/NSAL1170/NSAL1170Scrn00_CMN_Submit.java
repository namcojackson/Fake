 ...
 *</pre>
 */
public class NSAL1170Scrn00_CMN_Submit extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NSAL1170BMsg scrnMsg = (NSAL1170BMsg) bMsg;
        NSAL1170CommonLogic.commonInputCheck(scrnMsg);
        NSAL1170CommonLogic.commonAddCheckItem(scrnMsg);
