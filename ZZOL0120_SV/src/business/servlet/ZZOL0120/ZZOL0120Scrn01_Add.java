...
public class ZZOL0120Scrn01_Add extends S21CommonHandler implements ZZOL0120Constant {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
 
        ZZOL0120BMsg scrnMsg = (ZZOL0120BMsg) bMsg;
        scrnMsg.addCheckItem(scrnMsg.menuProcNm_B1);
        scrnMsg.addCheckItem(scrnMsg.othSysUrl_B1);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        S21SortColumnIMGController.clearIMG(SCREEN_NAME_00, scrnMsg, scrnMsg.B.no(0).getBaseContents());
