...
public class ZZOL0120Scrn00_Add extends S21CommonHandler implements ZZOL0120Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.menuProcGrpNm);
        scrnMsg.addCheckItem(scrnMsg.menuProcGrpCd);
        scrnMsg.addCheckItem(scrnMsg.menuProcGrpSortNum);
        scrnMsg.addCheckItem(scrnMsg.menuProcGrpDescTxt);
        scrnMsg.addCheckItem(scrnMsg.wfAppNm);
        scrnMsg.putErrorScreen();
        
        scrnMsg.menuProcGrpCd.setValue(ZYPCommonFunc.leftPad(scrnMsg.menuProcGrpCd.getValue(), 10, "0"));
    }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if ("E".equalsIgnoreCase(bizMsg.getMessageKind())) {
            // button Settings
            this.setButtonEnabled("Upd", false);
            this.setButtonEnabled("Add", true);
