 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB071001;
...
import business.db.NSBI2110_01TMsg;
...
/**
 * <pre>
 * Web OMAL FC Modification Jobs Parts File Batch
 * 
 ...
 * </pre>
 */
public class NSBB071001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB071001().executeBatch(NSBB071001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2110_01TMsg> inTMsgList = new ArrayList<NSBI2110_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2110_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2110_01TMsg> inMsgLst) {
        NSBI2110_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2110_01TMsg[inMsgLst.size()];
    ...
    private NSBI2110_01TMsg setCreateValue(ResultSet rs) {

        NSBI2110_01TMsg inParam = new NSBI2110_01TMsg();
