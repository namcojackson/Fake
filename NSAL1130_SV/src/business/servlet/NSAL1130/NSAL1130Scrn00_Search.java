 ...
 *</pre>
 */
public class NSAL1130Scrn00_Search extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.mtrLbCd_SV);
        scrnMsg.addCheckItem(scrnMsg.effFromDt_SC);
        scrnMsg.addCheckItem(scrnMsg.effThruDt_SC);
