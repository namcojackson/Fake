...
public class ZZZL0070_ZZZL0071 extends S21CommonHandler implements ZZZL0070Constant {
	...
	protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        ZZZL0070BMsg scrnMsg = (ZZZL0070BMsg) bMsg;
        int max = scrnMsg.A.length() - 5;
        if (scrnMsg.A.getValidCount() > max) {
            scrnMsg.setMessageInfo("ZZZM0005I", new String[] {"Job ID", String.valueOf(scrnMsg.A.length() - 5)});
            scrnMsg.A.setValidCount(max);
