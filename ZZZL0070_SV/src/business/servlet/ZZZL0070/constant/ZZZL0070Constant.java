package business.servlet.ZZZL0070.constant;

import parts.common.EZDApplicationContextConst;

public interface ZZZL0070Constant extends EZDApplicationContextConst {
    /**
     * Common button
     */
     ...
     * Screen ID
     */
    static final String SCREEN_ID = "ZZZL0070Scrn00";
    static final String BUSINESS_ID = "ZZZL0070";
    ...
    String DEF_YAXLE  = "ProcessingTime";
     ...
     * Y-axle contents
     */
    static final String[] Y_axle = {"ProcessingTime", "GlobalAreaSize", "Throughput"};
