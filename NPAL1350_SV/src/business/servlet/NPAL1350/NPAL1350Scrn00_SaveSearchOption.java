 ...
 *</pre>
 */
public class NPAL1350Scrn00_SaveSearchOption extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.dsWrkOrdTpCd_PL);
        scrnMsg.addCheckItem(scrnMsg.dsWrkOrdStsNm_PL);
        scrnMsg.addCheckItem(scrnMsg.wrkOrdDt_FM);
        scrnMsg.addCheckItem(scrnMsg.wrkOrdDt_TO);
        scrnMsg.addCheckItem(scrnMsg.prntMdseCd);
