...
/*
 *NSAL0830CMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NSAL0830CMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** XX_SEL_NUM_H*/
	public final EZDCStringItem              xxSelNum_H;

    /** ROW_SQ_NUM_H*/
	public final EZDCBigDecimalItem              rowSqNum_H;
    ...
    /** A*/
	public final business.blap.NSAL0830.NSAL0830_ACMsgArray              A;
    ...
    /** T*/
	public final business.blap.NSAL0830.NSAL0830_TCMsgArray              T;

    /** P*/
	public final business.blap.NSAL0830.NSAL0830_PCMsgArray              P;


	/**
	 * NSAL0830CMsg is constructor.
	 * The initialization when the instance of NSAL0830CMsg is generated.
	 */
	public NSAL0830CMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NSAL0830CMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		xxSelNum_H = (EZDCStringItem)newItem("xxSelNum_H");
		rowSqNum_H = (EZDCBigDecimalItem)newItem("rowSqNum_H");
		...
		A = (business.blap.NSAL0830.NSAL0830_ACMsgArray)newMsgArray("A");
		...
		T = (business.blap.NSAL0830.NSAL0830_TCMsgArray)newMsgArray("T");
		P = (business.blap.NSAL0830.NSAL0830_PCMsgArray)newMsgArray("P");
	}

	/**
	 * get the type of array which is stored
	 * @return NSAL0830CMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NSAL0830CMsgArray();
	}
	...
	{"A", "A", null, "50", "business.blap.NSAL0830.NSAL0830_ACMsgArray", null, null},
	...
	{"T", "T", null, "200", "business.blap.NSAL0830.NSAL0830_TCMsgArray", null, null},
	
	{"P", "P", null, "200", "business.blap.NSAL0830.NSAL0830_PCMsgArray", null, null},
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"XX_SEL_NUM",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxSelNum_H
        {"ROW_SQ_NUM",  NO,  null,null,null, NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//rowSqNum_H
