 ...
 */
package business.blap.NLBL2020.constant;
 ...
 * 2022/12/08   Hitachi         T.Kuroda        Update          QC#60810
...
public class NLBL2020Constant {
    ...
    /** SO List CSV file name */
    public static final String SO_LIST_CSV_NAME = "ManageShippingOrders(SO List)";

    /** SO List CSV Header */
    public static final String[] SO_LIST_CSV_HEADER = {
         ""
        ,""
        ,"Source Order#"
        ,"Line#"
        ...
        ,"UOM"
        ,"Serial#"
        ,"Shipping Creation Date/Time"
        ,"Requested Date"
        ,"Need By Date"
        ,"Picked Qty"
        ,"Ship Qty"
        ,"Pack Slip#"
        ,"Pick Confirm Date/Time"
        ,"Pack Confirm Date/Time"
        ,"Ship Confirm Date/Time"
        ,"Requested Carrier"
        ...
        // START 2023/08/08 M.Kikushima [QC#61677, ADD]
        ,"Scheduling Status"
        // END 2023/08/08 M.Kikushima [QC#61677, ADD]
        ,"Actual Carrier"
        ,"Actual Service Level"
        ,"Master Tracking#"
        ,"Tracking#"
        ,"Shipping Instructions"
        ,"Shipping Order Source"
        ,"Config ID"
        ,"Pick Config ID"
        ,"SS"
        ,"UOM Each Quantity"
    ...
    /** Pick List CSV file name */
    public static final String PICK_LIST_CSV_NAME = "ManageShippingOrders(Pick List)";

    /** Pick List CSV Header */
    public static final String[] PICK_LIST_CSV_HEADER = {
         "Source Order#"
        ,"Line#"
        ,"Shipping Order#"
        ,"Ship Line#"
