...
/*
 *NLBL2020CMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLBL2020CMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** A*/
	public final business.blap.NLBL2020.NLBL2020_ACMsgArray              A;
    ...
    /** B*/
	public final business.blap.NLBL2020.NLBL2020_BCMsgArray              B;

    /** C*/
	public final business.blap.NLBL2020.NLBL2020_CCMsgArray              C;
    ...
    /** P*/
	public final business.blap.NLBL2020.NLBL2020_PCMsgArray              P;
    ...
    /** S*/
	public final business.blap.NLBL2020.NLBL2020_SCMsgArray              S;
    ...
    /** T*/
	public final business.blap.NLBL2020.NLBL2020_TCMsgArray              T;
	...
	/**
	 * NLBL2020CMsg is constructor.
	 * The initialization when the instance of NLBL2020CMsg is generated.
	 */
	public NLBL2020CMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLBL2020CMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		A = (business.blap.NLBL2020.NLBL2020_ACMsgArray)newMsgArray("A");
		...
		B = (business.blap.NLBL2020.NLBL2020_BCMsgArray)newMsgArray("B");
		C = (business.blap.NLBL2020.NLBL2020_CCMsgArray)newMsgArray("C");
		...
		P = (business.blap.NLBL2020.NLBL2020_PCMsgArray)newMsgArray("P");
		...
		S = (business.blap.NLBL2020.NLBL2020_SCMsgArray)newMsgArray("S");
		...
		T = (business.blap.NLBL2020.NLBL2020_TCMsgArray)newMsgArray("T");
		xxFileData_DL = (EZDCMimeSourceItem)newItem("xxFileData_DL");
	}

	/**
	 * get the type of array which is stored
	 * @return NLBL2020CMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLBL2020CMsgArray();
	}

	/**
	 * Definition of Sub class for Schema Item Array(Basic data,Visible Field)
	 */
	private static class NLBL2020CMsgSchemaContents1 {
		...
		//["key name", "variable", "suffix", "array length", "item type", "digits", "after decimal point degits"] <- This is how to define.
			...
			{"A", "A", null, "20", "business.blap.NLBL2020.NLBL2020_ACMsgArray", null, null},
			...
			{"B", "B", null, "20", "business.blap.NLBL2020.NLBL2020_BCMsgArray", null, null},
			{"C", "C", null, "20", "business.blap.NLBL2020.NLBL2020_CCMsgArray", null, null},
			...
			{"P", "P", null, "35", "business.blap.NLBL2020.NLBL2020_PCMsgArray", null, null},
			{"xxSortTblNm", "xxSortTblNm", null, null, TYPE_HANKAKUEISU, "1", null},
			{"xxSortItemNm", "xxSortItemNm", null, null, TYPE_HANKAKUEISU, "50", null},
			{"xxSortOrdByTxt", "xxSortOrdByTxt", null, null, TYPE_HANKAKUEISU, "4", null},
			{"S", "S", null, "200", "business.blap.NLBL2020.NLBL2020_SCMsgArray", null, null},
	...
	private static class NLBL2020CMsgSchemaContents2 {
		...
		private static final String[][] BASE_CONTENTS = {
		//["key name", "variable", "suffix", "array length", "item type", "digits", "after decimal point degits"] <- This is how to define.
			{"T", "T", null, "99", "business.blap.NLBL2020.NLBL2020_TCMsgArray", null, null},
	 ...
	 */
	private static final String[][] BASE_CONTENTS = new String[102][NLBL2020CMsgSchemaContents1.BASE_CONTENTS[0].length];
	static {
		int arcpStartPoint=0;
	System.arraycopy(NLBL2020CMsgSchemaContents1.BASE_CONTENTS, 0, BASE_CONTENTS, arcpStartPoint, NLBL2020CMsgSchemaContents1.BASE_CONTENTS.length);
	arcpStartPoint = arcpStartPoint + NLBL2020CMsgSchemaContents1.BASE_CONTENTS.length;
	System.arraycopy(NLBL2020CMsgSchemaContents2.BASE_CONTENTS, 0, BASE_CONTENTS, arcpStartPoint, NLBL2020CMsgSchemaContents2.BASE_CONTENTS.length);
	arcpStartPoint = arcpStartPoint + NLBL2020CMsgSchemaContents2.BASE_CONTENTS.length;
	}
	...
	static {
		int arcpStartPoint=0;
		System.arraycopy(NLBL2020CMsgSchemaContents1.DISP_CONTENTS, 0, DISP_CONTENTS, arcpStartPoint, NLBL2020CMsgSchemaContents1.DISP_CONTENTS.length);
		arcpStartPoint = arcpStartPoint + NLBL2020CMsgSchemaContents1.DISP_CONTENTS.length;
		System.arraycopy(NLBL2020CMsgSchemaContents2.DISP_CONTENTS, 0, DISP_CONTENTS, arcpStartPoint, NLBL2020CMsgSchemaContents2.DISP_CONTENTS.length);
		arcpStartPoint = arcpStartPoint + NLBL2020CMsgSchemaContents2.DISP_CONTENTS.length;
	}
