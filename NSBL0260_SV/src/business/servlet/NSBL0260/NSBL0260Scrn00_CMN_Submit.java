...
import static business.servlet.NSBL0260.constant.NSBL0260Constant.FUNCTION_SUBMIT;
 ...
 *</pre>
 */
public class NSBL0260Scrn00_CMN_Submit extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NSBL0260BMsg scrnMsg = (NSBL0260BMsg) bMsg;
        NSBL0260CommonLogic.addCheckItems(scrnMsg);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSBL0260CommonLogic.commonAddCheckItem(scrnMsg);
        scrnMsg.putErrorScreen();
