 ...
 *</pre>
 */
public class NSBL0260Scrn00_OpenWin_ModelHeader extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setValue(scrnMsg.xxPopPrm_SE, SELECT_POPUP_MDL_HEADER);
        // set param
        NSBL0260CommonLogic.setParamMdlNm(scrnMsg, scrnMsg.mdlNm_H.getValue());
