 ...
 *</pre>
 */
public class NSBL0260Scrn00_OpenWin_SerialHeaderComb extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setValue(scrnMsg.xxPopPrm_SE, SELECT_POPUP_SER_HEADER_COMB);
        // set param
        setArgForSubScreen(NSBL0260CommonLogic.setConfigSearchPopUpInputParam(scrnMsg, scrnMsg.serNum_C));
    }
}
