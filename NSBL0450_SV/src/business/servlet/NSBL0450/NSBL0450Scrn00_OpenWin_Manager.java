 ...
 *</pre>
 */
public class NSBL0450Scrn00_OpenWin_Manager extends S21CommonHandler {
    ...
    private Object[] setCommonPopUpParam(EZDApplicationContext ctx, NSBL0450BMsg scrnMsg) {
        ...
        setValue(scrnMsg.xxScrEventNm, OPENWIN_MANAGER);
        ...
        params[i++] = "";
        // Window title
        params[i++] = "Resource Manager Search";
        // Table SQL
    ...
    private static String getSqlStr(String glblCmpyCd) {
        ...
        sql.append(" WHERE");
        sql.append("    EXISTS ( SELECT * FROM S21_PSN MGR ");
        sql.append("    WHERE PSN.PSN_CD      = MGR.HR_SUPV_ID");
        sql.append("    AND PSN.GLBL_CMPY_CD  = MGR.GLBL_CMPY_CD");
        sql.append("    AND MGR.EZCANCELFLAG  = '0' ) ");
    ...
    private List<Object[]> getWhereList(NSBL0450BMsg scrnMsg) {
        ...
        h0[WLIST_DSP_OBJ_NM] = "Resource Code";
        ...
        h1[WLIST_DSP_OBJ_NM] = "Resource Name";
    ...
    private List<Object[]> getColumnList() {
        ...
        c0[CLIST_DSP_OBJ_NM] = "Resource Code";
        ...
        c1[CLIST_DSP_OBJ_NM] = "Resource Name";
