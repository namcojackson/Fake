...
/**
 *<pre>
 * NLEL0060Scrn00_OpenWin_RtrnWhCd
 *
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2016/09/13   Fujitsu         C.Tanaka        Create          N/A
 * 2017/05/29   CITS            M.Naito         Update          Merge DS Lv2
 *</pre>
 */
public class NLEL0060Scrn00_OpenWin_RtrnWhCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).xxScrItem10Txt_B1)) {
            rtnWhCd = scrnMsg.B.no(idx).xxScrItem10Txt_B1.getValue();
        }
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(6).xxPopPrm, rtnWhCd);
        scrnMsg.P.no(7).clear();
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(12).xxPopPrm, OPENWIN_RTRN_WH_CD);
