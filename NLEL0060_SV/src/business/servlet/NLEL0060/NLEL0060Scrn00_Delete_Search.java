...
import static business.servlet.NLEL0060.constant.NLEL0060Constant.SRCH_OPT_PK;
 ...
 *</pre>
 */
public class NLEL0060Scrn00_Delete_Search extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.srchOptPk)) {
            scrnMsg.srchOptPk.setErrorInfo(1, ZZM9000E, new String[] {SRCH_OPT_PK });
        }
