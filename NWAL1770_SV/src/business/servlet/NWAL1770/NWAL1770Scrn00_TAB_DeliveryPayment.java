 ...
 *</pre>
 */
public class NWAL1770Scrn00_TAB_DeliveryPayment extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TAB_DELIVERY.equals(dplyTab) || (TAB_ITEMS.equals(dplyTab) && !ZYPCommonFunc.hasValue(scrnMsg.B.no(0).mdseCd_B))) {
            return;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxDplyTab, TAB_DELIVERY);
