...
import static business.servlet.NWAL1770.constant.NWAL1770Constant.MSG_PARAM_CATG;
 ...
 * ----------------------------------------------------------------------
 * 2016/03/09   Fujitsu         T.Yoshida       Create          N/A
 * 2016/05/16   Fujitsu         T.Murai         Update          S21_NA#7861
 * 2023/07/20   Hitachi         T.Fukuta        Update          CSA-QC#61467
 *</pre>
 */
public class NWAL1770Scrn00_OnBlur_DeriveFromSalesRepCode extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.psnNum)) { // S21_NA#7861 Mod
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxRqstFlg.getValue())) {
            ...
            Object[] params = NWAL1770CommonLogic.getParamNWAL1130ForSlsrep(scrnMsg);
