 ...
 *</pre>
 */
public class NWAL1770Scrn00_OnBlur_DeriveFromSoldToName extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.soldToCustAcctNm)) {
            return null;
        }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.addCheckItem(scrnMsg.soldToCustAcctNm);
        ...
        // Add Start 2017/09/05 QC#20923
        NWAL1770CommonLogicForScrnFields.setProtect(this, scrnMsg);
        // Add End 2017/09/05 QC#20923
        ...
        if (ZYPConstant.FLG_ON_Y.equals(scrnMsg.xxRqstFlg.getValue())) {
            ...
            Object[] params = NWAL1770CommonLogic.getParamNMAL6760ForSoldTo(scrnMsg);
            setArgForSubScreen(params);
            return;
        }
