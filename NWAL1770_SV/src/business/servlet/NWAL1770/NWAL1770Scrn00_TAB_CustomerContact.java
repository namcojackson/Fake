 ...
 *</pre>
 */
public class NWAL1770Scrn00_TAB_CustomerContact extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TAB_CUSTOMER.equals(dplyTab) || (TAB_ITEMS.equals(dplyTab) && !ZYPCommonFunc.hasValue(scrnMsg.B.no(0).mdseCd_B))) {
            return;
        }
