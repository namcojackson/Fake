 ...
 * ----------------------------------------------------------------------
 * 2017/09/20   Fujitsu         S.Ohki          Create          N/A
 * 2023/07/20   Hitachi         T.Fukuta        Update          CSA-QC#61467
 *</pre>
 */
public class NWAL1770Scrn00_OnBlur_CustomerPo extends S21CommonHandler {
...
//        return null;
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.custIssPoNum) && !ZYPCommonFunc.hasValue(scrnMsg.custIssPoDt)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.custIssPoDt, scrnMsg.slsDt);
        }
    }
}
