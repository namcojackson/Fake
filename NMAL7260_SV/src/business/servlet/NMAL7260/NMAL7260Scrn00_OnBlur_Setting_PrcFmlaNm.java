 ...
 * 2018/04/04   Fujitsu         H.Nagashima     Create          QC#24550
 * 2018/06/18   Fujitsu         M.Ishii         Update          QC#22594
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_PrcFmlaNm extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcFmlaPk_B1)) {
            scrnMsg.B.no(idx).prcFmlaNm_B1.clear();
            return;
        }
