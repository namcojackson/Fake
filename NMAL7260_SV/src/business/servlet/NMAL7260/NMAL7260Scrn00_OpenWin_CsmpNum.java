...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_CsmpNum
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_CsmpNum extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.CSMP_NUM,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_04, scrnMsg.B.no(idx).csmpNumCmntTxt_04, getGlobalCompanyCode(), scrnMsg.R));
    }
}
