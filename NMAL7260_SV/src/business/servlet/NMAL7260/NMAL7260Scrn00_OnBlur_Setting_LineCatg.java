...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_LineCatg
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_LineCatg extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_25)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_25);
        }
