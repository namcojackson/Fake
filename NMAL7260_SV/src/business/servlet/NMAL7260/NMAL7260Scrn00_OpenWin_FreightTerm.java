...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_FreightTerm
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_FreightTerm extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.FREIGHT_TERM, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_48, scrnMsg.B.no(idx).frtCondDescTxt_48, prmList));
    }
}
