...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_FreightZone
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_FreightZone extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.FREIGHT_ZONE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_49, scrnMsg.B.no(idx).fill40Txt_49, getGlobalCompanyCode(), scrnMsg.R));
    }
}
