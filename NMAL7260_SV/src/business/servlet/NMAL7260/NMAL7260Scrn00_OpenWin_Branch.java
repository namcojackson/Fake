 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_Branch extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.BRANCH, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_19, scrnMsg.B.no(idx).coaBrDescTxt_19, prmList));
    }
}
