 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_SlsMatGrpDescTxt2 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.MATERIAL_GROUP_2,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_60, scrnMsg.B.no(idx).slsMatGrpDescTxt_60, getGlobalCompanyCode(), scrnMsg.R));
    }
}
