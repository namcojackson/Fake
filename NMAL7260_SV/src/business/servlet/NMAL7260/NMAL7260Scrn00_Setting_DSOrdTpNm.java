...
/**
 *<pre>
 * NMAL7260Scrn00_Setting_DSOrdTpNm
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_Setting_DSOrdTpNm extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_12)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_12);
        }
