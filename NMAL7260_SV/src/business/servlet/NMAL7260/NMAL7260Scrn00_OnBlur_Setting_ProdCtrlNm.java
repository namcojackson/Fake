 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_ProdCtrlNm extends S21CommonHandler {
...
//            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_34);
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_06)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_06);
