 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_ProdCtrlNm3 extends S21CommonHandler {
...
//        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_08)) {
//            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_08);
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_34)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_34);
