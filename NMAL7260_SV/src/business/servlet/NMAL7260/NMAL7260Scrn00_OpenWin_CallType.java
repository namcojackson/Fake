...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_CallType
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_CallType extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.CALL_TYPE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_20, scrnMsg.B.no(idx).svcCallTpDescTxt_20, prmList));
    }
}
