...
import static business.servlet.NMAL7260.constant.NMAL7260Constant.DISP_HRCH_ACCT_CD_BILL;
...
/** 
 *<pre>
 *NMAL7260Scrn00_OpenWin_AcctNumCustSold
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2016/04/14   Fujitsu         Y.Kanefusa      Create          QC#6173
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_AcctNumCustSold extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        params[0]  = scrnMsg.B.no(idx).prcRuleCondFromTxt_54;
        params[1]  = scrnMsg.B.no(idx).dsAcctNm_54;
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(12).xxPopPrm, DISP_HRCH_ACCT_CD_BILL);
