...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_CoaProd
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_CoaProd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.PRODUCT_CODE,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_09, scrnMsg.B.no(idx).coaProdDescTxt_09, prmList));
    }
}
