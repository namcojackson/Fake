...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_BillToAcctClss
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_BillToAcctClss extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.BILL_TO_ACCT_CLASSIFICATION, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_18, scrnMsg.B.no(idx).dsAcctClsDescTxt_18, prmList));
    }
}
