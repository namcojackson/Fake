...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_DSOrdTp
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_DSOrdTp extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.ORDER_REASON,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_12, scrnMsg.B.no(idx).dsOrdTpDescTxt_12, prmList));
    }
}
