 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_PrcGrpMatQtyBrk extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.MATERIAL_PRICE_GROUP_QTYBREAK,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_57, scrnMsg.B.no(idx).prcGrpNm_57, getGlobalCompanyCode(), scrnMsg.R));
    }
}
