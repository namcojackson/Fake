...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_PaymentTp
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_PaymentTp extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_31)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_31);
        }
