...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_OrderSrc
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_OrderSrc extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_29)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_29);
        }
