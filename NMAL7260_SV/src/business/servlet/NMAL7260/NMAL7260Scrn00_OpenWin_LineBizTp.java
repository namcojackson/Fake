...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_LineBizTp
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_LineBizTp extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.ORDER_LINE_OF_BUSINESS,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_13, scrnMsg.B.no(idx).lineBizTpDescTxt_13, prmList));
    }
}
