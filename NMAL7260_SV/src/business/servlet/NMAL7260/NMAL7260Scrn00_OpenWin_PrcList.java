...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_PrcList
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_PrcList extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.PRICE_LIST, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_32, scrnMsg.B.no(idx).prcCatgNm_32, getGlobalCompanyCode(), scrnMsg.R));
    }
}
