...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_FreightTerm
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_FreightTerm extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_48)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_48);
        }
