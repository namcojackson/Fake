...
/**
 *<pre>
 * NMAL7260Scrn00_Setting_DSOrdCatgNm
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_Setting_DSOrdCatgNm extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_11)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_11);
        }
