...
/**
 *<pre>
 * NMAL7260Scrn00_Setting_PrcFmlaNm
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_Setting_PrcFmlaNm extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcFmlaPk_B1)) {
            scrnMsg.B.no(idx).prcFmlaPk_B1.setErrorInfo(1, ZZM9000E, new String[] {scrnMsg.B.no(idx).prcFmlaPk_B1.getNameForMessage()});
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcFmlaPk_B1);
        }
