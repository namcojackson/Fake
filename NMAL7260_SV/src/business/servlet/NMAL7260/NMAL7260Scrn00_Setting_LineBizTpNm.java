...
/**
 *<pre>
 * NMAL7260Scrn00_Setting_LineBizTpNm
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_Setting_LineBizTpNm extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_13)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_13);
        }
