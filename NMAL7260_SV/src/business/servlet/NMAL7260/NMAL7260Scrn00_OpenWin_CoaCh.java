 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_CoaCh extends S21CommonHandler {
...
//
//        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.CUSTOMER_CHANNEL_SHIP_TO,
//                scrnMsg.B.no(idx).prcRuleCondFromTxt_B1, scrnMsg.B.no(idx).coaChDescTxt_B1, prmList));
    }
}
