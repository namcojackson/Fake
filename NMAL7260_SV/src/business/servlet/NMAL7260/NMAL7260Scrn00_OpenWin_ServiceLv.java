...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_ServiceLv
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_ServiceLv extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.SERVICE_LEVEL, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_39, scrnMsg.B.no(idx).shpgSvcLvlDescTxt_39, prmList));
    }
}
