...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_PaymentTp
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_PaymentTp extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.PAYMENT_TYPE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_31, scrnMsg.B.no(idx).dsPmtMethDescTxt_31, prmList));
    }
}
