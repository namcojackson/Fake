 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_PrcGrpCustSold extends S21CommonHandler {
        ...
        protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
            ...
            setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.CUSTOMER_PRICE_GROUP_SOLD_TO,
                    scrnMsg.B.no(idx).prcRuleCondFromTxt_53, scrnMsg.B.no(idx).prcGrpNm_53, getGlobalCompanyCode(), scrnMsg.R));
        }
    }