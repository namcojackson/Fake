...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_CoaMdseTp
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_CoaMdseTp extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.MDSE_TYPE,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_08, scrnMsg.B.no(idx).coaMdseTpDescTxt_08, prmList));
    }
}
