...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_LineCatg
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_LineCatg extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.LINE_CATEGORY_LINE_TYPE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_25, scrnMsg.B.no(idx).dsOrdLineCatgDescTxt_25, prmList));
    }
}
