 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_SlsMatGrpDescTxt3 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.MATERIAL_GROUP_3,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_61, scrnMsg.B.no(idx).slsMatGrpDescTxt_61, getGlobalCompanyCode(), scrnMsg.R));
    }
}
