...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_BillToAcctClss
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_BillToAcctClss extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_18)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_18);
        }
