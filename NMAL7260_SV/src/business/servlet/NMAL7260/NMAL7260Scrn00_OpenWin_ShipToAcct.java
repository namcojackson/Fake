...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_ShipToAcct
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_ShipToAcct extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.SHIP_TO_ACCT_CLASSIFICATION, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_42, scrnMsg.B.no(idx).dsAcctClsDescTxt_42, prmList));
    }
}
