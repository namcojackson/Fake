...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_BizUnit
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_BizUnit extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.BUSINESS_UNIT, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_46, scrnMsg.B.no(idx).coaExtnDescTxt_46, prmList));
    }
}
