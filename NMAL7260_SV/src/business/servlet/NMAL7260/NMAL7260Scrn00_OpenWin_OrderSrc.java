...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_OrderSrc
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_OrderSrc extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.ORDER_SOURCE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_29, scrnMsg.B.no(idx).cpoSrcTpDescTxt_29, prmList));
    }
}
