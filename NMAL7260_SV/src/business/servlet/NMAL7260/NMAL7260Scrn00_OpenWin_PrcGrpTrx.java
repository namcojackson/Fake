...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_PrcGrpTrx
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_PrcGrpTrx extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.TRANSACTION_GROUP ,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_14, scrnMsg.B.no(idx).prcGrpNm_14, getGlobalCompanyCode(), scrnMsg.R));
    }
}
