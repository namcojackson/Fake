...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_MarketMdlNm
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_MarketMdlNm extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.MARKETING_MODEL_NAME, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_27, scrnMsg.B.no(idx).mktMdlDescTxt_27, prmList));
    }
}
