...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_ModelSeg
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_ModelSeg extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.MODEL_SEGMENT, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_28, scrnMsg.B.no(idx).mktMdlSegDescTxt_28, prmList));
    }
}
