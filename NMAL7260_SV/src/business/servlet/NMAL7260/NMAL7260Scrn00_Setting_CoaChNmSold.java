 ...
 *</pre>
 */
public class NMAL7260Scrn00_Setting_CoaChNmSold extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_55)) {
            scrnMsg.B.no(idx).prcRuleCondFromTxt_55.setErrorInfo(1, ZZM9000E, new String[] {scrnMsg.B.no(idx).prcRuleCondFromTxt_55.getNameForMessage()});
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_55);
        }
