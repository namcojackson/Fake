 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_ProdCtrl2 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.PROD_CTRL_2_MODEL_SERIES,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_07, scrnMsg.B.no(idx).prodCtrlNm_07, getGlobalCompanyCode(), scrnMsg.R));
