...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_ShipToAcct
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_ShipToAcct extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_42)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_42);
        }
