...
/** 
 *<pre>
 *NMAL7260Scrn00_OpenWin_ProdCtrl5
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2016/04/06   Fujitsu         Y.Kanefusa      Create          QC#6397
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_ProdCtrl5 extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor1130(PRC_RULE_ATTRB.PROD_CTRL_5_PRODUCT_TYPE,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_36, scrnMsg.B.no(idx).prodCtrlNm_36, getGlobalCompanyCode(), scrnMsg.R));
