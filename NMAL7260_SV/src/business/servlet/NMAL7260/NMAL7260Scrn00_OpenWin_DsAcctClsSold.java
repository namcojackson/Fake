...
/** 
 *<pre>
 *NMAL7260Scrn00_OpenWin_DsAcctClsSold
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2015/04/06   Fujitsu         Y.Kanefusa      Update          QC#6397
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_DsAcctClsSold extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.SOLD_TO_ACCT_CLASSIFICATION,
                scrnMsg.B.no(idx).prcRuleCondFromTxt_56, scrnMsg.B.no(idx).dsAcctClsDescTxt_56, prmList));
