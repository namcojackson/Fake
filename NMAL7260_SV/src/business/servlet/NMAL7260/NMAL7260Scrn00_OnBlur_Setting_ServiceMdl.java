...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_ServiceMdl
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_ServiceMdl extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_40)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_40);
        }
