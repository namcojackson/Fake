...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_SpecialHandTp
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_SpecialHandTp extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_44)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_44);
        }
