...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_Branch
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_Branch extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_19)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_19);
        }
