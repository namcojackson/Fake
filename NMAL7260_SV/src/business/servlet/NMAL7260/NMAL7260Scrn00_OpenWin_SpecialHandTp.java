...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_SpecialHandTp
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_SpecialHandTp extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.SPECIAL_HANDLING_TYPE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_44, scrnMsg.B.no(idx).spclHdlgTpDescTxt_44, prmList));
    }
}
