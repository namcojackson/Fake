...
/**
 *<pre>
 * NMAL7260Scrn00_OnBlur_Setting_RtnRsnCd
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OnBlur_Setting_RtnRsnCd extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.B.no(idx).prcRuleCondFromTxt_38)) {
            scrnMsg.addCheckItem(scrnMsg.B.no(idx).prcRuleCondFromTxt_38);
        }
