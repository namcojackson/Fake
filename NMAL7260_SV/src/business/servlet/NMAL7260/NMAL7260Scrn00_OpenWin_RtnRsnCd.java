...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_RtnRsnCd
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_RtnRsnCd extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.RETURN_REASON_CODE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_38, scrnMsg.B.no(idx).rtrnRsnDescTxt_38, prmList));
    }
}
