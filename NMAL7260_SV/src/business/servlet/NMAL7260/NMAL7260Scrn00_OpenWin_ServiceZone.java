...
/**
 *<pre>
 * NMAL7260Scrn00_OpenWin_ServiceZone
 *
 ...
 *</pre>
 */
public class NMAL7260Scrn00_OpenWin_ServiceZone extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMXC105001PriceMasterUtil.getRuleAttrbPopParamFor6050(PRC_RULE_ATTRB.SERVICE_ZONE, //
                scrnMsg.B.no(idx).prcRuleCondFromTxt_41, scrnMsg.B.no(idx).prcSvcZoneDescTxt_41, prmList));
    }
}
