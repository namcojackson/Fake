 ...
 */
package com.canon.cusa.s21.batch.NSB.NSBB072001;
...
import business.db.NSBI2120_01TMsg;
...
/**
 * <pre>
 * Web OMAL FD Service Types File Batch
 * 
 ...
 * </pre>
 */
public class NSBB072001 extends S21BatchMain {
    ...
    public static void main(String[] args) {
        new NSBB072001().executeBatch(NSBB072001.class.getSimpleName());
    }

    private void insertInterfaceData(String sqlId, Map<String, Object> paramMap) {
        List<NSBI2120_01TMsg> inTMsgList = new ArrayList<NSBI2120_01TMsg>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (this.commitNumber == inTMsgList.size()) {
                    ...
                    inTMsgList = new ArrayList<NSBI2120_01TMsg>();
    ...
    private int insertInterfaceData(List<NSBI2120_01TMsg> inMsgLst) {
        NSBI2120_01TMsg[] inMsgArray;
        inMsgArray = new NSBI2120_01TMsg[inMsgLst.size()];
    ...
    private Map<String, Object> setSearchCondition() {
        ...
        inParam.put("mdseItemTpCd", MDSE_ITEM_TP.MAINTENANCE);
        return inParam;
    }

    private NSBI2120_01TMsg setCreateValue(ResultSet rs) {

        NSBI2120_01TMsg inParam = new NSBI2120_01TMsg();
