...
/*
 *NMAL2560_ACMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NMAL2560_ACMsg extends EZDCMsg implements EZDSchemaItemDefines {
    ...
    /** BIZ_AREA_ORG_CD_A*/
	public final EZDCStringItem              bizAreaOrgCd_A;

    /** ORG_HRCH_STRU_DFN_NM_A*/
	public final EZDCStringItem              orgHrchStruDfnNm_A;
    ...
    /** STRU_DFN_CD_1*/
	public final EZDCStringItem              struDfnCd_1;

    /** STRU_DFN_CD_2*/
	public final EZDCStringItem              struDfnCd_2;

    /** STRU_DFN_CD_3*/
	public final EZDCStringItem              struDfnCd_3;

    /** STRU_DFN_CD_4*/
	public final EZDCStringItem              struDfnCd_4;

    /** STRU_DFN_CD_5*/
	public final EZDCStringItem              struDfnCd_5;

    /** STRU_DFN_CD_6*/
	public final EZDCStringItem              struDfnCd_6;

    /** STRU_DFN_CD_7*/
	public final EZDCStringItem              struDfnCd_7;

    /** STRU_DFN_CD_8*/
	public final EZDCStringItem              struDfnCd_8;

    /** STRU_DFN_CD_9*/
	public final EZDCStringItem              struDfnCd_9;

    /** STRU_DFN_CD_10*/
	public final EZDCStringItem              struDfnCd_10;

    /** XX_CHK_MAX_DESC_TXT_IN*/
	public final EZDCStringItem              xxChkMaxDescTxt_IN;

    /** XX_DT_TM_IN*/
	public final EZDCStringItem              xxDtTm_IN;

    /** XX_CHK_MAX_DESC_TXT_UP*/
	public final EZDCStringItem              xxChkMaxDescTxt_UP;

    /** XX_DT_TM_UP*/
	public final EZDCStringItem              xxDtTm_UP;

    /** ORG_HRCH_STRU_DFN_PK_1*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_1;

    /** ORG_HRCH_STRU_DFN_PK_2*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_2;

    /** ORG_HRCH_STRU_DFN_PK_3*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_3;

    /** ORG_HRCH_STRU_DFN_PK_4*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_4;

    /** ORG_HRCH_STRU_DFN_PK_5*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_5;

    /** ORG_HRCH_STRU_DFN_PK_6*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_6;

    /** ORG_HRCH_STRU_DFN_PK_7*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_7;

    /** ORG_HRCH_STRU_DFN_PK_8*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_8;

    /** ORG_HRCH_STRU_DFN_PK_9*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_9;

    /** ORG_HRCH_STRU_DFN_PK_10*/
	public final EZDCBigDecimalItem              orgHrchStruDfnPk_10;
	...
	/**
	 * NMAL2560_ACMsg is constructor.
	 * The initialization when the instance of NMAL2560_ACMsg is generated.
	 */
	public NMAL2560_ACMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NMAL2560_ACMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		bizAreaOrgCd_A = (EZDCStringItem)newItem("bizAreaOrgCd_A");
		orgHrchStruDfnNm_A = (EZDCStringItem)newItem("orgHrchStruDfnNm_A");
		effFromDt_A = (EZDCDateItem)newItem("effFromDt_A");
		effThruDt_A = (EZDCDateItem)newItem("effThruDt_A");
		struDfnCd_1 = (EZDCStringItem)newItem("struDfnCd_1");
		struDfnCd_2 = (EZDCStringItem)newItem("struDfnCd_2");
		struDfnCd_3 = (EZDCStringItem)newItem("struDfnCd_3");
		struDfnCd_4 = (EZDCStringItem)newItem("struDfnCd_4");
		struDfnCd_5 = (EZDCStringItem)newItem("struDfnCd_5");
		struDfnCd_6 = (EZDCStringItem)newItem("struDfnCd_6");
		struDfnCd_7 = (EZDCStringItem)newItem("struDfnCd_7");
		struDfnCd_8 = (EZDCStringItem)newItem("struDfnCd_8");
		struDfnCd_9 = (EZDCStringItem)newItem("struDfnCd_9");
		struDfnCd_10 = (EZDCStringItem)newItem("struDfnCd_10");
		xxChkMaxDescTxt_IN = (EZDCStringItem)newItem("xxChkMaxDescTxt_IN");
		xxDtTm_IN = (EZDCStringItem)newItem("xxDtTm_IN");
		xxChkMaxDescTxt_UP = (EZDCStringItem)newItem("xxChkMaxDescTxt_UP");
		xxDtTm_UP = (EZDCStringItem)newItem("xxDtTm_UP");
		orgHrchStruDfnPk_1 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_1");
		orgHrchStruDfnPk_2 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_2");
		orgHrchStruDfnPk_3 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_3");
		orgHrchStruDfnPk_4 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_4");
		orgHrchStruDfnPk_5 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_5");
		orgHrchStruDfnPk_6 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_6");
		orgHrchStruDfnPk_7 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_7");
		orgHrchStruDfnPk_8 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_8");
		orgHrchStruDfnPk_9 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_9");
		orgHrchStruDfnPk_10 = (EZDCBigDecimalItem)newItem("orgHrchStruDfnPk_10");
	 ...
	 * @return NMAL2560_ACMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NMAL2560_ACMsgArray();
	}
