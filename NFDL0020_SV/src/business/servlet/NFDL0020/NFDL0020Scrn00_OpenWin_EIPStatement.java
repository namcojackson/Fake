 ...
 * ----------------------------------------------------------------------
 * 2018/05/16   Fujitsu         Y.Matsui        Create          QC#24329
 *</pre>
 */
public class NFDL0020Scrn00_OpenWin_EIPStatement extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        try {
            ...
            BigDecimal eipRptRqstPk = scrnMsg.J.no(idx).eipRptRqstPk_J.getValue();
