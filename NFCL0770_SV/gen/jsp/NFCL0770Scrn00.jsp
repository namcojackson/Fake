...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NFCL0770Scrn00">
			<!-- Set Page Name -->
			<input type="hidden" name="pageName" value="Offset Entry">
<center>
					...
					<tr>
						<td>
							...
							<table border="0" cellpadding="1" cellspacing="0">
								...
								<col width="100">
								<col width="72">
								<col width="460"> <!-- <col width="390"> -->
								<col width="430"> <!-- <col width="500"> -->
								<tr>
									<td></td>
									<td class="stab">Customer</td>
									<td class="stab"><ezf:inputText name="payerCustCd" ezfName="payerCustCd" value="1015536" otherAttr=" size=\"12\" maxlength=\"8\" tabindex=\"-1\" ezftoupper=\"\""/></td>
									<td align="left">
										<ezf:inputButton name="CustomerName" value=">>" />
										<ezf:inputText name="dsAcctNm" ezfName="dsAcctNm" value="WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW60" otherAttr=" size=\"37\""/>
										<ezf:inputButton name="OpenWin_SearchAccountByTrxPopup" value="Search By Trx" htmlClass="pBtn8" />
									</td>
...
<%-- ######################################## DETAIL ######################################## --%>
				<table border="0">
					<tr>
							...
							<td>Apply To</td>
							<td><ezf:inputText name="arCustRefNum_H1" ezfName="arCustRefNum_H1" value="123" otherAttr=" size=\"15\" tabindex=\"-1\""/></td>
				...
				<table border="0" cellpadding="1" cellspacing="0">
					...
					<tr>
						...
						<td><ezf:inputButton name="OpenWin_New" value="Adjust" htmlClass="pBtn10" otherAttr=" id=\"OpenWinNewId\""/></td>
					</tr>
				</table>
