...
public class ZZXL0030Scrn00_CMN_Return extends S21CommonHandler implements ZZXL0030Constant {

	@Override
	protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
		
		ZZXL0030BMsg scrnMsg = (ZZXL0030BMsg) bMsg;
		if (!scrnMsg.xxLastBtnNm.getValue().equals(RETURN_BUTTON)) {
			scrnMsg.xxLastBtnNm.isClear();
		}
	}
