 ...
 *</pre>
 */
public class NLBL3070Scrn00_OpenWin_AplyCarrCode extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxMntEventNm, NLBL3070Constant.EVENT_NM_OPENWIN_CARR_APLY);
        setArgForSubScreen(params);
    }

    private List<Object> getSearchConditionSetting(NLBL3070BMsg scrnMsg) {
        ...
        Object[] whereObj2 = {"Carrier Name", "CARR_NM", scrnMsg.carrNm_AP.getValue(), ZYPConstant.FLG_ON_Y };
        ...
        whereList.add(whereObj2);
            ...
            Object[] whereObj1 = {"Carrier Code", "CARR_CD", null, ZYPConstant.FLG_ON_Y };
            Object[] whereObj2 = {"Carrier Name", "CARR_NM", scrnMsg.carrNm_BP.getValue(), ZYPConstant.FLG_ON_Y };
    ...
    private String getSelectSQL(NLBL3070BMsg scrnMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.shpgSvcLvlCd_AP) && NLBL3070Constant.TAB_ID_SCHD.equals(scrnMsg.xxDplyTab.getValue())) {
        ...
        if (NLBL3070Constant.TAB_ID_SCHD.equals(scrnMsg.xxDplyTab.getValue())) {
            ...
            sql = sql.replaceAll("#SHPG_SVC_LVL_CD#", scrnMsg.shpgSvcLvlCd_AP.getValue());
        }
