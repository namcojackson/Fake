...
/*
 *NFBL1120_ABMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NFBL1120_ABMsg extends EZDBMsg implements EZDSchemaItemDefines {
    ...
    // Data Definition
    /** AP_BAT_NUM_A1*/
    public final EZDBStringItem              apBatNum_A1;

    /** AP_BAT_DT_A1*/
    public final EZDBDateItem              apBatDt_A1;
    ...
    /** VND_SITE_NM_A1*/
    public final EZDBStringItem              vndSiteNm_A1;

    /** AP_MAINT_INV_STS_CD_A1*/
    public final EZDBStringItem              apMaintInvStsCd_A1;

    /** AP_MAINT_INV_STS_DESC_TXT_A1*/
    public final EZDBStringItem              apMaintInvStsDescTxt_A1;

    /** APVR_USR_ID_A1*/
    public final EZDBStringItem              apvrUsrId_A1;

    /** VAR_CHAR_CONST_VAL_A1*/
    public final EZDBStringItem              varCharConstVal_A1;

    /** AP_INV_NUM_A1*/
    public final EZDBStringItem              apInvNum_A1;

    /** INV_DT_A1*/
    public final EZDBDateItem              invDt_A1;

    /** AP_INV_AMT_A1*/
    public final EZDBBigDecimalItem              apInvAmt_A1;
    ...
    /**
     * NFBL1120_ABMsg is constructor.
     * The initialization when the instance of NFBL1120_ABMsg is generated.
     */
    public NFBL1120_ABMsg() {
        this(false, -1);
    }
     ...
     */
    public NFBL1120_ABMsg(boolean child, int eleNo) {
        super(child, eleNo);

        // Initialization of item

        apBatNum_A1 = (EZDBStringItem)newItem("apBatNum_A1");
        apBatDt_A1 = (EZDBDateItem)newItem("apBatDt_A1");
        ...
        vndSiteNm_A1 = (EZDBStringItem)newItem("vndSiteNm_A1");
        apMaintInvStsCd_A1 = (EZDBStringItem)newItem("apMaintInvStsCd_A1");
        apMaintInvStsDescTxt_A1 = (EZDBStringItem)newItem("apMaintInvStsDescTxt_A1");
        apvrUsrId_A1 = (EZDBStringItem)newItem("apvrUsrId_A1");
        varCharConstVal_A1 = (EZDBStringItem)newItem("varCharConstVal_A1");
        apInvNum_A1 = (EZDBStringItem)newItem("apInvNum_A1");
        invDt_A1 = (EZDBDateItem)newItem("invDt_A1");
        apInvAmt_A1 = (EZDBBigDecimalItem)newItem("apInvAmt_A1");
     ...
     * @return NFBL1120_ABMsgArray
     */
    public EZDMsgArray getMyArray() {
        return new NFBL1120_ABMsgArray();
    }
    ...
    private static final String[][] DISP_CONTENTS = {
        ...
        {"AP_BAT_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO}, //apBatNum_A1
        {"AP_BAT_DT",  NO,  null,null,"1", NO, NO, NO, NO,null,null,UNI, SEIREKI4,  NO, YES},   //apBatDt_A1
        ...
        {"VND_SITE_NM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},    //vndSiteNm_A1
        {"AP_MAINT_INV_STS_CD",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},    //apMaintInvStsCd_A1
        {"AP_MAINT_INV_STS_DESC_TXT",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},  //apMaintInvStsDescTxt_A1
        {"APVR_USR_ID",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},    //apvrUsrId_A1
        {"VAR_CHAR_CONST_VAL",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO}, //varCharConstVal_A1
        {"AP_INV_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO}, //apInvNum_A1
        {"INV_DT",  NO,  null,null,"1", NO, NO, NO, NO,null,null,UNI, SEIREKI4,  NO, YES},  //invDt_A1
        {"AP_INV_AMT",  NO,  null,null,"0", NO,YES, NO, NO,"17","2",null, null,  NO,  NO},  //apInvAmt_A1
