...
/*
 *NLAL2040_ASMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLAL2040_ASMsg extends EZDSMsg implements EZDSchemaItemDefines {
    ...
    /** SVC_SEG_DESC_TXT_A1*/
	public final EZDSStringItem              svcSegDescTxt_A1;
    ...
    /** FROM_MTR_CNT_A1*/
	public final EZDSBigDecimalItem              fromMtrCnt_A1;

    /** TO_MTR_CNT_A1*/
	public final EZDSBigDecimalItem              toMtrCnt_A1;

    /** FROM_ELPS_MTH_AOT_A1*/
	public final EZDSBigDecimalItem              fromElpsMthAot_A1;

    /** TO_ELPS_MTH_AOT_A1*/
	public final EZDSBigDecimalItem              toElpsMthAot_A1;

    /** RTL_SWH_CD_AS*/
	public final EZDSStringItem              rtlSwhCd_AS;

    /** INVTY_OWNR_CD_AS*/
	public final EZDSStringItem              invtyOwnrCd_AS;

    /** THIRD_PTY_DSP_TP_CD_AS*/
	public final EZDSStringItem              thirdPtyDspTpCd_AS;

    /** MDL_ID_A1*/
	public final EZDSBigDecimalItem              mdlId_A1;

    /** SQ_ID_A1*/
	public final EZDSStringItem              sqId_A1;
	...
	/**
	 * NLAL2040_ASMsg is constructor.
	 * The initialization when the instance of NLAL2040_ASMsg is generated.
	 */
	public NLAL2040_ASMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLAL2040_ASMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		svcSegDescTxt_A1 = (EZDSStringItem)newItem("svcSegDescTxt_A1");
		coaMdseTpCd_A1 = (EZDSStringItem)newItem("coaMdseTpCd_A1");
		coaProdCd_A1 = (EZDSStringItem)newItem("coaProdCd_A1");
		fromMtrCnt_A1 = (EZDSBigDecimalItem)newItem("fromMtrCnt_A1");
		toMtrCnt_A1 = (EZDSBigDecimalItem)newItem("toMtrCnt_A1");
		fromElpsMthAot_A1 = (EZDSBigDecimalItem)newItem("fromElpsMthAot_A1");
		toElpsMthAot_A1 = (EZDSBigDecimalItem)newItem("toElpsMthAot_A1");
		rtlSwhCd_AS = (EZDSStringItem)newItem("rtlSwhCd_AS");
		invtyOwnrCd_AS = (EZDSStringItem)newItem("invtyOwnrCd_AS");
		thirdPtyDspTpCd_AS = (EZDSStringItem)newItem("thirdPtyDspTpCd_AS");
		mdlId_A1 = (EZDSBigDecimalItem)newItem("mdlId_A1");
		sqId_A1 = (EZDSStringItem)newItem("sqId_A1");
	 ...
	 * @return NLAL2040_ASMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLAL2040_ASMsgArray();
	}
