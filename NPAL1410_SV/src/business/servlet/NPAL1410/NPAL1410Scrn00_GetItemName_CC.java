 ...
 *</pre>
 */
public class NPAL1410Scrn00_GetItemName_CC extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NPAL1410BMsg scrnMsg = (NPAL1410BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.A.no(getButtonSelectNumber()).rmnfToCmptMdseCd_A1)) {
            scrnMsg.A.no(getButtonSelectNumber()).rmnfToCmptMdseCd_A1.setErrorInfo(1, NPAM1536E, new String[] {"Convert to Material" });
        }
        scrnMsg.addCheckItem(scrnMsg.A.no(getButtonSelectNumber()).rmnfToCmptMdseCd_A1);
