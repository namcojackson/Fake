...
import static business.servlet.NPAL1410.constant.NPAL1410Constant.NAMM0027E;
 ...
 *</pre>
 */
public class NPAL1410Scrn00_Search extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NPAL1410BMsg scrnMsg = (NPAL1410BMsg) bMsg;

        if (!ZYPCommonFunc.hasValue(scrnMsg.rmnfOrdNum_H1)) {
            scrnMsg.rmnfOrdNum_H1.setErrorInfo(1, NAMM0027E, new String[] {"Reman Order#" });
        }
