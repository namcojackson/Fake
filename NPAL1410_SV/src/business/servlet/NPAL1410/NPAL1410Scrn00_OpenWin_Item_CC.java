 ...
 *</pre>
 */
public class NPAL1410Scrn00_OpenWin_Item_CC extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.eventNm.setValue(EVENT_NAME_ITEM_CC_POPUP);
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_P0, scrnMsg.A.no(getButtonSelectNumber()).rmnfToCmptMdseCd_A1);
