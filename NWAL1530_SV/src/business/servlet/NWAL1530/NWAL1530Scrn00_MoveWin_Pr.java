 ...
 *</pre>
 */
public class NWAL1530Scrn00_MoveWin_Pr extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (TAB_SHIPPING_DETAIL.equals(scrnMsg.xxDplyTab.getValue())) {
            ...
            scrnMsg.P.no(0).xxPopPrm_P.setValue(abMsg.prchReqNum_A.getValue());

        } else {

            NWAL1530_CBMsg cbMsg = scrnMsg.C.no(getButtonSelectNumber());
            scrnMsg.P.no(0).xxPopPrm_P.setValue(cbMsg.prchReqNum_C.getValue());
        }
