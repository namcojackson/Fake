...
import static business.servlet.NWAL1530.constant.NWAL1530Constant.TAB_RWS;
 ...
 *</pre>
 */
public class NWAL1530Scrn00_TAB_Rws extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (ZYPCommonFunc.hasValue(bizMsg.errMsgCd_RW)) {
            scrnMsg.setMessageInfo(bizMsg.errMsgCd_RW.getValue());
        }

        // 2018/07/11 QC#19801 add start
        NWAL1530CommonLogic.initCmnBtnProp(this);
        for (int i=0; i < scrnMsg.D.getValidCount(); i++) {
            scrnMsg.D.no(i).mdseDescShortTxt_D.setInputProtected(true);
        }
        // 2018/07/11 QC#19801 add end
        
        // Display TAB = RWS
        scrnMsg.xxDplyTab.setValue(TAB_RWS);
    }
}
