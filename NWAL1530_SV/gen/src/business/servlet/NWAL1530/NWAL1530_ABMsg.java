...
/*
 *NWAL1530_ABMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NWAL1530_ABMsg extends EZDBMsg implements EZDSchemaItemDefines {
    ...
    /** DS_CPO_LINE_NUM_A*/
	public final EZDBBigDecimalItem              dsCpoLineNum_A;

    /** DS_CPO_LINE_SUB_NUM_A*/
	public final EZDBBigDecimalItem              dsCpoLineSubNum_A;

    /** ORD_QTY_A*/
	public final EZDBBigDecimalItem              ordQty_A;

    /** ORD_LINE_STS_NM_A*/
	public final EZDBStringItem              ordLineStsNm_A;

    /** SO_NUM_A*/
	public final EZDBStringItem              soNum_A;

    /** PRCH_REQ_NUM_A*/
	public final EZDBStringItem              prchReqNum_A;

    /** PO_ORD_NUM_A*/
	public final EZDBStringItem              poOrdNum_A;

    /** RWS_NUM_A*/
	public final EZDBStringItem              rwsNum_A;
	...
	/**
	 * NWAL1530_ABMsg is constructor.
	 * The initialization when the instance of NWAL1530_ABMsg is generated.
	 */
	public NWAL1530_ABMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NWAL1530_ABMsg(boolean child, int eleNo) {
		super(child, eleNo);
		...
		dsCpoLineNum_A = (EZDBBigDecimalItem)newItem("dsCpoLineNum_A");
		dsCpoLineSubNum_A = (EZDBBigDecimalItem)newItem("dsCpoLineSubNum_A");
		ordQty_A = (EZDBBigDecimalItem)newItem("ordQty_A");
		ordLineStsNm_A = (EZDBStringItem)newItem("ordLineStsNm_A");
		soNum_A = (EZDBStringItem)newItem("soNum_A");
		prchReqNum_A = (EZDBStringItem)newItem("prchReqNum_A");
		poOrdNum_A = (EZDBStringItem)newItem("poOrdNum_A");
		rwsNum_A = (EZDBStringItem)newItem("rwsNum_A");
	 ...
	 * @return NWAL1530_ABMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NWAL1530_ABMsgArray();
	}
	...
	private static final String[][] DISP_CONTENTS = {
        ...
        {"DS_CPO_LINE_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsCpoLineNum_A
        {"DS_CPO_LINE_SUB_NUM",  NO,  null,null,"1", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//dsCpoLineSubNum_A
        {"ORD_QTY",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//ordQty_A
        {"ORD_LINE_STS_NM",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//ordLineStsNm_A
        {"SO_NUM",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//soNum_A
        {"PRCH_REQ_NUM",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//prchReqNum_A
        {"PO_ORD_NUM",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//poOrdNum_A
        {"RWS_NUM",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//rwsNum_A
        {"INV_NUM",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//invNum_A
        {"XX_SCR_ITEM_20_TXT",  NO,  null,null,"0", NO, NO, NO, NO,null,null,null, null,  NO,  NO},	//xxScrItem20Txt_A
	};
