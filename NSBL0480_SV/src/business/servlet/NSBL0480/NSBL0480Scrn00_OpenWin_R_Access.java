 ...
 *</pre>
 */
public class NSBL0480Scrn00_OpenWin_R_Access extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        params[i++] = "Access Permits Search Popup";
        ...
        List<Object[]> columnList = NSBL0480CommonLogic.getRColumnList();
        params[i++] = columnList;
        // 5 : Lv2 : Sort Condition (List: Sort columns)
        params[i++] = NSBL0480CommonLogic.getRSortConditionList();
        // 6 : Lv2 : Output
        params[i++] = scrnMsg.C;

        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, "OpenWin_R_Access");
        setArgForSubScreen(params);
    }

    private String getSqlStr(NSBL0480BMsg scrnMsg) {

        return NSBL0480CommonLogic.getRSql(scrnMsg);
    }

    private List<Object[]> getWhereList(NSBL0480BMsg scrnMsg) {

        int index = getButtonSelectNumber();
        return NSBL0480CommonLogic.getRWhereList(scrnMsg, index);
    }
}
