 ...
 *</pre>
 */
public class NSBL0480Scrn00_Delete_Row extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        NSBL0480BMsg scrnMsg = (NSBL0480BMsg) bMsg;
        NSBL0480CommonLogic.addCheckItemRadioBtn(scrnMsg);
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSBL0480CommonLogic.screenControlDelete(this, scrnMsg);
    }
}
