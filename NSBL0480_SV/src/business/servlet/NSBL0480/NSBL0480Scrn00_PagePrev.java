 ...
 *</pre>
 */
public class NSBL0480Scrn00_PagePrev extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NSBL0480CommonLogic.checkInputPageCheckItem(scrnMsg);
        scrnMsg.putErrorScreen();

        NSBL0480CommonLogic.searchScreenControl(this, scrnMsg);
    }
}
