 ...
 *</pre>
 */
public class NFAL0120Scrn00_OpenWin_CashApp extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxModeInd.setValue("2");
        params[0] = scrnMsg.xxModeInd;  // "2" : Read Only Mode
        params[1] = scrnMsg.A.no(selectIdx).rcptNum_A;
