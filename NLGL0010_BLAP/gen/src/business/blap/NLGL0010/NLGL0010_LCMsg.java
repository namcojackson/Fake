...
/*
 *NLGL0010_LCMsg.java  Copyright  FUJITSU LIMITED 2007
 *Outline :
 *    1.
 *Release:
 ...
 */
public class NLGL0010_LCMsg extends EZDCMsg implements EZDSchemaItemDefines {
	...
	// Data Definition
    /** WMS_SHIP_TO_NM_L1*/
	public final EZDCStringItem              wmsShipToNm_L1;

    /** WMS_SHIP_TO_NM_L2*/
	public final EZDCStringItem              wmsShipToNm_L2;

    /** WMS_SHIP_TO_CTAC_NM_L1*/
	public final EZDCStringItem              wmsShipToCtacNm_L1;

    /** FILL_256_TXT_L1*/
	public final EZDCStringItem              fill256Txt_L1;

    /** CTY_ADDR_L1*/
	public final EZDCStringItem              ctyAddr_L1;

    /** ST_CD_L1*/
	public final EZDCStringItem              stCd_L1;

    /** POST_CD_L1*/
	public final EZDCStringItem              postCd_L1;

    /** SHIP_TO_CTAC_NUM_L1*/
	public final EZDCStringItem              shipToCtacNum_L1;


	/**
	 * NLGL0010_LCMsg is constructor.
	 * The initialization when the instance of NLGL0010_LCMsg is generated.
	 */
	public NLGL0010_LCMsg() {
		this(false, -1);
	}
	 ...
	 */
	public NLGL0010_LCMsg(boolean child, int eleNo) {
		super(child, eleNo);

		// Initialization of item

		wmsShipToNm_L1 = (EZDCStringItem)newItem("wmsShipToNm_L1");
		wmsShipToNm_L2 = (EZDCStringItem)newItem("wmsShipToNm_L2");
		wmsShipToCtacNm_L1 = (EZDCStringItem)newItem("wmsShipToCtacNm_L1");
		fill256Txt_L1 = (EZDCStringItem)newItem("fill256Txt_L1");
		ctyAddr_L1 = (EZDCStringItem)newItem("ctyAddr_L1");
		stCd_L1 = (EZDCStringItem)newItem("stCd_L1");
		postCd_L1 = (EZDCStringItem)newItem("postCd_L1");
		shipToCtacNum_L1 = (EZDCStringItem)newItem("shipToCtacNum_L1");
	}

	/**
	 * get the type of array which is stored
	 * @return NLGL0010_LCMsgArray
	 */
	public EZDMsgArray getMyArray() {
		return new NLGL0010_LCMsgArray();
	}
