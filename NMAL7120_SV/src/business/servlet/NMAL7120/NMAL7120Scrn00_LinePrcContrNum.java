...
// * 09/12/2017   Fujitsu         K.Ishizuka      Delete          QC#20206(Sol#269)
// *</pre>
// */
//public class NMAL7120Scrn00_LinePrcContrNum extends S21CommonHandler implements NMAL7120Constant {
//
//	@Override
...
//		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL7120Scrn00_LinePrcContrNum");
//		String selectStr = NMAL7120CommonLogic.setSelectFromStrForPrcContr(getGlobalCompanyCode());
//		List<Object[]> whereList = NMAL7120CommonLogic.setWhereListForPrcContr(scrnMsg.A.no(getButtonSelectNumber()).prcContrNum_A1.getValue());
