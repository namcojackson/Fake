 ...
 *</pre>
 */
public class NMAL7120Scrn00_LineCustNum extends S21CommonHandler implements NMAL7120Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(0).xxPopPrm.setValue(scrnMsg.A.no(getButtonSelectNumber()).dsAcctNum_A1.getValue());
		scrnMsg.P.no(1).xxPopPrm.setValue(scrnMsg.A.no(getButtonSelectNumber()).dsAcctNm_A1.getValue());
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL7120Scrn00_LineCustNum");
