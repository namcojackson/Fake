 ...
 *</pre>
 */
public class NMAL7120Scrn00_Prc_Link extends S21CommonHandler implements NMAL7120Constant {
	...
	protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
		...
		scrnMsg.P.no(29).xxPopPrm.setValue("NMAL7120Scrn00_Prc_Link");
		String selectStr = NMAL7120CommonLogic.setSelectFromStrForPrcCatg(getGlobalCompanyCode());
		List<Object[]> whereList = NMAL7120CommonLogic.setWhereListForPrcCatg(scrnMsg.prcCatgNm_H1.getValue());
