...
<%-- **** Task specific area starts here **** --%>
			...
			<!-- Set Page ID  -->
			<input type="hidden" name="pageID" value="NWAL2190Scrn00">
			<!-- Set Page Name -->
						...
						<td valign="top" width="1100" align="left">
							<table border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td></td>
									<td colspan="4"><ezf:inputText name="dsImptSvcLineNum" ezfName="dsImptSvcLineNum" value="11" otherAttr=" maxlength=\"10\" size=\"10\" style=\"text-align:right\""/></td>
								</tr>
								<tr>
									<td class="stab"><label>Shell Item</label></td>
									<td></td>
									<td colspan="4"><ezf:inputText name="dsImptSvcMdseCd" ezfName="dsImptSvcMdseCd" value="WWWWWWWW" otherAttr=" maxlength=\"16\" size=\"20\""/></td>
								</tr>
								<tr>
									<td class="stab"><label>Shell Term</label></td>
									<td></td>
									<td colspan="4"><ezf:inputText name="shpgIntvlMthNum" ezfName="shpgIntvlMthNum" value="123" otherAttr=" maxlength=\"3\" size=\"4\" style=\"text-align:right\""/></td>
								</tr>
								<tr>
