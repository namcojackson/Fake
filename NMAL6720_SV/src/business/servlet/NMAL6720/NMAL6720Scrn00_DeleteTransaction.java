...
import static business.servlet.NMAL6720.constant.NMAL6720Constant.CHKBOX_D;
 ...
 *</pre>
 */
public class NMAL6720Scrn00_DeleteTransaction extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        List<Integer> checkList = ZYPTableUtil.getSelectedRows(scrnMsg.D, CHKBOX_D, ZYPConstant.CHKBOX_ON_Y);
        if (checkList.size() <= 0) {
            for (int i = 0; i < scrnMsg.D.getValidCount(); i++) {
                scrnMsg.D.no(i).xxChkBox_D1.setErrorInfo(1, NZZM0011E);
