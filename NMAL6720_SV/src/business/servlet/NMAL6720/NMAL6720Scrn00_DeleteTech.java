...
import static business.servlet.NMAL6720.constant.NMAL6720Constant.CHKBOX_G;
 ...
 *</pre>
 */
public class NMAL6720Scrn00_DeleteTech extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        List<Integer> checkList = ZYPTableUtil.getSelectedRows(scrnMsg.G, CHKBOX_G, ZYPConstant.CHKBOX_ON_Y);
        if (checkList.size() <= 0) {
            for (int i = 0; i < scrnMsg.G.getValidCount(); i++) {
                scrnMsg.G.no(i).xxChkBox_G1.setErrorInfo(1, NZZM0011E);
