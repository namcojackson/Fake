...
import static business.servlet.NMAL6720.constant.NMAL6720Constant.CHKBOX_E;
 ...
 *</pre>
 */
public class NMAL6720Scrn00_DeleteMsgNote extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        List<Integer> checkList = ZYPTableUtil.getSelectedRows(scrnMsg.E, CHKBOX_E, ZYPConstant.CHKBOX_ON_Y);
        if (checkList.size() <= 0) {
            for (int i = 0; i < scrnMsg.E.getValidCount(); i++) {
                scrnMsg.E.no(i).xxChkBox_E1.setErrorInfo(1, NZZM0011E);
