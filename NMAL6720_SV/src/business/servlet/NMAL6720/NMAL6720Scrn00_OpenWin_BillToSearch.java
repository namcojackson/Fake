 ...
 *</pre>
 */
public class NMAL6720Scrn00_OpenWin_BillToSearch extends S21CommonHandler {
...
//
//        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(1).xxPopPrm_P, scrnMsg.billToCustCd_SH.getValue());
...
//        params.add(scrnMsg.P.no(23).xxPopPrm_P);
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(15).xxPopPrm_P, scrnMsg.billToCustCd_SH.getValue());
