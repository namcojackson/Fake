 ...
 *</pre>
 */
public class NMAL6720Scrn00_AddCertReq extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (scrnMsg.F.getValidCount() == scrnMsg.F.length()) {
            scrnMsg.setMessageInfo(NMAM0050E, new String[] {String.valueOf(scrnMsg.F.length()) });
