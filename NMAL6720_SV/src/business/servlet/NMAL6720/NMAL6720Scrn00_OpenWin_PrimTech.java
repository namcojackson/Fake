 ...
 *</pre>
 */
public class NMAL6720Scrn00_OpenWin_PrimTech extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm_P.setValue(EVENT_PRIM_TECH);
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(9).xxPopPrm_P, scrnMsg.prfTechCd_SA);
