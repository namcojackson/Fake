 ...
 *</pre>
 */
public class NMAL6720Scrn00_Search_PrimTechNm extends S21CommonHandler {

    @Override
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {

        NMAL6720BMsg scrnMsg = (NMAL6720BMsg) bMsg;
        if (!ZYPCommonFunc.hasValue(scrnMsg.prfTechCd_SA)) {
            scrnMsg.prfTechCd_SA.setErrorInfo(1, NMAL6720Constant.ZZZM9024E, new String[] {"Primary Technician Code" });
        }
