 ...
 *</pre>
 */
public class NMAL6720Scrn00_OpenWin_Tech extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        scrnMsg.xxScrEventNm_P.setValue(EVENT_TECH);
        ...
        if (0 <= index) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(9).xxPopPrm_P, scrnMsg.G.no(index).nonPrfTechCd_G1.getValue());
        }
