...
import static business.servlet.NMAL6860.common.NMAL6860CommonLogic.getParamNWAL1130ForInvoiceSupplier;
 ...
 *</pre>
 */
public class NMAL6860Scrn00_OpenWin_InvoiceSupplier extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (TAB_NM_DETAIL.equals(scrnMsg.xxDplyTab.getValue()) && scrnMsg.invVndCd_H2.isInputProtected()) {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NMAL6860BMsg scrnMsg = (NMAL6860BMsg) bMsg;
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_AD, LINK_OPENWIN_INVOICE_SUPPLIER);
        Object[] params = getParamNWAL1130ForInvoiceSupplier(scrnMsg);
