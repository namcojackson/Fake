 ...
 *</pre>
 */
public class NWAL2200Scrn00_Line_Expand extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        //     scrnMsg.A.no(getButtonSelectNumber()).xxSmryLineFlg_L.setValue(ZYPConstant.FLG_OFF_N);
        // } else if (TAB_RMA.equals(scrnMsg.xxDplyTab.getValue())) {
        //     scrnMsg.C.no(getButtonSelectNumber()).xxSmryLineFlg_R.setValue(ZYPConstant.FLG_OFF_N);
        // }
