...
/**
 *<pre>
 * NWAL2200Scrn00_TAB_RMA
 *
 * Date         Company         Name            Create/Update   Defect No
 * ----------------------------------------------------------------------
 * 2016/01/22   Fujitsu         T.Ishii         Create          N/A
 * 2018/08/31   Fujitsu         S.Takami        Update          S21_NA#26022
 *</pre>
 */
public class NWAL2200Scrn00_TAB_RMA extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxDplyTab, NWAL2200Constant.TAB_RMA);
