...
/**
 *<pre>
 * NWAL2200Scrn00_Line_All_Collapsed
 *
 ...
 *</pre>
 */
public class NWAL2200Scrn00_Line_All_Collapsed extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        if (TAB_LINE_CONFIG.equals(scrnMsg.xxDplyTab.getValue())) {
            ...
            for (int i = 0; i < scrnMsg.A.getValidCount(); i++) {
                ...
                scrnMsg.A.no(i).xxSmryLineFlg_L.setValue(ZYPConstant.FLG_ON_Y);
            }
        } else if (TAB_RMA.equals(scrnMsg.xxDplyTab.getValue())) {

            for (int i = 0; i < scrnMsg.C.getValidCount(); i++) {

                scrnMsg.C.no(i).xxSmryLineFlg_R.setValue(ZYPConstant.FLG_ON_Y);
            }
        }
    }
}
