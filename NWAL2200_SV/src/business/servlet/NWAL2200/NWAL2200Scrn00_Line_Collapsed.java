 ...
 *</pre>
 */
public class NWAL2200Scrn00_Line_Collapsed extends S21CommonHandler {
    ...
    protected EZDCMsg setRequestData(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        // 2018/08/31 S21_NA#26022 Mod Start
        NWAL2200BMsg scrnMsg = (NWAL2200BMsg) bMsg;
        ...
        return bizMsg;
        //return null;
        // 2018/08/31 S21_NA#26022 Mod End
    }
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        // 2018/08/31 S21_NA#26022 Del Start
        // if (TAB_LINE_CONFIG.equals(scrnMsg.xxDplyTab.getValue())) {
        //     scrnMsg.A.no(getButtonSelectNumber()).xxSmryLineFlg_L.setValue(ZYPConstant.FLG_ON_Y);
        // } else if (TAB_RMA.equals(scrnMsg.xxDplyTab.getValue())) {
        //     scrnMsg.C.no(getButtonSelectNumber()).xxSmryLineFlg_R.setValue(ZYPConstant.FLG_ON_Y);
        // }
        // 2018/08/31 S21_NA#26022 Del End
    }
}
