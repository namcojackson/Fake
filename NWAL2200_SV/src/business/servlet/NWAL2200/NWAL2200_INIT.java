 ...
 *</pre>
 */
public class NWAL2200_INIT extends S21INITCommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        NWAL2200CommonLogicForScreenFields.setAmount(scrnMsg);
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.getMessageCode()) && ZYPCommonFunc.hasValue(scrnMsg.ordSrcRefNum)) {
    ...
    protected void setNameForMessage(EZDBMsg bMsg) {
        ...
        NWAL2200CommonLogicForScreenFields.setNameForMessage(scrnMsg);
        NWAL2200CommonLogicForScreenFields.setButtonMessage(this);
    }
}
