 ...
 *</pre>
 */
public class NMAL7420Scrn00_OpenWin_Formula extends S21CommonHandler {
    ...
    protected void doProcess(EZDApplicationContext ctx, EZDBMsg bMsg, EZDCMsg cMsg) {
        ...
        setArgForSubScreen(NMAL7420CommonLogic.getPopParamFor1130(scrnMsg, scrnMsg.prcFmlaPk, //
                scrnMsg.prcFmlaNm, ctx.getEventName(), PRC_RULE_ATTRB.FORMULA, getGlobalCompanyCode()));
