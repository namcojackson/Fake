...
import business.file.NSAL0850F00FMsg;
 ...
 *</pre>
 */
public class NSAL0850BL02 extends S21BusinessHandler {
    ...
    protected void doProcess(EZDCMsg cMsg, EZDSMsg sMsg) {
        ...
        try {
            ...
            if ("NSAL0850_INIT".equals(screenAplID)) {
                doProcess_NSAL0850_INIT((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
                ZYPGUITableColumn.getColData((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_Search".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_Search((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_PageJump".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_PageJump((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_PageNext".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_PageNext((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_PagePrev".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_PagePrev((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_CMN_Reset".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_Reset((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_CMN_Save".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_Search((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_SelectAll".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_SelectAll((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_UnselectAll".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_UnselectAll((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_TBLColumnSort".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_TBLColumnSort((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_CMN_Download".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_Download((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_TemplateDownload".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_TemplateDownload((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            } else if ("NSAL0850Scrn00_Upload".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_Upload((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
            ...
            } else if ("NSAL0850Scrn00_AddRow".equals(screenAplID)) {
                doProcess_NSAL0850Scrn00_AddRow((NSAL0850CMsg) cMsg, (NSAL0850SMsg) sMsg);
     ...
     */
    private void doProcess_NSAL0850_INIT(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
        ...
        ZYPCodeDataUtil.createPulldownList(PRC_ALLOC_INTFC_TP.class, cMsg.prcAllocIntfcTpCd_AP, cMsg.prcAllocIntfcTpDescTxt_AP);

        // search
        getSearchData(cMsg, sMsg);

        // START 2016/07/28 M.Gotou [QC#12141, ADD]
        S21SsmEZDResult ssmResult = NSAL0850Query.getInstance().countCpltData(cMsg, sMsg);
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_PageJump(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_PageNext(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
        int rowIndex = NSAL0850CommonLogic.convertPageNumToFirstRowIndex(cMsg.A.length(), cMsg.xxPageShowCurNum.getValueInt() + 1);
        NSAL0850CommonLogic.pagenation(cMsg, sMsg, rowIndex);
    }
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_PagePrev(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
        int rowIndex = NSAL0850CommonLogic.convertPageNumToFirstRowIndex(cMsg.A.length(), cMsg.xxPageShowCurNum.getValueInt() - 1);
        NSAL0850CommonLogic.pagenation(cMsg, sMsg, rowIndex);
    }
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_Reset(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {

        String xxComnColOrdTxt = cMsg.xxComnColOrdTxt.getValue();
        doProcess_NSAL0850_INIT(cMsg, sMsg);
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_Search(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_TBLColumnSort(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
        ...
        if ("A".equals(sortTblNm)) {
            ...
            // set Paging Data
            NSAL0850CommonLogic.pagenation(cMsg, sMsg, 0);
        }
    }
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_Download(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
        ResultSet rs = null;
        PreparedStatement stmtSelect = null;

        try {
            NSAL0850Query query = NSAL0850Query.getInstance();
            ...
            NSAL0850F00FMsg fMsg = new NSAL0850F00FMsg();
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_TemplateDownload(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_SelectAll(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_UnselectAll(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
     ...
     * @param sMsg NSAL0850SMsg
     */
    private void doProcess_NSAL0850Scrn00_Upload(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
        ...
        try {
            ...
            NSAL0850CommonLogic.updateValidationResult(cMsg, sMsg, prcAllocIntfcTMsgList, false);
    ...
    private boolean validateAndCopyToSMsg_UPLOAD(int status, int count, NSAL0850_ASMsgArray asMsgArray, NSAL0850F00FMsg fMsg, NSAL0850CMsg cMsg, List<String> msgKeys, List<List<String>> msgArgs, List<EZDSItem> msgItems) {
        if (count > asMsgArray.length()) {
            cMsg.setMessageInfo(NSAM0214E);
            return false;
        }
        int row = count - 1;
        NSAL0850_ASMsg sMsgLine = asMsgArray.no(row);
        ...
        if (!hasValue(fMsg.prcAllocIntfcTpCd)) {
            // START 2016/07/27 M.Gotou [QC#11854, MOD]
            setValue(sMsgLine.intfcErrMsgTxt_A, S21MessageFunc.clspGetMessage(NSAM0362E, new String[] {PRC_ALLOC_INTFC_TP_CD}));
            // END 2016/07/27 M.Gotou [QC#11854, MOD]
            sMsgLine.intfcErrMsgTxt_A.setErrorInfo(1, NSAM0362E, new String[] {PRC_ALLOC_INTFC_TP_CD});
            setValue(sMsgLine.dsContrIntfcStsCd_A, DS_CONTR_INTFC_STS.ERROR);

        } else {
            setValue(sMsgLine.prcAllocIntfcTpCd_A, fMsg.prcAllocIntfcTpCd);
        }
        // MOD end 2016/04/22 CSA Defect#6691

        // MOD start 2016/04/22 CSA Defect#6691
        if (!hasValue(fMsg.tocCd)) {
            // START 2016/07/27 M.Gotou [QC#11854, MOD]
            setValue(sMsgLine.intfcErrMsgTxt_A, S21MessageFunc.clspGetMessage(NSAM0362E, new String[] {TOC_CD}));
            // END 2016/07/27 M.Gotou [QC#11854, MOD]
            sMsgLine.intfcErrMsgTxt_A.setErrorInfo(1, NSAM0362E, new String[] {TOC_CD});
            setValue(sMsgLine.dsContrIntfcStsCd_A, DS_CONTR_INTFC_STS.ERROR);

        } else {
            setValue(sMsgLine.tocCd_A, fMsg.tocCd);
        }
        // MOD end 2016/04/22 CSA Defect#6691

        setValue(sMsgLine.tocNm_A, fMsg.tocNm);
        setValue(sMsgLine.prcAllocRate_A, fMsg.prcAllocRate);
...
//        setValue(sMsgLine.mdseCd_A, fMsg.mdseCd);
        // mod start 2016/11/29 CSA Defect#12077
        if (hasValue(fMsg.mdseCd)) {
            setValue(sMsgLine.mdseCd_A, fMsg.mdseCd);
        }
        if (hasValue(fMsg.svcMachMstrPk)) {
            SVC_MACH_MSTRTMsg tMsg = NSAL0850CommonLogic.getSvcMachMstr(cMsg.glblCmpyCd.getValue(), fMsg.svcMachMstrPk.getValue());
            if (tMsg != null) {
                setValue(sMsgLine.svcMachMstrPk_A, fMsg.svcMachMstrPk);
            ...
            if (hasValue(fMsg.serNum)) {
                setValue(sMsgLine.serNum_A, fMsg.serNum);
                SVC_MACH_MSTRTMsg tMsg = NSAL0850CommonLogic.getSvcMachMstrForSerNum(cMsg.glblCmpyCd.getValue(), fMsg.serNum.getValue());
                if (tMsg != null) {
        ...
        // mod end 2016/11/29 CSA Defect#12077
        // END 2016/07/27 M.Gotou [QC#12077, MOD]

        setPrcAllocIntfcData(cMsg.glblCmpyCd.getValue(), sMsgLine, fMsg);

        // MOD start 2016/04/22 CSA Defect#6691
        // duplicate check (Clear duplicate dsActlCntIntfcPk)
        for (int i = 0; i < asMsgArray.getValidCount(); i++) {
            if (hasValue(asMsgArray.no(i).prcAllocIntfcPk_A) && hasValue(sMsgLine.prcAllocIntfcPk_A) && sMsgLine.prcAllocIntfcPk_A.getValue().compareTo(asMsgArray.no(i).prcAllocIntfcPk_A.getValue()) == 0) {
                sMsgLine.prcAllocIntfcPk_A.clear();
    ...
    // START 2016/07/27 M.Gotou [QC#11854, DEL]
...
//    }
    // END 2016/07/27 M.Gotou [QC#11854, DEL]

    // MOD start 2016/04/22 CSA Defect#6691
    private void setPrcAllocIntfcData(String glblCmpyCd, NSAL0850_ASMsg sMsgLine, NSAL0850F00FMsg fMsg) {
        if (hasValue(sMsgLine.dsContrIntfcBatNum_A) && hasValue(sMsgLine.dsContrSrcRefNum_A) && hasValue(sMsgLine.contrIntfcSrcTpCd_A) && hasValue(sMsgLine.prcAllocIntfcTpCd_A) && hasValue(sMsgLine.tocCd_A)) {
            S21SsmEZDResult ssmResultUpdate = NSAL0850Query.getInstance().getPrcAllocIntfcPk(glblCmpyCd, sMsgLine);
            ...
            if (rsUpdate != null) {
                ...
                setValue(sMsgLine.prcAllocIntfcPk_A, (BigDecimal) rsUpdate.get("PRC_ALLOC_INTFC_PK"));
                ...
                S21SsmEZDResult ssmResultInsert = NSAL0850Query.getInstance().getDsContrIntfcPk(glblCmpyCd, sMsgLine);
                ...
                if (rsInsert != null){
                    ...
                    setValue(sMsgLine.dsContrIntfcStsCd_A, (String) rsInsert.get("DS_CONTR_INTFC_STS_CD"));
                    setValue(sMsgLine.intfcErrMsgTxt_A, (String) rsInsert.get("INTFC_ERR_MSG_TXT"));
                ...
                // END 2016/07/27 M.Gotou [QC#12077, ADD]
                    ...
                    setValue(sMsgLine.intfcErrMsgTxt_A, S21MessageFunc.clspGetMessage(NSAM0559E));
                    sMsgLine.intfcErrMsgTxt_A.setErrorInfo(1, NSAM0559E);
                    setValue(sMsgLine.dsContrIntfcStsCd_A, DS_CONTR_INTFC_STS.ERROR);
     ...
     * @return Data List
     */
    private void getSearchData(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {

        sMsg.clear();
        S21SsmEZDResult ssmResult = NSAL0850Query.getInstance().getSearchData(cMsg, sMsg);
     ...
     * @return true/false
     */
    private boolean isAllwDataCrctFlg(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
...
//        }
    ...
    /**
     * Write csv file
     * @param bizMsg NSAL0850CMsg
     * @param globalMsg NSAL0850SMsg
     * @param rs ResultSet
     * @param fMsg NSAL0850F00FMsg
     * @param csvOutFile ZYPCSVOutFile
     * @throws SQLException
     */
    private void writeCsvFileForHeaderTab(NSAL0850CMsg bizMsg, NSAL0850SMsg globalMsg, ResultSet rs, NSAL0850F00FMsg fMsg, ZYPCSVOutFile csvOutFile) throws SQLException {
        ...
        do {
            ...
            setValue(fMsg.prcAllocIntfcTpCd, rs.getString("PRC_ALLOC_INTFC_TP_CD"));
            ...
            setValue(fMsg.tocCd, rs.getString("TOC_CD"));
            setValue(fMsg.tocNm, rs.getString("TOC_NM"));
            setValue(fMsg.prcAllocRate, rs.getBigDecimal("PRC_ALLOC_RATE"));
     ...
     * @param cMsg
     */
    private void writeCsvFileHeader(ZYPCSVOutFile csvOutFile, NSAL0850F00FMsg fMsg, NSAL0850CMsg cMsg) {
        final String[] csvHeader = new String[] {"Interface Bat#", "Source Ref#", "Source Type", "Allocation Type", "Serial#", "IB ID", "Mdse Code", "Rep Code", "Rep Name", "Split%" };
     ...
     */
    private Map<String, Object> setDownloadPram(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
    ...
    // START 2016/07/28 M.Gotou [QC#12141, ADD]
    private void doProcess_NSAL0850Scrn00_AddRow(NSAL0850CMsg cMsg, NSAL0850SMsg sMsg) {
        ...
        S21SsmEZDResult ssmResult = NSAL0850Query.getInstance().getDsContrIntfcActDescTxt(cMsg, sMsg);
        ...
        NSAL0850CommonLogic.pagenation(cMsg, sMsg, vldCnt);
