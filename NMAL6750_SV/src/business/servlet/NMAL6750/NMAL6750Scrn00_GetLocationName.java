 ...
 *</pre>
 */
public class NMAL6750Scrn00_GetLocationName extends S21CommonHandler {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        if (!ZYPCommonFunc.hasValue(scrnMsg.locNum_H1)) {
            scrnMsg.locNum_H1.setErrorInfo(1, ZZM9000E, new String[] {scrnMsg.locNum_H1.getNameForMessage() });
