 ...
 *</pre>
 */
public class NMAL6750Scrn00_OpenWin_Loc extends S21CommonHandler {
...
//        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(5).xxPopPrm_P, scrnMsg.locNum_H1.getValue());
        ZYPEZDItemValueSetter.setValue(scrnMsg.P.no(2).xxPopPrm_P, scrnMsg.locNum_H1.getValue());
        ...
        ZYPEZDItemValueSetter.setValue(scrnMsg.xxScrEventNm, OPENWIN_LOC);
