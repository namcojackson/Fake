 ...
 *</pre>
 */
public class NMAL2620Scrn00_LINK_RESRC_NUM extends S21CommonHandler {
    ...
    private Object[] setParam(EZDApplicationContext ctx, NMAL2620BMsg scrnMsg) {
        ...
        if (ZYPCommonFunc.hasValue(scrnMsg.psnNum_H)) {
            ZYPEZDItemValueSetter.setValue(scrnMsg.xxPopPrm_0, scrnMsg.psnNum_H);
        }
        params[0] = scrnMsg.xxPopPrm_0;
        params[1] = scrnMsg.xxPopPrm_1;
        params[2] = scrnMsg.xxPopPrm_3;
        return params;
    }
}
