...
public class ZYPL0220Scrn00_Update extends S21CommonHandler implements ZYPL0220Constant {
    ...
    protected void checkInput(EZDApplicationContext ctx, EZDBMsg bMsg) {
        ...
        // ------------------------------------------
        // (1)-4check same upld CSV Upload id
        // ------------------------------------------
        String scrnUploadCsvId = scrnMsg.upldCsvId.getValue();
        String saveUploadCsvId = scrnMsg.upldCsvId_SC.getValue();
        if (!saveUploadCsvId.equals(scrnUploadCsvId)) {
            scrnMsg.upldCsvId.setErrorInfo(1, MSG_CD_NO_SEARCHED_UPLD_CSV_ID);
